...
public class DialChartViewer extends Composite implements PaintListener, SelectionListener {
	...
	public static void main(String[] args) {
		...
		DialChartViewer dcViewer = new DialChartViewer(shell, SWT.NO_BACKGROUND);
