...
public class ColoredByValueSeries {

	public static final Chart createColoredByValueSeries() {
		...
		cwaBar.getTitle().getLabel().getCaption().setValue("Bar Chart Colored by Series");//$NON-NLS-1$
