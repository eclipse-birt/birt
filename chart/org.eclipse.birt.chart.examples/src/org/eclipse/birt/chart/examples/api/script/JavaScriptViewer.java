...
public class JavaScriptViewer extends Composite implements PaintListener, SelectionListener {
	...
	public static void main(String[] args) {
		...
		JavaScriptViewer jsViewer = new JavaScriptViewer(shell, SWT.NO_BACKGROUND);
