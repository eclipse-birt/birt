...
public class MarkerLine {
	public static final Chart createMarkerLine() {
		...
		// Title
		cwaBar.getTitle().getLabel().getCaption().setValue("Bar Chart with Marker Line"); //$NON-NLS-1$
		...
		yAxisPrimary.getMarkerLines().add(MarkerLineImpl.create(yAxisPrimary, NumberDataElementImpl.create(20)));
