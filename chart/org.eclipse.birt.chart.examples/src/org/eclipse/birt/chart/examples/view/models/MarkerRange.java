...
public class MarkerRange {
	...
	public static final Chart createMarkerRange() {
		...
		// Title
		cwaBar.getTitle().getLabel().getCaption().setValue("Bar Chart with Marker Range"); //$NON-NLS-1$
		...
		yAxisPrimary.getMarkerRanges().add(MarkerRangeImpl.create(yAxisPrimary, NumberDataElementImpl.create(20),
				NumberDataElementImpl.create(28), ColorDefinitionImpl.GREEN().translucent()));
