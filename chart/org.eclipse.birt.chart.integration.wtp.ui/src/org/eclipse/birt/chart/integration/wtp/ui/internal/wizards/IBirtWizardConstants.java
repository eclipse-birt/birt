...
public interface IBirtWizardConstants {
	...
	public final static String BIRT_RESOURCES_EXTENSION_POINT = "org.eclipse.birt.chart.integration.wtp.ui.birtResourcesDefinition"; //$NON-NLS-1$

	// Extension ID
	public final static String BIRTEXAMPLE_WIZARD_ID = "org.eclipse.birt.chart.integration.wtp.ui.BirtExampleProjectCreationWizard"; //$NON-NLS-1$
	public final static String BIRT_WIZARD_ID = "org.eclipse.birt.chart.integration.wtp.ui.internal.wizards.BirtWebProjectCreationWizard"; //$NON-NLS-1$
	public final static String DEFAULT_BIRT_WEBAPP_ID = "org.eclipse.birt.chart.integration.wtp.ui.defaultBirtWebappDefinition"; //$NON-NLS-1$
