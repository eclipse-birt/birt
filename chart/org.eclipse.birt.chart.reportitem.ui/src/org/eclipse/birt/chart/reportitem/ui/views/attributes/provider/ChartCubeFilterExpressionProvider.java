...
public class ChartCubeFilterExpressionProvider extends ExpressionProvider
{
	 ...
	 * 
	 * @param handle
	 *            report element handle which chart relies on.
	 */
	public ChartCubeFilterExpressionProvider( DesignElementHandle handle,
			final String[] availableExpressions )
	{
		super( handle );
	...
	public Object[] getChildren( Object parent )
	{
		...
		if ( parent instanceof ReportItemHandle
				&& fChartElementHandles.contains( parent ) )
		{
	 ...
	 *            the report item handle which chart relies on.
	 * @return
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.birt.report.designer.ui.dialogs.ExpressionProvider#getAllBindingElementHandles()
	 */
	...
	/**
	 * Overwrite the method to disable Cube Data selection, because chart with
	 * cube set only allow to set filter condition on used expressions.
	 * 
