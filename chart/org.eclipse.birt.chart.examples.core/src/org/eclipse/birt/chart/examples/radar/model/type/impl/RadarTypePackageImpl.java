		...
		RadarTypePackage
{
	...
	public static RadarTypePackage init( )
	{
		...
		RadarTypePackageImpl theRadarTypePackage = (RadarTypePackageImpl) ( EPackage.Registry.INSTANCE.get( eNS_URI ) instanceof RadarTypePackageImpl ? EPackage.Registry.INSTANCE.get( eNS_URI )
	...
	{
		return (EAttribute) radarSeriesEClass.getEStructuralFeatures( )
				.get( 10 );
	}
	...
	{
		return (EReference) radarSeriesEClass.getEStructuralFeatures( )
				.get( 11 );
	}
	...
	public void initializePackageContents( )
	{
		...
		radarSeriesEClass.getESuperTypes( )
				.add( theComponentPackage.getSeries( ) );

		// Initialize classes and features; add operations and parameters
		initEClass( radarSeriesEClass,
				RadarSeries.class,
				"RadarSeries",
				!IS_ABSTRACT,
				!IS_INTERFACE,
	...
	protected void createExtendedMetaDataAnnotations( )
	{
		...
		addAnnotation( radarSeriesEClass, source, new String[]{
				"name", "RadarSeries", "kind", "elementOnly"
		} );
		addAnnotation( getRadarSeries_Marker( ), source, new String[]{
				"kind", "element", "name", "Marker"
		} );
		addAnnotation( getRadarSeries_LineAttributes( ), source, new String[]{
				"kind", "element", "name", "LineAttributes"
		} );
		addAnnotation( getRadarSeries_PaletteLineColor( ),
				source,
				new String[]{
						"kind", "element", "name", "PaletteLineColor"
				} );
		addAnnotation( getRadarSeries_BackgroundOvalTransparent( ),
				source,
				new String[]{
						"kind", "element", "name", "BackgroundOvalTransparent"
				} );
		addAnnotation( getRadarSeries_WebLineAttributes( ),
				source,
				new String[]{
		...
		addAnnotation( getRadarSeries_ConnectEndpoints( ),
				source,
				new String[]{
						"kind", "element", "name", "ConnectEndpoints"
				} );
		addAnnotation( getRadarSeries_WebLabel( ), source, new String[]{
				"kind", "element", "name", "WebLabel"
		} );
