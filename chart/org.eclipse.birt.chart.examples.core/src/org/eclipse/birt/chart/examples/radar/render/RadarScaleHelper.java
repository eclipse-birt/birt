...
public class RadarScaleHelper
{
	...
	public RadarScaleHelper( RadarSeries series,
			ChartWithoutAxes chartWithoutAxes )
	{
	...
	private void computeDsMinMax( ) throws ChartException
	{
		...
		// Auto Scale
		if ( !radarSeries.isSetRadarAutoScale( )
				|| radarSeries.isRadarAutoScale( ) )
		{
			autoscale = true;
		}
		else
		...
		( (ChartWithoutAxesImpl) chartWithoutAxes ).recursivelyGetSeries( el,
				al,
				0,
				0 );
