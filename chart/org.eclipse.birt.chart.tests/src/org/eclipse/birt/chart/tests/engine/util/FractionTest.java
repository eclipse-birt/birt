...
public class FractionTest extends TestCase
{
	...
	private void helpTestExactFraction( double decimal, String fractionListStr,
			String fractionStr )
	{
	...
	private void helpTestMaxDigitsFraction( double decimal,
			String fractionListStr, String fractionStr,
			int maxDigitsForDenominator )
	{
		ContinuedFraction cf = new ContinuedFraction( decimal );
		assertEquals( fractionListStr, cf.toString( ) );
		assertEquals( fractionStr,
				cf.getFractionWithMaxDigits( maxDigitsForDenominator )
						.toString( ) );
	}
	...
	private void helpTestFixedNumeratorFraction( double decimal,
			String fractionStr, long numerator )
	{
		assertEquals( fractionStr,
				FractionApproximator.getFractionWithNumerator( decimal,
						numerator ).toString( ) );
	}
	 ...
	 * ); assertEquals( f1, f3 ); }
	 * 
	 * public void testSubtract( ) { Fraction f1 = new Fraction( 1, 3 );
	 * Fraction f2 = new Fraction( 1, 6 ); Fraction f3 = new Fraction( 1, 2 );
	 * f3.subtract( f2 ); assertEquals( f3, f1 ); }
	 * 
	 * public void testMultiply( ) { Fraction f1 = new Fraction( 1, 3 );
	 * Fraction f2 = new Fraction( 1, 6 ); Fraction f3 = new Fraction( 1, 2 );
	 * f1.multiply( f3 ); assertEquals( f1, f2 ); }
	 * 
	 * public void testDivide( ) { Fraction f1 = new Fraction( 1, 3 ); Fraction
	 * f2 = new Fraction( 1, 6 ); Fraction f3 = new Fraction( 1, 2 ); f2.divide(
	 * f1 ); assertEquals( f2, f3 ); }
	 */
	...
	/*
	 * public void testNegate( ) { Fraction f1 = new Fraction( 1, 3 ); Fraction
	 * f2 = new Fraction( -1, 3 ); f1.negate( ); assertEquals( f1, f2 ); }
	 */
}
