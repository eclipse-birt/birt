...
public class ChartEngine
{
	 ...
	 * 
	 * If the config is null, it will use the BIRT_HOME JVM property to find the OSGi chart bundles.
	 * Subsequent calls to this method will ignore the config parameter .
	 * 
	...
	/**
	 * Retrieve the Serializer interface, used for loading/saving chart design from/to an XML
	 * stream
	 ...
	 * @param deviceID The type of output. Examples are dv.SWT, dv.PNG, dv.JPG, dv.PDF, dv.SVG
	 * @return An IDeviceRenderer instance
	 * @throws ChartException If the device renderer does not exist or there is problem loading  it.
	 */
