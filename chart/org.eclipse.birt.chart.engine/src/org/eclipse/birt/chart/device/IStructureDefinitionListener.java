...
/**
 * Notifies a listener of group change events associated with a structure
 * being rendered.
 */
public interface IStructureDefinitionListener
{
    ...
    /**
     * Sends out a notification to a listener indicating that
     * a structure group has changed (either via a start or end)
     * notification.
     * 
     * @param   scev    Encapsulated information associated with the structure change notification
     *                  that identifies the source object being changed.
     */
