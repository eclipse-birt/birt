...
public final class MarkerRenderer
{
	...
	private void drawCrosshair( IPrimitiveRenderer ipr ) throws ChartException
	{
		...
		final LineAttributes lia = goFactory.createLineAttributes( goFactory.copyOf( cd ),
		...
		if ( bRendering3D )
		{
			...
			lre3d.setStart3D( goFactory.createLocation3D( lo3d.getX( ),
					lo3d.getY( )
					- iSize, lo3d.getZ( ) ) );
			lre3d.setEnd3D( goFactory.createLocation3D( lo3d.getX( ),
					lo3d.getY( )
					+ iSize, lo3d.getZ( ) ) );
		}
		else
		{
			...
			lre.setStart( goFactory.createLocation( lo.getX( ), lo.getY( )
					- iSize ) );
			lre.setEnd( goFactory.createLocation( lo.getX( ), lo.getY( )
					+ iSize ) );
		}
		...
		if ( bRendering3D )
		{
			...
			loa[0] = goFactory.createLocation3D( lo3d.getX( ) - iSize,
					lo3d.getY( )
					+ iSize
					- 1, lo3d.getZ( ) );
			loa[1] = goFactory.createLocation3D( lo3d.getX( ) + iSize,
					lo3d.getY( )
					+ iSize
					- 1, lo3d.getZ( ) );
			loa[2] = goFactory.createLocation3D( lo3d.getX( ) + iSize,
					lo3d.getY( )
					- iSize
					- 1, lo3d.getZ( ) );
			loa[3] = goFactory.createLocation3D( lo3d.getX( ) - iSize,
					lo3d.getY( )
					- iSize
					- 1, lo3d.getZ( ) );
		...
		else
		{
			...
			loa[0] = goFactory.createLocation( lo.getX( ) - iSize, lo.getY( )
					+ iSize );
			loa[1] = goFactory.createLocation( lo.getX( ) + iSize, lo.getY( )
					+ iSize );
			loa[2] = goFactory.createLocation( lo.getX( ) + iSize, lo.getY( )
					- iSize );
			loa[3] = goFactory.createLocation( lo.getX( ) - iSize, lo.getY( )
					- iSize );
		...
		if ( bRendering3D )
		{
			...
			lre3d.setLineAttributes( lia );
			lre3d.setStart3D( goFactory.createLocation3D( lo3d.getX( ) - iSize,
					lo3d.getY( ),
					lo3d.getZ( ) ) );
			lre3d.setEnd3D( goFactory.createLocation3D( lo3d.getX( ) + iSize,
					lo3d.getY( ),
					lo3d.getZ( ) ) );
		...
		else
		{
			...
			lre.setLineAttributes( lia );
			lre.setStart( goFactory.createLocation( lo.getX( ) - iSize,
					lo.getY( ) ) );
	...
	private void drawTriangle( IPrimitiveRenderer ipr ) throws ChartException
	{
		if ( bRendering3D )
		{
			...
			loa[1] = goFactory.createLocation3D( lo3d.getX( ) + iSize,
					...
					- iSize
					- 1, lo3d.getZ( ) );
			loa[2] = goFactory.createLocation3D( lo3d.getX( ), lo3d.getY( )
					+ iSize
					- 1, lo3d.getZ( ) );
		...
		else
		{
			...
			if ( bTransposed )
			{
				loa[0] = goFactory.createLocation( lo.getX( ) - iSize - 1,
						lo.getY( )
						- iSize );
				loa[1] = goFactory.createLocation( lo.getX( ) - iSize - 1,
						lo.getY( )
						+ iSize );
				loa[2] = goFactory.createLocation( lo.getX( ) + iSize - 1,
						lo.getY( ) );
			}
			else
			{
				loa[0] = goFactory.createLocation( lo.getX( ) - iSize,
						lo.getY( )
						+ iSize
						- 1 );
				loa[1] = goFactory.createLocation( lo.getX( ) + iSize,
						lo.getY( )
						+ iSize
						- 1 );
				loa[2] = goFactory.createLocation( lo.getX( ), lo.getY( )
						- iSize
						- 1 );
			}
	...
	private void drawDiamond( IPrimitiveRenderer ipr ) throws ChartException
	{
		...
		{
			final Location3D[] loa = new Location3D[4];
			loa[0] = goFactory.createLocation3D( lo3d.getX( ) - offset,
					lo3d.getY( ),
					lo3d.getZ( ) );
			loa[1] = goFactory.createLocation3D( lo3d.getX( ),
					lo3d.getY( ) + offset,
					lo3d.getZ( ) );
			loa[2] = goFactory.createLocation3D( lo3d.getX( ) + offset,
					lo3d.getY( ),
					lo3d.getZ( ) );
			loa[3] = goFactory.createLocation3D( lo3d.getX( ),
					lo3d.getY( ) - offset,
					lo3d.getZ( ) );
			...
			throws ChartException
	{
		...
		{
			final Location3D[] loa = new Location3D[4];
			loa[0] = goFactory.createLocation3D( lo3d.getX( ) - 2 * offset,
					lo3d.getY( ),
					lo3d.getZ( ) );
			loa[1] = goFactory.createLocation3D( lo3d.getX( ), lo3d.getY( )
					+ 2
					* offset, lo3d.getZ( ) );
			loa[2] = goFactory.createLocation3D( lo3d.getX( ) + 2 * offset,
					lo3d.getY( ),
					lo3d.getZ( ) );
			loa[3] = goFactory.createLocation3D( lo3d.getX( ), lo3d.getY( )
					- 2
					* offset, lo3d.getZ( ) );
			...
			loa1[0] = goFactory.createLocation3D( lo3d.getX( ) - offset + 1,
					lo3d.getY( ) - offset,
					lo3d.getZ( ) );
			loa1[1] = goFactory.createLocation3D( lo3d.getX( ),
					lo3d.getY( ) - 1,
					lo3d.getZ( ) );
			loa1[2] = goFactory.createLocation3D( lo3d.getX( ) + offset - 1,
					lo3d.getY( ) - offset,
					lo3d.getZ( ) );
			loa1[3] = goFactory.createLocation3D( lo3d.getX( ), lo3d.getY( )
					- 2
					* offset
					+ 1, lo3d.getZ( ) );
			...
			loa2[0] = goFactory.createLocation3D( lo3d.getX( ) + 1,
					lo3d.getY( ),
					lo3d.getZ( ) );
			loa2[1] = goFactory.createLocation3D( lo3d.getX( ) + offset,
					lo3d.getY( )
					+ offset
					- 1, lo3d.getZ( ) );
			loa2[2] = goFactory.createLocation3D( lo3d.getX( ) + 2 * offset - 1,
					lo3d.getY( ),
					lo3d.getZ( ) );
			loa2[3] = goFactory.createLocation3D( lo3d.getX( ) + offset,
					lo3d.getY( )
					- offset
					+ 1, lo3d.getZ( ) );

			final Location3D[] loa3 = new Location3D[4];
			loa3[0] = goFactory.createLocation3D( lo3d.getX( ) - offset + 1,
					lo3d.getY( ) + offset,
					lo3d.getZ( ) );
			loa3[1] = goFactory.createLocation3D( lo3d.getX( ), lo3d.getY( )
					+ 2
					* offset
					- 1, lo3d.getZ( ) );
			loa3[2] = goFactory.createLocation3D( lo3d.getX( ) + offset - 1,
					lo3d.getY( ) + offset,
					lo3d.getZ( ) );
			loa3[3] = goFactory.createLocation3D( lo3d.getX( ),
					lo3d.getY( ) + 1,
					lo3d.getZ( ) );

			final Location3D[] loa4 = new Location3D[4];
			loa4[0] = goFactory.createLocation3D( lo3d.getX( ) - 2 * offset + 1,
					lo3d.getY( ),
					lo3d.getZ( ) );
			loa4[1] = goFactory.createLocation3D( lo3d.getX( ) - offset,
					lo3d.getY( )
					+ offset
					- 1, lo3d.getZ( ) );
			loa4[2] = goFactory.createLocation3D( lo3d.getX( ) - 1,
					lo3d.getY( ),
					lo3d.getZ( ) );
			loa4[3] = goFactory.createLocation3D( lo3d.getX( ) - offset,
					lo3d.getY( )
					- offset
					+ 1, lo3d.getZ( ) );
		...
		{
			final Location[] loa = new Location[4];
			loa[0] = goFactory.createLocation( lo.getX( ) - 2 * offset,
					lo.getY( ) );
			loa[1] = goFactory.createLocation( lo.getX( ), lo.getY( )
					+ 2
					* offset );
			loa[2] = goFactory.createLocation( lo.getX( ) + 2 * offset,
					lo.getY( ) );
			loa[3] = goFactory.createLocation( lo.getX( ), lo.getY( )
					- 2
					* offset );
			...
			loa1[0] = goFactory.createLocation( lo.getX( ) - offset + 1,
					lo.getY( )
					- offset );
			loa1[1] = goFactory.createLocation( lo.getX( ), lo.getY( ) - 1 );
			loa1[2] = goFactory.createLocation( lo.getX( ) + offset - 1,
					lo.getY( )
					- offset );
			loa1[3] = goFactory.createLocation( lo.getX( ), lo.getY( )
					- 2
					* offset
					+ 1 );

			final PolygonRenderEvent pre1 = ( (EventObjectCache) ipr ).getEventObject( oSource,
					PolygonRenderEvent.class );
			pre1.setPoints( loa1 );
			pre1.setBackground( paletteEntry );
			pre1.setOutline( la );
			...
			loa2[1] = goFactory.createLocation( lo.getX( ) + offset, lo.getY( )
					+ offset
					- 1 );
			loa2[2] = goFactory.createLocation( lo.getX( ) + 2 * offset - 1,
					lo.getY( ) );
			loa2[3] = goFactory.createLocation( lo.getX( ) + offset, lo.getY( )
					- offset
					+ 1 );

			final Location[] loa3 = new Location[4];
			loa3[0] = goFactory.createLocation( lo.getX( ) - offset + 1,
					lo.getY( )
					+ offset );
			loa3[1] = goFactory.createLocation( lo.getX( ), lo.getY( )
					+ 2
					* offset
					- 1 );
			loa3[2] = goFactory.createLocation( lo.getX( ) + offset - 1,
					lo.getY( )
					+ offset );
			loa3[3] = goFactory.createLocation( lo.getX( ), lo.getY( ) + 1 );

			final Location[] loa4 = new Location[4];
			loa4[0] = goFactory.createLocation( lo.getX( ) - 2 * offset + 1,
					lo.getY( ) );
			loa4[1] = goFactory.createLocation( lo.getX( ) - offset, lo.getY( )
					+ offset
					- 1 );
			loa4[2] = goFactory.createLocation( lo.getX( ) - 1, lo.getY( ) );
			loa4[3] = goFactory.createLocation( lo.getX( ) - offset, lo.getY( )
					- offset
					+ 1 );
	...
	private void drawCross( IPrimitiveRenderer ipr ) throws ChartException
	{
		...
		if ( bRendering3D )
		{
			...
			loa[0] = goFactory.createLocation3D( lo3d.getX( ) - iSize,
					lo3d.getY( )
					+ offset, lo3d.getZ( ) );
			loa[1] = goFactory.createLocation3D( lo3d.getX( ) - offset,
					lo3d.getY( ),
					lo3d.getZ( ) );
			loa[2] = goFactory.createLocation3D( lo3d.getX( ) - iSize,
					lo3d.getY( )
					- offset, lo3d.getZ( ) );
			loa[3] = goFactory.createLocation3D( lo3d.getX( ) - offset,
					lo3d.getY( )
					- iSize, lo3d.getZ( ) );
			loa[4] = goFactory.createLocation3D( lo3d.getX( ),
					lo3d.getY( ) - offset,
					lo3d.getZ( ) );
			loa[5] = goFactory.createLocation3D( lo3d.getX( ) + offset,
					lo3d.getY( )
					- iSize, lo3d.getZ( ) );
			loa[6] = goFactory.createLocation3D( lo3d.getX( ) + iSize,
					lo3d.getY( )
					- offset, lo3d.getZ( ) );
			loa[7] = goFactory.createLocation3D( lo3d.getX( ) + offset,
					lo3d.getY( ),
					lo3d.getZ( ) );
			loa[8] = goFactory.createLocation3D( lo3d.getX( ) + iSize,
					lo3d.getY( )
					+ offset, lo3d.getZ( ) );
			loa[9] = goFactory.createLocation3D( lo3d.getX( ) + offset,
					lo3d.getY( )
					+ iSize, lo3d.getZ( ) );
			loa[10] = goFactory.createLocation3D( lo3d.getX( ) + offset,
					lo3d.getY( ),
					lo3d.getZ( ) );
			loa[11] = goFactory.createLocation3D( lo3d.getX( ) - offset,
					lo3d.getY( )
					+ iSize, lo3d.getZ( ) );
		...
		else
		{
			...
			loa[2] = goFactory.createLocation( lo.getX( ) - iSize, lo.getY( )
					- offset );
			loa[3] = goFactory.createLocation( lo.getX( ) - offset, lo.getY( )
					- iSize );
			loa[4] = goFactory.createLocation( lo.getX( ), lo.getY( ) - offset );
			loa[5] = goFactory.createLocation( lo.getX( ) + offset, lo.getY( )
					- iSize );
			loa[6] = goFactory.createLocation( lo.getX( ) + iSize, lo.getY( )
					- offset );
			loa[7] = goFactory.createLocation( lo.getX( ) + offset, lo.getY( ) );
			loa[8] = goFactory.createLocation( lo.getX( ) + iSize, lo.getY( )
					+ offset );
			loa[9] = goFactory.createLocation( lo.getX( ) + offset, lo.getY( )
					+ iSize );
			loa[10] = goFactory.createLocation( lo.getX( ), lo.getY( ) + offset );
			loa[11] = goFactory.createLocation( lo.getX( ) - offset, lo.getY( )
					+ iSize );
			pre.setPoints( loa );
			pre.setBackground( paletteEntry );
			pre.setOutline( la );
	...
	private void drawSemiCircle( IPrimitiveRenderer ipr ) throws ChartException
	{
		...
		if ( bRendering3D )
		{
			final Arc3DRenderEvent are3d = ( (EventObjectCache) ipr ).getEventObject( oSource,
					Arc3DRenderEvent.class );
			are3d.setBackground( paletteEntry );
			are3d.setOutline( la );
			are3d.setStartAngle( -90.0 );
			are3d.setAngleExtent( 180.0 );
			are3d.setTopLeft3D( goFactory.createLocation3D( lo3d.getX( )
					- iSize
		...
		{
			final ArcRenderEvent are = ( (EventObjectCache) ipr ).getEventObject( oSource,
					ArcRenderEvent.class );
			if ( bTransposed )
			{
				are.setStartAngle( 0 );
				are.setAngleExtent( 180.0 );
				are.setBounds( goFactory.createBounds( lo.getX( ) - iSize,
						lo.getY( )
			...
			else
			{
				...
				are.setAngleExtent( 180.0 );
				are.setBounds( goFactory.createBounds( lo.getX( )
						- iSize
						- offset,
						lo.getY( ) - iSize,
						2 * iSize,
	...
	private void drawHexagon( IPrimitiveRenderer ipr ) throws ChartException
	{
		...
		if ( bRendering3D )
		{
			...
			loa[0] = goFactory.createLocation3D( lo3d.getX( ) - offset2,
					lo3d.getY( )
					- offset1, lo3d.getZ( ) );
			loa[1] = goFactory.createLocation3D( lo3d.getX( ) + offset2,
					lo3d.getY( )
					- offset1, lo3d.getZ( ) );
			loa[2] = goFactory.createLocation3D( lo3d.getX( ) + iSize,
					lo3d.getY( ),
					lo3d.getZ( ) );
			loa[3] = goFactory.createLocation3D( lo3d.getX( ) + offset2,
					lo3d.getY( )
					+ offset1, lo3d.getZ( ) );
			loa[4] = goFactory.createLocation3D( lo3d.getX( ) - offset2,
					lo3d.getY( )
					+ offset1, lo3d.getZ( ) );
			loa[5] = goFactory.createLocation3D( lo3d.getX( ) - iSize,
					lo3d.getY( ),
					lo3d.getZ( ) );
		...
		else
		{
			...
			loa[0] = goFactory.createLocation( lo.getX( ) - offset2, lo.getY( )
					- offset1 );
			loa[1] = goFactory.createLocation( lo.getX( ) + offset2, lo.getY( )
					- offset1 );
			loa[2] = goFactory.createLocation( lo.getX( ) + iSize, lo.getY( ) );
			loa[3] = goFactory.createLocation( lo.getX( ) + offset2, lo.getY( )
					+ offset1 );
			loa[4] = goFactory.createLocation( lo.getX( ) - offset2, lo.getY( )
					+ offset1 );
	...
	private void drawStar( IPrimitiveRenderer ipr ) throws ChartException
	{
		...
		if ( bRendering3D )
		{
			...
			lre0.setStart3D( goFactory.createLocation3D( lo3d.getX( ),
					lo3d.getY( )
					+ iSize, lo3d.getZ( ) ) );
			lre0.setEnd3D( goFactory.createLocation3D( lo3d.getX( ) + offsetx,
					lo3d.getY( ) + offsety,
					lo3d.getZ( ) ) );

			final Line3DRenderEvent lre1 = new Line3DRenderEvent( oSource );
			lre1.setStart3D( goFactory.createLocation3D( lo3d.getX( ) + offsetx,
					lo3d.getY( ) + offsety,
					lo3d.getZ( ) ) );
			lre1.setEnd3D( goFactory.createLocation3D( lo3d.getX( ) + offset1,
					lo3d.getY( ) + offsety,
					lo3d.getZ( ) ) );

			final Line3DRenderEvent lre2 = new Line3DRenderEvent( oSource );
			lre2.setStart3D( goFactory.createLocation3D( lo3d.getX( ) + offset1,
					lo3d.getY( ) + offsety,
					lo3d.getZ( ) ) );
			lre2.setEnd3D( goFactory.createLocation3D( lo3d.getX( ) + offset2,
					lo3d.getY( ) - offset3,
					lo3d.getZ( ) ) );

			final Line3DRenderEvent lre3 = new Line3DRenderEvent( oSource );
			lre3.setStart3D( goFactory.createLocation3D( lo3d.getX( ) + offset2,
					lo3d.getY( ) - offset3,
					lo3d.getZ( ) ) );
			lre3.setEnd3D( goFactory.createLocation3D( lo3d.getX( ) + offset4,
					lo3d.getY( ) - offset5,
					lo3d.getZ( ) ) );

			final Line3DRenderEvent lre4 = new Line3DRenderEvent( oSource );
			lre4.setStart3D( goFactory.createLocation3D( lo3d.getX( ) + offset4,
					lo3d.getY( ) - offset5,
					lo3d.getZ( ) ) );
			lre4.setEnd3D( goFactory.createLocation3D( lo3d.getX( ),
					lo3d.getY( )
					- offsety
			...
			lre5.setStart3D( goFactory.createLocation3D( lo3d.getX( ),
					...
					- offsety
					/ Math.cos( Math.toRadians( 18 ) ), lo3d.getZ( ) ) );
			lre5.setEnd3D( goFactory.createLocation3D( lo3d.getX( ) - offset4,
					lo3d.getY( ) - offset5,
					lo3d.getZ( ) ) );

			final Line3DRenderEvent lre6 = new Line3DRenderEvent( oSource );
			lre6.setStart3D( goFactory.createLocation3D( lo3d.getX( ) - offset4,
					lo3d.getY( ) - offset5,
					lo3d.getZ( ) ) );
			lre6.setEnd3D( goFactory.createLocation3D( lo3d.getX( ) - offset2,
					lo3d.getY( ) - offset3,
					lo3d.getZ( ) ) );

			final Line3DRenderEvent lre7 = new Line3DRenderEvent( oSource );
			lre7.setStart3D( goFactory.createLocation3D( lo3d.getX( ) - offset2,
					lo3d.getY( ) - offset3,
					lo3d.getZ( ) ) );
			lre7.setEnd3D( goFactory.createLocation3D( lo3d.getX( ) - offset1,
					lo3d.getY( ) + offsety,
					lo3d.getZ( ) ) );

			final Line3DRenderEvent lre8 = new Line3DRenderEvent( oSource );
			lre8.setStart3D( goFactory.createLocation3D( lo3d.getX( ) - offset1,
					lo3d.getY( ) + offsety,
					lo3d.getZ( ) ) );
			lre8.setEnd3D( goFactory.createLocation3D( lo3d.getX( ) - offsetx,
					lo3d.getY( ) + offsety,
					lo3d.getZ( ) ) );

			final Line3DRenderEvent lre9 = new Line3DRenderEvent( oSource );
			lre9.setStart3D( goFactory.createLocation3D( lo3d.getX( ) - offsetx,
					lo3d.getY( ) + offsety,
					lo3d.getZ( ) ) );
			lre9.setEnd3D( goFactory.createLocation3D( lo3d.getX( ),
					lo3d.getY( )
					+ iSize, lo3d.getZ( ) ) );
		...
		else
		{
			...
			lre0.setStart( goFactory.createLocation( lo.getX( ), lo.getY( )
					- iSize ) );
			lre0.setEnd( goFactory.createLocation( lo.getX( ) + offsetx,
					lo.getY( )
					- offsety ) );

			final LineRenderEvent lre1 = new LineRenderEvent( oSource );
			lre1.setStart( goFactory.createLocation( lo.getX( ) + offsetx,
					lo.getY( )
					- offsety ) );
			lre1.setEnd( goFactory.createLocation( lo.getX( ) + offset1,
					lo.getY( )
					- offsety ) );

			final LineRenderEvent lre2 = new LineRenderEvent( oSource );
			lre2.setStart( goFactory.createLocation( lo.getX( ) + offset1,
					lo.getY( )
					- offsety ) );
			lre2.setEnd( goFactory.createLocation( lo.getX( ) + offset2,
					lo.getY( )
					+ offset3 ) );

			final LineRenderEvent lre3 = new LineRenderEvent( oSource );
			lre3.setStart( goFactory.createLocation( lo.getX( ) + offset2,
					lo.getY( )
					+ offset3 ) );
			lre3.setEnd( goFactory.createLocation( lo.getX( ) + offset4,
					lo.getY( )
					+ offset5 ) );

			final LineRenderEvent lre4 = new LineRenderEvent( oSource );
			lre4.setStart( goFactory.createLocation( lo.getX( ) + offset4,
					lo.getY( )
					+ offset5 ) );
			lre4.setEnd( goFactory.createLocation( lo.getX( ), lo.getY( )
					+ offsety
					/ Math.cos( Math.toRadians( 18 ) ) ) );

			final LineRenderEvent lre5 = new LineRenderEvent( oSource );
			lre5.setStart( goFactory.createLocation( lo.getX( ), lo.getY( )
					+ offsety
					/ Math.cos( Math.toRadians( 18 ) ) ) );
			lre5.setEnd( goFactory.createLocation( lo.getX( ) - offset4,
					lo.getY( )
					+ offset5 ) );

			final LineRenderEvent lre6 = new LineRenderEvent( oSource );
			lre6.setStart( goFactory.createLocation( lo.getX( ) - offset4,
					lo.getY( )
					+ offset5 ) );
			lre6.setEnd( goFactory.createLocation( lo.getX( ) - offset2,
					lo.getY( )
					+ offset3 ) );

			final LineRenderEvent lre7 = new LineRenderEvent( oSource );
			lre7.setStart( goFactory.createLocation( lo.getX( ) - offset2,
					lo.getY( )
					+ offset3 ) );
			lre7.setEnd( goFactory.createLocation( lo.getX( ) - offset1,
					lo.getY( )
					- offsety ) );

			final LineRenderEvent lre8 = new LineRenderEvent( oSource );
			lre8.setStart( goFactory.createLocation( lo.getX( ) - offset1,
					lo.getY( )
					- offsety ) );
			lre8.setEnd( goFactory.createLocation( lo.getX( ) - offsetx,
					lo.getY( )
					- offsety ) );

			final LineRenderEvent lre9 = new LineRenderEvent( oSource );
			lre9.setStart( goFactory.createLocation( lo.getX( ) - offsetx,
					lo.getY( )
					- offsety ) );
			lre9.setEnd( goFactory.createLocation( lo.getX( ), lo.getY( )
					- iSize ) );
