...
/**
 * <!-- begin-user-doc --> A representation of the literals of the enumeration '<em><b>Chart Dimension</b></em>',
 * and utility methods for working with them. <!-- end-user-doc --> <!-- begin-model-doc -->
 * 
 * This type defines the allowed values for Chart dimensions. Any new Chart dimension type needs to be added here to be
 * supported.
 * 
 * <!-- end-model-doc -->
 * 
...
public final class ChartDimension extends AbstractEnumerator
{
    ...
    /**
     * The '<em><b>Two Dimensional</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * The '<em><b>Two Dimensional With Depth</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
    ...
    /**
     * The '<em><b>Three Dimensional</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     ...
     * <p>
     * If the meaning of '<em><b>Two Dimensional</b></em>' literal object isn't clear, there really should be more
    ...
    /**
     * The '<em><b>Two Dimensional With Depth</b></em>' literal object. <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Two Dimensional With Depth</b></em>' literal object isn't clear, there really
     ...
     * <p>
     * If the meaning of '<em><b>Three Dimensional</b></em>' literal object isn't clear, there really should be
    ...
    /**
     * An array of all the '<em><b>Chart Dimension</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @generated
     */
