...
public interface FontDefinition extends IChartObject
{
	...
	/**
	 * Returns the value of the '<em><b>Size</b></em>' attribute. <!-- begin-user-doc --> Gets the font size. <!--
	 * end-user-doc --> <!-- begin-model-doc -->
	 * 
	 ...
	 * {@link org.eclipse.birt.chart.model.attribute.FontDefinition#getSize <em>Size</em>}' attribute is set. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Bold</b></em>' attribute. <!-- begin-user-doc --> Gets whether the font is
	 * to be in bold. <!-- end-user-doc --> <!-- begin-model-doc -->
	 * 
	...
	/**
	 * Returns whether the value of the '
	 * {@link org.eclipse.birt.chart.model.attribute.FontDefinition#isBold <em>Bold</em>}' attribute is set. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Italic</b></em>' attribute. <!-- begin-user-doc --> Gets whether the font
	 * is to be rendered in italics. <!-- end-user-doc --> <!-- begin-model-doc -->
	 * 
	...
	/**
	 * Returns whether the value of the '
	 * {@link org.eclipse.birt.chart.model.attribute.FontDefinition#isItalic <em>Italic</em>}' attribute is set. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Strikethrough</b></em>' attribute. <!-- begin-user-doc --> Gets whether the
	 * font is to be rendered with strikethrough. <!-- end-user-doc --> <!-- begin-model-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Underline</b></em>' attribute. <!-- begin-user-doc --> Gets whether the
	 * font is to be underlined. <!-- end-user-doc --> <!-- begin-model-doc -->
	 * 
	 ...
	 * {@link org.eclipse.birt.chart.model.attribute.FontDefinition#isUnderline <em>Underline</em>}' attribute. <!--
	 * begin-user-doc --> Sets whether the font is to be underlined. <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Word Wrap</b></em>' attribute. <!-- begin-user-doc --> Gets whether the
	 * word wrapping is enabled. <!-- end-user-doc --> <!-- begin-model-doc -->
	 * 
	...
	/**
	 * Sets the value of the '
	 * {@link org.eclipse.birt.chart.model.attribute.FontDefinition#isWordWrap <em>Word Wrap</em>}' attribute. <!--
	 * begin-user-doc --> Sets whether the word wrapping is enabled. <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Word Wrap</em>' attribute.
	 * @see #isSetWordWrap()
	 * @see #unsetWordWrap()
	 * @see #isWordWrap()
	 * @generated
	...
	/**
	 * Returns the value of the '<em><b>Alignment</b></em>' containment reference. <!-- begin-user-doc --> Gets the
	 * text alignment for the font. <!-- end-user-doc --> <!-- begin-model-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Rotation</b></em>' attribute. <!-- begin-user-doc --> Gets the text
	 * rotation angle (in degrees). <!-- end-user-doc --> <!-- begin-model-doc -->
	 * 
	 * Holds the angle (in degrees) through which the text is to be rotated while rendering.
	 * 
	 * <!-- end-model-doc -->
	 * 
	...
	/**
	 * Sets the value of the '
	 * {@link org.eclipse.birt.chart.model.attribute.FontDefinition#getRotation <em>Rotation</em>}' attribute. <!--
	 * begin-user-doc --> Sets the text rotation angle (in degrees). <!-- end-user-doc -->
	 * 
	 * @param value
