...
public class DataPackageImpl extends EPackageImpl implements DataPackage
{
    ...
    public void initializePackageContents()
    {
        ...
        initEReference(getSeriesDefinition_FormatSpecifier(), theAttributePackage.getFormatSpecifier(), null,
            "formatSpecifier", null, 1, 1, SeriesDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
            IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    protected void createExtendedMetaDataAnnotations()
    {
        ...
        addAnnotation(getSeriesDefinition_FormatSpecifier(), source, new String[]
        {
