...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Date Format Specifier</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class DateFormatSpecifierImpl extends FormatSpecifierImpl implements DateFormatSpecifier
{
    ...
    /**
     * The default value of the '{@link #getDetail() <em>Detail</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getDetail()
     * @generated @ordered
    ...
    /**
     * The cached value of the '{@link #getDetail() <em>Detail</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getDetail()
     * @generated @ordered
    ...
    private final int getJavaType() throws UndefinedValueException
    {
        if (!isSetType())
        {
            throw new UndefinedValueException("The TYPE has not been set for this instance of DateFormatSpecifier");
        }
