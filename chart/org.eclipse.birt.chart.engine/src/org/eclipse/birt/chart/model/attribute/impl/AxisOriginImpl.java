...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Axis Origin</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class AxisOriginImpl extends EObjectImpl implements AxisOrigin
{
	...
	public void setType( IntersectionType newType )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					AttributePackage.AXIS_ORIGIN__TYPE,
					oldType,
					type,
					!oldTypeESet ) );
	}
			...
			NotificationChain msgs )
	{
		...
		if ( eNotificationRequired( ) )
		{
			ENotificationImpl notification = new ENotificationImpl( this,
					Notification.SET,
					AttributePackage.AXIS_ORIGIN__VALUE,
					oldValue,
					newValue );
			if ( msgs == null )
				msgs = notification;
	...
	public static AxisOrigin create( EObject parent, EReference ref )
	{
