...
public class TypePackageImpl extends EPackageImpl implements TypePackage
{
	...
	public static TypePackage init( )
	{
		...
		TypePackageImpl theTypePackage = (TypePackageImpl) ( EPackage.Registry.INSTANCE.get( eNS_URI ) instanceof TypePackageImpl ? EPackage.Registry.INSTANCE.get( eNS_URI )
				: new TypePackageImpl( ) );
	...
	protected void createExtendedMetaDataAnnotations( )
	{
		...
		addAnnotation( getLineSeries_ConnectMissingValue( ),
				source,
				new String[]{
						"kind", "element", //$NON-NLS-1$ //$NON-NLS-2$
