 ...
 * </li>
 * <li>{@link org.eclipse.birt.chart.model.component.impl.ScaleImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class ScaleImpl extends EObjectImpl implements Scale
{
    ...
    /**
     * The cached value of the '{@link #getMin() <em>Min</em>}' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getMin()
     * @generated @ordered
    ...
    /**
     * The cached value of the '{@link #getMax() <em>Max</em>}' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getMax()
     * @generated @ordered
    ...
    /**
     * The cached value of the '{@link #getStep() <em>Step</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @see #getStep()
     * @generated @ordered
    ...
    public void setType(String newType)
    {
        ...
        type = newType;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ComponentPackage.SCALE__TYPE, oldType, type));
    }
    ...
    public Object eGet(EStructuralFeature eFeature, boolean resolve)
    {
        switch (eDerivedStructuralFeatureID(eFeature))
        {
            ...
            case ComponentPackage.SCALE__TYPE:
                return getType();
        }
