 ...
 * <li>{@link org.eclipse.birt.chart.model.data.SeriesDefinition#getSeriesDefinitions <em>Series Definitions</em>}
 * </li>
...
public interface SeriesDefinition extends EObject
{
    ...
    /**
     * Returns the value of the '<em><b>Series Palette</b></em>' containment reference. <!-- begin-user-doc -->
     * Gets the palette associated with the series definiton instance. This palette will be used to determine the
     * sequence of colors for the series that are represented by this definition. <!-- end-user-doc -->
     * 
     ...
     * {@link org.eclipse.birt.chart.model.data.SeriesDefinition#getSeriesPalette <em>Series Palette</em>}' containment
     * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Series Palette</em>' containment reference.
    ...
    /**
     * Returns the value of the '<em><b>Series</b></em>' containment reference list. The list contents are of type
     * {@link org.eclipse.birt.chart.model.component.Series}. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc -->
     * 
     ...
     * @model type="org.eclipse.birt.chart.model.component.Series" containment="true" resolveProxies="false"
     *        required="true"
     * @generated
     */
    EList getSeries();
    ...
    /**
     * Returns the value of the '<em><b>Grouping</b></em>' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc -->
     * 
     * Defines if and how the series data is to be grouped for display. This should only be applied to Base Series.
     * 
     * <!-- end-model-doc -->
     * 
     ...
     * 
     * @param value
     *            the new value of the '<em>Grouping</em>' containment reference.
     * @see #getGrouping()
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Sorting</b></em>' attribute. The default value is <code>"Ascending"</code>.
     * The literals are from the enumeration {@link org.eclipse.birt.chart.model.attribute.SortOption}. <!--
     * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * 
     * Defines if and how the series data is to be sorted for display. This should only be applied to Base Series.
     * 
     * <!-- end-model-doc -->
     * 
     ...
     * {@link org.eclipse.birt.chart.model.data.SeriesDefinition#getSorting <em>Sorting</em>}' attribute is set. <!--
