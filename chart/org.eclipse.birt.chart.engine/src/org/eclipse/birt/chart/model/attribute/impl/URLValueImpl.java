 ...
 *   <li>{@link org.eclipse.birt.chart.model.attribute.impl.URLValueImpl#getLabel <em>Label</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class URLValueImpl extends ActionValueImpl implements URLValue
{
			...
			NotificationChain msgs )
	{
		...
		if ( eNotificationRequired( ) )
		{
			ENotificationImpl notification = new ENotificationImpl( this,
					Notification.SET,
					AttributePackage.URL_VALUE__LABEL,
					oldLabel,
					newLabel );
			if ( msgs == null )
				msgs = notification;
			...
			int featureID, NotificationChain msgs )
	{
		switch ( featureID )
		{
			case AttributePackage.URL_VALUE__LABEL :
