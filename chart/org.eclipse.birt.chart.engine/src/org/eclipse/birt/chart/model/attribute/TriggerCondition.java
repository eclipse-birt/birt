...
/**
 * <!-- begin-user-doc --> A representation of the literals of the enumeration '<em><b>Trigger Condition</b></em>',
 * and utility methods for working with them. <!-- end-user-doc --> <!-- begin-model-doc -->
 * 
 * This type defines the allowed values for Trigger conditions (for interactivity with chart). Any new condition needs
...
public final class TriggerCondition extends AbstractEnumerator
{
    ...
    /**
     * The '<em><b>Mouse Hover</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * The '<em><b>Mouse Click</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     ...
     * <p>
     * If the meaning of '<em><b>Mouse Hover</b></em>' literal object isn't clear, there really should be more of a
     * description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     ...
     * <p>
     * If the meaning of '<em><b>Mouse Click</b></em>' literal object isn't clear, there really should be more of a
     * description here...
     * </p>
     * <!-- end-user-doc -->
     * 
