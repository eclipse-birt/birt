...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Needle</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class NeedleImpl extends EObjectImpl implements Needle
{
	...
	{
		return ComponentPackage.eINSTANCE.getNeedle( );
	}
			...
			LineAttributes newLineAttributes, NotificationChain msgs )
	{
		...
		if ( eNotificationRequired( ) )
		{
			ENotificationImpl notification = new ENotificationImpl( this,
					Notification.SET,
					ComponentPackage.NEEDLE__LINE_ATTRIBUTES,
					oldLineAttributes,
					newLineAttributes );
			if ( msgs == null )
				msgs = notification;
	...
	public void setDecorator( LineDecorator newDecorator )
	{
		...
		if ( eNotificationRequired( ) )
			eNotify( new ENotificationImpl( this,
					Notification.SET,
					ComponentPackage.NEEDLE__DECORATOR,
					oldDecorator,
					decorator,
					!oldDecoratorESet ) );
	}
