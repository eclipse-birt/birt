...
public class BoundsImpl extends EObjectImpl implements Bounds
{
    ...
    {
        return AttributePackage.eINSTANCE.getBounds();
    }
    ...
    {
        return BoundsImpl.create(getLeft() + ins.getLeft(), getTop() + ins.getTop(), getWidth() - ins.getLeft()
            - ins.getRight(), getHeight() - ins.getTop() - ins.getBottom());
    }

    /*
     * (non-Javadoc)
     * 
     * @see org.eclipse.birt.chart.model.attribute.Bounds#delta(double, double, double, double)
     */
    ...
    {
        set(getLeft() + ins.getLeft(), getTop() + ins.getTop(), getWidth() - ins.getLeft() - ins.getRight(),
