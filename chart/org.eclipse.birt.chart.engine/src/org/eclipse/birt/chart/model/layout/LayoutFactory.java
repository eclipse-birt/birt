...
public interface LayoutFactory extends EFactory
{
    ...
    /**
     * Returns a new object of class '<em>Client Area</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Label Block</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Legend</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Plot</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Title Block</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
