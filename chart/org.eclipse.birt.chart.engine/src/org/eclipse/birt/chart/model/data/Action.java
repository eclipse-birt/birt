...
public interface Action extends EObject
{
	 ...
	 * The literals are from the enumeration {@link org.eclipse.birt.chart.model.attribute.ActionType}. <!--
	 ...
	 * @model default="URL_Redirect" unique="false" unsettable="true" required="true"
	 * @generated
	 */
	ActionType getType( );
	...
	/**
	 * Returns the value of the '<em><b>Value</b></em>' containment reference. <!-- begin-user-doc --> Gets the
	 * value of the action. This value defines the details for the action to be performed for a given element. (e.g. If
	 * action type is 'URL', the actual URL will be the value). <!-- end-user-doc --> <!-- begin-model-doc -->
	 * 
