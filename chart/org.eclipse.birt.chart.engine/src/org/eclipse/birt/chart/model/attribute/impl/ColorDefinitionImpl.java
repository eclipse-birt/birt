...
public class ColorDefinitionImpl extends FillImpl implements ColorDefinition
{
	...
	public int hashCode( )
	{
		...
		result = prime * result + ( blueESet ? 1231 : 1237 );
		result = prime * result + green;
		result = prime * result + ( greenESet ? 1231 : 1237 );
		result = prime * result + red;
		result = prime * result + ( redESet ? 1231 : 1237 );
		result = prime * result + transparency;
		result = prime * result + ( transparencyESet ? 1231 : 1237 );
		return result;
	}
	...
	public boolean equals( Object obj )
	{
		...
		if ( blue != other.blue )
			return false;
		if ( blueESet != other.blueESet )
			return false;
		if ( green != other.green )
			return false;
		if ( greenESet != other.greenESet )
			return false;
		if ( red != other.red )
			return false;
		if ( redESet != other.redESet )
			return false;
		if ( transparency != other.transparency )
			return false;
		if ( transparencyESet != other.transparencyESet )
			return false;
		return true;
	}
