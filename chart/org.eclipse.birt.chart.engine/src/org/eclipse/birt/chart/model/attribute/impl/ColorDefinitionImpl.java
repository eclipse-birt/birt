...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Color Definition</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class ColorDefinitionImpl extends FillImpl implements ColorDefinition
{
    ...
    /**
     * The default value of the '{@link #getBlue() <em>Blue</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getBlue()
     * @generated @ordered
    ...
    /**
     * A convenient method provided to initialize member variables (without transparency)
     * 
    ...
    /**
     * A convenient method provided to initialize all member variables (including transparency)
     * 
     * Note: Manually written
     * 
     * @param iRed
    ...
    public final ColorDefinition brighter()
    {
        ...
        return ColorDefinitionImpl.create(Math.min((int) (r / FACTOR), 255), Math.min((int) (g / FACTOR), 255), Math
    ...
    {
        return ColorDefinitionImpl.create(Math.max((int) (getRed() * FACTOR), 0), Math.max((int) (getGreen() * FACTOR),
            0), Math.max((int) (getBlue() * FACTOR), 0), getTransparency());
    }
