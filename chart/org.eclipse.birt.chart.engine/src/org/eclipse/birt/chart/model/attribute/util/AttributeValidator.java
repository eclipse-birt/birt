...
public class AttributeValidator extends EObjectValidator
{
			...
			DiagnosticChain diagnostics, Map<Object, Object> context )
	{
		switch ( classifierID )
		{
			...
			case AttributePackage.AXIS_ORIGIN :
				return validateAxisOrigin( (AxisOrigin) value,
						diagnostics,
						context );
			...
			case AttributePackage.DATA_POINT_COMPONENT :
				return validateDataPointComponent( (DataPointComponent) value,
						diagnostics,
						context );
			...
			case AttributePackage.FONT_DEFINITION :
				return validateFontDefinition( (FontDefinition) value,
						diagnostics,
						context );
			...
			case AttributePackage.JAVA_NUMBER_FORMAT_SPECIFIER :
				return validateJavaNumberFormatSpecifier( (JavaNumberFormatSpecifier) value,
						diagnostics,
						context );
			case AttributePackage.LINE_ATTRIBUTES :
				return validateLineAttributes( (LineAttributes) value,
						diagnostics,
						context );
			...
			case AttributePackage.LOCATION3_D :
				return validateLocation3D( (Location3D) value,
						diagnostics,
						context );
			...
			case AttributePackage.SERIES_VALUE :
				return validateSeriesValue( (SeriesValue) value,
						diagnostics,
						context );
			...
			case AttributePackage.TEXT_ALIGNMENT :
				return validateTextAlignment( (TextAlignment) value,
						diagnostics,
						context );
			case AttributePackage.TOOLTIP_VALUE :
				return validateTooltipValue( (TooltipValue) value,
						diagnostics,
						context );
			...
			case AttributePackage.ACTION_TYPE_OBJECT :
				return validateActionTypeObject( (ActionType) value,
						diagnostics,
						context );
			...
			case AttributePackage.AXIS_TYPE_OBJECT :
				return validateAxisTypeObject( (AxisType) value,
						diagnostics,
						context );
			case AttributePackage.CHART_DIMENSION_OBJECT :
				return validateChartDimensionObject( (ChartDimension) value,
						diagnostics,
						context );
			...
			case AttributePackage.DATA_TYPE_OBJECT :
				return validateDataTypeObject( (DataType) value,
						diagnostics,
						context );
			case AttributePackage.DATE_FORMAT_DETAIL_OBJECT :
				return validateDateFormatDetailObject( (DateFormatDetail) value,
						diagnostics,
						context );
			case AttributePackage.DATE_FORMAT_TYPE_OBJECT :
				return validateDateFormatTypeObject( (DateFormatType) value,
						diagnostics,
						context );
			case AttributePackage.DIRECTION_OBJECT :
				return validateDirectionObject( (Direction) value,
						diagnostics,
						context );
			case AttributePackage.GROUPING_UNIT_TYPE_OBJECT :
				return validateGroupingUnitTypeObject( (GroupingUnitType) value,
						diagnostics,
						context );
			case AttributePackage.HORIZONTAL_ALIGNMENT_OBJECT :
				return validateHorizontalAlignmentObject( (HorizontalAlignment) value,
						diagnostics,
						context );
			...
			case AttributePackage.LINE_DECORATOR_OBJECT :
				return validateLineDecoratorObject( (LineDecorator) value,
						diagnostics,
						context );
			case AttributePackage.LINE_STYLE_OBJECT :
				return validateLineStyleObject( (LineStyle) value,
						diagnostics,
						context );
			...
			case AttributePackage.POSITION_OBJECT :
				return validatePositionObject( (Position) value,
						diagnostics,
						context );
			...
			case AttributePackage.RISER_TYPE_OBJECT :
				return validateRiserTypeObject( (RiserType) value,
						diagnostics,
						context );
			case AttributePackage.RULE_TYPE_OBJECT :
				return validateRuleTypeObject( (RuleType) value,
						diagnostics,
						context );
			case AttributePackage.SCALE_UNIT_TYPE_OBJECT :
				return validateScaleUnitTypeObject( (ScaleUnitType) value,
						diagnostics,
						context );
			case AttributePackage.SORT_OPTION_OBJECT :
				return validateSortOptionObject( (SortOption) value,
						diagnostics,
						context );
			case AttributePackage.STRETCH_OBJECT :
				return validateStretchObject( (Stretch) value,
						diagnostics,
						context );
			case AttributePackage.STYLED_COMPONENT_OBJECT :
				return validateStyledComponentObject( (StyledComponent) value,
						diagnostics,
						context );
			case AttributePackage.TICK_STYLE_OBJECT :
				return validateTickStyleObject( (TickStyle) value,
						diagnostics,
						context );
			...
			case AttributePackage.UNITS_OF_MEASUREMENT_OBJECT :
				return validateUnitsOfMeasurementObject( (UnitsOfMeasurement) value,
						diagnostics,
						context );
			case AttributePackage.VERTICAL_ALIGNMENT_OBJECT :
				return validateVerticalAlignmentObject( (VerticalAlignment) value,
						diagnostics,
						context );
			default :
				return true;
	 ...
	 * @generated
	 */
	public boolean validateJavaDateFormatSpecifier(
	 ...
	 * @generated
	 */
	public boolean validateJavaNumberFormatSpecifier(
	 ...
	 * @generated
	 */
	public boolean validateNumberFormatSpecifier(
	 ...
	 * @generated
	 */
	public boolean validateChartDimensionObject(
			ChartDimension chartDimensionObject, DiagnosticChain diagnostics,
			Map<Object, Object> context )
	{
		return true;
	}
	 ...
	 * @generated
	 */
	public boolean validateDataPointComponentTypeObject(
			DataPointComponentType dataPointComponentTypeObject,
			DiagnosticChain diagnostics, Map<Object, Object> context )
	{
		return true;
	}
	 ...
	 * @generated
	 */
	public boolean validateDateFormatDetailObject(
			DateFormatDetail dateFormatDetailObject,
			DiagnosticChain diagnostics, Map<Object, Object> context )
	{
		return true;
	}
	 ...
	 * @generated
	 */
	public boolean validateDateFormatTypeObject(
			DateFormatType dateFormatTypeObject, DiagnosticChain diagnostics,
			Map<Object, Object> context )
	{
		return true;
	}
	 ...
	 * @generated
	 */
	public boolean validateGroupingUnitTypeObject(
			GroupingUnitType groupingUnitTypeObject,
			DiagnosticChain diagnostics, Map<Object, Object> context )
	{
		return true;
	}
	 ...
	 * @generated
	 */
	public boolean validateHorizontalAlignmentObject(
			HorizontalAlignment horizontalAlignmentObject,
			DiagnosticChain diagnostics, Map<Object, Object> context )
	{
		return true;
	}
	 ...
	 * @generated
	 */
	public boolean validateID( String id, DiagnosticChain diagnostics,
			Map<Object, Object> context )
	{
	 ...
	 * @generated
	 */
	public boolean validateIntersectionTypeObject(
			IntersectionType intersectionTypeObject,
			DiagnosticChain diagnostics, Map<Object, Object> context )
	{
		return true;
	}
	 ...
	 * @generated
	 */
	public boolean validateLegendItemTypeObject(
			LegendItemType legendItemTypeObject, DiagnosticChain diagnostics,
			Map<Object, Object> context )
	{
		return true;
	}
	 ...
	 * @generated
	 */
	public boolean validateLineDecoratorObject(
			LineDecorator lineDecoratorObject, DiagnosticChain diagnostics,
			Map<Object, Object> context )
	{
		return true;
	}
	...
	public boolean validatePercentage( double percentage,
			DiagnosticChain diagnostics, Map<Object, Object> context )
	{
		boolean result = validatePercentage_Min( percentage,
				diagnostics,
				context );
	 ...
	 * @generated
	 */
	public boolean validateStyledComponentObject(
			StyledComponent styledComponentObject, DiagnosticChain diagnostics,
			Map<Object, Object> context )
	{
		return true;
	}
	 ...
	 * @generated
	 */
	public boolean validateUnitsOfMeasurementObject(
			UnitsOfMeasurement unitsOfMeasurementObject,
			DiagnosticChain diagnostics, Map<Object, Object> context )
	{
		return true;
	}
	 ...
	 * @generated
	 */
	public boolean validateVerticalAlignmentObject(
			VerticalAlignment verticalAlignmentObject,
			DiagnosticChain diagnostics, Map<Object, Object> context )
	{
		return true;
	}
