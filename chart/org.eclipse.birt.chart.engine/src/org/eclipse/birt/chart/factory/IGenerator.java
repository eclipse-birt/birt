...
public interface IGenerator {
	 ...
	 * @since 2.1
	 */
	RunTimeContext prepare(Chart model, IExternalContext externalContext, IScriptClassLoader iscl, ULocale locale)
			throws ChartException;
	 ...
	 * @since 2.0
	 */
	void bindData(java.sql.ResultSet resultSet, Chart chart, RunTimeContext rtc) throws ChartException;
	 ...
	 * @since 2.0
	 */
	void bindData(IDataRowExpressionEvaluator expressionEvaluator, IActionEvaluator iae, Chart chart,
	 ...
	 * @throws ChartException
	 */
	GeneratedChartState build(IDisplayServer ids, Chart cmDesignTime, Bounds bo, IExternalContext externalContext,
			RunTimeContext rtc) throws ChartException;
	 ...
	 * @throws ChartException
	 */
	void render(IDeviceRenderer idr, GeneratedChartState gcs) throws ChartException;
