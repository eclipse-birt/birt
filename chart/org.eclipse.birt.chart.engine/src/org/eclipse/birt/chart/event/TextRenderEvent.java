...
public final class TextRenderEvent extends PrimitiveRenderEvent
{
    ...
    /**
     * Renders a shadow offset with the encapsulating container rectangle's corner or edge aligned with a given point
     * 
    ...
    /**
     * Renders text (with optional insets, border, fill, etc) with the encapsulating container rectangle's corner or
     * edge aligning with a given point
     * 
     * This action requires Label, Location, TextPosition to be set
     */
    ...
    /**
     * Renders text (with optional insets, border, fill, etc) with the encapsulating container rectangle's bounding box
     * aligned with a parent block's bounds
     * 
    ...
    /**
     * A constant used with the 'TextPosition' attribute. This indicates that the text is positioned to the left of the
     * reference point 'Location'
     */
    public static final int LEFT = IConstants.LEFT;

    /**
     * A constant used with the 'TextPosition' attribute. This indicates that the text is positioned to the right of the
     * reference point 'Location'
     */
    public static final int RIGHT = IConstants.RIGHT;

    /**
     * A constant used with the 'TextPosition' attribute. This indicates that the text is positioned above the reference
     * point 'Location'
     */
    public static final int ABOVE = IConstants.ABOVE;

    /**
     * A constant used with the 'TextPosition' attribute. This indicates that the text is positioned below the reference
     * point 'Location'
     */
    public static final int BELOW = IConstants.BELOW;

    /**
     * The bounds of the enclosing block space in which the text's bounding box will be aligned
     */
