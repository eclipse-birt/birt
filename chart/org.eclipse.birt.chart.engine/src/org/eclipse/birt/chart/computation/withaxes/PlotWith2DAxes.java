...
public final class PlotWith2DAxes extends PlotContent
{
	...
	private final int getOrientation( int iBaseOrOrthogonal )
	{
		if ( !cwa.isTransposed( ) )
		{
			return ( iBaseOrOrthogonal == IConstants.BASE ) ? IConstants.HORIZONTAL
					: IConstants.VERTICAL;
		}
		else
		{
			return ( iBaseOrOrthogonal == IConstants.BASE ) ? IConstants.VERTICAL
	 ...
	 * @throws UnexpectedInputException
	 */
	private final int transposeTickStyle( int iBaseOrOrthogonal,
	 ...
	 * @throws ValidationException
	 */
	private final void validateAxis( Axis ax ) throws ChartException
	{
	 ...
	 * @return
	 */
	private final DataSetIterator getTypedDataSet( Axis ax, int iType,
	 ...
	 * @return
	 */
	private final double adjustHorizontal( double dBlockX, double dBlockWidth,
	 ...
	 * @return
	 */
	private final double adjustVerticalDueToHorizontal( double dBlockY,
