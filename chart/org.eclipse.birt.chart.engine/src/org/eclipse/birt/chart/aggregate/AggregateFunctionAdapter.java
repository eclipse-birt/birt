...
public abstract class AggregateFunctionAdapter implements IAggregateFunction
{
     ...
     */
    public void accumulate(Object oValue) throws UnexpectedInputException
    {
    ...
    /**
     * Internally detects if the accumulated data's data type has changed
     * in the aggregate function.
     * 
     * @param oValue
     */
    private final void detectTypeChange(Object oValue) throws UnexpectedInputException
    {
        ...
        else
        {
            ...
            if (iExistingType != iDataType)
            {
                throw new UnexpectedInputException(
                    "exception.mixed.data.types", //$NON-NLS-1$
    ...
    /**
     * Returns the locale associated with this aggregate function instance to be used by this aggregate function
     * 
