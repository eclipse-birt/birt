...
/**
 * Provides an abstraction layer into the logging framework capable of
 * writing categorized messages into a target repository (or console).
 */
public interface ILogger
{
     ...
     * 
     * @param   iVerboseLevel   Determines how to filter messages to be displayed on the console.
     */
