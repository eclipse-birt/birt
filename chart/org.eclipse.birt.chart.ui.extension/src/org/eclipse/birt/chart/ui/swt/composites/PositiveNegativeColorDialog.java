...
public class PositiveNegativeColorDialog extends TrayDialog implements Listener
{
	...
	public PositiveNegativeColorDialog( Shell shellParent,
			ChartWizardContext wizardContext, MultipleFill mSelected,
	...
	private void setMultipleColor( MultipleFill mFill,
			ColorDefinition selectedColor )
	{
