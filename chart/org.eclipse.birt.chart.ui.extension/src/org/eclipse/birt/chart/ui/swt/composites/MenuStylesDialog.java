...
public class MenuStylesDialog extends TrayDialog implements Listener {
	...
	private void updateProperties(MenuStylesKeyType menuStylesKeyType) {
		fPropertiesMap.put(menuStylesKeyType.getName(), serializeProperties(fCurrentAttrList));
	}
	 ...
	 * EffectLabelProvider
	 */
	static class PropertiesLabelProvider extends LabelProvider implements ITableLabelProvider {
