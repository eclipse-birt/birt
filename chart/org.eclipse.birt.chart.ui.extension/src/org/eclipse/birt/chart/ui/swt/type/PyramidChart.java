...
public class PyramidChart extends DefaultChartTypeImpl
{
	...
	public static final String CHART_TITLE = Messages.getString( "PyramidChart.Txt.DefaultPyramidChartTitle" ); //$NON-NLS-1$

	private static final String sStackedDescription = Messages.getString( "PyramidChart.Txt.StackedDescription" ); //$NON-NLS-1$

	private static final String sPercentStackedDescription = Messages.getString( "PyramidChart.Txt.PercentStackedDescription" ); //$NON-NLS-1$

	private static final String sSideBySideDescription = Messages.getString( "PyramidChart.Txt.SideBySideDescription" ); //$NON-NLS-1$
	...
	public PyramidChart( )
	{
		imgIcon = UIHelper.getImage( "icons/obj16/pyramidcharticon.gif" ); //$NON-NLS-1$
	}
	...
	public IHelpContent getHelp( )
	{
		return new HelpContentImpl( TYPE_LITERAL,
				Messages.getString( "PyramidChart.Txt.HelpText" ) ); //$NON-NLS-1$
	}
			...
			Orientation orientation )
	{
				...
				|| sDimension.equals( ChartDimension.TWO_DIMENSIONAL_LITERAL.getName( ) ) )
		{
			...
			{
				imgStacked = UIHelper.getImage( "icons/wizban/stackedpyramidchartimage.gif" ); //$NON-NLS-1$
				imgPercentStacked = UIHelper.getImage( "icons/wizban/percentstackedpyramidchartimage.gif" ); //$NON-NLS-1$
				imgSideBySide = UIHelper.getImage( "icons/wizban/sidebysidepyramidchartimage.gif" ); //$NON-NLS-1$
			}
			else
			{
				imgStacked = UIHelper.getImage( "icons/wizban/horizontalstackedpyramidchartimage.gif" ); //$NON-NLS-1$
				imgPercentStacked = UIHelper.getImage( "icons/wizban/horizontalpercentstackedpyramidchartimage.gif" ); //$NON-NLS-1$
				imgSideBySide = UIHelper.getImage( "icons/wizban/horizontalsidebysidepyramidchartimage.gif" ); //$NON-NLS-1$
			}

			vSubTypes.add( new DefaultChartSubTypeImpl( SIDE_SUBTYPE_LITERAL,
					imgSideBySide,
					sSideBySideDescription,
					Messages.getString( "PyramidChart.SubType.Side" ) ) ); //$NON-NLS-1$
			vSubTypes.add( new DefaultChartSubTypeImpl( STACKED_SUBTYPE_LITERAL,
					imgStacked,
					sStackedDescription,
					Messages.getString( "PyramidChart.SubType.Stacked" ) ) ); //$NON-NLS-1$
			vSubTypes.add( new DefaultChartSubTypeImpl( PERCENTSTACKED_SUBTYPE_LITERAL,
					imgPercentStacked,
					sPercentStackedDescription,
					Messages.getString( "PyramidChart.SubType.PercentStacked" ) ) ); //$NON-NLS-1$
		}
				...
				|| sDimension.equals( ChartDimension.TWO_DIMENSIONAL_WITH_DEPTH_LITERAL.getName( ) ) )
		{
			if ( orientation.equals( Orientation.VERTICAL_LITERAL ) )
			{
				imgStackedWithDepth = UIHelper.getImage( "icons/wizban/stackedpyramidchartwithdepthimage.gif" ); //$NON-NLS-1$
				imgPercentStackedWithDepth = UIHelper.getImage( "icons/wizban/percentstackedpyramidchartwithdepthimage.gif" ); //$NON-NLS-1$
				imgSideBySideWithDepth = UIHelper.getImage( "icons/wizban/sidebysidepyramidchartwithdepthimage.gif" ); //$NON-NLS-1$
			}
			else
			{
				imgStackedWithDepth = UIHelper.getImage( "icons/wizban/horizontalstackedpyramidchartwithdepthimage.gif" ); //$NON-NLS-1$
				imgPercentStackedWithDepth = UIHelper.getImage( "icons/wizban/horizontalpercentstackedpyramidchartwithdepthimage.gif" ); //$NON-NLS-1$
				imgSideBySideWithDepth = UIHelper.getImage( "icons/wizban/horizontalsidebysidepyramidchartwithdepthimage.gif" ); //$NON-NLS-1$
			}
			vSubTypes.add( new DefaultChartSubTypeImpl( SIDE_SUBTYPE_LITERAL,
				...
				|| sDimension.equals( ChartDimension.THREE_DIMENSIONAL_LITERAL.getName( ) ) )
		{
			if ( orientation.equals( Orientation.VERTICAL_LITERAL ) )
			{
				imgSideBySide3D = UIHelper.getImage( "icons/wizban/sidebysidepyramidchart3dimage.gif" ); //$NON-NLS-1$
			}
			else
			{
				imgSideBySide3D = UIHelper.getImage( "icons/wizban/horizontalsidebysidepyramidchart3dimage.gif" ); //$NON-NLS-1$
			}
			vSubTypes.add( new DefaultChartSubTypeImpl( SIDE_SUBTYPE_LITERAL,
					imgSideBySide3D,
					sSideBySideDescription,
			...
			String sDimension, Chart currentChart )
	{
		...
		if ( sSubType.equalsIgnoreCase( STACKED_SUBTYPE_LITERAL ) )
		{
			...
			( (BarSeries) valueSeries ).setRiser( RiserType.TRIANGLE_LITERAL );
	...
	private Series getConvertedSeries( Series series, int seriesIndex )
	{
		...
		barseries.setRiser( RiserType.TRIANGLE_LITERAL );
	...
	{
		return Messages.getString( "PyramidChart.Txt.DisplayName" ); //$NON-NLS-1$
	}
}
