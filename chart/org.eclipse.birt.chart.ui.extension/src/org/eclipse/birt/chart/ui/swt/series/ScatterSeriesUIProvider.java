...
{
    private static final String SERIES_CLASS = "org.eclipse.birt.chart.model.type.impl.ScatterSeriesImpl"; //$NON-NLS-1$
        ...
        IUIServiceProvider builder, Object oContext)
    {
        ...
        {
            sTitle = sPrefix + Messages.getString("ScatterSeriesUIProvider.Lbl.SeriesDefinition"); //$NON-NLS-1$
        }
        else
        {
