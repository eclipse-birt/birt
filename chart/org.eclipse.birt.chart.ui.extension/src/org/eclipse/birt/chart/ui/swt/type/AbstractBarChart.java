...
public abstract class AbstractBarChart extends DefaultChartTypeImpl
{
	...
	private transient Image foImgStackedWithDepth = null;

	private transient Image foImgPercentStacked = null;

	private transient Image foImgPercentStackedWithDepth = null;

	private transient Image foImgSideBySide = null;
	 ...
	 * 
	 * @param chartTypePrefix
	 *            the prefix string of chart type.
	 * @param typeLiteral
	 *            comment for type literal.
	 * @param riserType
	 *            riser type of bar series.
	 */
	public AbstractBarChart( String chartTypePrefix, String typeLiteral,
			RiserType riserType )
	{
	...
	public IHelpContent getHelp( )
	{
		return new HelpContentImpl( fsTypeLiteral,
				Messages.getString( fsChartTypePrefix + "Chart.Txt.HelpText" ) ); //$NON-NLS-1$
	}
