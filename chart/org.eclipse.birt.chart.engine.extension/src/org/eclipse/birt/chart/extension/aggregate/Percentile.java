 ...
 *
 */
public class Percentile extends AggregateFunctionAdapter {
	/*
	 * (non-Javadoc)
	 * 
	 * @see
	...
	public String[] getDisplayParameters() {
		return new String[] { Messages.getString("Percentile.AggregateFunction.Parameters.Label.Percentage") }; //$NON-NLS-1$
	}
