...
public final class GanttEntry implements IDataPointEntry {
	...
	public String getFormattedString(FormatSpecifier formatter, ULocale locale) {
		...
		StringBuilder formattedString = new StringBuilder("S ").append(strStart).append("; E ").append(strEnd); //$NON-NLS-1$ //$NON-NLS-2$
		if (strLabel != null) {
			formattedString.append("; ").append(strLabel); //$NON-NLS-1$
		}
