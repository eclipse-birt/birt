...
class Chunk
{
    ...
    /**
     * Returns the data stream. The returned output stream should <b>not </b> be closed by the caller.
     */
    ...
    /**
     * Writes the entire chunk to a given output stream. This does not close either the output stream or the internal
     * data stream, so multiple calls to this method may be made if necessary.
     */
    ...
    /**
     * Closes the chunk's internal data stream. After this method has been called, no other methods may be called.
     */
    void close()
    {
        IOUtil.close(data);
