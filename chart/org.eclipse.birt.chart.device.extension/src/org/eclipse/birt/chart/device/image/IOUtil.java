...
class IOUtil
{
    ...
    /**
     * Private constructor to stop anyone from instantiating this class - the static methods should be used explicitly.
     */
    private IOUtil()
    {
    }
    ...
    /**
     * Attempts to completely read the contents of a specified InputStream. The stream is closed whether or not the read
     * was successful.
     * 
     * @param is
    ...
    /**
     * Attempts to completely read the contents of a specified text file, line by line. The file is closed whether or
    ...
    /**
     * Attempts to completely read data from the specified Reader, line by line. The Reader is closed whether or not the
     * read was successful.
     * 
     * @param filename
     *            the name of the file to be read
    ...
    /**
     * Attempts to completely write the contents of a Vector of Strings to a specified text file, line by line. The file
     * is closed whether or not the write was successful.
     * 
     * @param lines
    ...
    /**
     * Attempts to completely write the contents of a Vector of Strings to a specified writer, line by line. The writer
     * is closed whether or not the write was successful.
     * 
     * @param lines
     *            a Vector of String objects to write to the file
     ...
     * 
     * @param in
     *            the InputStream to close. May be null.
     */
     ...
     * 
     * @param out
     *            the Writer to close. May be null.
     */
