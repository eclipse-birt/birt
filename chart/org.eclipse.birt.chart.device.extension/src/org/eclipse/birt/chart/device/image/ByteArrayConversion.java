...
final class ByteArrayConversion
{
    ...
    /**
     * Return the int value given by the byte array in little-endian order. Here we interpret the first bit of the first
     * byte as being a sign bit.
     */
    ...
    /**
     * Convert the long value into a byte array that starts from index "startOff" and end at index "endOff" - 1 of
     * "buf". Bytes are in big-endian order.
     */
    ...
    /**
     * Convert the int value into a little-endian byte array that starts from index "startOff" and end at index "endOff" -
     * 1 of "buf".
     */
