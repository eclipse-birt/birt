...
public interface IUIManager
{
     ...
     * @param saNodePaths array of node paths associated with each sheet entry in the collection
     ...
     * @return true if addition of all the nodes succeeds. false if any component was not found or if addition of any node fails
     */
     ...
     * @return true if removal of all nodes was successful. false if any component was not found or any component could not be removed
     */
