...
public class StyledElementTest extends BaseTestCase
{
	 ...
	 * <li>get name value from parent element , equal to value "hexingjie"
	 * </li>
	 * </ul>
	 */
	...
	public void testStyleProperty( ) throws Exception
	{
		...
		LabelHandle parent = designHandle.getElementFactory( ).newLabel(
				"parent" ); //$NON-NLS-1$
		...
		assertEquals( style1.getElement( ), ( (StyledElement) label
				.getElement( ) ).getStyle( design ) );
	 ...
	 * <li>color property not defined on both of the parent & child. It defined
	 * on the selector. Returns the selector defined value.</li>
	 * 
	...
	public void testGetFactoryProperty( ) throws DesignFileException,
			SemanticException, IOException
	{

		openDesign( "StyledElementTest.xml" ); //$NON-NLS-1$

		LabelHandle label1 = (LabelHandle) designHandle
				.findElement( "insideLabel1" ); //$NON-NLS-1$
		LabelHandle label2 = (LabelHandle) designHandle
				.findElement( "insideLabel2" ); //$NON-NLS-1$
		LabelHandle label3 = (LabelHandle) designHandle
				.findElement( "insideLabel3" ); //$NON-NLS-1$
		LabelHandle label4 = (LabelHandle) designHandle
				.findElement( "insideLabel4" ); //$NON-NLS-1$

		FactoryPropertyHandle factoryColorPropHandle1 = label1
				.getFactoryPropertyHandle( Style.COLOR_PROP );
		FactoryPropertyHandle factoryColorPropHandle2 = label2
				.getFactoryPropertyHandle( Style.COLOR_PROP );
		FactoryPropertyHandle factoryColorPropHandle3 = label3
				.getFactoryPropertyHandle( Style.COLOR_PROP );
		FactoryPropertyHandle factoryColorPropHandle4 = label4
				.getFactoryPropertyHandle( Style.COLOR_PROP );
		...
		assertNull( childTable
				.getFactoryPropertyHandle( IStyleModel.BACKGROUND_COLOR_PROP ) );
		childTable.setExtends( parentTable );
		assertEquals(
				"red", childTable.getFactoryPropertyHandle( IStyleModel.BACKGROUND_COLOR_PROP ).getValue( ) ); //$NON-NLS-1$
