 ...
 * <td width="33%" height="16">Sets/gets normal predefined choice property.
 * </td>
...
public class ChoiceParseTest extends BaseTestCase
{
	...
	public void testChoiceWithProperty( ) throws Exception
	{
		...
		assertEquals( DesignChoiceConstants.FONT_SIZE_X_SMALL, styleHandle
				.getFontSize( ).getStringValue( ) );

		styleHandle.getFontSize( ).setStringValue(
				DesignChoiceConstants.FONT_SIZE_XX_SMALL );

		// Gets the choice value out of values of ChoiceSet.

		assertEquals( DesignChoiceConstants.FONT_WEIGHT_NORMAL, styleHandle
				.getFontWeight( ) );
		...
		assertEquals( DesignChoiceConstants.FONT_WEIGHT_400, styleHandle
				.getFontWeight( ) );
		...
		assertEquals( "12mm", //$NON-NLS-1$
				style1.getHandle( design ).getStringProperty(
						Style.FONT_SIZE_PROP ).toString( ) );
		...
		assertEquals( style1.getProperty( design, Style.FONT_SIZE_PROP )
				.toString( ), "12cm" ); //$NON-NLS-1$
		...
		assertNotNull( label2 );
		assertEquals( "12mm", //$NON-NLS-1$
				label2.getHandle( design ).getStringProperty(
						Style.FONT_SIZE_PROP ).toString( ) );
	...
	public void testChoiceWithMember( ) throws Exception
	{
		...
		MemberHandle memberHandle = strHandle
				.getMember( StyleRule.OPERATOR_MEMBER );
		assertEquals( memberHandle.getStringValue( ),
				DesignChoiceConstants.MAP_OPERATOR_EQ );
	...
	public void testVerticalAlign( ) throws Exception
	{
		...
		String verticalAlign = (String) myStyle.getLocalProperty( design,
