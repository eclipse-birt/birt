...
public class ExtendsPropertyTypeTest extends PropertyTypeTestCase
{
	...
	public void testToXml( )
	{
		...
		assertEquals( "ElementName", //$NON-NLS-1$
				type.toXml( design, propDefn, new ElementRefValue( null,
	...
	public void testToString( )
	{
		...
		assertEquals( "ElementName", //$NON-NLS-1$
				type.toString( design, propDefn, new ElementRefValue( null,
						"ElementName" ) ) ); //$NON-NLS-1$
	...
	public void testToDisplayString( )
	{
		...
		assertEquals( "ElementName", //$NON-NLS-1$
				type.toDisplayString( design, propDefn, new ElementRefValue(
						null, "ElementName" ) ) ); //$NON-NLS-1$
	}
