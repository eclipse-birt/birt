...
//				.getCopiedCells( data ).get( 0 );
	...
	/**
	 * Copies non-merged cells in the source grid to another grid with merged
	 * cells.
	 * 
	 * @throws Exception
	 */
	...
	public void copyPasteNonMergedCells2MergedCells( ) throws Exception
	{
		...
		GridHandle copyGrid = (GridHandle) designHandle
				.findElement( "CopyGrid1" ); //$NON-NLS-1$
		assertNotNull( copyGrid );

		GridHandle pasteGrid = (GridHandle) designHandle
				.findElement( "PasteGrid1" ); //$NON-NLS-1$
		...
		assertEquals( IColorConstants.YELLOW, column1
				.getStringProperty( Style.COLOR_PROP ) );
		assertEquals( 1, column2.getRepeatCount( ) );
	}

	/**
	 * Copies merged cells in the source grid to another grid without merged
	 * cells.
	 * 
	 * @throws Exception
	 */
	...
	public void copyPasteWithUndoRedo( ) throws Exception
	{
		...
		GridHandle copyGrid = (GridHandle) designHandle
				.findElement( "CopyGrid2" ); //$NON-NLS-1$
		assertNotNull( copyGrid );

		GridHandle pasteGrid = (GridHandle) designHandle
				.findElement( "PasteGrid2" ); //$NON-NLS-1$
		assertNotNull( pasteGrid );
