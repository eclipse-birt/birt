...
public class DesignElementTest extends BaseTestCase
{
	 ...
	 * 
	 */
	public void testBroadcast( ) throws ContentException, NameException,
			ExtendsException
	{
		// set the derivation relationship and the listener.

		TextItemHandle parent = designHandle.getElementFactory( ).newTextItem(
				"parent" ); //$NON-NLS-1$
		TextItemHandle grand = designHandle.getElementFactory( ).newTextItem(
				"grand" ); //$NON-NLS-1$
		...
		assertNull( designElement.getProperty( design,
	...
	public void testGetPropertyDefn( )
	{
		...
		Object o = designElement
				.getPropertyDefn( DesignElement.DISPLAY_NAME_PROP );
		assertTrue( o != null );
	...
	public void testGetProperty( ) throws SemanticException
	{
		...
		Object o = designElement.getProperty( design,
				DesignElement.DISPLAY_NAME_PROP );
		...
		assertEquals(
				"blue", label1.getStringProperty( StyleHandle.BACKGROUND_COLOR_PROP ) ); //$NON-NLS-1$

		// get backgroud color from the table-detail selector

		SharedStyleHandle tableDetailSelector = elemFactory
				.newStyle( "table-detail" ); //$NON-NLS-1$
		tableDetailSelector.setProperty( Style.BACKGROUND_COLOR_PROP,
				ColorPropertyType.AQUA );
		...
		assertEquals( ColorPropertyType.AQUA, row
				.getProperty( Style.BACKGROUND_COLOR_PROP ) );
		...
		SharedStyleHandle listDetailSelector = elemFactory
				.newStyle( "list-detail" ); //$NON-NLS-1$
		listDetailSelector.setProperty( Style.BACKGROUND_COLOR_PROP,
				ColorPropertyType.YELLOW );
		...
		assertEquals( ColorPropertyType.YELLOW, listLabel
				.getProperty( Style.BACKGROUND_COLOR_PROP ) );
		...
		assertEquals(
				"red", childTable.getProperty( IStyleModel.BACKGROUND_COLOR_PROP ) ); //$NON-NLS-1$
	...
	{
		PropertyDefn prop = designElement
				.getPropertyDefn( DesignElement.DISPLAY_NAME_PROP );
		designElement.setProperty( DesignElement.DISPLAY_NAME_PROP, "Hello" );//$NON-NLS-1$
	...
	{
		designElement.setProperty( DesignElement.DISPLAY_NAME_PROP, "Hello" );//$NON-NLS-1$
		Object o = designElement.getLocalProperty( design,
				DesignElement.DISPLAY_NAME_PROP );
		assertEquals( "Hello", o );//$NON-NLS-1$

		designElement.setProperty( DesignElement.DISPLAY_NAME_PROP, "element" );//$NON-NLS-1$
		o = designElement.getLocalProperty( design,
				DesignElement.DISPLAY_NAME_PROP );
	...
	public void testGetDoubleProperty( )
	{
		...
		assertNull( designElement.getProperty( design,
				ReportDesign.DISPLAY_NAME_PROP ) );
		double o = designElement.getFloatProperty( design,
				ReportDesign.DISPLAY_NAME_PROP );
	 ...
	 * <li>this label has text attribute and value is blue , it also has label
	 * name hexingjie</li>
	 * <li>this label has text attribute and value is blue , but hasnot label
	 * name</li>
	 * <li>this label has text attribute and value is blue , and length more
	 * than 30 chars</li>
	 * </ul>
	 * </li>
	 * </ul>
	...
	public void testLabelDisplayLabel( ) throws Exception
	{
		...
		// situation 1
		matchSituation( DesignElementTest.LABEL, 0,
				"he", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 2

		matchSituation( DesignElementTest.LABEL, 1,
				"label2", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.LABEL, 2,
				"label3", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 4

		matchSituation( DesignElementTest.LABEL, 3,
				"Ant", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 5

		matchSituation( DesignElementTest.LABEL, 4, null,
				DesignElement.USER_LABEL );

		// situation 6

		matchSituation( DesignElementTest.LABEL, 5, null,
				DesignElement.USER_LABEL );
		...
		// situation 1
		matchSituation( DesignElementTest.LABEL, 0,
				"he", DesignElement.SHORT_LABEL );//$NON-NLS-1$

		// situation 2

		matchSituation( DesignElementTest.LABEL, 1,
				"label2", DesignElement.SHORT_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.LABEL, 2,
				"label3", DesignElement.SHORT_LABEL );//$NON-NLS-1$

		// situation 4

		matchSituation( DesignElementTest.LABEL, 3,
				"Ant", DesignElement.SHORT_LABEL );//$NON-NLS-1$

		// situation 5

		matchSituation( DesignElementTest.LABEL, 4,
				"\u6807\u7b7e", DesignElement.SHORT_LABEL );//$NON-NLS-1$

		// situation 6

		matchSituation( DesignElementTest.LABEL, 5,
				"\u6807\u7b7e", DesignElement.SHORT_LABEL ); //$NON-NLS-1$
		...
		// situation 1
		matchSituation( DesignElementTest.LABEL, 0,
				"he", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 2

		matchSituation( DesignElementTest.LABEL, 1,
				"label2", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.LABEL, 2,
				"label3", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 4

		matchSituation( DesignElementTest.LABEL, 3,
				"Ant", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 5

		matchSituation( DesignElementTest.LABEL, 4,
				"\u6807\u7b7e", DesignElement.FULL_LABEL );//$NON-NLS-1$
		...
		matchSituation( DesignElementTest.LABEL, 6,
				"hexingjie(\"blue\")", DesignElement.FULL_LABEL );//$NON-NLS-1$
		...
		matchSituation(
				DesignElementTest.LABEL,
				8,
				"\u6807\u7b7e(\"test asdf sadf sadf sdaf...\")", DesignElement.FULL_LABEL );//$NON-NLS-1$
	...
	public void testTextDisplayLabel( ) throws Exception
	{
		...
		// situation 1
		matchSituation( DesignElementTest.TEXT, 0,
				"he", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 2

		matchSituation( DesignElementTest.TEXT, 1,
				"text2", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.TEXT, 2,
				"text3", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 4

		matchSituation( DesignElementTest.TEXT, 3,
				"Ant", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 5

		matchSituation( DesignElementTest.TEXT, 4, null,
				DesignElement.USER_LABEL );

		// situation 6

		matchSituation( DesignElementTest.TEXT, 5, null,
				DesignElement.USER_LABEL );
		...
		matchSituation( DesignElementTest.TEXT, 1,
				"text2", DesignElement.SHORT_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.TEXT, 2,
				"text3", DesignElement.SHORT_LABEL );//$NON-NLS-1$
		...
		matchSituation( DesignElementTest.TEXT, 4,
				"\u6587\u672c", DesignElement.SHORT_LABEL );//$NON-NLS-1$

		// situation 6

		matchSituation( DesignElementTest.TEXT, 5,
				"\u6587\u672c", DesignElement.SHORT_LABEL );//$NON-NLS-1$
		...
		matchSituation( DesignElementTest.TEXT, 1,
				"text2", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.TEXT, 2,
				"text3", DesignElement.FULL_LABEL );//$NON-NLS-1$
		...
		matchSituation( DesignElementTest.TEXT, 4,
				"\u6587\u672c", DesignElement.FULL_LABEL );//$NON-NLS-1$
		...
		matchSituation(
				DesignElementTest.TEXT,
				6,
				"hexingjie(\"This is a sample bit of plain...\")", DesignElement.FULL_LABEL );//$NON-NLS-1$
		...
		matchSituation(
				DesignElementTest.TEXT,
				7,
				"\u6587\u672c(\"hello,12345678910111213141adfa...\")", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 9
		// just for FULL_LABEL

		matchSituation( DesignElementTest.TEXT, 8,
				"\u6587\u672c(\"This is \")", DesignElement.FULL_LABEL );//$NON-NLS-1$
		...
		matchSituation(
				DesignElementTest.TEXT,
				9,
				"\u6587\u672c(\"a sample bit of plain...\")", DesignElement.FULL_LABEL );//$NON-NLS-1$
	...
	public void testGridDisplayLabel( ) throws Exception
	{
		...
		// situation 1
		matchSituation( DesignElementTest.GRID, 0,
				"he", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 2

		matchSituation( DesignElementTest.GRID, 1,
				"grid2", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.GRID, 2,
				"grid3", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 4

		matchSituation( DesignElementTest.GRID, 3,
				"Ant", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 5

		matchSituation( DesignElementTest.GRID, 4, null,
				DesignElement.USER_LABEL );

		// situation 6

		matchSituation( DesignElementTest.GRID, 5, null,
				DesignElement.USER_LABEL );
		...
		matchSituation( DesignElementTest.GRID, 1,
				"grid2", DesignElement.SHORT_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.GRID, 2,
				"grid3", DesignElement.SHORT_LABEL );//$NON-NLS-1$
		...
		matchSituation( DesignElementTest.GRID, 4,
				"\u7f51\u683c", DesignElement.SHORT_LABEL );//$NON-NLS-1$

		// situation 6

		matchSituation( DesignElementTest.GRID, 5,
				"\u7f51\u683c", DesignElement.SHORT_LABEL );//$NON-NLS-1$
		...
		// situation 1
		matchSituation( DesignElementTest.GRID, 0,
				"he(0 x 0)", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 2

		matchSituation( DesignElementTest.GRID, 1,
				"grid2(0 x 0)", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.GRID, 2,
				"grid3(0 x 0)", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 4

		matchSituation( DesignElementTest.GRID, 3,
				"Ant(0 x 0)", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 5

		matchSituation( DesignElementTest.GRID, 4,
				"\u7f51\u683c(0 x 0)", DesignElement.FULL_LABEL );//$NON-NLS-1$
		...
		matchSituation( DesignElementTest.GRID, 6,
				"hexingjie(3 x 2)", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 8
		// just for FULL_LABEL

		matchSituation( DesignElementTest.GRID, 7,
				"\u7f51\u683c(1 x 0)", DesignElement.FULL_LABEL );//$NON-NLS-1$
	...
	public void testListDisplayLabel( ) throws Exception
	{
		...
		// situation 1
		matchSituation( DesignElementTest.LIST, 0,
				"he", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 2

		matchSituation( DesignElementTest.LIST, 1,
				"list2", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.LIST, 2,
				"list3", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 4

		matchSituation( DesignElementTest.LIST, 3,
				"Ant", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 5

		matchSituation( DesignElementTest.LIST, 4, null,
				DesignElement.USER_LABEL );

		// situation 6

		matchSituation( DesignElementTest.LIST, 5, null,
				DesignElement.USER_LABEL );
		...
		matchSituation( DesignElementTest.LIST, 1,
				"list2", DesignElement.SHORT_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.LIST, 2,
				"list3", DesignElement.SHORT_LABEL );//$NON-NLS-1$
		...
		matchSituation( DesignElementTest.LIST, 4,
				"\u5217\u8868", DesignElement.SHORT_LABEL ); //$NON-NLS-1$

		// situation 6

		matchSituation( DesignElementTest.LIST, 5,
				"\u5217\u8868", DesignElement.SHORT_LABEL ); //$NON-NLS-1$
		...
		// situation 1
		matchSituation( DesignElementTest.LIST, 0,
				"he(firstDataSet)", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 2

		matchSituation( DesignElementTest.LIST, 1,
				"list2(firstDataSet)", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.LIST, 2,
				"list3(firstDataSet)", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 4

		matchSituation( DesignElementTest.LIST, 3,
				"Ant(firstDataSet)", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 5

		matchSituation( DesignElementTest.LIST, 4,
				"\u5217\u8868(firstDataSet)", DesignElement.FULL_LABEL ); //$NON-NLS-1$
		...
		matchSituation( DesignElementTest.LIST, 7,
				"\u5217\u8868(secondDataSet)", //$NON-NLS-1$
				DesignElement.FULL_LABEL );
		...
		matchSituation(
				DesignElementTest.LIST,
				8,
				"\u5217\u8868(test asdf sadf sadf sdaf...)", DesignElement.FULL_LABEL ); //$NON-NLS-1$
	...
	public void testDataDisplayLabel( ) throws Exception
	{
		...
		// situation 1
		matchSituation( DesignElementTest.DATA, 0,
				"he", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 2

		matchSituation( DesignElementTest.DATA, 1,
				"data2", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.DATA, 2,
				"data3", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 4

		matchSituation( DesignElementTest.DATA, 3,
				"Ant", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 5

		matchSituation( DesignElementTest.DATA, 4, null,
				DesignElement.USER_LABEL );

		// situation 6

		matchSituation( DesignElementTest.DATA, 5, null,
				DesignElement.USER_LABEL );
		...
		matchSituation( DesignElementTest.DATA, 1,
				"data2", DesignElement.SHORT_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.DATA, 2,
				"data3", DesignElement.SHORT_LABEL );//$NON-NLS-1$
		...
		matchSituation( DesignElementTest.DATA, 4,
				"\u6570\u636e", DesignElement.SHORT_LABEL );//$NON-NLS-1$

		// situation 6

		matchSituation( DesignElementTest.DATA, 5,
				"\u6570\u636e", DesignElement.SHORT_LABEL );//$NON-NLS-1$
		...
		matchSituation( DesignElementTest.DATA, 1,
				"data2", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.DATA, 2,
				"data3", DesignElement.FULL_LABEL );//$NON-NLS-1$
		...
		matchSituation( DesignElementTest.DATA, 4,
				"\u6570\u636e", DesignElement.FULL_LABEL );//$NON-NLS-1$
		...
		matchSituation( DesignElementTest.DATA, 6,
				"hexingjie(haha)", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 8
		// just for FULL_LABEL

		matchSituation( DesignElementTest.DATA, 7,
				"\u6570\u636e(testtest)", DesignElement.FULL_LABEL );//$NON-NLS-1$
		...
		matchSituation(
				DesignElementTest.DATA,
				8,
				"\u6570\u636e(test asdf sadf sadf sdaf...)", DesignElement.FULL_LABEL );//$NON-NLS-1$
	}
	...
	public void testImageDisplayLabel( ) throws Exception
	{
		...
		// situation 1
		matchSituation( DesignElementTest.IMAGE, 0,
				"he", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 2

		matchSituation( DesignElementTest.IMAGE, 1,
				"image2", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.IMAGE, 2,
				"image3", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 4

		matchSituation( DesignElementTest.IMAGE, 3,
				"Ant", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 5

		matchSituation( DesignElementTest.IMAGE, 4, null,
				DesignElement.USER_LABEL );

		// situation 6

		matchSituation( DesignElementTest.IMAGE, 5, null,
				DesignElement.USER_LABEL );
		...
		matchSituation( DesignElementTest.IMAGE, 1,
				"image2", DesignElement.SHORT_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.IMAGE, 2,
				"image3", DesignElement.SHORT_LABEL );//$NON-NLS-1$
		...
		matchSituation( DesignElementTest.IMAGE, 4,
				"\u56fe\u50cf", DesignElement.SHORT_LABEL );//$NON-NLS-1$

		// situation 6

		matchSituation( DesignElementTest.IMAGE, 5,
				"\u56fe\u50cf", DesignElement.SHORT_LABEL );//$NON-NLS-1$
		...
		matchSituation( DesignElementTest.IMAGE, 6,
				"hexingjie1(Blue He)", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 8
		// just for FULL_LABEL

		matchSituation( DesignElementTest.IMAGE, 7,
				"hexingjie2(test image)", DesignElement.FULL_LABEL );//$NON-NLS-1$
		...
		matchSituation(
				DesignElementTest.IMAGE,
				9,
				"\u56fe\u50cf(test asdf sadf sadf sdaf...)", DesignElement.FULL_LABEL );//$NON-NLS-1$
		...
		matchSituation(
				DesignElementTest.IMAGE,
				10,
				"\u56fe\u50cf(test asdf sadf sadf...)", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 12
		// just for FULL_LABEL

		matchSituation( DesignElementTest.IMAGE, 11,
				"\u56fe\u50cf(test asdf sadf...)",//$NON-NLS-1$
				DesignElement.FULL_LABEL );
	...
	public void testTableDisplayLabel( ) throws Exception
	{
		...
		// situation 1
		matchSituation( DesignElementTest.TABLE, 0,
				"he", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 2

		matchSituation( DesignElementTest.TABLE, 1,
				"table2", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.TABLE, 2,
				"table3", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 4

		matchSituation( DesignElementTest.TABLE, 3,
				"Ant", DesignElement.USER_LABEL );//$NON-NLS-1$

		// situation 5

		matchSituation( DesignElementTest.TABLE, 4, null,
				DesignElement.USER_LABEL );

		// situation 6

		matchSituation( DesignElementTest.TABLE, 5, null,
				DesignElement.USER_LABEL );
		...
		matchSituation( DesignElementTest.TABLE, 1,
				"table2", DesignElement.SHORT_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.TABLE, 2,
				"table3", DesignElement.SHORT_LABEL );//$NON-NLS-1$
		...
		matchSituation( DesignElementTest.TABLE, 4,
				"\u8868\u683c", DesignElement.SHORT_LABEL );//$NON-NLS-1$

		// situation 6

		matchSituation( DesignElementTest.TABLE, 5,
				"\u8868\u683c", DesignElement.SHORT_LABEL );//$NON-NLS-1$
		...
		matchSituation( DesignElementTest.TABLE, 1,
				"table2(firstDataSet)", DesignElement.FULL_LABEL );//$NON-NLS-1$

		// situation 3

		matchSituation( DesignElementTest.TABLE, 2,
				"table3(firstDataSet)", DesignElement.FULL_LABEL );//$NON-NLS-1$
		...
		matchSituation( DesignElementTest.TABLE, 4,
				"\u8868\u683c(firstDataSet)", DesignElement.FULL_LABEL );//$NON-NLS-1$
		...
		matchSituation( DesignElementTest.TABLE, 7,
				"\u8868\u683c(secondDataSet)", DesignElement.FULL_LABEL );//$NON-NLS-1$

		matchSituation( DesignElementTest.TABLE, 7,
				"\u8868\u683c(secondDataSet)",//$NON-NLS-1$
				DesignElement.FULL_LABEL );
		...
		matchSituation( DesignElementTest.TABLE, 8,
				"\u8868\u683c(asdf sadf asdfa...)",//$NON-NLS-1$
				DesignElement.FULL_LABEL );
	 ...
	 * 
	 * @param type
	 *            there are seven types:label,text,grid,list,table,image,data
	 * @param number
	 *            which sequence element should be selected
	 * @param exceptValue
	 *            excepted value
	 * @param level
	 *            there are three levels 1,USER_LABEL , 2, SHORT_LABEL 3,
	 *            FULL_LABEL
	 */
	private void matchSituation( int type, int number, String exceptValue,
			int level )
	{
		SlotHandle slotHandle = designHandle.getBody( );
		SlotHandle reportSlotHandle = ( (FreeFormHandle) slotHandle.get( 0 ) )
				.getReportItems( );
		...
		{
			case LABEL :
				LabelHandle lblHandle = (LabelHandle) reportSlotHandle
						.get( number );
				displayLabel = lblHandle.getDisplayLabel( level );
				break;
			case TEXT :
				TextItemHandle textHandle = (TextItemHandle) reportSlotHandle
						.get( number );
				displayLabel = textHandle.getDisplayLabel( level );
				break;
			case GRID :
				GridHandle gridHandle = (GridHandle) reportSlotHandle
						.get( number );
				displayLabel = gridHandle.getDisplayLabel( level );
				break;
			case LIST :
				ListHandle listHandle = (ListHandle) reportSlotHandle
						.get( number );
				displayLabel = listHandle.getDisplayLabel( level );
				break;
			case DATA :
				DataItemHandle dataHandle = (DataItemHandle) reportSlotHandle
						.get( number );
				displayLabel = dataHandle.getDisplayLabel( level );
				break;
			case IMAGE :
				ImageHandle imageHandle = (ImageHandle) reportSlotHandle
						.get( number );
				displayLabel = imageHandle.getDisplayLabel( level );
				break;
			case TABLE :
				TableHandle tableHandle = (TableHandle) reportSlotHandle
						.get( number );
	...
	/**
	 * Tests the case that one styled element has no name, but has style. The
	 * value of name property should be from element not style.
	 */
	 ...
	 * 
	 * @throws SemanticException
	 *             if setting properties with errors.
	 */
	...
	public void testID( ) throws SemanticException
	{
		...
		FreeFormHandle container1 = (FreeFormHandle) designHandle
				.getComponents( ).get( 0 );
	...
	public void testElementRef( ) throws SemanticException
	{
		...
		assertEquals( label1.getStringProperty( ReportItem.DATA_SET_PROP ),
				dataSet1.getName( ) );
		assertEquals( label1.getElementProperty( ReportItem.DATA_SET_PROP ),
				dataSet1 );
		...
		DataSourceHandle dataSource1 = designHandle
				.findDataSource( "Data Source 1" ); //$NON-NLS-1$
		...
		assertEquals( label1.getStringProperty( ReportItem.DATA_SET_PROP ),
				"Data Set 1" ); //$NON-NLS-1$
		assertNull( label1.getElementProperty( ReportItem.DATA_SET_PROP ) );

		// Create new class for unresolved

		dataSet1 = designHandle.getElementFactory( ).newOdaDataSet(
				"Data Set 1" ); //$NON-NLS-1$
	...
	public void testIsContentOf( ) throws SemanticException
	{
		...
		assertTrue( label1.getElement( )
				.isContentOf( designHandle.getElement( ) ) );
		assertFalse( designHandle.getElement( ).isContentOf(
				label1.getElement( ) ) );
	...
	private void setupDesign( ) throws SemanticException
	{
		...
		DataSourceHandle dataSource1 = factory
				.newOdaDataSource( "Data Source 1" );//$NON-NLS-1$
		designHandle.getDataSources( ).add( dataSource1 );

		DataSourceHandle dataSource2 = factory
				.newOdaDataSource( "Data Source 2" );//$NON-NLS-1$
	...
	public void testElementIdentifier( ) throws Exception
	{
		...
		assertEquals(
				"Table(\"table1\").Detail[0].Cells[0]", cell.getElement( ).getIdentifier( ) ); //$NON-NLS-1$
		...
		assertEquals(
				"Table.Detail[0].Cells[0]", cell.getElement( ).getIdentifier( ) ); //$NON-NLS-1$
		...
		assertEquals(
				"report.Body[2].Detail[0].Cells[0]", cell.getElement( ).getIdentifier( ) ); //$NON-NLS-1$
	...
	public void testExtendsValidatorAndResolve( ) throws Exception
	{
		...
		assertEquals( InvalidParentException.DESIGN_EXCEPTION_PARENT_NOT_FOUND,
				error.getErrorCode( ) );
		...
		ImageHandle libImage = (ImageHandle) designHandle
				.getLibrary( "lib" ).findElement( "libImage" ); //$NON-NLS-1$ //$NON-NLS-2$
		ImageHandle designImage = (ImageHandle) designHandle
				.findElement( "designImage" ); //$NON-NLS-1$
