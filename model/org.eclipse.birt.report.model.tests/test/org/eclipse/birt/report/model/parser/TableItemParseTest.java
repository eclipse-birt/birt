...
public class TableItemParseTest extends ParserTestCase
{
	...
	public void testReadVisibilityRules( RowHandle handle ) throws Exception
	{
		...
		assertEquals( DesignChoiceConstants.FORMAT_TYPE_PDF, hideHandle
				.getFormat( ) );
		...
		assertEquals( DesignChoiceConstants.FORMAT_TYPE_ALL, hideHandle
				.getFormat( ) );
	...
	public void testParser( ) throws Exception
	{
		...
		assertTrue( column
				.getBooleanProperty( TableColumn.SUPPRESS_DUPLICATES_PROP ) );
		...
		assertEquals( DesignChoiceConstants.FORMAT_TYPE_VIEWER, hideRule
				.getFormat( ) );
	...
	public void testWriter( ) throws Exception
	{
		...
		PropertyHandle propHandle = column
				.getPropertyHandle( TableColumn.VISIBILITY_PROP );
