...
public class ColorPropertyTypeTest extends PropertyTypeTestCase
{
	...
	public void testToCSSCompatibleColor( )
	{
		...
		assertEquals(
				"RGB(18,52,250)", type.toCSSCompatibleColor( design, "myColor1" ) ); //$NON-NLS-1$ //$NON-NLS-2$
		assertEquals(
				"RGB(255,255,255)", type.toCSSCompatibleColor( design, "myColor2" ) ); //$NON-NLS-1$ //$NON-NLS-2$

		assertEquals(
				"RGB(255,0,255)", type.toCSSCompatibleColor( design, Integer.decode( "#FF00FF" ) ) ); //$NON-NLS-1$//$NON-NLS-2$
	...
	public void testToCssColor( )
	{
		...
		assertEquals(
				"#ff00ff", type.toCssColor( design, Integer.decode( "#FF00FF" ) ) ); //$NON-NLS-1$//$NON-NLS-2$
	...
	public void testToDouble( )
	{
		...
		assertEquals(
				Integer.decode( "#FF0000" ).doubleValue( ), type.toDouble( design, "red" ), 0 ); //$NON-NLS-1$ //$NON-NLS-2$
		assertEquals(
				Integer.decode( "#FFFFFF" ).doubleValue( ), type.toDouble( design, "myColor2" ), 0 ); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public void testToInteger( )
	{
		...
		assertEquals(
				Integer.decode( "#FF0000" ).intValue( ), type.toInteger( design, "red" ) ); //$NON-NLS-1$ //$NON-NLS-2$
		assertEquals(
				Integer.decode( "#FFFFFF" ).intValue( ), type.toInteger( design, "myColor2" ) ); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public void testToXml( )
	{
		...
		assertEquals(
				"#FF00FF", type.toXml( design, propDefn, Integer.decode( "#FF00FF" ) ) ); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void testToString( )
	{
		...
		assertEquals(
				"#FF00FF", type.toString( design, propDefn, Integer.decode( "#FF00FF" ) ) ); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public void testToDisplayString( ) throws PropertyValueException
	{
		...
		ThreadResources.setLocale( TEST_LOCALE );
		assertEquals(
				"\u7ea2\u8272", type.toDisplayString( design, propDefn, "red" ) ); //$NON-NLS-1$ //$NON-NLS-2$

		assertEquals(
				"Color 2", type.toDisplayString( design, propDefn, "myColor2" ) ); //$NON-NLS-1$ //$NON-NLS-2$

		design.getSession( ).setColorFormat( ColorUtil.CSS_ABSOLUTE_FORMAT );
		assertEquals(
				"RGB(255,0,255)", type.toDisplayString( design, propDefn, Integer.decode( "#FF00FF" ) ) ); //$NON-NLS-1$ //$NON-NLS-2$

		design.getSession( ).setColorFormat( ColorUtil.CSS_RELATIVE_FORMAT );
		assertEquals(
				"RGB(100.0%,0.0%,100.0%)", type.toDisplayString( design, propDefn, Integer.decode( "#FF00FF" ) ) ); //$NON-NLS-1$ //$NON-NLS-2$
	}
