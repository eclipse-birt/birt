...
public class EmptyListParseTest extends BaseTestCase
{
	...
	public void testParseEmptyListProperty( ) throws Exception
	{
		...
		ComputedColumnHandle columnBinding = (ComputedColumnHandle) dataHandle
				.getColumnBindings( ).getAt( 0 );
		...
		columnBinding = (ComputedColumnHandle) dataHandle.getColumnBindings( )
				.getAt( 1 );
	...
	public void testParseEmptyListPropertyWithValue( ) throws Exception
	{
		...
		//assertTrue( compareFile( "ParseEmptyListPropertyWithValueTest_golden.xml" ) ); //$NON-NLS-1$
