...
public class StructListPropertyTypeTest extends PropertyTypeTestCase
{
    ...
    protected void setUp( ) throws Exception
    {
       ...
       /* prepareDouble = new Object[]{ null};
        expectDouble = new double[]{0};

        prepareInteger = new Object[]{ null, value};
        expectInteger = new int[]{ 0, 3 }; 
        
        prepareXml = new Object[]{ null};
        expectXml = new String[]{null};

        prepareString = new Object[]{ null, "nothing"};
        expectString = new String[]{null, null};
        
        prepareValue = null;
        prepareInvalidValue = new Object[]{null};
        expectValue = null;*/
	...
	public void testValidateValue( ) throws PropertyValueException
	{
		try
        {
			type.validateValue( design, propDefn, "any-data" ); //$NON-NLS-1$
            fail();
        }
