...
public class DesignElementPropsTest extends BaseTestCase
{
	...
	public void testImageProperties( ) throws Exception
	{
		...
		assertTrue( compareListWithGoldenFile( list,
				"ImagePropsTest_golden.txt" ) ); //$NON-NLS-1$
		list = getLocalProperties( ReportDesignConstants.IMAGE_ITEM );
		assertTrue( compareListWithGoldenFile( list,
				"ImageLocalPropsTest_golden.txt" ) ); //$NON-NLS-1$
	}
	...
	public void testTableProperties( ) throws Exception
	{
		...
		assertTrue( compareListWithGoldenFile( list,
				"TableItemPropsTest_golden.txt" ) ); //$NON-NLS-1$
		list = getLocalProperties( ReportDesignConstants.TABLE_ITEM );

		assertTrue( compareListWithGoldenFile( list,
				"TableItemLocalPropsTest_golden.txt" ) ); //$NON-NLS-1$
	}
	...
	public void testCellProperties( ) throws Exception
	{
		...
		assertTrue( compareListWithGoldenFile( list,
				"CellLocalPropsTest_golden.txt" ) ); //$NON-NLS-1$
	}
	 ...
	 * @param goldenFile
	 *            the golden file name.
	 * @return true is every element in the list is identical the corresponding
