...
public class DimensionValueTest extends BaseTestCase
{
	...
	{
		DimensionValue dim = new DimensionValue( 120000000.12345656d,
	...
	{
		DimensionValue v1 = new DimensionValue( 25.4,
				DesignChoiceConstants.UNITS_MM );
		DimensionValue v2 = DimensionUtil.convertTo( 1.0,
				DesignChoiceConstants.UNITS_IN, DesignChoiceConstants.UNITS_MM );
		DimensionValue v3 = new DimensionValue( 25.4,
				DesignChoiceConstants.UNITS_MM );
		DimensionValue v4 = new DimensionValue( 1.0,
