...
public class DimensionUtilTest extends TestCase
{
	...
	{
		assertTrue( DimensionUtil
				.isAbsoluteUnit( DesignChoiceConstants.UNITS_CM ) );
		assertFalse( DimensionUtil
				.isAbsoluteUnit( DesignChoiceConstants.UNITS_EM ) );
		assertFalse( DimensionUtil
				.isAbsoluteUnit( DesignChoiceConstants.UNITS_EX ) );
		assertTrue( DimensionUtil
				.isAbsoluteUnit( DesignChoiceConstants.UNITS_IN ) );
		assertTrue( DimensionUtil
				.isAbsoluteUnit( DesignChoiceConstants.UNITS_MM ) );
		assertTrue( DimensionUtil
				.isAbsoluteUnit( DesignChoiceConstants.UNITS_PC ) );
		assertFalse( DimensionUtil
				.isAbsoluteUnit( DesignChoiceConstants.UNITS_PERCENTAGE ) );
		assertTrue( DimensionUtil
				.isAbsoluteUnit( DesignChoiceConstants.UNITS_PT ) );
		assertFalse( DimensionUtil
				.isAbsoluteUnit( DesignChoiceConstants.UNITS_PX ) );
	}
	...
	{
		// * => in
		DimensionValue value = DimensionUtil.convertTo( 100,
				DesignChoiceConstants.UNITS_CM, DesignChoiceConstants.UNITS_IN );
		assertEquals( 39.37, value.getMeasure( ), 0.01 );

		value = DimensionUtil.convertTo( 100, DesignChoiceConstants.UNITS_IN,
				DesignChoiceConstants.UNITS_IN );
		assertEquals( 100, value.getMeasure( ), 0.01 );

		value = DimensionUtil.convertTo( 100, DesignChoiceConstants.UNITS_MM,
				DesignChoiceConstants.UNITS_IN );
		assertEquals( 3.94, value.getMeasure( ), 0.01 );

		value = DimensionUtil.convertTo( 100, DesignChoiceConstants.UNITS_PC,
				DesignChoiceConstants.UNITS_IN );
		assertEquals( 16.67, value.getMeasure( ), 0.01 );

		value = DimensionUtil.convertTo( 100, DesignChoiceConstants.UNITS_PT,
				DesignChoiceConstants.UNITS_IN );
		assertEquals( 1.39, value.getMeasure( ), 0.01 );

		// * => cm

		value = DimensionUtil.convertTo( 100, DesignChoiceConstants.UNITS_CM,
		...
		value = DimensionUtil.convertTo( 100, DesignChoiceConstants.UNITS_CM,
				DesignChoiceConstants.UNITS_PC );
	...
	{
		int dpi = 72;
		assertEquals( 0.0, DimensionUtil.convertTo( null,
				DesignChoiceConstants.UNITS_CM, DesignChoiceConstants.UNITS_MM,
				10, dpi ), 0.01 );
		...
		assertEquals( DimensionUtil.convertTo( value,
				DesignChoiceConstants.UNITS_IN, DesignChoiceConstants.UNITS_CM,
				10, DesignChoiceConstants.UNITS_PT, dpi ), DimensionUtil
				.convertTo( 100, DesignChoiceConstants.UNITS_PT,
		...
		assertEquals( DimensionUtil.convertTo( value,
				DesignChoiceConstants.UNITS_IN, DesignChoiceConstants.UNITS_CM,
				10, DesignChoiceConstants.UNITS_PT, dpi ), DimensionUtil
				.convertTo( 5, DesignChoiceConstants.UNITS_PT,
						DesignChoiceConstants.UNITS_CM ).getMeasure( ), 0.01 );
