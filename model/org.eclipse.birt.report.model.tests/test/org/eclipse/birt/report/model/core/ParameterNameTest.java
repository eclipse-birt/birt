...
public class ParameterNameTest extends BaseTestCase
{
	...
	/**
	 * Tests the backward compatibility when the name of the parameter and
	 * parameter group is changed to be case insensitive since 3.2.21.
	 * 
	 * @throws Exception
	 */
	...
	public void testParser( ) throws Exception
	{
		...
		catch ( DesignFileException e )
		{
			...
			assertEquals( NameException.DESIGN_EXCEPTION_DUPLICATE, errors.get(
					0 ).getErrorCode( ) );
		}
