...
public class TableColumnBandTest extends BaseTestCase {
	...
	public void testColumnCopy() throws Exception {
		...
		data = table.copyColumn(2);
		assertEquals(2, ApiTestUtil.getCopiedCells(data).size());
		assertEquals(IColorConstants.BLACK, ApiTestUtil.getCopiedCell(data, 1).getProperty(design, Style.COLOR_PROP));
	...
	public void testPasteNonMergedCells2MergedCells() throws Exception {
		...
		TableHandle copyTable = (TableHandle) designHandle.findElement("CopyTable1"); //$NON-NLS-1$
		assertNotNull(copyTable);

		TableHandle pasteTable = (TableHandle) designHandle.findElement("PasteTable1"); //$NON-NLS-1$
		...
		assertEquals(IColorConstants.RED, column1.getStringProperty(Style.COLOR_PROP));
		assertEquals(1, column2.getRepeatCount());
	}
	...
	public void testPasteMergedCells2NonMergedCells() throws Exception {
		...
		TableHandle copyTable = (TableHandle) designHandle.findElement("CopyTable2"); //$NON-NLS-1$
		assertNotNull(copyTable);

		TableHandle pasteTable = (TableHandle) designHandle.findElement("PasteTable2"); //$NON-NLS-1$
		assertNotNull(pasteTable);
	...
	public void testColumnWithDifferentLayout() throws Exception {
		...
		TableHandle copyTable = (TableHandle) designHandle.findElement("CopyTable3"); //$NON-NLS-1$
		assertNotNull(copyTable);

		TableHandle pasteTable = (TableHandle) designHandle.findElement("PasteTable3"); //$NON-NLS-1$
		assertNotNull(pasteTable);
		...
		assertEquals(IColorConstants.AQUA, column.getProperty(Style.COLOR_PROP));

		column = (ColumnHandle) pasteColumns.get(1);
		assertEquals(IColorConstants.RED, column.getProperty(Style.COLOR_PROP));
	...
	public void testInsertAndPasteWithColumn() throws Exception {
		...
		assertEquals(IColorConstants.AQUA, column.getStringProperty(Style.COLOR_PROP));

		column = (ColumnHandle) columns.get(1);
		assertEquals(1, column.getRepeatCount());
		assertEquals(IColorConstants.RED, column.getStringProperty(Style.COLOR_PROP));
	...
	public void testInsertPasteWithoutColumns() throws Exception {
		...
		openDesign(fileName);
		TableHandle table = (TableHandle) designHandle.findElement("My table5"); //$NON-NLS-1$
		assertNotNull(table);
	...
	public void testInsertAndPasteForColumn() throws Exception {
		openDesign(fileName);
		TableHandle copyTable = (TableHandle) designHandle.findElement("CopyTable4"); //$NON-NLS-1$
		assertNotNull(copyTable);

		TableHandle pasteTable = (TableHandle) designHandle.findElement("PasteTable4"); //$NON-NLS-1$
		assertNotNull(copyTable);
	...
	public void testShiftFailed() throws Exception {
		...
		TableHandle table = (TableHandle) designHandle.findElement("My table3"); //$NON-NLS-1$
		assertNotNull(table);
	...
	public void testOperationsOnCopiedTable() throws SemanticException, CloneNotSupportedException {
		...
		TableHandle table1 = (TableHandle) table.copy().getHandle(designHandle.getModule());
		...
		assertTrue(((TableHandle) table2.getHandle(designHandle.getModule())).canCopyColumn(1));

		assertTrue(((TableHandle) table2.getHandle(designHandle.getModule())).canCopyColumn(2));
	}
