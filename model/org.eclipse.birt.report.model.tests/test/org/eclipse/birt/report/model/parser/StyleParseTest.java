...
public class StyleParseTest extends BaseTestCase
{
	...
	public void testParser( ) throws Exception
	{
		...
		assertEquals(
				"larger", style.getStringProperty( design, Style.FONT_SIZE_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"italic", style.getStringProperty( design, Style.FONT_STYLE_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"normal", style.getStringProperty( design, Style.FONT_VARIANT_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"bold", style.getStringProperty( design, Style.FONT_WEIGHT_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"line-through", style.getStringProperty( design, Style.TEXT_LINE_THROUGH_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"overline", style.getStringProperty( design, Style.TEXT_OVERLINE_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"underline", style.getStringProperty( design, Style.TEXT_UNDERLINE_PROP ) ); //$NON-NLS-1$

		assertEquals(
				"dotted", style.getStringProperty( design, Style.BORDER_TOP_STYLE_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"thin", style.getStringProperty( design, Style.BORDER_TOP_WIDTH_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"blue", style.getStringProperty( design, Style.BORDER_TOP_COLOR_PROP ) ); //$NON-NLS-1$

		assertEquals(
				"dashed", style.getStringProperty( design, Style.BORDER_LEFT_STYLE_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"thin", style.getStringProperty( design, Style.BORDER_LEFT_WIDTH_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"green", style.getStringProperty( design, Style.BORDER_LEFT_COLOR_PROP ) ); //$NON-NLS-1$

		assertEquals( DesignChoiceConstants.LINE_STYLE_SOLID, style
				.getStringProperty( design, Style.BORDER_BOTTOM_STYLE_PROP ) );
		assertEquals(
				"thin", style.getStringProperty( design, Style.BORDER_BOTTOM_WIDTH_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"red", style.getStringProperty( design, Style.BORDER_BOTTOM_COLOR_PROP ) ); //$NON-NLS-1$

		assertEquals(
				"double", style.getStringProperty( design, Style.BORDER_RIGHT_STYLE_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"thin", style.getStringProperty( design, Style.BORDER_RIGHT_WIDTH_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"maroon", style.getStringProperty( design, Style.BORDER_RIGHT_COLOR_PROP ) ); //$NON-NLS-1$

		assertEquals(
				"1mm", style.getStringProperty( design, Style.PADDING_TOP_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"2mm", style.getStringProperty( design, Style.PADDING_LEFT_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"3mm", style.getStringProperty( design, Style.PADDING_RIGHT_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"4mm", style.getStringProperty( design, Style.PADDING_BOTTOM_PROP ) ); //$NON-NLS-1$

		assertEquals(
				"scroll", style.getStringProperty( design, Style.BACKGROUND_ATTACHMENT_PROP ) ); //$NON-NLS-1$
		assertEquals(
		...
		assertEquals(
				"top", style.getStringProperty( design, Style.BACKGROUND_POSITION_Y_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"repeat", style.getStringProperty( design, Style.BACKGROUND_REPEAT_PROP ) ); //$NON-NLS-1$

		assertEquals(
				"right", style.getStringProperty( design, Style.TEXT_ALIGN_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"5mm", style.getStringProperty( design, Style.TEXT_INDENT_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"normal", style.getStringProperty( design, Style.LETTER_SPACING_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"normal", style.getStringProperty( design, Style.LINE_HEIGHT_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"19", style.getStringProperty( design, Style.ORPHANS_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"uppercase", style.getStringProperty( design, Style.TEXT_TRANSFORM_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"middle", style.getStringProperty( design, Style.VERTICAL_ALIGN_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"nowrap", style.getStringProperty( design, Style.WHITE_SPACE_PROP ) ); //$NON-NLS-1$
		assertEquals( "12", style.getStringProperty( design, Style.WIDOWS_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"normal", style.getStringProperty( design, Style.WORD_SPACING_PROP ) ); //$NON-NLS-1$
		...
		assertEquals(
				"true", style.getStringProperty( design, Style.CAN_SHRINK_PROP ) ); //$NON-NLS-1$

		assertEquals(
				"right", style.getStringProperty( design, Style.NUMBER_ALIGN_PROP ) ); //$NON-NLS-1$

		assertEquals(
				"auto", style.getStringProperty( design, Style.MARGIN_TOP_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"auto", style.getStringProperty( design, Style.MARGIN_LEFT_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"auto", style.getStringProperty( design, Style.MARGIN_RIGHT_PROP ) ); //$NON-NLS-1$
		assertEquals(
		...
		assertEquals(
				"[somefield]", ( (MapRule) mapRules.get( 0 ) ).getTestExpression( ) ); //$NON-NLS-1$
		assertEquals( "Closed", ( (MapRule) mapRules.get( 0 ) ).getDisplay( ) ); //$NON-NLS-1$
		assertEquals( "\"X\"", ( (MapRule) mapRules.get( 0 ) ).getValue1( ) ); //$NON-NLS-1$

		assertEquals( DesignChoiceConstants.MAP_OPERATOR_TRUE,
				( (MapRule) mapRules.get( 1 ) ).getOperator( ) );
	...
	public void testSearchingProperty( ) throws Exception
	{
		...
		Label label = (Label) form.getSlot( FreeForm.REPORT_ITEMS_SLOT )
				.getContent( 0 );
		assertEquals( "4mm", label.getStringProperty( design, Label.WIDTH_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"4mm", label.getFactoryProperty( design, Label.WIDTH_PROP ).toString( ) ); //$NON-NLS-1$
		...
		assertEquals(
				"bold", label.getFactoryProperty( design, Style.FONT_WEIGHT_PROP ).toString( ) ); //$NON-NLS-1$
		...
		assertEquals(
				"bolder", label.getStringProperty( design, Style.FONT_WEIGHT_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"bolder", label.getFactoryProperty( design, Style.FONT_WEIGHT_PROP ).toString( ) ); //$NON-NLS-1$
		...
		assertEquals(
				"lighter", label.getFactoryProperty( design, Style.FONT_WEIGHT_PROP ).toString( ) ); //$NON-NLS-1$
		...
		assertEquals( null, label.getStyleName( ) );
		assertEquals(
				"100", label.getStringProperty( design, Style.FONT_WEIGHT_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"100", label.getFactoryProperty( design, Style.FONT_WEIGHT_PROP ).toString( ) ); //$NON-NLS-1$

		// Test getting the unset non-style property value whose "canInherit" is
		// false.

		assertEquals( null, design.getStringProperty( design,
				ReportDesign.AUTHOR_PROP ) );
		assertEquals( null, design.getFactoryProperty( design,
				ReportDesign.AUTHOR_PROP ) );

		// Test getting the unset non-style property value whose "canInherit" is
		// true.

		MasterPage page = (MasterPage) design.getSlot( ReportDesign.PAGE_SLOT )
				.getContent( 0 );
		...
		assertEquals(
				"1", page.getFactoryProperty( design, GraphicMasterPage.COLUMNS_PROP ).toString( ) ); //$NON-NLS-1$

		// Test getting the unset style property value whose "canInherit" is
		// false.

		form = (FreeForm) design.findElement( "My Fifth Form" ); //$NON-NLS-1$
		assertEquals( null, form.getStringProperty( design,
				Style.BACKGROUND_COLOR_PROP ) );
		assertEquals(
				"repeat", form.getStringProperty( design, Style.BACKGROUND_REPEAT_PROP ) ); //$NON-NLS-1$
		assertEquals( null, form.getFactoryProperty( design,
				Style.BACKGROUND_COLOR_PROP ) );
		assertEquals( null, form.getFactoryProperty( design,
		...
		assertEquals(
				"normal", form.getStringProperty( design, Style.FONT_STYLE_PROP ) ); //$NON-NLS-1$
		assertEquals( null, form.getFactoryProperty( design,
				Style.FONT_FAMILY_PROP ) );
		assertEquals( null, form.getFactoryProperty( design,
		...
		assertEquals(
				"999mm", childForm.getStringProperty( design, FreeForm.X_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"999mm", childForm.getFactoryProperty( design, FreeForm.X_PROP ).toString( ) ); //$NON-NLS-1$
		...
		assertEquals( null, childForm.getStyleName( ) );
		assertEquals(
				"x-small", childForm.getStringProperty( design, Style.FONT_SIZE_PROP ) ); //$NON-NLS-1$
		assertEquals(
				"small-caps", childForm.getStringProperty( design, Style.FONT_VARIANT_PROP ) ); //$NON-NLS-1$
		assertEquals( "x-small", childForm.getFactoryProperty( design, //$NON-NLS-1$
				Style.FONT_SIZE_PROP ) );
		assertEquals(
				"small-caps", childForm.getFactoryProperty( design, Style.FONT_VARIANT_PROP ).toString( ) ); //$NON-NLS-1$

		// Test getting the style property value that is set on
		// the non-local style of element's parent.

		assertEquals(
				"red", childForm.getStringProperty( design, Style.COLOR_PROP ) ); //$NON-NLS-1$ 
		assertEquals(
				"red", childForm.getFactoryProperty( design, Style.COLOR_PROP ) ); //$NON-NLS-1$ 
		...
		assertNotNull( table );
		TableRow row = (TableRow) ( table.getSlot( TableItem.DETAIL_SLOT )
				.getContent( 0 ) );
		assertEquals(
				"large", row.getStringProperty( design, Style.FONT_SIZE_PROP ) ); //$NON-NLS-1$
		assertEquals( "large", row //$NON-NLS-1$
				.getFactoryProperty( design, Style.FONT_SIZE_PROP ) );

		TableRow row1 = (TableRow) ( table.getSlot( TableItem.HEADER_SLOT )
				.getContent( 0 ) );
		...
		assertNotNull( table );
		row = (TableRow) ( table.getSlot( TableItem.HEADER_SLOT )
				.getContent( 0 ) );
		assertEquals(
				"xx-large", row.getStringProperty( design, Style.FONT_SIZE_PROP ) ); //$NON-NLS-1$
		assertEquals( null, row.getFactoryProperty( design,
				Style.FONT_SIZE_PROP ) );
		...
		row = (TableRow) ( table.getSlot( TableItem.HEADER_SLOT )
				.getContent( 0 ) );
		assertEquals(
				"100", row.getStringProperty( design, Style.FONT_WEIGHT_PROP ) ); //$NON-NLS-1$
		assertEquals( null, row.getFactoryProperty( design,
	...
	public void testWriteHighlightRules( ) throws Exception
	{
		...
		highlightHandle
				.setOperator( DesignChoiceConstants.MAP_OPERATOR_BETWEEN );
		highlightHandle
				.setOperator( DesignChoiceConstants.MAP_OPERATOR_NOT_BETWEEN );
		highlightHandle
				.setOperator( DesignChoiceConstants.MAP_OPERATOR_NOT_NULL );
	...
	public void testPredefinedStyle( ) throws Exception
	{
		...
		elementDefn = (ElementDefn) dd
				.getElement( ReportDesignConstants.TEXT_ITEM );
		...
		elementDefn = (ElementDefn) dd
				.getElement( ReportDesignConstants.RECTANGLE_ITEM );
		assertEquals( "rectangle", elementDefn.getSelector( ) ); //$NON-NLS-1$

		elementDefn = (ElementDefn) dd
				.getElement( ReportDesignConstants.LIST_ITEM );
		assertEquals( "list", elementDefn.getSelector( ) ); //$NON-NLS-1$
		assertEquals(
				"list-header", ( (SlotDefn) elementDefn.getSlot( ListItem.HEADER_SLOT ) ).getSelector( ) ); //$NON-NLS-1$
		assertEquals(
				"list-footer", ( (SlotDefn) elementDefn.getSlot( ListItem.FOOTER_SLOT ) ).getSelector( ) ); //$NON-NLS-1$
		assertEquals(
				"list-detail", ( (SlotDefn) elementDefn.getSlot( ListItem.DETAIL_SLOT ) ).getSelector( ) ); //$NON-NLS-1$

		elementDefn = (ElementDefn) dd
				.getElement( ReportDesignConstants.LIST_GROUP_ELEMENT );
		assertEquals( null, elementDefn.getSelector( ) );
		assertEquals(
				"list-group-header", ( (SlotDefn) elementDefn.getSlot( ListGroup.HEADER_SLOT ) ).getSelector( ) ); //$NON-NLS-1$
		assertEquals(
				"list-group-footer", ( (SlotDefn) elementDefn.getSlot( ListGroup.FOOTER_SLOT ) ).getSelector( ) ); //$NON-NLS-1$

		elementDefn = (ElementDefn) dd
				.getElement( ReportDesignConstants.TABLE_ITEM );
		assertEquals( "table", elementDefn.getSelector( ) ); //$NON-NLS-1$
		assertEquals(
				"table-header", ( (SlotDefn) elementDefn.getSlot( TableItem.HEADER_SLOT ) ).getSelector( ) ); //$NON-NLS-1$
		assertEquals(
				"table-footer", ( (SlotDefn) elementDefn.getSlot( TableItem.FOOTER_SLOT ) ).getSelector( ) ); //$NON-NLS-1$
		assertEquals(
				"table-detail", ( (SlotDefn) elementDefn.getSlot( TableItem.DETAIL_SLOT ) ).getSelector( ) ); //$NON-NLS-1$

		elementDefn = (ElementDefn) dd
				.getElement( ReportDesignConstants.TABLE_GROUP_ELEMENT );
		assertEquals( null, elementDefn.getSelector( ) );
		assertEquals(
				"table-group-header", ( (SlotDefn) elementDefn.getSlot( TableGroup.HEADER_SLOT ) ).getSelector( ) ); //$NON-NLS-1$
		assertEquals(
				"table-group-footer", ( (SlotDefn) elementDefn.getSlot( TableGroup.FOOTER_SLOT ) ).getSelector( ) ); //$NON-NLS-1$
	}
	...
	public void testPropertySearchWithLevel( ) throws Exception
	{
		...
		TableGroup group = (TableGroup) ( table.getSlot( TableItem.GROUP_SLOT )
				.getContent( 0 ) );
		TableRow row = (TableRow) ( group.getSlot( TableItem.HEADER_SLOT )
				.getContent( 0 ) );
		assertEquals(
				"center", row.getStringProperty( design, Style.TEXT_ALIGN_PROP ) ); //$NON-NLS-1$
		assertEquals( "center", row.getFactoryProperty( design, //$NON-NLS-1$
				Style.TEXT_ALIGN_PROP ) );

		// Test group level two

		group = (TableGroup) ( table.getSlot( TableItem.GROUP_SLOT )
				.getContent( 1 ) );
		row = (TableRow) ( group.getSlot( TableItem.HEADER_SLOT )
				.getContent( 0 ) );
		assertEquals(
				"right", row.getStringProperty( design, Style.TEXT_ALIGN_PROP ) ); //$NON-NLS-1$
			...
			PropertyValueException
	{
		...
		design.getSession( ).setDefaultValue( Style.BORDER_BOTTOM_COLOR_PROP,
				"#0000ff" ); //$NON-NLS-1$

		// Session default value

		assertEquals(
				"#0000FF", form.getStringProperty( design, Style.BORDER_BOTTOM_COLOR_PROP ).toString( ) ); //$NON-NLS-1$

		// Metadata default value

		assertEquals(
				"black", form.getStringProperty( design, Style.BORDER_TOP_COLOR_PROP ).toString( ) ); //$NON-NLS-1$

		// Remove session default value
		design.getSession( ).setDefaultValue( Style.BORDER_BOTTOM_COLOR_PROP,
				null );
		assertEquals(
				"black", form.getStringProperty( design, Style.BORDER_BOTTOM_COLOR_PROP ).toString( ) ); //$NON-NLS-1$
	}
