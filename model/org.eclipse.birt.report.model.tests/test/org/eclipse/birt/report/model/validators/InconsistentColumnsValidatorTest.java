...
public class InconsistentColumnsValidatorTest extends ValidatorTestCase
{
	...
	public void testTriggers( ) throws Exception
	{
		...
		ColumnHandle columnHandle1 = tableHandle.getElementFactory( )
				.newTableColumn( );
		ColumnHandle columnHandle2 = tableHandle.getElementFactory( )
				.newTableColumn( );
		ColumnHandle columnHandle3 = tableHandle.getElementFactory( )
				.newTableColumn( );
		ColumnHandle columnHandle4 = tableHandle.getElementFactory( )
				.newTableColumn( );

		tableHandle.getColumns( ).add( columnHandle1 );
		assertTrue( listener.hasError( tableHandle,
				InconsistentColumnsValidator.getInstance( ).getName( ),
		...
		assertFalse( listener.hasError( tableHandle,
				InconsistentColumnsValidator.getInstance( ).getName( ),
				SemanticError.DESIGN_EXCEPTION_INCONSITENT_TABLE_COL_COUNT ) );
