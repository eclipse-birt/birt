...
public class MasterPageHandleTest extends BaseTestCase
{
	 ...
	 * Test getSize().
	 * <p>
	 * 1. type is not provided. Default value of "USLetter" should be returned,
	 * in session unit.
	 * 
	 * @throws Exception
	 * 
	...
	public void testDefaultPage( ) throws Exception
	{
		...
		assertEquals( DesignChoiceConstants.PAGE_SIZE_US_LETTER, pageHandle
				.getPageType( ) );

		assertEquals( DesignChoiceConstants.PAGE_ORIENTATION_AUTO, pageHandle
				.getOrientation( ) );

		// should be null, related to getEffectiveHeight() and
		// getEffectiveWidth()

		assertEquals( IMasterPageModel.US_LETTER_HEIGHT, pageHandle.getHeight( )
				.getStringValue( ) );
		assertEquals( IMasterPageModel.US_LETTER_WIDTH, pageHandle.getWidth( )
				.getStringValue( ) );
	 ...
	 * <p>
	 * 1. type is "Custom", width="8.3cm", height="13.3cm" , application unit is
	 * in. Return value should be the converted value in inch unit.
	 * 
	 * @throws Exception
	 */
	...
	public void testCustomPage( ) throws Exception
	{
		...
		assertEquals(
				"0.25mm", graphicHandle.getColumnSpacing( ).getStringValue( ) ); //$NON-NLS-1$
	...
	public void testSetProperty( ) throws Exception
	{
		...
		assertEquals( DesignChoiceConstants.PAGE_SIZE_A4, page
				.getStringProperty( MasterPage.TYPE_PROP ) );
		assertEquals( MasterPage.A4_HEIGHT, page
				.getStringProperty( MasterPage.HEIGHT_PROP ) );
		assertEquals( MasterPage.A4_WIDTH, page
				.getStringProperty( MasterPage.WIDTH_PROP ) );
		assertEquals( IMasterPageModel.A4_HEIGHT, ( (DimensionValue) ( page
				.getHeight( ).getValue( ) ) ).toString( ) );
		...
		assertEquals( DesignChoiceConstants.PAGE_SIZE_US_LEGAL, page
				.getStringProperty( MasterPage.TYPE_PROP ) );
		assertEquals( MasterPage.US_LEGAL_HEIGHT, page
				.getStringProperty( MasterPage.HEIGHT_PROP ) );
		assertEquals( MasterPage.US_LEGAL_WIDTH, page
				.getStringProperty( MasterPage.WIDTH_PROP ) );

	}

	/**
	 * Tests masterpage will be rotated if orientation type is landscape and
	 * page type is not custom, and will NOT be rotated if orientation type is
	 * landscape and page type is custom.
	 * 
	...
	public void testLandscape( ) throws DesignFileException, SemanticException
	{
		...
		page.setPageType( DesignChoiceConstants.PAGE_SIZE_A4 );
		page.setOrientation( DesignChoiceConstants.PAGE_ORIENTATION_LANDSCAPE );
		assertEquals( IMasterPageModel.A4_WIDTH, page.getHeight( )
				.getStringValue( ) );
		assertEquals( IMasterPageModel.A4_HEIGHT, page.getWidth( )
				.getStringValue( ) );
		...
		assertEquals( IMasterPageModel.A4_HEIGHT, page.getHeight( )
				.getStringValue( ) );
		assertEquals( IMasterPageModel.A4_WIDTH, page.getWidth( )
				.getStringValue( ) );
		...
		page.setPageType( DesignChoiceConstants.PAGE_SIZE_US_LEGAL );
		page.setOrientation( DesignChoiceConstants.PAGE_ORIENTATION_LANDSCAPE );
		assertEquals( IMasterPageModel.US_LEGAL_WIDTH, page.getHeight( )
				.getStringValue( ) );
		assertEquals( IMasterPageModel.US_LEGAL_HEIGHT, page.getWidth( )
				.getStringValue( ) );
		...
		// is US_LEGEL.
		page.setOrientation( DesignChoiceConstants.PAGE_ORIENTATION_PORTRAIT );
		assertEquals( IMasterPageModel.US_LEGAL_HEIGHT, page.getHeight( )
				.getStringValue( ) );
		assertEquals( IMasterPageModel.US_LEGAL_WIDTH, page.getWidth( )
				.getStringValue( ) );
		...
		page.setOrientation( DesignChoiceConstants.PAGE_ORIENTATION_LANDSCAPE );
		assertEquals( IMasterPageModel.US_LETTER_WIDTH, page.getHeight( )
				.getStringValue( ) );
		assertEquals( IMasterPageModel.US_LETTER_HEIGHT, page.getWidth( )
				.getStringValue( ) );
		...
		// is US_LETTER.
		page.setOrientation( DesignChoiceConstants.PAGE_ORIENTATION_PORTRAIT );
		assertEquals( IMasterPageModel.US_LETTER_HEIGHT, page.getHeight( )
				.getStringValue( ) );
		assertEquals( IMasterPageModel.US_LETTER_WIDTH, page.getWidth( )
				.getStringValue( ) );

	}

	/**
	 * Tests that height and width are not allowed to be set if masterpage size
	 ...
	 * 
	 */
	public void testPredefinedType( ) throws DesignFileException,
			SemanticException
	{
		openDesign( fileName );
	...
	private void assertSizeUnsettable( MasterPageHandle page, String property )
			throws SemanticException
	{
		try
		{
