...
public class ImageHandleTest extends BaseTestCase
{
	...
	protected void setUp( ) throws Exception
	{
		...
		assertEquals( DesignChoiceConstants.IMAGE_REF_TYPE_FILE, fileImage
				.getSource( ) );

		exprImage = (ImageHandle) designHandle.findElement( "Image3" ); //$NON-NLS-1$
		assertEquals( DesignChoiceConstants.IMAGE_REF_TYPE_EXPR, exprImage
				.getSource( ) );

		urlImage = (ImageHandle) designHandle.findElement( "Image6" ); //$NON-NLS-1$
		assertEquals( DesignChoiceConstants.IMAGE_REF_TYPE_URL, urlImage
				.getSource( ) );
	}
	 ...
	 *             if the image source is invalid.
	 */
	...
	public void testChangeImageType( ) throws SemanticException
	{
		...
		assertEquals( DesignChoiceConstants.IMAGE_REF_TYPE_EMBED, fileImage
				.getSource( ) );
	...
	public void testSetImageProperties( ) throws Exception
	{
		...
		ImageHandle image = (ImageHandle) designHandle.findMasterPage(
				"My Page" ).getSlot( 0 ).get( 5 ); //$NON-NLS-1$
		...
		assertEquals( DesignChoiceConstants.IMAGE_SIZE_SCALE_TO_ITEM, image
				.getStringProperty( ImageItem.SIZE_PROP ) ); //$NON-NLS-1$
		...
		{
			assertEquals( StyleException.DESIGN_EXCEPTION_NOT_FOUND, se
					.getErrorCode( ) );
	...
	public void testGetImageProperties( )
	{
		...
		ImageHandle imageHandle = (ImageHandle) designHandle.findMasterPage(
				"My Page" ).getSlot( 0 ).get( 5 ); //$NON-NLS-1$
		assertNotNull( imageHandle );
		assertEquals( DesignChoiceConstants.IMAGE_REF_TYPE_FILE, imageHandle
				.getSource( ) );
		...
		assertEquals( designHandle.getComponents( ).get( 0 ), fileImage
				.getExtends( ) );
	...
	public void testGetImageName( )
	{
		...
		CellHandle cell1 = (CellHandle) ( (RowHandle) myGrid1.getRows( )
