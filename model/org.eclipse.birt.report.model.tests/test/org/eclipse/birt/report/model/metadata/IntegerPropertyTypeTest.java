...
public class IntegerPropertyTypeTest extends PropertyTypeTestCase
{
	...
	public void testToXml( )
	{
		...
		assertEquals(
				"123456", type.toXml( design, propDefn, new Integer( 123456 ) ) ); //$NON-NLS-1$
	}
	...
	public void testToString( )
	{
		...
		assertEquals(
				"123456", type.toString( design, propDefn, new Integer( 123456 ) ) ); //$NON-NLS-1$
	}
	...
	public void testToDisplayString( )
	{
		...
		assertEquals(
				"123,456", type.toDisplayString( design, propDefn, new Integer( "123456" ) ) ); //$NON-NLS-1$//$NON-NLS-2$
	}
