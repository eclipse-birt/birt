...
public class StringUtilTest extends TestCase
{
	...
	{
		assertEquals(
				"123456.789", StringUtil.doubleToString( 123456.7890123, 3 ) ); //$NON-NLS-1$
		assertEquals(
				"1234567.89", StringUtil.doubleToString( 1234567.890123, 3 ) );//$NON-NLS-1$
		assertEquals(
				"12345678.901", StringUtil.doubleToString( 12345678.90123, 3 ) );//$NON-NLS-1$
		assertEquals(
				"123456789.012", StringUtil.doubleToString( 123456789.0123, 3 ) );//$NON-NLS-1$
		assertEquals(
				"1234567890.123", StringUtil.doubleToString( 1234567890.123, 3 ) );//$NON-NLS-1$
		assertEquals(
				"12345678901.23", StringUtil.doubleToString( 12345678901.23, 3 ) );//$NON-NLS-1$
		assertEquals(
				"1234567890123", StringUtil.doubleToString( 1234567890123.0, 3 ) );//$NON-NLS-1$

		assertEquals(
				"1234567890123.457", StringUtil.doubleToString( 1234567890123.4567890, 3 ) );//$NON-NLS-1$
		assertEquals(
				"12345678901234.568", StringUtil.doubleToString( 12345678901234.567890, 3 ) );//$NON-NLS-1$
		assertEquals(
				"123456789012345.67", StringUtil.doubleToString( 123456789012345.67890, 3 ) );//$NON-NLS-1$
		assertEquals(
				"1234567890123456.8", StringUtil.doubleToString( 1234567890123456.7890, 3 ) );//$NON-NLS-1$ 
		assertEquals(
				"12345678901234568", StringUtil.doubleToString( 12345678901234567.890, 3 ) );//$NON-NLS-1$
		assertEquals(
				"123456789012345680", StringUtil.doubleToString( 123456789012345678.90, 3 ) );//$NON-NLS-1$
