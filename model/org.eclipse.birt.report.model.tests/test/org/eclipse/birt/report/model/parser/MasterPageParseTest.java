...
public class MasterPageParseTest extends BaseTestCase
{
	...
	public void testParser( ) throws Exception
	{
		...
		assertEquals( DesignChoiceConstants.PAGE_SIZE_US_LETTER, page
				.getPageType( ) );
		assertEquals( DesignChoiceConstants.PAGE_ORIENTATION_PORTRAIT, page
				.getOrientation( ) );

		assertEquals( 2, page.getColumnCount( ) );
		assertEquals( "2mm", page.getColumnSpacing( ).getStringValue( ) ); //$NON-NLS-1$
		assertEquals(
				"yellow", page.getPrivateStyle( ).getBackgroundColor( ).getStringValue( ) ); //$NON-NLS-1$
		assertEquals(
				"red", page.getPrivateStyle( ).getColor( ).getStringValue( ) ); //$NON-NLS-1$
		assertEquals(
				"12mm", page.getPrivateStyle( ).getFontSize( ).getStringValue( ) ); //$NON-NLS-1$
	...
	public void testSimpleMasterPage( ) throws Exception
	{
		...
		SimpleMasterPageHandle simplePage = (SimpleMasterPageHandle) designHandle
				.findMasterPage( "Simple Page" ); //$NON-NLS-1$
