...
public class PropertyStructureCloneTest extends BaseTestCase
{
	...
	/**
	 * Copy action from Image1 to Image2, then change the type of "action1",
	 * write them back, ensure that change to image1 won't affect image2.
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * Copy action from image1 to image2. Change a list value of action in
	 * image1, ensure that it won't affect action on image2.
	 * 
	 * @throws Exception
	 */
