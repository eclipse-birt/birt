 ...
 * <td>Values are set correctly and the output file matches the golden file.</td>
 * </tr>
 * 
 * <tr>
...
public class ReportDesignHandleTest extends BaseTestCase {
	...
	public void testReportDesignProperties() throws Exception {
		...
		assertEquals("Script here", designHandle
				.getProperty(ReportDesignHandle.ON_CONTENT_UPDATE_METHOD));
	...
	public void testUniqueStyleName() throws Exception {
		...
		clonedElementHandle = clonedElement
				.getHandle(libraryHandle.getModule());
	...
	public void testFindResource() throws Exception {
		...
		designHandle.getModule()
				.setSystemId(new URL("http://www.eclipse.org/")); //$NON-NLS-1$
