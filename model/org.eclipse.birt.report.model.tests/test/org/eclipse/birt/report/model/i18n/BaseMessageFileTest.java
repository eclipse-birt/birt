...
public abstract class BaseMessageFileTest extends BaseTestCase
{
	...
	/**
	 * Loads all the display names,tooltips and tags defined in the given file
	 * into the resource key map, keyed by themselves and valued by their
	 * description.
	 * 
	 * @param fileName
	 *            the file name
	 ...
	 * @throws IOException
	 */
	protected void loadResourceKeys( String fileName, InputStream is )
			throws IOException
	{
		...
		for ( int lineCount = 1; line != null; line = br.readLine( ), lineCount++ )
		{
			...
			if ( displayNameId != null
					&& !resourceKeyMap.containsKey( displayNameId ) )
