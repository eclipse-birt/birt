...
public class NumberPropertyTypeTest extends PropertyTypeTestCase
{
	...
	{
		assertEquals(
				"1234567.123", type.toXml( design, propDefn, new BigDecimal( 1234567.123d ) ) ); //$NON-NLS-1$
	}
	...
	{
		assertEquals(
				"1234567.123", type.toString( design, propDefn, new BigDecimal( 1234567.123d ) ) ); //$NON-NLS-1$
	}
	...
	public void testToDisplayString( )
	{
		ThreadResources.setLocale( ULocale.ENGLISH );
		assertEquals(
				"1,234,567.123", type.toDisplayString( design, propDefn, new BigDecimal( 1234567.123d ) ) ); //$NON-NLS-1$
	}
