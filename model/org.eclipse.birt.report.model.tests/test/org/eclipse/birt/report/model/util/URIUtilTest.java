...
public class URIUtilTest extends BaseTestCase
{
	...
	public void testFileProtocol( ) throws IOException
	{
		...
		assertNull( URIUtil
				.getLocalPath( "http://hp.msn.com/2I/_XM9~_`9ZW5I]T9{Q29,@+.jpg" ) ); //$NON-NLS-1$

		assertEquals(
				"hp.msn.com/2I/_XM9~_`9ZW5I]T9{Q29,@+.jpg", //$NON-NLS-1$
				URIUtil
						.getLocalPath( "file://hp.msn.com/2I/_XM9~_`9ZW5I]T9{Q29,@+.jpg" ) ); //$NON-NLS-1$		

		assertEquals(
				"C:\\hp.msn.com/2I/_XM9~_`9ZW5I]T9{Q29,@+.jpg", //$NON-NLS-1$
				URIUtil
						.getLocalPath( "C:\\hp.msn.com/2I/_XM9~_`9ZW5I]T9{Q29,@+.jpg" ) ); //$NON-NLS-1$

		assertEquals(
				"/C:/hp.msn.com/2I/_XM9~_`9ZW5I]T9{Q29,@+.jpg", //$NON-NLS-1$
				URIUtil
						.getLocalPath( "file:///C:/hp.msn.com/2I/_XM9~_`9ZW5I]T9{Q29,@+.jpg" ) ); //$NON-NLS-1$
	 ...
	 * <li>5. the base path with file name. Filename is also treated as a
	 * directory.
	 * </ul>
	 */
	...
	private void getRelativePathOnWindows( )
	{
		...
		assertEquals( "E:/birt/sampleReports/lib/lib1.rptlibrary", //$NON-NLS-1$
				URIUtil.getRelativePath(
						"D:/birt/sampleReports/reportdesigns/", //$NON-NLS-1$
						"E:/birt/sampleReports/lib/lib1.rptlibrary" ) ); //$NON-NLS-1$
		...
		// from the base
		assertEquals(
				"D:/spaced directory name/lib.xml", URIUtil.getRelativePath( //$NON-NLS-1$
	...
	{
		assertEquals( "E:" + File.separator + "birt" + File.separator //$NON-NLS-1$ //$NON-NLS-2$
