...
public class GridItemHandleTest extends BaseTestCase
{
	...
	public void testRowCopyPasteAction( ) throws Exception
	{
		GridHandle gridHandle = (GridHandle) designHandle
				.findElement( "My grid" ); //$NON-NLS-1$
		GridHandle gridHandle2 = (GridHandle) designHandle
				.findElement( "My grid 1" );//$NON-NLS-1$
		RowOperationParameters parameters1 = new RowOperationParameters( 0, -1,
				0 );
		RowOperationParameters parameters2 = new RowOperationParameters( 0, -1,
				1 );
		RowOperationParameters parameters3 = new RowOperationParameters( 0, -1,
				100 );
