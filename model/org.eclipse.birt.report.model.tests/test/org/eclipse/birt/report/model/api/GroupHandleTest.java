...
public class GroupHandleTest extends BaseTestCase
{
	...
	public void testProperties( ) throws Exception
	{
		...
		group
				.setPageBreakBefore( DesignChoiceConstants.PAGE_BREAK_BEFORE_ALWAYS_EXCLUDING_FIRST );
		assertEquals(
				DesignChoiceConstants.PAGE_BREAK_BEFORE_ALWAYS_EXCLUDING_FIRST,
				group.getPageBreakBefore( ) );
		...
		assertNull( group
				.getPropertyDefn( IStyleModel.BACKGROUND_ATTACHMENT_PROP ) );
