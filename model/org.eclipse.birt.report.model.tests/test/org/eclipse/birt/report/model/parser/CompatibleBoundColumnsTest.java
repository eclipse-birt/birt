...
public class CompatibleBoundColumnsTest extends BaseTestCase
{
	 ...
	 * 
	 * <ul>
	 * <li>parse the old design and create bound columns during parsing
	 * procedure.
	 * </ul>
	 * 
	 * @throws Exception
	...
	public void testExpressionCompatible( ) throws Exception
	{
		...
		saveAs( "CompatibleBirt2_1M5Expr_out.xml" );//$NON-NLS-1$

		assertTrue( compareTextFile( "CompatibleBirt2_1M5Expr_golden.xml", //$NON-NLS-1$
				"CompatibleBirt2_1M5Expr_out.xml" ) ); //$NON-NLS-1$
	}
	...
	public void testDataValueExpr( ) throws Exception
	{
		...
		saveAs( "Birt2_1_0Expr_out.xml" );//$NON-NLS-1$

		assertTrue( compareTextFile( "Birt2_1_0Expr_golden.xml", //$NON-NLS-1$
				"Birt2_1_0Expr_out.xml" ) ); //$NON-NLS-1$
	}
	 ...
	 * 
	 * <ul>
	 * <li>parse the obsolete design file with text item. Content of text item
	 * is a special case.
	 * </ul>
	 * 
	 * @throws Exception
	...
	public void testTextContent( ) throws Exception
	{
		...
		saveAs( "Birt2_1_M5TextContent_out.xml" );//$NON-NLS-1$

		assertTrue( compareTextFile( "Birt2_1_M5TextContent_golden.xml", //$NON-NLS-1$
				"Birt2_1_M5TextContent_out.xml" ) ); //$NON-NLS-1$
	}
	...
	public void testNestedTable( ) throws Exception
	{
		...
		saveAs( "CompatibleBoundColumnNestedTable_out.xml" );//$NON-NLS-1$

		assertTrue( compareTextFile(
				"CompatibleBoundColumnNestedTable_golden.xml", //$NON-NLS-1$
				"CompatibleBoundColumnNestedTable_out.xml" ) ); //$NON-NLS-1$
	}
	 ...
	 * 
	 * <ul>
	 * <li>parse the obsolete design file with multi data items in the group.
	 * For same result set columns in different group, must create a
	 * table-unique bound column name with aggregateOn of groupName.
	 * </ul>
	 * 
	 * @throws Exception
	 */
	...
	public void testDataValueExprWithGroup( ) throws Exception
	{
		...
		saveAs( "CompatibleDataValueExprWithGroup_out.xml" );//$NON-NLS-1$

		assertTrue( compareTextFile(
				"CompatibleDataValueExprWithGroup_golden.xml", //$NON-NLS-1$
				"CompatibleDataValueExprWithGroup_out.xml" ) ); //$NON-NLS-1$
	}
	...
	public void testGroupBoundCOlumns( ) throws Exception
	{
		...
		ListingHandle tableHandle = (ListingHandle) designHandle
		...
		assertEquals( group.getName( ), structure.getAggregrateOn( ) );
	 ...
	 * <li>the result is: bound column created automatically. And aggregateOn
	 * set with group name.
	 * </ul>
	 * 
	 * <ul>
	 * For the design file with version greater than "3" and smaller than
	 * "3.2.2". That is, has bound column feature. And the group has the bound
	 * column property.
	 * <li>parser the design file without bound columns feature.
	 * <li>the result is: bound column created automatically. If the bound
	 * columns already on the table. Do nothing.
	 * </ul>
	 * 
	 * @throws Exception
	 */
	 ...
	 * <ul>
	 * For the design file with version "3" or early.
	 * <li>Creates the column bindings for rows[0]. And change rows[0] to
	 * row._outer
	 ...
	 * 
	 * <ul>
	 * For the design file with version "3.2.1" or early. The nested table has
	 * an extended item.
	 * <li>Change rows[0] to row._outer. Column bindings should be created in
	 * the nested table.
	 * <li>the result is expected.
	 * </ul>
	 * 
	 ...
	 * <li>Create bound data columns on outer data container. And convert
	 * rows[] to row._outer.
	 * <li>the result is expected.
	 * </ul>
	 * 
