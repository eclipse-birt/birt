...
public class StyleHandleTest extends BaseTestCase
{
	 ...
	 *             if there is something wrong with opening xml file
	 */
	public void testSetOperator( ) throws SemanticException,
			DesignFileException
	{
	 ...
	 * exists in design file or not. The expected result is no information
	 * exists.
	 * 
	 * @throws Exception
	 */
