...
public class DimensionHandleTest extends BaseTestCase {
	...
	public void testGetDisplayValue() {
		...
		assertEquals(DesignChoiceConstants.UNITS_PT, fontSizeHandle.getDefaultUnit());
	...
	public void testGetStringValue() {
		...
		dimensionHandle = highlightHandle.getFontSize();
		assertNotNull(dimensionHandle);
		assertEquals(DesignChoiceConstants.FONT_SIZE_MEDIUM, dimensionHandle.getStringValue());
	...
	public void testGetMeasure() throws SemanticException {
		StyleHandle styleHandle = designHandle.findStyle("My-Style"); //$NON-NLS-1$
		DimensionHandle fontSizeHandle = styleHandle.getFontSize();
		assertEquals(DesignChoiceConstants.FONT_SIZE_LARGER, fontSizeHandle.getStringValue());
	...
	public void testGetUnits() throws SemanticException {
		...
		assertEquals(DesignChoiceConstants.UNITS_PC, dimensionHandle.getUnits());
	...
	public void testComputedValue() {
		FreeFormHandle freeFormHandle1 = (FreeFormHandle) designHandle.findElement("form1"); //$NON-NLS-1$
		TextItemHandle textHandle1 = (TextItemHandle) designHandle.findElement("text1"); //$NON-NLS-1$

		// form1 has fontSize and textIndent, while text1 has fontSize only.
		// The font size is from form1

		assertEquals("12px", freeFormHandle1.getStringProperty(Style.FONT_SIZE_PROP)); //$NON-NLS-1$
		assertEquals("3em", freeFormHandle1.getStringProperty(Style.TEXT_INDENT_PROP)); //$NON-NLS-1$
		assertEquals("15px", textHandle1.getStringProperty(Style.FONT_SIZE_PROP)); //$NON-NLS-1$
		assertEquals("3em", textHandle1.getStringProperty(Style.TEXT_INDENT_PROP)); //$NON-NLS-1$
		...
		FreeFormHandle freeFormHandle2 = (FreeFormHandle) designHandle.findElement("form2"); //$NON-NLS-1$
		TextItemHandle textHandle2 = (TextItemHandle) designHandle.findElement("text2"); //$NON-NLS-1$
		...
		FreeFormHandle freeFormHandle3 = (FreeFormHandle) designHandle.findElement("form3"); //$NON-NLS-1$
		TextItemHandle textHandle3 = (TextItemHandle) designHandle.findElement("text3"); //$NON-NLS-1$
		...
		FreeFormHandle freeFormHandle4 = (FreeFormHandle) designHandle.findElement("form4"); //$NON-NLS-1$
		TextItemHandle textHandle4 = (TextItemHandle) designHandle.findElement("text4"); //$NON-NLS-1$
		...
		FreeFormHandle freeFormHandle5 = (FreeFormHandle) designHandle.findElement("form5"); //$NON-NLS-1$
		TextItemHandle textHandle5 = (TextItemHandle) designHandle.findElement("text5"); //$NON-NLS-1$
		...
		FreeFormHandle freeFormHandle6 = (FreeFormHandle) designHandle.findElement("form6"); //$NON-NLS-1$
		FreeFormHandle innerFreeFormHandle6 = (FreeFormHandle) designHandle.findElement("innerForm6"); //$NON-NLS-1$
		TextItemHandle textHandle6 = (TextItemHandle) designHandle.findElement("text6"); //$NON-NLS-1$
		...
		assertEquals("38px", innerFreeFormHandle6.getDimensionProperty( //$NON-NLS-1$
				Style.BACKGROUND_POSITION_X_PROP).getAbsoluteValue().toString());
		assertEquals("0px", textHandle6.getDimensionProperty( //$NON-NLS-1$
				Style.BACKGROUND_POSITION_X_PROP).getAbsoluteValue().toString());

		// textIndent is computed with the font size from form7

		TextItemHandle textHandle7 = (TextItemHandle) designHandle.findElement("text7"); //$NON-NLS-1$
		assertEquals("18px", textHandle7.getDimensionProperty( //$NON-NLS-1$
				Style.TEXT_INDENT_PROP).getAbsoluteValue().toString());

		TextItemHandle textHandle9 = (TextItemHandle) designHandle.findElement("text9"); //$NON-NLS-1$
		FreeFormHandle innerFreeFormHandle9 = (FreeFormHandle) designHandle.findElement("innerForm9"); //$NON-NLS-1$
	...
	public void testFontSizeAbsoluteValue() throws SemanticException {
		FreeFormHandle freeFormHandle8 = (FreeFormHandle) designHandle.findElement("form8"); //$NON-NLS-1$
		TextItemHandle textHandle8 = (TextItemHandle) designHandle.findElement("text8"); //$NON-NLS-1$

		DimensionHandle fontSizeOnForm = freeFormHandle8.getDimensionProperty(Style.FONT_SIZE_PROP);

		DimensionHandle fontSizeOnText = textHandle8.getDimensionProperty(Style.FONT_SIZE_PROP);

		fontSizeOnText.setStringValue(DesignChoiceConstants.FONT_SIZE_SMALL);
		assertEquals(DesignChoiceConstants.FONT_SIZE_SMALL, fontSizeOnText.getValue().toString());
		...
		assertEquals(DesignChoiceConstants.FONT_SIZE_MEDIUM, fontSizeOnForm.getValue().toString());
		...
		assertEquals(DesignChoiceConstants.FONT_SIZE_LARGE, fontSizeOnForm.getValue().toString());
