...
public class DataItemParseTest extends BaseTestCase {
	...
	public void testParser() throws Exception {
		...
		dataHandle = (DataItemHandle) designHandle.findElement("componentsData"); //$NON-NLS-1$
		assertNull(dataHandle.getValueExpr());
		...
		dataHandle = (DataItemHandle) designHandle.findElement("scratchpadData"); //$NON-NLS-1$
		assertNull(dataHandle.getValueExpr());
		...
		dataHandle = (DataItemHandle) designHandle.findElement("graphicmasterpageData"); //$NON-NLS-1$
		assertNull(dataHandle.getValueExpr());
	...
	public void testSemanticCheck() throws Exception {
		...
		assertEquals(SemanticError.DESIGN_EXCEPTION_MISSING_COLUMN_BINDING, error.getErrorCode());
