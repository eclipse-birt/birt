...
public class TOCHandle extends StructureHandle
{
	 ...
	 * </ul>
	 * 
	 * @return the data type for the toc
	 * 
	...
	{
		return (String) getProperty( TOC.DATA_TYPE_MEMBER );
	}
	
	/**
	 * Sets the data type for this toc. Types are defined in 
