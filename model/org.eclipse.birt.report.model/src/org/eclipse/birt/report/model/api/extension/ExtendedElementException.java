...
public class ExtendedElementException extends SemanticException
{
	...
	public ExtendedElementException( DesignElement element, String pluginId,
			String errorCode, ResourceBundle bundle )
	{
	...
	public ExtendedElementException( DesignElement element, String pluginId,
			String errorCode, ResourceBundle bundle, Throwable cause )
	{
	...
	public ExtendedElementException( DesignElement element, String pluginId,
			String errorCode, Object[] args, ResourceBundle bundle,
			Throwable cause )
	{
	...
	public ExtendedElementException( DesignElement element, String pluginId,
			String errorCode, Object arg0, ResourceBundle bundle,
			Throwable cause )
	{
	...
	public ExtendedElementException( DesignElement element, String pluginId,
			String errorCode, Object[] args, Throwable cause )
	{
	...
	public String getLocalizedMessage( )
	{
		...
		if ( element instanceof ExtendedItem )
		{
			...
			if ( msgs != null )
			{
				externalizedMessage = msgs.getMessage( sResourceKey,
