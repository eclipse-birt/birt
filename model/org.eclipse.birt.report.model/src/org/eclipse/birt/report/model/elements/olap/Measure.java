...
public class Measure extends ReferenceableElement implements IMeasureModel
{
	...
	public MeasureHandle handle( Module module )
	{
		if ( handle == null )
		{
			handle = new MeasureHandle( module, this );
		}
		return (MeasureHandle) handle;
	}
}
