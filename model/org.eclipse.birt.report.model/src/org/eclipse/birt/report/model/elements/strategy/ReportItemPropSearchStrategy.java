...
public class ReportItemPropSearchStrategy extends PropertySearchStrategy {
	...
	static {
		...
		tmpIntegerSet.add(Integer.valueOf(IReportItemModel.PARAM_BINDINGS_PROP.hashCode()));
		tmpIntegerSet.add(Integer.valueOf(IReportItemModel.BOUND_DATA_COLUMNS_PROP.hashCode()));
		tmpIntegerSet.add(Integer.valueOf(IReportItemModel.DATA_SET_PROP.hashCode()));
		tmpIntegerSet.add(Integer.valueOf(IReportItemModel.CUBE_PROP.hashCode()));
		tmpIntegerSet.add(Integer.valueOf(IListingElementModel.FILTER_PROP.hashCode()));
		tmpIntegerSet.add(Integer.valueOf(IListingElementModel.SORT_PROP.hashCode()));
		...
		tmpIntegerSet.add(Integer.valueOf(IReportItemModel.DATA_SET_PROP.hashCode()));
		tmpIntegerSet.add(Integer.valueOf(IReportItemModel.CUBE_PROP.hashCode()));
		tmpIntegerSet.add(Integer.valueOf(IExtendedItemModel.FILTER_PROP.hashCode()));
	...
	protected Object getPropertyFromSelf(Module module, DesignElement element, ElementPropertyDefn prop) {
		...
		if (refPropDefn == null)
			return null;
		if (prop.getTypeCode() != refPropDefn.getTypeCode() || prop.getStructDefn() != refPropDefn.getStructDefn()
