...
public class PropertyBinding extends Structure
{
	...
	/**
	 * Sets the name of the property binding. It must be one of the defined
			...
			DesignElement element )
	{
		...
		if ( StringUtil.isBlank( getName( ) ) )
		{
			list.add( new PropertyValueException( element, getDefn( )
				...
				|| module.getElementByID( id.longValue( ) ) == null )
		{
			list
		...
		else if ( module.getElementByID( id.longValue( ) ).getPropertyDefn(
				getName( ) ) == null )
		{
