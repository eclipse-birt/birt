...
public class FilterCondition extends PropertyStructure {
	...
	/**
	 * Name of the member that indicates the extension name defined to map to a BIRT
	 * filter operator.
	 */
	...
	/**
	 * Name of the member that indicates the name of the dynamic filter parameter to
	 * reference.
	 */
	...
	/**
	 * Name of the member that indicates if the current filter condition need to
	 * update aggregation.
	 */
	...
	public List validate(Module module, DesignElement element) {
		...
		if (StringUtil.isBlank(getFilterExpr())) {
			list.add(new PropertyValueException(element, getDefn().getMember(EXPR_MEMBER), getFilterExpr(),
