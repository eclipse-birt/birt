 ...
 * will be notified when {@link #execute(ActivityRecord)},{@link #commit()},
...
public final class ActivityStack implements CommandStack
{
	...
	public void execute( ActivityRecord record )
	{
		// The record must exist and must be in the initial state.
	...
	public ActivityRecord getRedoRecord( )
	{
	...
	public ActivityRecord getUndoRecord( )
	{
	...
	{
		ActivityRecord cmd = getUndoRecord( );
		if ( cmd == null )
			return null;
	...
	{
		ActivityRecord cmd = getRedoRecord( );
		if ( cmd == null )
			return null;
