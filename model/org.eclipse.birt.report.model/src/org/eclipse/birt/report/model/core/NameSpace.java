...
public class NameSpace implements Cloneable {
	 ...
	 * command: it represents a temporary period in which the model is inconsistent.
	 * The element name has already changed, we are now updating the name space. The
