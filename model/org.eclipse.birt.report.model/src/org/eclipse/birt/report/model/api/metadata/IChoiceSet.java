...
public interface IChoiceSet {
	...
	boolean contains(String choiceName);
	...
	IChoice[] getChoices(Comparator<Object> c);
	...
	IChoice findChoice(String name);
	...
	IChoice findChoiceByDisplayName(String name);
	...
	UserChoice findUserChoiceByDisplayName(Module module, String name);
