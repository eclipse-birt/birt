...
public class TextDataItemState extends ReportItemState
{
	...
	/**
	 * Constructs the multi-line data state with the design parser handler, the container
	 * element and the container slot of the multi-line data.
	 * 
	...
	public TextDataItemState( DesignParserHandler handler,
