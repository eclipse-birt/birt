...
public class StructRefValue
{
	...
	public StructRefValue( String theName )
	{
		assert theName != null;
		name = theName;
	}
	...
	public StructRefValue( Structure structure )
	{
	 ...
	 * 
	 * @return the referenced structure, or null if this reference is not
	...
	/**
	 * Returns the target structure as a referenceable structure. This form
	 ...
	 * 
	 * @param theName the unresolved structure name
	 */
	 ...
	 * 
	 * @return true if this structure is resolved, false
