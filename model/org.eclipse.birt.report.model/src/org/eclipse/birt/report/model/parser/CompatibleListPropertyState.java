...
abstract class CompatibleListPropertyState extends ListPropertyState {
	...
	public CompatibleListPropertyState(ModuleParserHandler theHandler, DesignElement element, PropertyDefn propDefn,
			IStructure struct) {
	...
	public CompatibleListPropertyState(ModuleParserHandler theHandler, DesignElement element) {
