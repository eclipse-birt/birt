...
public class XPathUtil
{
	 ...
	 * @param index
	 *            index of property
	 * @return If it is not list type or index less than zero or index larger
	 *         than property list value size, return false. else return true.
	 */
