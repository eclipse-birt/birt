...
public class PropertyHandleImpl extends SimpleValueHandle
{
	...
	public boolean equals( Object propertyHandle )
	{
		...
		DesignElement element = ( (PropertyHandleImpl) propertyHandle )
				.getElement( );
	...
	public void move( DesignElementHandle content,
			DesignElementHandle newContainer, String propName )
			throws ContentException
	{
	...
	public void move( DesignElementHandle content,
			DesignElementHandle newContainer, String propName, int newPos )
			throws ContentException
	{
		if ( content == null || newContainer == null )
			return;
