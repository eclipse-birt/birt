			...
			Cloneable
{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.birt.model.extension.IExtendedElement#serialize(java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.birt.model.extension.IExtendedElement#checkProperty(java.lang.String,
	 *      java.lang.Object)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.birt.model.extension.IExtendedElement#setProperty(java.lang.String,
	 *      java.lang.Object)
	 */

	public void setProperty( String propName, Object value )
	{
		IElementCommand command = new ElementCommandImpl( this, propName,
				value, extItemHandle );
	...
	public List getPredefinedStyles( )
	{
		...
		while ( e != null )
		{
			...
			if ( container instanceof ExtendedItemHandle
					...
					&& e.getContainerPropertyHandle( ).getDefn( ).getName( )
							.equalsIgnoreCase( "detail" ) ) //$NON-NLS-1$
			{
				styles.add( "testing-box-detail" ); //$NON-NLS-1$
				StyleHandle style = this.moduleHandle
						.findStyle( "testPredefinedStyle" ); //$NON-NLS-1$
				if ( style != null )
