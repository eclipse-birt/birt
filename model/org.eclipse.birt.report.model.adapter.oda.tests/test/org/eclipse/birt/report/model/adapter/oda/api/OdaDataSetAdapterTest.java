...
public class OdaDataSetAdapterTest extends BaseTestCase {
	...
	public void testODADataSetToROMDataSet() throws Exception {
		...
		designHandle.getDataSources()
				.add(new ModelOdaAdapter().createDataSourceHandle(setDesign.getDataSourceDesign(), designHandle));
	...
	public void testCreateDataSetReferDataSource() throws Exception {
		...
		/*
		 * save( ); assertTrue( compareTextFile(
		 * "CreateDataSetReferDataSource_golden.xml" ) ); //$NON-NLS-1$
		 */
		saveAndOpenDesign();
