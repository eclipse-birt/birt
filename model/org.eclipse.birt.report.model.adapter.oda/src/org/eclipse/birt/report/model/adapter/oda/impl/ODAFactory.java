...
class ODAFactory implements IODAFactory
{
	...
	public String getUpdatedDataType( String dataSourceId, String dataSetId,
			int nativeCode, String romDataType, String choiceName )
			throws BirtException
	{
		...
		try
		{
			ExtensionManifest manifest = ManifestExplorer.getInstance( )
					.getExtensionManifest( dataSourceId );
	 ...
	 * @param apiDataType
	 *            the DTE api data type
	 * @return the ROM defined data type.
	 */

	private static String convertApiTypeToROMType( String choiceName,
			int apiDataType )
	{
