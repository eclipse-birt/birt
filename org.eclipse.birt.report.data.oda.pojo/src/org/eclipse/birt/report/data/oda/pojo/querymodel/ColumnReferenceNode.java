...
public class ColumnReferenceNode extends ReferenceNode implements Comparable<ColumnReferenceNode>
{
	...
	public ColumnReferenceNode( RelayReferenceNode parent,
			IMappingSource reference, Column column )
	{
	...
	/* (non-Javadoc)
	 * @see org.eclipse.birt.report.data.oda.pojo.querymodel.ReferenceNode#getColumnReferenceNodes()
	 */
	@Override
