...
package org.eclipse.birt.report.data.oda.pojo.impl.internal;
...
public class PojoDataSetFromCustomClass implements IPojoDataSet
{
	...
	public PojoDataSetFromCustomClass( Class dataSetClass ) throws OdaException
	{
		...
		catch ( SecurityException e )
		{
			logger.log( Level.WARNING,
					"failed to locate open(Object appContext) method ", //$NON-NLS-1$
					e );
		}
		...
		try
		{
			nextMethod = this.dataSetClass.getMethod( Constants.NEXT_METHOD_NAME,
					(Class[]) null );
		...
		try
		{
			closeMethod = this.dataSetClass.getMethod( Constants.CLOSE_METHOD_NAME,
					(Class[]) null );
		}
		catch ( SecurityException e )
		{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.birt.report.data.oda.pojo.api.IPojoDataSet#close()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.birt.report.data.oda.pojo.api.IPojoDataSet#next()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.birt.report.data.oda.pojo.api.IPojoDataSet#open(java.lang.Object,Map<String, Object>)
	 */
	public void open( Object appContext, Map<String, Object> dataSetParamValues ) throws OdaException
	{
		if ( openMethod != null )
		{
			try
			{
				openMethod.invoke( instance, new Object[]{
					appContext, dataSetParamValues
				} );
			}
			catch ( IllegalArgumentException e )
			{
