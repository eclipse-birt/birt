...
/**
 * A special <code>IColumnsMapping</code> that maps a class into multiple columns.
 * <br> the type of its source result is generally another POJO class.
 * A counterpart of <code>ELEMENT_CLASS_COLUMN_MAPPINGS</code> element in POJO query text.
 */
public class ClassColumnMappings implements IColumnsMapping
{
	...
	/* (non-Javadoc)
	 * @see org.eclipse.birt.report.data.oda.pojo.querymodel.IColumnsMapping#getSource()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.birt.report.data.oda.pojo.querymodel.IColumnsMapping#getReferenceNode(org.eclipse.birt.report.data.oda.pojo.querymodel.RelayReferenceNode)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.birt.report.data.oda.pojo.querymodel.IColumnsMapping#createElement(org.w3c.dom.Document)
	 */
