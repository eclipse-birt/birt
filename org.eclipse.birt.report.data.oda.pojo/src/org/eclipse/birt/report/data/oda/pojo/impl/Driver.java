...
{
    static String ODA_DATA_SOURCE_ID = "org.eclipse.birt.report.data.oda.pojo";  //$NON-NLS-1$
    ...
    /**
     * Returns the native data type code of the specified name, as
     * defined in this data source extension's manifest.
     * @param nativeDataTypeName    the native data type name
     * @return                  corresponding native data type code
     * @throws OdaException     if lookup fails
     */
    public static int getNativeDataTypeCode( String nativeDataTypeName ) 
        throws OdaException
    {
        DataTypeMapping typeMapping = 
                            getManifest().getDataSetType( null )
                                .getDataTypeMapping( nativeDataTypeName );
        if( typeMapping != null )
        {
