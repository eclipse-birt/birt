...
public class ExpressionParserUtilityTest extends TestCase
{
    ...
    public void testAggregationExpression14( )
	{
		...
		try
		{
			List list = ExpressionParserUtility.compileColumnExpression( expression );
			assertTrue( list.size( ) == 1 );
			assertTrue( ( (IColumnBinding) list.get( 0 ) ).getResultSetColumnName( )
					.equals( "aaa" ) );
			...
			assertTrue( ( (IColumnBinding) list.get( 1 ) ).getResultSetColumnName( )
					.equals( "bbb" ) );
			...
			assertTrue( ( (IColumnBinding) list.get( 1 ) ).getResultSetColumnName( )
					.equals( "bbb" ) );
			assertTrue( ( (IColumnBinding) list.get( 1 ) ).getOuterLevel( ) == 1 );
			assertTrue( ( (IColumnBinding) list.get( 2 ) ).getResultSetColumnName( )
					.equals( "aaa" ) );
