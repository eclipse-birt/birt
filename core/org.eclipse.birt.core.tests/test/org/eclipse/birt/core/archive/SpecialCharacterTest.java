...
public class SpecialCharacterTest extends TestCase
{
     ...
     * @throws Exception
     */
    public void doTest( IDocArchiveWriter writer, IDocArchiveReader reader )
            throws IOException
    {
        final String[] fileNames = new String[]{"d:/abc.txt", "../abc/txt",
                "./txt", "...txt", "....txt", ".//.txt", "%25.txt", ":.txt",
                "::", "\\\\.txt", "\\.txt"};
    ...
    public void testFolderReaderWriter( ) throws IOException
    {
        FolderArchiveWriter writer = new FolderArchiveWriter(
                "./utest/folder.rw" );
        FolderArchiveReader reader = new FolderArchiveReader(
                "./utest/folder.rw" );
        try
        {
