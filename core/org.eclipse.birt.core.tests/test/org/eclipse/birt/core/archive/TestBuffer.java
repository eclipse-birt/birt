...
public class TestBuffer
{
	...
	static void testByte( ArchiveWriter writer, ArchiveReader reader )
			throws IOException
	{
		long start, end;
	...
	static void testInteger( ArchiveWriter writer, ArchiveReader reader )
			throws IOException
	{
		long start, end;
	...
	static void testLong( ArchiveWriter writer, ArchiveReader reader )
			throws IOException
	{
		long start, end;
	...
	protected static void testBytes( ArchiveWriter writer, ArchiveReader reader )
			throws IOException
	{
		long start, end;
	...
	static int[] sizes = new int[]{1, 7, 13, 31, 61, 113, 251, 509, 1021, 2039,
			4091, 4093};
