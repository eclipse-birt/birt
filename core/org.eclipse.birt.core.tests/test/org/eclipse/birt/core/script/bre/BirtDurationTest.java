...
public class BirtDurationTest extends TestCase {
	...
	public void testAdd() throws DatatypeConfigurationException {
		...
		assertEquals(toDuration(((String) cx.evaluateString(scope, script1, "inline", 1, null))),
				toDuration("P2Y4M3D"));
		assertEquals(toDuration(((String) cx.evaluateString(scope, script2, "inline", 1, null))),
				toDuration("P2Y4M3DT3S"));
	}
	...
	public void testAddTo() throws DatatypeConfigurationException {
		...
		assertEquals(cx.evaluateString(scope, script1, "inline", 1, null), new Date(55, 1, 12));
		assertEquals(cx.evaluateString(scope, script2, "inline", 1, null), new Date(55, 1, 12, 0, 0, 3));
	}
	...
	public void testTimeInMills() throws DatatypeConfigurationException {
		...
		assertEquals(cx.evaluateString(scope, script1, "inline", 1, null), Long.valueOf(1000));
		assertEquals(cx.evaluateString(scope, script2, "inline", 1, null), Long.valueOf(3000));
	}
	...
	public void testSubstract() throws DatatypeConfigurationException {
		...
		assertEquals(toDuration(((String) cx.evaluateString(scope, script1, "inline", 1, null))), toDuration("-P1D"));
		assertEquals(toDuration(((String) cx.evaluateString(scope, script2, "inline", 1, null))), toDuration("PT3S"));
	}
	...
	public void testCompare() throws DatatypeConfigurationException {
		...
		assertEquals(cx.evaluateString(scope, script1, "inline", 1, null), Integer.valueOf(-1));
		assertEquals(cx.evaluateString(scope, script2, "inline", 1, null), Integer.valueOf(0));
	}
	...
	public void testIsLongerThan() throws DatatypeConfigurationException {
		...
		assertEquals(cx.evaluateString(scope, script1, "inline", 1, null), Boolean.valueOf(true));
		assertEquals(cx.evaluateString(scope, script2, "inline", 1, null), Boolean.valueOf(false));
	}
	...
	public void testIsShorterThan() throws DatatypeConfigurationException {
		...
		assertEquals(cx.evaluateString(scope, script1, "inline", 1, null), Boolean.valueOf(false));
		assertEquals(cx.evaluateString(scope, script2, "inline", 1, null), Boolean.valueOf(true));
	}
	...
	public void testGetSign() throws DatatypeConfigurationException {
		...
		assertEquals(cx.evaluateString(scope, script1, "inline", 1, null), Integer.valueOf(-1));
		assertEquals(cx.evaluateString(scope, script2, "inline", 1, null), Integer.valueOf(1));
	}
	...
	public void testMonth() throws DatatypeConfigurationException {
		...
		assertEquals((cx.evaluateString(scope, script1, "inline", 1, null)), Integer.valueOf(2));
		assertEquals((cx.evaluateString(scope, script2, "inline", 1, null)), Integer.valueOf(0));
	}
	...
	public void testDay() throws DatatypeConfigurationException {
		...
		assertEquals((cx.evaluateString(scope, script1, "inline", 1, null)), Integer.valueOf(1));
		assertEquals((cx.evaluateString(scope, script2, "inline", 1, null)), Integer.valueOf(2));
	}
	...
	public void testHour() throws DatatypeConfigurationException {
		...
		assertEquals((cx.evaluateString(scope, script1, "inline", 1, null)), Integer.valueOf(0));
		assertEquals((cx.evaluateString(scope, script2, "inline", 1, null)), Integer.valueOf(4));
	}
	...
	private static Duration toDuration(String arg) throws DatatypeConfigurationException {
		Duration duration;
		duration = DatatypeFactory.newInstance().newDuration(arg);
		return duration;
	}
}
