...
public class NativeDateTimeSpanTest extends TestCase {
	...
	public void testMonths() {
		...
		/*
		 * In two diffent years, and the first month is less than the second month
		 */
		...
		/*
		 * In two diffent years, and the first month is more than the second month
		 */
	...
	public void testAddDate() {
		...
		/*
		 * Add one year to the startDate, and since 2008 is leap year, so the result
		 * date is 3/1/09.
		 */
		...
		/*
		 * Adding one month to Jan.31 would produce the invalid date Feb.31. The method
		 * adjusts the date to be valid, in this case, if the year is not a leap year,
		 * then Feb. has 28 days and the resulting date would be Mar.3.
		 */
