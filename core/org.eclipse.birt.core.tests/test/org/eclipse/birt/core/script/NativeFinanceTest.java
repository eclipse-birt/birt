...
public class NativeFinanceTest extends TestCase {
	...
	public void testDdb() {
		...
		assertEquals(280.0, value, Double.MIN_VALUE);
		/*
		 * Failure Test. All parameters of this function,cost,salvage,life,period should
		 * be positive. If we provide a negative parameter, application will report
	...
	public void testFv() {
		...
		/*
		 * All parameters of this function should be positive. If we provide a negative
		 * parameter, application will report IllegalArgumentException. And if we input
		 * the value of parameter due is neither 1 or 0, application will also report
		 * error.
		 */
	...
	public void testPmt() {
		...
		assertFalse(hasException);
		/*
		 * If we input the value of parameter due is neither 1 or 0, application will
		 * also report error.
		 */
	...
	public void testIpmt() {
		...
		/*
		 * If any parameter meet the following condition:rate < 0 || nPer < 0 || per >
		 * nPer || ( due != 1 && due != 0 ), application will report error
		 */
	...
	public void testPv() {
		...
		/*
		 * If any parameter meet the following condition:(( nPer < 0 || ( due != 1 &&
		 * due != 0 ) ), application will report error
		 */
	...
	public void testIrr() {
		...
		String script1 = "var array=new Array(6);array[0]=-70000;array[1]=12000;"
				+ "array[2]=15000;array[3]=18000;array[4]=21000;array[5]=26000;" + "Finance.irr( array, 0.01)";
		double value1 = eval(script1);
	...
	public void testMirr() {
		...
		String script1 = "var array=new Array(6);array[0]=-120000;array[1]=39000;"
				+ "array[2]=30000;array[3]=21000;array[4]=37000;array[5]=46000;" + "Finance.mirr( array, 0.1, 0.12 )";
		double value1 = eval(script1);
