...
@Test
    ...
    private class MyResources extends ResourceBundle {
        public Object handleGetObject(String key) {
            if (key.equals( FATAL_ERROR_KEY )) return fatalError;
            if (key.equals( CONCATENATED_ERROR_KEY)) return concatenatedError;
            if (key.equals( CONCATENATED_ERROR_ONE_ARG_KEY)) return concatenatedErrorOneArg;
            return null;
        }
    ...
    private class MyResources_de extends MyResources {
        public Object handleGetObject(String key) {
            if (key.equals(FATAL_ERROR_KEY)) return fatalErrorDE;
            if (key.equals(CONCATENATED_ERROR_KEY)) return concatenatedErrorDE;
            if (key.equals( CONCATENATED_ERROR_ONE_ARG_KEY)) return concatenatedErrorDEOneArg;
            return null;
        }
    }
