...
public class NumberFormatterTest extends TestCase
{
    ...
    public void testApplyPattern( )
	{
		...
		assertEquals( number.format( 1002.20 ), numFormat
				.format( 1002.20 ) );
		assertEquals( number.format( -1002.2 ), numFormat
				.format( -1002.2 ) );
		assertEquals( number.format( 0.004 ), numFormat.format( 0.004 ) );
		assertEquals( number.format( 0.004123456 ), numFormat
				.format( 0.004123456 ) );
		...
		assertEquals( "-0.00", numFormat.format( -0.004 ) );
		assertEquals( "3,333,333,333.33", numFormat
				.format( 3333333333.33 ) );
		assertEquals( "0.00", numFormat.format( 0 ) );
		...
		assertEquals( "-0.40%", numFormat.format( -0.004 ) );
		assertEquals( "333333333333.00%", numFormat
				.format( 3333333333.33 ) );
		assertEquals( "0.00%", numFormat.format( 0 ) );
		...
		assertEquals( "0.41 %", numFormat.format( 0.004123456 ) );
		assertEquals( "-0.40 %", numFormat.format( -0.004 ) );
		assertEquals( "333,333,333,333.00 %", numFormat
				.format( 3333333333.33 ) );
		assertEquals( "0.00 %", numFormat.format( 0 ) );
    ...
    public void testFormatBigDecimal( )
	{
		...
		assertEquals( numFormat.format( new BigDecimal( 2.139 ) ),
				"$2.14" );
		assertEquals( numFormat.format( new BigDecimal( -2.13 ) ),
				"Negative2.13" );
		assertEquals( numFormat.format( new BigDecimal( 0.0 ) ),
						"$0.00" );
		assertEquals( numFormat.format( new BigDecimal( 2000 ) ),
				"$2,000.00" );
