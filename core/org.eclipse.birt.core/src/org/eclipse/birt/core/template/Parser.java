...
public class Parser/* @bgen(jjtree) */ implements ParserTreeConstants, ParserConstants {/* @bgen(jjtree) */
	...
	private boolean jj_3R_7() {
		...
		if (jj_scan_token(TAGC))
			return true;
		if (jj_3R_11())
			return true;
		if (jj_scan_token(END_VIEWTIMEVALUEOF))
			return true;
		if (jj_scan_token(TAGC))
			return true;
		return false;
	...
	private boolean jj_3R_15() {
		if (jj_scan_token(A_NAME))
			return true;
		if (jj_scan_token(A_EQ))
			return true;
