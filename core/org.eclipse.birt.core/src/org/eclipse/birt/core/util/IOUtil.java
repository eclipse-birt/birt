		...
		while (count < utflen) {
			...
			case 13:
				...
				if ((char2 & 0xC0) != 0x80) {
					throw new UTFDataFormatException(
							CoreMessages.getFormattedString(ResourceConstants.MALFORMED_INPUT_AROUND_BYTE, count));
				}
			...
			case 14:
				...
				if ((char2 & 0xC0) != 0x80 || (char3 & 0xC0) != 0x80) {
					throw new UTFDataFormatException(
							CoreMessages.getFormattedString(ResourceConstants.MALFORMED_INPUT_AROUND_BYTE, count - 1));
				}
