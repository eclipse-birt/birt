...
public class DateFormatter implements IFormatter {
	...
	public String format(Date date) {
		try {
			...
			} else if ((date instanceof java.sql.Time) && (timeFormat != null)) {
	...
	public SimpleDateFormat getFormatter() {
		...
		if (formatPattern.equals("Medium Date")) {
			dateFormat = (SimpleDateFormat) DateFormat.getDateInstance(com.ibm.icu.text.DateFormat.MEDIUM, locale);
		...
		if (formatPattern.equals("Medium Time")) {
			dateFormat = (SimpleDateFormat) DateFormat.getTimeInstance(com.ibm.icu.text.DateFormat.MEDIUM, locale);
		}
