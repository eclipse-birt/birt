...
public class HelpUtil
{
	...
	public static final String CONEXT_ID_DATASET_POJO_PROPS = PREFIX
		+ "Wizard_POJO_Dataset_Props_ID";//$NON-NLS-1$
	
	public static final String CONEXT_ID_DATASET_POJO_COLUMN_MAPPING = PREFIX
		+ "Wizard_POJO_Dataset_ColumnMapping_ID";//$NON-NLS-1$
	...
	public static final String CONEXT_ID_DATASET_POJO_CLASS_INPUT_DIALOG = PREFIX
		+ "Dialog_POJO_Dataset_ClassInput_ID";//$NON-NLS-1$
