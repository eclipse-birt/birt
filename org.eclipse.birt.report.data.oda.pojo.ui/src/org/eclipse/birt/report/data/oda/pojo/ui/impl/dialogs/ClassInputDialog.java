...
import org.eclipse.birt.report.data.oda.pojo.util.Utils;
	...
	protected Control createDialogArea( Composite parent )
	{
		...
		txtName.addModifyListener( new ModifyListener( ) {
			public void modifyText( ModifyEvent e )
			{
				...
				{
					classTableViewer.setSelection( new StructuredSelection( 
						classTableViewer.getElementAt( 0 )) );
				}
			}
		} );
		...
		classTableViewer.setLabelProvider( new LabelProvider( )
		{
			...
			{
				return org.eclipse.birt.report.data.oda.pojo.ui.util.Utils.getClassFlagImg( );
			}
