...
import org.eclipse.birt.report.data.oda.pojo.util.ClassParser;
...
public class ClassTreeContentProvider implements ITreeContentProvider
{
	...
	public Object[] getChildren( Object arg0 )
	{
		if ( arg0 instanceof TreeData )
		{
			...
			{
				Member[] members = ClassParser.getPublicMembers( ( (ClassWrapper) obj ).getWrappedClass( ),
						filter );
				return createTreeDataArray( members, level );
			}
			if ( obj instanceof Field )
			{
				return createTreeDataArray( cp.getPublicMembers( (Field) obj,
						filter ), level );
			}
			if ( obj instanceof Method )
			{
				return createTreeDataArray( cp.getPublicMembers( (Method) obj,
						filter ), level );
			}
		}
		return new Object[0];
	...
	{
		return chainItems != null && chainItems.length > level
				? chainItems[level].trim( ) : null;
	}
	...
	public boolean hasChildren( Object arg0 )
	{
		if ( arg0 instanceof TreeData )
		{
			...
			if ( obj instanceof ClassWrapper )
			{
				return ClassParser.getPublicMembers( ( (ClassWrapper) obj ).getWrappedClass( ),
						null ).length > 0;
			}
			if ( obj instanceof Field )
			{
	...
	public Object[] getElements( Object arg0 )
	{
		if ( arg0 instanceof TreeData )
		{
			...
			{
				return new Object[]{
					new TreeData( new ClassWrapper( (Class) obj ), 0 )
				};
			}
