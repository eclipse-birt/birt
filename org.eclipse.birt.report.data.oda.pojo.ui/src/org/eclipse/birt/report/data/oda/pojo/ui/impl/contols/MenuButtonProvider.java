...
public class MenuButtonProvider implements IMenuButtonProvider
{
	...
	private static String RELATIVE_PATH_MENU = Messages.getString( "DataSource.POJOClassTabFolderPage.menuButton.item.relativePath" ); //$NON-NLS-1$
	private static String ABSOLUTE_PATH_MENU = Messages.getString( "DataSource.POJOClassTabFolderPage.menuButton.item.absolutePath" ); //$NON-NLS-1$
	...
	public MenuButtonProvider( )
	{
		optionTypes = new String[]{
			ClassPathElement.ABSOLUTE_PATH
		};
	}
	...
	public String getTooltipText( String type )
	{
		return ClassPathElement.RELATIVE_PATH.equals( type )
				? Messages.getString( "DataSource.button.tooltip.AddRelativeJars" ) : Messages.getString( "DataSource.button.tooltip.AddAbsoluteJars" );//$NON-NLS-1$ //$NON-NLS-2$
	}

	public void handleSelectionEvent( String type )
	{
		Object value = button.getMenuButtonHelper( )
		...
		if ( isRelative )
		{
			...
			{
				JarsSelectionDialog dialog = new JarsSelectionDialog( button.getControl( )
						.getShell( ),
						(File) value );
			...
			{
				ExceptionHandler.openErrorMessageBox( Messages.getString( "DataSource.POJOClassTabFolderPage.error.title.empty.resourceIdentifier" ),//$NON-NLS-1$
	...
	public void resetProperties( )
	{
		...
		{
			optionTypes = new String[]{
					ClassPathElement.RELATIVE_PATH,
					ClassPathElement.ABSOLUTE_PATH
			};
		}
		else
