				...
				switch (event.type) {
					...
					case SWT.MouseHover: {
						...
						if (item != null) {
							...
							tip.setBackground (tv.getTree( ).getShell( ).getDisplay( ).getSystemColor (SWT.COLOR_INFO_BACKGROUND));
							FillLayout layout = new FillLayout ();
							layout.marginWidth = 2;
							tip.setLayout (layout);
							label = new Label (tip, SWT.NONE);
							label.setForeground (tv.getTree( ).getShell( ).getDisplay( ).getSystemColor (SWT.COLOR_INFO_FOREGROUND));
							label.setBackground (tv.getTree( ).getShell( ).getDisplay( ).getSystemColor (SWT.COLOR_INFO_BACKGROUND));
