...
public class ConnectionTest {
	...
	public void testCommit() throws Exception {
		...
		String sql = "update " + TestUtil.TABLE_NAME + " set col0 = 7777 where col3=1";
		stmt.prepare(sql);
		stmt.execute();
		conn.commit();
		stmt.close();
	...
	public void testOpen() throws Exception {
		...
		conn.close();
		/*
		 * Calling the method open with null URL properties, should throw exception.
		 */
		try {
			conn = new Connection();
		...
		/*
		 * Calling the method open with null user properties, should use the info in
		 * url.
		 */
		try {
			conn = new Connection();
			...
			props = new Properties();
			props.setProperty(Connection.Constants.ODAURL,
		...
		/*
		 * Calling the method open with wrong properties, should throw exception.
		 */
		try {
			conn = new Connection();
