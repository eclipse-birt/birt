...
public class JDBCDriverInfoManager {
	...
	/**
	 * Returns a list of JDBC drivers discovered in the driverInfo extensions, as an
	...
	private static JDBCDriverInformation newJdbcDriverInfo(IConfigurationElement configElement) {
		JDBCDriverInformation driverInfo = JDBCDriverInformation
				.newInstance(configElement.getAttribute(OdaJdbcDriver.Constants.DRIVER_INFO_ATTR_DRIVERCLASS));
		...
		driverInfo.setSelectorId(configElement.getAttribute(OdaJdbcDriver.Constants.DRIVER_INFO_ATTR_SELECTORID));
