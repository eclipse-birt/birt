...
public class QueryModel
{
	...
	private static final String[] SUPPORTED_DB_COMMANDS = new String[]{
			"buildInfo", //$NON-NLS-1$
			"collStats", //$NON-NLS-1$
			"connPoolStats", //$NON-NLS-1$
			"count", //$NON-NLS-1$
			"cursorInfo", //$NON-NLS-1$
			"dataSize", //$NON-NLS-1$
			"dbStats", //$NON-NLS-1$
			"distinct", //$NON-NLS-1$
			EVAL_KEY,
			"geoNear",
			"geoSearch", //$NON-NLS-1$
			"getLastError", //$NON-NLS-1$
			"getLog", //$NON-NLS-1$
			"getPrevError", //$NON-NLS-1$
			"group", //$NON-NLS-1$
			"isMaster", //$NON-NLS-1$
			"isdbgrid", //$NON-NLS-1$
			"listCommands", //$NON-NLS-1$
			"listDatabases", //$NON-NLS-1$
			"listShards", //$NON-NLS-1$
			"ping", //$NON-NLS-1$
			"printShardingStatus", //$NON-NLS-1$
			"replSetGetStatus", //$NON-NLS-1$
			"serverStatus" //$NON-NLS-1$
	};
			...
			throws OdaException
	{
		...
		{
			boolean noLockValue = getBooleanValueOfKey( commandObj,
					NOLOCK_KEY,
					false );
			if ( noLockValue != true )
				throw new OdaException(
