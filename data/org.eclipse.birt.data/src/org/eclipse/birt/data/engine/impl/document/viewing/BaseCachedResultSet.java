			...
			IResultIterator
{
	...
	/*
	 * @see org.eclipse.birt.data.engine.executor.transformation.CachedResultSet#getResultClass()
	 */
	...
	/*
	 * Move to the row which is available to this cached result set after
	 * filering operation is done.
	 * 
	 * @see org.eclipse.birt.data.engine.executor.transformation.CachedResultSet#next()
	 */
    ...
    /*
     * @see org.eclipse.birt.data.engine.executor.transformation.CachedResultSet#getCurrentResult()
     */
    ...
    /*
     * @see org.eclipse.birt.data.engine.executor.transformation.CachedResultSet#getCurrentResultIndex()
     */
    ...
    /*
     * @see org.eclipse.birt.data.engine.executor.transformation.CachedResultSet#getCurrentGroupIndex(int)
     */
    ...
    /*
     * @see org.eclipse.birt.data.engine.executor.transformation.CachedResultSet#getStartingGroupLevel()
     */
    ...
    /*
	 * @see org.eclipse.birt.data.engine.executor.transformation.CachedResultSet#getEndingGroupLevel()
	 */
    ...
    /*
	 * @see org.eclipse.birt.data.engine.executor.transformation.CachedResultSet#first(int)
	 */
	...
	/*
	 * @see org.eclipse.birt.data.engine.executor.transformation.CachedResultSet#last(int)
	 */
    ...
    /*
	 * @see org.eclipse.birt.data.engine.executor.transformation.CachedResultSet#getGroupStartAndEndIndex(int)
	 */
	...
	/*
	 * @see org.eclipse.birt.data.engine.impl.document.CacheProvider#getCurrentIndex()
	 */
