...
/**
 * Defines a level. A level definition includes key columns and attribute columns.
 */
...
public class LevelDefinition implements ILevelDefn
{
	...
	/*
	 * (non-Javadoc)
	 * @see org.eclipse.birt.data.olap.data.api.ILevelDefinition#getAttributeColumns()
	 */
