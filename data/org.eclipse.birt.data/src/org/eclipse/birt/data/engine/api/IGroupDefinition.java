...
public interface IGroupDefinition extends IBaseTransform
{
	 ...
	 * not specified. <p>
	 * A start value defines the boundary of range based grouping. For numeric values, 
	 * the default start value is 0. For date range based grouping, the default start
	 * value is Jan. 1, 2000. It has no meaning for grouping based on string prefix
	 * or distinct values
	 */
