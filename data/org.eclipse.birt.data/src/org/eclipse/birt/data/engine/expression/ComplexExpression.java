...
public final class ComplexExpression extends BytecodeExpression
{
    ...
    ComplexExpression()
	{
		logger.entering( ComplexExpression.class.getName( ),
				"ComplexExpression" );
	 ...
	 * <code>ComplexExpression</code>.  This is a helper method to 
	 * consolidate nested <code>ComplexExpression</code>.
	...
	/**
	 * Adds a subexpression to this <code>ComplexExpression</code>. 
	 * Each subexpression is an instance of <code>CompiledExpression</code>.
	...
	/**
	 * Adds a <code>Collection</code> of
	 * <code>ConstantExpression<code> to this
	 * <code>ComplexExpression</code>. This is a helper method to consolidate
	 * nested <code>ComplexExpression</code>.
	 * 
	 * @param subExprs
	 *            the <code>Collection<code> of <code>ConstantExpression<code>.
	 */
	 ...
	 * 
	 * @param subExprs
	 *            the <code>ConstantExpression</code>.
	 */
	...
	/**
	 * Returen a <code>Collection</code> of ConstantExpression value. These
	 * constant expression is contains in the complex expression.
	 * 
	 * @return
	 */
	 ...
	 * <code>ComplexExpression</code>.  Each instance in the 
	 * <code>Collection</code> is a <code>CompiledExpression</code>.
