...
public class JSFacttableFilterEvalHelper implements IJSFacttableFilterEvalHelper
{
	...
	/*
	 * (non-Javadoc)
	 * @see org.eclipse.birt.data.engine.olap.util.filter.IJSMeasureFilterEvalHelper#evaluateFilter(org.eclipse.birt.data.engine.olap.util.filter.IFacttableRow)
	 */
	...
	private static class DummyLevelAttrObject extends ScriptableObject
	{
		...
		public Object get( String attrName, Scriptable scope )
		{
			...
			try
			{
				...
				return this.host.row.getLevelAttributeValue( this.dimName,
						this.levelName,
						OlapExpressionUtil.getAttributeColumnName( this.levelName,
								attrName ) );
			}
			catch ( Exception e )
			{
