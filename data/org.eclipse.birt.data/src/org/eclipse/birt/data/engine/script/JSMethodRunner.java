...
/**
 * Utility class to execute Javascript code as methods of a scope object.
 * As per ROM Scripting spec, data set/data source event handler scripts
 * are executed as if they are the bodies of methods defined on the data set /data source
 ...
 * 
 * To achieve this, this class defines functions in the data set/ data source scope
 * with the script code, and then executes those functions. 
 */
public class JSMethodRunner
{
	...
	/**
	 * Constructor
	 * @param scope Javascript scope within which to execute JS code. This should be
	 * the Javascript object implementing the data source or data set
