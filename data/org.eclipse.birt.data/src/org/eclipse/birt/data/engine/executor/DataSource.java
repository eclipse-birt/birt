...
class DataSource implements IDataSource {
	...
	/**
	 * Find a connection available for new statements in the pool, or create a new
	...
	/**
	 * Prepares an ODA Statement. May use an existing Connection from the pool which
	 * has free active statements, or a new connection if all connections in pool
	...
	/**
	 * Closes a PreparedStatement returned by the prepareStatement call. Frees the
	 * associated ODA Connection and make it available for new statements.
	 */
