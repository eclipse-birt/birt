...
public class BidiFormat
{
	...
	public BidiFormat( String orderingScheme, String textDirection,
			boolean symSwap, String textShaping, String numeralShaping )
	{
	...
	public String getBiDiFormatString( )
	{
		...
		if ( textDirection.equals( BidiConstants.TEXT_DIRECTION_LTR ) )
			...
			buf.append( TEXT_DIRECTION_RTL_CODE );
				...
				.equals( BidiConstants.TEXT_DIRECTION_CONTEXTLTR ) )
			buf.append( TEXT_DIRECTION_CONTEXTUALLTR_CODE );
		else if ( textDirection
				.equals( BidiConstants.TEXT_DIRECTION_CONTEXTRTL ) )
	...
	public void update( String fieldName, Object value )
	{
		if ( BidiConstants.BIDI_FORMAT_ORIENTATION.equals( fieldName )
				|| BidiConstants.BIDI_FORMAT_CONTENT_ORIENTATION
						.equals( fieldName )
				|| BidiConstants.BIDI_FORMAT_METADATA_ORIENTATION
						.equals( fieldName ) )
			updateTextDirection( value.toString( ) );
		else if ( BidiConstants.BIDI_FORMAT_ORDERINGSCHEME.equals( fieldName )
				|| BidiConstants.BIDI_FORMAT_CONTENT_ORDERINGSCHEME
						.equals( fieldName )
				|| BidiConstants.BIDI_FORMAT_METADATA_ORDERINGSCHEME
						.equals( fieldName ) )
			updateOrderingScheme( value.toString( ) );
				...
				|| BidiConstants.BIDI_FORMAT_METADATA_SYMSWAP
						.equals( fieldName ) )
			updateSymSwap( value );
		else if ( BidiConstants.BIDI_FORMAT_TEXTSHAPING.equals( fieldName )
				|| BidiConstants.BIDI_FORMAT_CONTENT_TEXTSHAPING
						.equals( fieldName )
				|| BidiConstants.BIDI_FORMAT_METADATA_TEXTSHAPING
						.equals( fieldName ) )
	...
	{
		if ( ( BidiConstants.TEXT_DIRECTION_LTR.equals( value ) )
				|| ( BidiConstants.TEXT_DIRECTION_RTL.equals( value ) )
	...
	{
		if ( ( BidiConstants.SHAPING_NOMINAL.equals( value ) )
				|| ( BidiConstants.SHAPING_SHAPED.equals( value ) ) )
			textShaping = value;
	}

	private void updateNumericShaping( String value )
	{
		if ( ( BidiConstants.NUMSHAPING_CONTEXT.equals( value ) )
				|| ( BidiConstants.NUMSHAPING_NATIONAL.equals( value ) )
	...
	public boolean equals( BidiFormat biDiFormat )
	{
		if ( this.numeralShaping.equals( biDiFormat.numeralShaping )
				...
				&& this.textShaping.equals( biDiFormat.textShaping )
				&& this.symSwap == biDiFormat.symSwap )
			return true;
		return false;
	}
