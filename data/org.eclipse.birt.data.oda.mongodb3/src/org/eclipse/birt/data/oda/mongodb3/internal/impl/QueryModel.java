...
{
    private static final int DEFAULT_RUNTIME_METADATA_SEARCH_LIMIT = 
                QueryProperties.DEFAULT_RUNTIME_METADATA_SEARCH_LIMIT;
        ...
        if( ! m_queryProps.hasRunCommand() )
        {
            ...
            if( m_mongoCollection == null )
                throw new OdaException( 
                        Messages.bind( Messages.queryModel_invalidCollectionName, collectionName ));
        }
    }
        ...
        if( parsedSortObj instanceof BasicDBObject )
        {
            ...
            for( Object sortKeySpec : sortExprObj.values() )
            {
                ...
                if( !(sortKeySpec instanceof Number) )
                    throw new OdaException( 
                            Messages.bind( Messages.queryModel_invalidQuerySortExpr, sortExpr ));
            }
        }        
    }
     ...
     */
    public static void validateCommandSyntax( CommandOperationType cmdOp, String commandExpr )
        throws OdaException
    {
