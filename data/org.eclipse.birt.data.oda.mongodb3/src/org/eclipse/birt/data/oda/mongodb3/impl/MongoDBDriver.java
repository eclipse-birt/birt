...
import org.eclipse.birt.data.oda.mongodb3.internal.impl.DriverUtil;
...
{
    public static final String ODA_DATA_SOURCE_ID = "org.eclipse.birt.data.oda.mongodb3";  //$NON-NLS-1$
        ...
        throws OdaException
    {
    	...
    	try {
	        ...
	        if( clientURI != null )  // has user-defined MongoURI
	        {
	            ...
	            MongoCredential mongoCredential = MongoCredential.createCredential(userName, databaseName, (password == null ? null : password.toCharArray()));
    ...
    private class ServerNodeKey
    {
        ...
        public boolean equals( Object obj )
        {
            ...
            if( this.m_connProperties != null && 
                    ! this.m_connProperties.equals( thatKey.m_connProperties ) )
                return false;
