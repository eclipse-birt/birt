...
import org.eclipse.birt.data.oda.mongodb3.impl.MongoDBDriver.ReadPreferenceChoice;
...
public class QueryProperties
{
    ...
    BasicDBObject getSortExprAsParsedObject() throws OdaException
    {
        ...
        if (!(sortObj instanceof BasicDBObject)) {
        	throw new OdaException( 
                    Messages.bind( "Unexpected data type ({0}) in {1}", sortObj.getClass().getSimpleName(), SORT_EXPR_PROP) );        	
        }
