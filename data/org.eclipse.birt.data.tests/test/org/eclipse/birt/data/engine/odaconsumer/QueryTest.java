...
public class QueryTest extends ConnectionTest
{
	...
	{
		// Note that even though oda.jdbd driver supports queryTimeOut property, Derby does
	...
	public final void testSetSortSpec( ) throws DataException
	{
		...
		catch ( DataException ex )
		{
			...
			assertEquals( "setSortSpec is not supported.", ex.getCause( )
					.getMessage( ) );
		}
	}
	...
	public final void testGetParameterTypeInt( )
	{
		...
		{
			assertEquals( ResourceConstants.CANNOT_GET_PARAMETER_METADATA,
					ex.getErrorCode() );
