 ...
 * If you want to define your datasource and dataset, please use this case.
 * 
    ...
    public void testQueryWithJDBC( )
	{
		...
		QueryInfo queryInfo = new QueryInfo( ) {
			...
			private void furthurProcessQueryDefn( QueryDefinition queryDefn2 )
			{
				...
				{
					int maxKey = 2;
					FilterDefinition exprFilter = new FilterDefinition( new ScriptExpression( "dataSetRow.C_CUSTKEY<"
							+ maxKey ) );
    ...
    public void testQueryWithScript( )
	{
		...
		QueryInfo queryInfo = new QueryInfo( ) {
			...
			public IBaseDataSetDesign getDataSet( ) throws Exception
			{
				...
				odaDataSet.setDataSource( getDataSource( ).getName( ) );
				odaDataSet.setOpenScript( 
						"count=300000;" );
				odaDataSet.setFetchScript( 
						"if (count==0) " +
						"{" +
							"return false; " +
						"} " +
