...
public class OutputParametersTest extends OdaTestDriverCase
{
    ...
    public void testOutputParamDataTypeMapping()
    {
        ...
        try
        {
            ...
            hostStmt = getOpenedConnection().prepareStatement( null,
    ...
    public void testGetParameterByNativeName() throws Exception
    {
        ...
        try
        {
            ...
            outParam1Value = hostStmt.getParameterValue( 
                    TestParamMetaDataImpl.TEST_PARAM_NATIVE_NAME_PREFIX + 1 );
            outParam2Value = hostStmt.getParameterValue( 
                    TestParamMetaDataImpl.TEST_PARAM_NATIVE_NAME_PREFIX + 2 );
            outParam3Value = hostStmt.getParameterValue( 
                    TestParamMetaDataImpl.TEST_PARAM_NATIVE_NAME_PREFIX + 3 );
        }
        catch( DataException e1 )
        {
        ...
        assertTrue( ((String)outParam1Value).startsWith( 
