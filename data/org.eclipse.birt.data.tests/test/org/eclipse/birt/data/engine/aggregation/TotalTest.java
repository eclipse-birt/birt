...
public class TotalTest {
	...
	private int[] doubleArray3DenseRankDec = { 2, 4, 6, 1, 6, 3, 5, 5 };
	private int[] doubleArray3DenseRankAsc = { 5, 3, 1, 6, 1, 4, 2, 2 };

	private int[] doubleArray3PercentRank = { 857, 571, 0, 1000, 0, 714, 285, 285 };
	private Object[] doubleArray3PercentSum = { Integer.valueOf(208), Integer.valueOf(41), null, Integer.valueOf(625),
			null, Integer.valueOf(83), Integer.valueOf(20), Integer.valueOf(20) };
	...
	private Object[] anyObjectArray = { "aa", "bb", null, Integer.valueOf(0), null, Double.valueOf(1), new Float(0),
			null };
	private Object[] anyObjectArray2 = { "aa", "bb", null, Integer.valueOf(0), null, Double.valueOf(1), new Float(0),
			null,
	...
	private int[] bigDecimalDenseRankAsc = { 1, 2, 4, 3, 5, 7, 2, 3, 4, 6, 8, 9, 3, 5, 6 };
	...
	public void testTotalCount() throws Exception {
		...
		ac.finish();
		assertEquals(Integer.valueOf(5), ac.getValue());
		...
		ac.finish();
		assertEquals(Integer.valueOf(8), ac.getValue());
		...
		ac.finish();
		assertEquals(Integer.valueOf(15), ac.getValue());
		...
		ac.finish();
		assertEquals(Integer.valueOf(14), ac.getValue());
		...
		ac.start();
		ac.finish();
		assertEquals(Integer.valueOf(0), ac.getValue());
	...
	public void testTotalSum() throws Exception {
		...
		ac.start();
		for (int i = 0; i < doubleArray1.length; i++) {
			ac.onRow(new Double[] { Double.valueOf(doubleArray1[i]) });
		}
		ac.finish();
		assertEquals(Double.valueOf(82.0), ac.getValue());

		ac.start();
		for (int i = 0; i < doubleArray2.length; i++) {
			ac.onRow(new Double[] { Double.valueOf(doubleArray2[i]) });
		}
		ac.finish();
		assertEquals(Double.valueOf(69.0), ac.getValue());
		...
		// test Total.sum() for heterogeneous Number array data
		{
			Number numberArray[] = { BigDecimal.ZERO, BigDecimal.ONE, BigDecimal.TEN, Double.valueOf("0.1"),
					new BigDecimal("0.1"), new BigDecimal(0.1D), new BigDecimal("0.1"), Double.valueOf(0.1D), };
			ac.start();
	...
	public void testTotalRunningSum() throws Exception {
...

		{
			...
			for (int i = 0; i < doubleArray1.length; i++) {
				ac.onRow(new Double[] { Double.valueOf(doubleArray1[i]) });
				sum += doubleArray1[i];
				assertEquals(Double.valueOf(sum), ac.getValue());
			}
			ac.finish();
		}
	...
	public void testTotalAve() throws Exception {
		...
		ac.finish();
		assertEquals(Double.valueOf(5.466666666666667), ac.getValue());
		...
		ac.finish();
		assertEquals(Double.valueOf(4.928571428571429), ac.getValue());
	...
	public void testTotalFirst() throws Exception {
		...
		ac.finish();
		assertEquals(Double.valueOf(1.0), ac.getValue());
		...
		ac.finish();
		assertEquals(Double.valueOf(4), ac.getValue());
	...
	public void testTotalLast() throws Exception {
		...
		ac.finish();
		assertEquals(Double.valueOf(7.0), ac.getValue());
		...
		ac.finish();
		assertEquals(Double.valueOf(34.0), ac.getValue());
	...
	public void testTotalMax() throws Exception {
		...
		ac.finish();
		assertEquals(Double.valueOf(10.0), ac.getValue());
		...
		ac.finish();
		assertEquals(Double.valueOf(63.0), ac.getValue());
	...
	public void testTotalMin() throws Exception {
		...
		ac.finish();
		assertEquals(Double.valueOf(-43), ac.getValue());
	...
	public void testTotalRange() throws Exception {
		...
		ac.finish();
		assertEquals(Double.valueOf(9.0), ac.getValue());
		...
		ac.finish();
		assertEquals(Double.valueOf(106), ac.getValue());
	...
	public void testTotalMedian() throws Exception {
		...
		ac.finish();
		assertEquals(Double.valueOf(5.0), ac.getValue());
		...
		ac.finish();
		assertEquals(Double.valueOf(3.5), ac.getValue());
		...
		ac.finish();
		assertEquals(Double.valueOf(3.5D), ac.getValue());
	...
	public void testTotalMode() throws Exception {
		...
		ac.finish();
		assertEquals(Double.valueOf(4.0), ac.getValue());
		...
		for (int i = 0; i < doubleArray4.length; i++) {
			ac.onRow(new Double[] { Double.valueOf(doubleArray4[i]) });
		}
		ac.finish();
		assertEquals(null, ac.getValue());
		...
		for (int i = 0; i < doubleArray5.length; i++) {
			ac.onRow(new Double[] { Double.valueOf(doubleArray5[i]) });
		}
		ac.finish();
		assertEquals(Double.valueOf(1.0), ac.getValue());
		...
		for (int i = 0; i < doubleArray6.length; i++) {
			ac.onRow(new Double[] { Double.valueOf(doubleArray6[i]) });
		}
		ac.finish();
		assertEquals(Double.valueOf(1.0), ac.getValue());
		...
		ac.start();
		ac.onRow(new Double[] { Double.valueOf(4) });
		ac.onRow(new Double[] { Double.valueOf(4) });
		ac.onRow(new Double[] { Double.valueOf(3) });
		ac.finish();
		assertEquals(ac.getValue(), Double.valueOf(4));
		// mode test for Date
		// 1: no mode date
		ac.start();
		for (int i = 0; i < dates.length; i++) {
	...
	public void testTotalStdDev() throws Exception {
		...
		ac.finish();
		assertEquals(Double.valueOf(26.560422510872147), ac.getValue());
	...
	public void testTotalVariance() throws Exception {
		...
		ac.finish();
		assertEquals(Double.valueOf(705.4560439560439), ac.getValue());
	...
	public void testTotalWeightedAva() throws Exception {
		...
		ac.start();
		for (int i = 0; i < doubleArray1.length; i++) {
			ac.onRow(new Double[] { Double.valueOf(doubleArray1[i]), Double.valueOf(weight[i]) });
		}
		ac.finish();

		assertEquals(Double.valueOf(5.343042071197409), ac.getValue());

		ac.start();
		for (int i = 0; i < doubleArray2.length; i++) {
			ac.onRow(new Double[] { Double.valueOf(doubleArray2[i]), Double.valueOf(weight[i]) });
		}
		ac.finish();

		assertEquals(Double.valueOf(3.236104279390063), ac.getValue());

		ac.start();
		for (int i = 0; i < str1.length; i++) {
			ac.onRow(new Object[] { str1[i], Double.valueOf(weight[i]) });
		}
		ac.finish();
		...
		ac.start();
		ac.onRow(new Object[] { Double.valueOf(1), Double.valueOf(1) });
		ac.onRow(new Object[] { Double.valueOf(2), Double.valueOf(2) });
		ac.finish();
		assertEquals(Double.valueOf(1.6666666666666667), ac.getValue());

		ac.start();
		ac.onRow(new Object[] { null, Double.valueOf(3) });
		ac.onRow(new Object[] { Double.valueOf(2), Double.valueOf(2) });
		ac.onRow(new Object[] { Double.valueOf(2), null });
		ac.finish();
		assertEquals(Double.valueOf(2), ac.getValue());

		ac.start();
		ac.onRow(new Object[] { Double.valueOf(1), Double.valueOf(3) });
		ac.onRow(new Object[] { Double.valueOf(1), Double.valueOf(-3) });
		ac.finish();
		assertEquals(Double.NaN, ac.getValue());

		ac.start();
		ac.onRow(new Object[] { Double.valueOf(1), Double.valueOf(2) });
		ac.onRow(new Object[] { Double.valueOf(2), Double.valueOf(-4) });
		ac.finish();
		assertEquals(Double.valueOf(3.0), ac.getValue());
		...
		ac.start();
		for (int i = 0; i < bigDecimalArray.length; i++) {
			ac.onRow(new Object[] { bigDecimalArray[i], Double.valueOf(weight[i]) });
		}
		ac.finish();
		Object ret = ac.getValue();
		assertTrue(ret instanceof Double);
	...
	public void testTotalMovingAve() throws Exception {
		...
		ac.start();
		for (int i = 0; i < doubleArray1.length; i++) {
			ac.onRow(new Object[] { Double.valueOf(doubleArray1[i]), Integer.valueOf(8) });
			assertEquals(Double.valueOf(values1[i]), ac.getValue());
		}
		ac.finish();

		ac.start();
		for (int i = 0; i < doubleArray2.length; i++) {
			ac.onRow(new Object[] { Double.valueOf(doubleArray2[i]), Integer.valueOf(6) });
		...
		ac.start();
		for (int i = 0; i < str1.length; i++) {
			ac.onRow(new Object[] { str1[i], Integer.valueOf(6) });
			assertEquals(Double.valueOf(values2[i]), ac.getValue());
		}
		ac.finish();
	...
	public void testTotalTop() throws Exception {
		...
		ac.start();
		for (int i = 0; i < doubleArray1.length; i++) {
			ac.onRow(new Double[] { Double.valueOf(doubleArray1[i]), Double.valueOf(5) });
		}
		ac.finish();
		...
		for (int i = 0; i < doubleArray1.length; i++) {
			ac.onRow(new Double[] { Double.valueOf(doubleArray1[i]), Double.valueOf(5) });
			assertEquals(Boolean.valueOf(doubleArray1TopBottom[i]), ac.getValue());
		}
		ac.finish();
		...
		ac.start();
		ac.onRow(new Double[] { Double.valueOf(6), Double.valueOf(5) });
		ac.finish();
		ac.start();
		ac.onRow(new Double[] { Double.valueOf(6), Double.valueOf(5) });
		ac.finish();

		assertEquals(Boolean.valueOf(true), ac.getValue());

		// test Total.ISTOPN() for BigDecimal data
		ac = ag.newAccumulator();
		ac.start();
		for (int i = 0; i < bigDecimalArray.length; i++) {
			ac.onRow(new Object[] { bigDecimalArray[i], Double.valueOf(5) });
		}
		ac.finish();
		ac.start();
		for (int i = 0; i < bigDecimalArray.length; i++) {
		...
		ac.start();
		for (int i = 0; i < doubleArray1.length; i++) {
			ac.onRow(new Double[] { Double.valueOf(doubleArray1[i]), Double.valueOf(33) });
		}
		ac.finish();
		ac.start();
		for (int i = 0; i < doubleArray1.length; i++) {
		...
		ac.start();
		for (int i = 0; i < bigDecimalArray.length; i++) {
			ac.onRow(new Object[] { bigDecimalArray[i], Double.valueOf(33) });
		}
		ac.finish();
		ac.start();
		for (int i = 0; i < bigDecimalArray.length; i++) {
		...
		ac.start();
		ac.onRow(new Double[] { Double.valueOf(6), Double.valueOf(100) });
		ac.finish();
		ac.start();
		ac.onRow(new Double[] { Double.valueOf(6), Double.valueOf(100) });
		ac.finish();
	...
	public void testTotalTop2() throws Exception {
		...
		for (int i = 0; i < doubleArray3.length; i++) {
			ac.onRow(new Double[] { doubleArray3[i], Double.valueOf(2) });
		}
		ac.finish();
		...
		for (int i = 0; i < doubleArray3.length; i++) {
			ac.onRow(new Double[] { doubleArray3[i], Double.valueOf(2) });
			assertEquals(Boolean.valueOf(doubleArray3TopBottom[i]), ac.getValue());
		}
		ac.finish();
	}
	...
	public void testTotalBottom() throws Exception {
		...
		ac.start();
		for (int i = 0; i < doubleArray1.length; i++) {
			ac.onRow(new Double[] { Double.valueOf(doubleArray1[i]), Double.valueOf(10) });
		}
		ac.finish();
		ac.start();
		for (int i = 0; i < doubleArray1.length; i++) {
		...
		ac.start();
		for (int i = 0; i < bigDecimalArray.length; i++) {
			ac.onRow(new Object[] { bigDecimalArray[i], Double.valueOf(10) });
		}
		ac.finish();
		ac.start();
		for (int i = 0; i < bigDecimalArray.length; i++) {
		...
		ac.start();
		for (int i = 0; i < doubleArray1.length; i++) {
			ac.onRow(new Double[] { Double.valueOf(doubleArray1[i]), Double.valueOf(66) });
		}
		ac.finish();
		...
		ac.start();
		for (int i = 0; i < bigDecimalArray.length; i++) {
			ac.onRow(new Object[] { bigDecimalArray[i], Double.valueOf(66) });
		}
		ac.finish();
		ac.start();
		for (int i = 0; i < bigDecimalArray.length; i++) {
	...
	public void testTotalRank() throws Exception {
		...
		ac.start();
		for (int i = 0; i < doubleArray3.length; i++) {
			ac.onRow(new Object[] { doubleArray3[i], Boolean.valueOf(false) });
		}
		ac.finish();

		ac.start();
		for (int i = 0; i < doubleArray3.length; i++) {
			ac.onRow(new Object[] { doubleArray3[i], Integer.valueOf(0) });
			assertEquals(Integer.valueOf(doubleArray3RankDec[i]), ac.getValue());
		}
		ac.finish();
		...
		ac.start();
		for (int i = 0; i < doubleArray3.length; i++) {
			ac.onRow(new Object[] { doubleArray3[i], Boolean.valueOf(true) });
		}
		ac.finish();
		ac.start();
		for (int i = 0; i < doubleArray3.length; i++) {
			ac.onRow(new Object[] { doubleArray3[i], Integer.valueOf(1) });
			assertEquals(Integer.valueOf(doubleArray3RankAsc[i]), ac.getValue());
		}
		ac.finish();
		...
		ac.start();
		for (int i = 0; i < bigDecimalArray.length; i++) {
			ac.onRow(new Object[] { bigDecimalArray[i], Boolean.valueOf(true) });
		}
		ac.finish();
		ac.start();
		for (int i = 0; i < bigDecimalArray.length; i++) {
			ac.onRow(new Object[] { bigDecimalArray[i], Double.valueOf(0) });
			assertEquals(Integer.valueOf(bigDecimalRankAsc[i]), ac.getValue());
		}
		ac.finish();
	}
	...
	public void testTotalDenseRank() throws Exception {
		...
		ac.start();
		int[] doubleResultArray3DenseRankDec = new int[doubleArray3.length];
		for (int i = 0; i < doubleArray3.length; i++) {
			ac.onRow(new Object[] { doubleArray3[i], Integer.valueOf(0) });
			doubleResultArray3DenseRankDec[i] = ((Integer) ac.getValue()).intValue();
		}
		assertArrayEquals(doubleArray3DenseRankDec, doubleResultArray3DenseRankDec);
		ac.finish();

		ag = buildInAggrFactory.getAggregation("denserank");
		ac = ag.newAccumulator();
		...
		ac.finish();
		ac.start();
		int[] doubleResultArray3DenseRankAsc = new int[doubleArray3.length];
		for (int i = 0; i < doubleArray3.length; i++) {
			ac.onRow(new Object[] { doubleArray3[i], Integer.valueOf(1) });
			doubleResultArray3DenseRankAsc[i] = ((Integer) ac.getValue()).intValue();
		}
		assertArrayEquals(doubleArray3DenseRankAsc, doubleResultArray3DenseRankAsc);
		ac.finish();

		// test Total.denserank() for BigDecimal data
		ac = ag.newAccumulator();
		ac.start();
		for (int i = 0; i < bigDecimalArray.length; i++) {
			ac.onRow(new Object[] { bigDecimalArray[i], Boolean.valueOf(true) });
		...
		ac.finish();
		ac.start();
		int[] bigDecimalResultArray3DenseRankAsc = new int[bigDecimalArray.length];
		for (int i = 0; i < bigDecimalArray.length; i++) {
			ac.onRow(new Object[] { bigDecimalArray[i], Double.valueOf(0) });
			bigDecimalResultArray3DenseRankAsc[i] = ((Integer) ac.getValue()).intValue();
		}
		assertArrayEquals(bigDecimalDenseRankAsc, bigDecimalResultArray3DenseRankAsc);
		ac.finish();
	}
	...
	public void testTotalPercentRank() throws Exception {
		...
		for (int i = 0; i < doubleArray3.length; i++) {
			...
			assertEquals(doubleArray3PercentRank[i],
					Double.valueOf((((Double) ac.getValue()).doubleValue() * 1000)).intValue());
		}
		ac.finish();
	...
	public void testTotalPercentSum() throws Exception {
		...
		for (int i = 0; i < doubleArray3.length; i++) {
			ac.onRow(new Object[] { doubleArray3[i] });
			assertEquals(doubleArray3PercentSum[i] == null ? Integer.valueOf(0) : doubleArray3PercentSum[i],
					Integer.valueOf((int) (Double.parseDouble(ac.getValue().toString()) * 1000)));
		}
		ac.finish();
		...
		for (int i = 0; i < bigDecimalArray.length; i++) {
			...
			Object ret = ac.getValue();
			assertTrue(ret instanceof Double);
			assertEquals(bigDecimalPercentSum[i], Double.valueOf((((Number) ret).doubleValue() * 1000)).intValue());
		}
		ac.finish();
	}
	...
	public void testTotalPercentile() throws Exception {
		...
		ac.start();
		for (int i = 0; i < doubleArray3.length; i++) {
			ac.onRow(new Object[] { doubleArray3[i], Double.valueOf(0.1) });
		}
		ac.finish();
		Object value = ac.getValue();
		assertEquals(value, Double.valueOf(10.0));

		ac.start();
		for (int i = 0; i < doubleArray3.length; i++) {
			ac.onRow(new Object[] { doubleArray3[i], Double.valueOf(0) });
		}
		ac.finish();
		value = ac.getValue();
		assertEquals(value, Double.valueOf(10));

		ac.start();
		for (int i = 0; i < doubleArray3.length; i++) {
			ac.onRow(new Object[] { doubleArray3[i], Double.valueOf(1) });
		}
		ac.finish();
		value = ac.getValue();
		assertEquals(value, Double.valueOf(300));

		ac.start();
		for (int i = 0; i < doubleArray3.length; i++) {
			ac.onRow(new Object[] { doubleArray3[i], Double.valueOf(0.7) });
		}
		ac.finish();
		value = ac.getValue();
		assertEquals(value, Double.valueOf(70));

		ac.start();
		for (int i = 0; i < doubleArray3.length; i++) {
			ac.onRow(new Object[] { doubleArray3[i], Double.valueOf(0.35) });
		}
		ac.finish();
		value = ac.getValue();
		assertEquals(value, Double.valueOf(17.5));
		...
		for (int i = 0; i < doubleArray3.length; i++) {
			try {
				ac.onRow(new Object[] { doubleArray3[i], Double.valueOf(-0.9) });
				fail();
			} catch (DataException e) {
			}

			try {
				ac.onRow(new Object[] { doubleArray3[i], Double.valueOf(4.1) });
				fail();
			} catch (DataException e) {
			}
		}
		...
		ac.start();
		for (int i = 0; i < bigDecimalArray.length; i++) {
			ac.onRow(new Object[] { bigDecimalArray[i], Double.valueOf(0.1) });
		}
		ac.finish();
		Object ret = ac.getValue();
		assertTrue(ret instanceof Double);
	...
	public void testTotalQuartile() throws Exception {
		...
		ac.finish();
		value = ac.getValue();
		assertEquals(value, Double.valueOf(12.5));

		ac.start();
		for (int i = 0; i < doubleArray3.length; i++) {
			ac.onRow(new Object[] { doubleArray3[i], Double.valueOf(2) });
		}
		ac.finish();
		value = ac.getValue();
		assertEquals(value, Double.valueOf(30));

		ac.start();
		for (int i = 0; i < doubleArray3.length; i++) {
			ac.onRow(new Object[] { doubleArray3[i], Double.valueOf(3) });
		}
		ac.finish();
		value = ac.getValue();
		assertEquals(value, Double.valueOf(85));

		ac.start();
		for (int i = 0; i < doubleArray3.length; i++) {
			ac.onRow(new Object[] { doubleArray3[i], Double.valueOf(4) });
		}
		ac.finish();
		value = ac.getValue();
		assertEquals(value, Double.valueOf(300));
		...
		try {
			ac.start();
			for (int i = 0; i < doubleArray3.length; i++) {
				ac.onRow(new Object[] { doubleArray3[i], Double.valueOf(5) });
			}
			ac.finish();
			fail("should not arrive here");
		} catch (DataException e) {
		...
		ac.start();
		for (int i = 0; i < bigDecimalArray.length; i++) {
			ac.onRow(new Object[] { bigDecimalArray[i], Double.valueOf(1) });
		}
		ac.finish();
		Object ret = ac.getValue();
		assertTrue(ret instanceof Double);
	...
	public void testTotalRunningCount() throws Exception {
		...
		for (int i = 0; i < doubleArray1.length; i++) {
			ac.onRow(new Double[] { Double.valueOf(doubleArray1[i]), Double.valueOf(5) });
			assertEquals(Integer.valueOf(i + 1), ac.getValue());
		}
		ac.finish();
