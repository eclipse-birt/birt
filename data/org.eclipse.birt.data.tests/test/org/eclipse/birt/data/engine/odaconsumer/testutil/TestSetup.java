...
public class TestSetup
{
	...
	private final static String PROCEDURE_ELEMENTS = 
...
//	    " EXTERNAL NAME 'org.eclipse.birt.data.engine.odaconsumer.util.TestSetup.setInputParamData'";
    ...
    private final static String PROCEDURE_SET_INOUT = 
        " EXTERNAL NAME 'org.eclipse.birt.data.engine.odaconsumer.util.TestSetup.selectInOutParamData'";
	...
	public static void createTestTable() throws Exception
	{
		...
		statement.execute( "INSERT INTO \"testtable\" VALUES( 123, 1.212312, 'blah blah blah', "
				+ "'2000-09-01', 600 )" );
		statement.execute( "INSERT INTO \"testtable\" VALUES( 14, 3.14, 'hahahahahahhahaha', "
				+ "'1991-10-02', 10 )" );
		statement.execute( "INSERT INTO \"testtable\" VALUES( 0, 1.23, 'niem', "
				+ "'1979-11-28', 10 )" );
		statement.execute( "INSERT INTO \"testtable\" VALUES( NULL, NULL, NULL, "
				+ "NULL, NULL )" );
		statement.execute( "INSERT INTO \"testtable\" VALUES( 4, 12.3636, 'seven zero six', "
				+ "'2004-01-01', 10000 )" );
	...
	public static void createTestStoredProcedures() throws Exception
    {
        ...
        sqlText = "CREATE PROCEDURE "
            + PROCEDURE_NAME_PREFIX + "In" 
            + " (IN " + PROCEDURE_PARAM_NAME_PREFIX + "1 INTEGER "
