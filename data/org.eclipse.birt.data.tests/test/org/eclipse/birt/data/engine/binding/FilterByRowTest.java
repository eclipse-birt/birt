...
public class FilterByRowTest extends APITestCase {
	...
	public void testAccept1WithCache() throws Exception {
		...
		IResultIterator resultIterator = getResultIterator(filterDefn, bindingNameFilter, bindingExprFilter, true);
		String queryResultID = resultIterator.getQueryResults().getID();
		resultIterator.close();
		resultIterator = getResultIterator(filterDefn, bindingNameFilter, bindingExprFilter, true, queryResultID);
		while (resultIterator.next()) {
			Integer value0 = resultIterator.getInteger(getBindingExpressionName()[0]);
			Integer value1 = resultIterator.getInteger(getBindingExpressionName()[1]);
			Integer value2 = resultIterator.getInteger(getBindingExpressionName()[2]);
	...
	public void testAccept2WithCache() throws Exception {
		...
		String queryResultID = resultIterator.getQueryResults().getID();
		resultIterator.close();
		resultIterator = getResultIterator(filterDefn, null, null, true, queryResultID);
		while (resultIterator.next()) {
			Integer value0 = resultIterator.getInteger(getBindingExpressionName()[0]);
			Integer value1 = resultIterator.getInteger(getBindingExpressionName()[1]);
			Integer value2 = resultIterator.getInteger(getBindingExpressionName()[2]);
	...
	public void testJSFilter() throws Exception {
		...
		QueryDefinition queryDefn1 = this.createQuery(null, null, null, null, null, null, null, null, filterDefn,
	...
	public void testBooleanFilterOnDataRows() throws Exception {
		...
		IResultIterator resultIt = this.executeQuery(this.createQuery(null, null, null, null, null, null, null, null,
				filterDefn, bindingNameRow, bindingExprRow));
	...
	public void testTopNFilter() throws Exception {
		...
		IResultIterator resultIt1 = executeQuery(createQuery(null, null, null, null, null, null, null, null,
		...
		IResultIterator resultIt2 = executeQuery(createQuery(null, null, null, null, null, null, null, null,
				filterDefn2, bindingNameRow, bindingExprRow));
	...
	public void testInvalidFilterDefinition() throws Exception {
		...
		try {
			executeQuery(createQuery(null, null, null, null, null, null, null, null, filterDefn1, bindingNameRow,
					bindingExprRow));
	...
	public void testInvalidFilterDefinition2() throws Exception {
		...
		try {
			...
			assertEquals(ResourceConstants.INVALID_DEFINITION_IN_FILTER, e.getErrorCode());
		}
	}
	 ...
	 * @throws Exception
	 */
	protected void checkQueryResult(IResultIterator resultIt1, IResultIterator resultIt2, String[] expressions)
			throws Exception {
		while (resultIt1.next() && resultIt2.next()) {
			for (int i = 0; i < expressions.length; i++) {
				assertTrue(evalAsString(expressions[i], resultIt1).equals(evalAsString(expressions[i], resultIt2)));
			}
		}
	}

	private IResultIterator getResultIterator(FilterDefinition[] filterDefn, String[] bindingNameFilter,
	...
	/*
	 * Please refer to SCR #77518 Filter Expression does not allow "null" value
	 */
	@Test
	...
	public void testConstantWithNull() throws BirtException {
		...
		ConditionalExpression expr = new ConditionalExpression(
				ScriptExpressionUtil.createJavaScriptExpression("row.ROW_CH"), IConditionalExpression.OP_EQ,
				ScriptExpressionUtil.createConstantExpression(null), null);
		...
		expr = new ConditionalExpression(ScriptExpressionUtil.createJavaScriptExpression("row.ROW_CH"),
				IConditionalExpression.OP_IN, expression);
	...
	private ScriptDataSetDesign newDataSet() {
		...
		dataSet.setFetchScript("count--;" + "if (count==0) {return false; } else "
