...
public class InputParameterTest extends APITestCase {
	...
	public void test1() throws Exception {
		IBaseDataSetDesign baseDataset = newDataSet("newDataSet",
				"select * from " + InputParameterTest.TEST_TABLE_NAME + " where AMOUNT > ?");
	...
	public void test2() throws Exception {
		IBaseDataSetDesign baseDataset = newDataSet("newDataSet",
				"select * from " + InputParameterTest.TEST_TABLE_NAME + " where AMOUNT > ? and AMOUNT < ?");
		...
		InputParameterBinding paramBinding = new InputParameterBinding(1, new ScriptExpression("'100'"));
		inputParamBindings.add(paramBinding);
		paramBinding = new InputParameterBinding("param2", new ScriptExpression("100*70"));
		inputParamBindings.add(paramBinding);
		runQuery(baseDataset, inputParamDefns, inputParamBindings);
	}
	...
	public void test3() throws Exception {
		IBaseDataSetDesign baseDataset = newDataSet("newDataSet",
				"select * from " + InputParameterTest.TEST_TABLE_NAME + " where CITY<>? ");

		ParameterDefinition inputParamDefn = new ParameterDefinition("param1", DataType.STRING_TYPE, true, false);
		inputParamDefn.setPosition(1);
		inputParamDefn.setDefaultInputValue("0");
		Collection inputParamDefns = new ArrayList();
		inputParamDefns.add(inputParamDefn);
		...
		Collection inputParamBindings = new ArrayList();
		InputParameterBinding paramBinding = new InputParameterBinding(1, new ScriptExpression("'Shanghai'"));
		inputParamBindings.add(paramBinding);
		runQuery(baseDataset, inputParamDefns, inputParamBindings);
	}
	...
	public void testRegression103982() throws Exception {
		IBaseDataSetDesign baseDataset = newDataSet("newDataSet",
				"select * from " + InputParameterTest.TEST_TABLE_NAME + " where SALE_DATE > ?");

		Collection inputParamDefns = new ArrayList();
		ParameterDefinition inputParamDefn = new ParameterDefinition("param1", DataType.DATE_TYPE);
		inputParamDefn.setInputMode(true);
		inputParamDefn.setPosition(1);
	 ...
	 * @throws Exception
	 */
	private void runQuery(IBaseDataSetDesign dataSet, Collection inputParamDefns, Collection inputParamBindingsOfQuery)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	private void runQuery(IBaseDataSetDesign dataSet, Collection inputParamDefns, Collection inputParamBindingsOfDS,
	...
	private void createAndRunQuery(IBaseDataSetDesign dataSet, Collection inputParamBindings) throws Exception {
		...
		QueryDefinition queryDefn = createQuery(bindingNameGroup, bindingExprGroup, groupDefn, bindingNameSort,
