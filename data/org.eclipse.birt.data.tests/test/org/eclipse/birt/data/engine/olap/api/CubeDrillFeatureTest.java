...
public class CubeDrillFeatureTest extends BaseTestCase {
	...
	public void testBasicDrillUpOperation() throws Exception {
		...
		printCube(cursor, columnEdgeBindingNames, rowEdgeBindingNames, "measure1", null, null, null, null);
	...
	public void testBasicDrillOperation6() throws Exception {
		...
		printCube(cursor, columnEdgeBindingNames, rowEdgeBindingNames, "measure1", "total2", "total1", "grandTotal1",
				null);
	...
	public void testBasicDrillOperation7() throws Exception {
		...
		printCube(cursor, columnEdgeBindingNames, rowEdgeBindingNames, "measure1", null, "rank", null, null);
	...
	public void testBasicDrillOperation8() throws Exception {
		...
		printCube(cursor, columnEdgeBindingNames, rowEdgeBindingNames, "measure1", null, "sum", null, null);
	...
	private void printCube(CubeCursor cursor, List columnEdgeBindingNames, List rowEdgeBindingNames,
			String measureBindingNames, String columnAggr, String rowAggr, String overallAggr, String subTotal)
			throws Exception {
		String output = getOutputFromCursor(cursor, columnEdgeBindingNames, rowEdgeBindingNames, measureBindingNames,
				columnAggr, rowAggr, overallAggr, subTotal);
