...
public class DriverManagerTest extends OdaconsumerTestCase
{
	...
	public final void testGetDriver() throws Exception
	{
		IDriver driverHelper = 
			DriverManager.getInstance().getDriverHelper( JDBCOdaDataSource.DATA_SOURCE_TYPE );
...
*/	}
	...
	public final void testGetExtensionDataSourceType() throws Exception
	{
		String dataSourceType = 
			DriverManager.getInstance().getExtensionDataSourceId( JDBCOdaDataSource.DATA_SOURCE_TYPE );
	...
	{
		assertEquals( expectedOdaType, 
                DataTypeUtil.toOdaType( nativeType, 
                        JDBCOdaDataSource.DATA_SOURCE_TYPE, 
