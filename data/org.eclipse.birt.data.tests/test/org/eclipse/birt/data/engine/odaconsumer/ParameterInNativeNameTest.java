...
public class ParameterInNativeNameTest extends OdaTestDriverCase
{
    ...
    public void testSetParameterByNativeName() throws Exception
    {
        ...
        try
        {
            ...
            hostStmt.setParameterValue( 
                    TestParamMetaDataImpl.TEST_PARAM_NATIVE_NAME_PREFIX + 1, "stringValue" );
            hostStmt.setParameterValue( 
                    TestParamMetaDataImpl.TEST_PARAM_NATIVE_NAME_PREFIX + 2, Date.valueOf( "2005-11-13" ));

            // test driver does not support setBoolean by name,
            // without hints to get corresponding index, expects it to retry setString by name
            hostStmt.setParameterValue( 
                    TestParamMetaDataImpl.TEST_PARAM_NATIVE_NAME_PREFIX + 3, Boolean.valueOf( "true" ));
