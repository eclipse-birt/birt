...
/**
 * Util class, provide following utility:
 * 		1: dump info of ResultMetaData
 * 		2: provide a helper class for CachedResultSet
 * 		   In odi layer, it is not easy to construct an instance of
 * 		   CachedResultSet to do test, but easy in Impl Layer. So this helper
 * 		   class is placed here.
 */
public class Util
{	
	public static String getMetaDadataInfo( IResultMetaData meta )
