...
public class ManifestExplorerTest extends OdaconsumerTestCase
{
	...
	void verifyExtensionConfig( ExtensionManifest config )
		throws Exception
	{
		...
		assertEquals( "org.eclipse.birt.report.data.oda.jdbc.OdaJdbcDriver",
	...
	{
		{ new Integer( (int) -7 ), "BIT", "Integer" },
		{ new Integer( (int) -6 ), "TINYINT", "Integer" },
		{ new Integer( (int) 5 ), "SMALLINT", "Integer" },
		{ new Integer( (int) 4 ), "INTEGER", "Integer" },
		{ new Integer( (int) -5 ), "BIGINT", "Decimal" },
		{ new Integer( (int) 6 ), "FLOAT", "Double" },
		{ new Integer( (int) 7 ), "REAL", "Double" },
		{ new Integer( (int) 8 ), "DOUBLE", "Double" },
		{ new Integer( (int) 2 ), "NUMERIC", "Decimal" },
		{ new Integer( (int) 3 ), "DECIMAL", "Decimal" },
		{ new Integer( (int) 1 ), "CHAR", "String" },
		{ new Integer( (int) 12 ), "VARCHAR", "String" },
		{ new Integer( (int) -1 ), "LONGVARCHAR", "String" },
		{ new Integer( (int) 91 ), "DATE", "Date" },
		{ new Integer( (int) 92 ), "TIME", "Time" },
		{ new Integer( (int) 93 ), "TIMESTAMP", "Timestamp" },
