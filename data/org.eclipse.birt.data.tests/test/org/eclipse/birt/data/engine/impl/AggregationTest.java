...
public class AggregationTest extends APITestCase {
	...
	public void test1() throws Exception {
		...
		ScriptExpression e8 = new ScriptExpression(
				"dataSetRow.PRICE * dataSetRow.QUANTITY / Total.Sum( dataSetRow.PRICE * dataSetRow.QUANTITY )");
...
//	}
	...
	// This test is obsoleted. We will throw exception when evaluating column
	// binding.
...
//	}
	...
	public void test5() throws Exception {
		...
		IBinding aggr1 = new Binding("Rank", new ScriptExpression("dataSetRow[\"PRICE\"]"));
	...
	public void test6() throws Exception {
		...
		IBinding aggr2 = new Binding("Runningsum", new ScriptExpression("dataSetRow[\"PRICE\"]"));
	...
	public void test7() throws Exception {
		...
		IBinding binding1 = new Binding("sqrtSum", new ScriptExpression("Math.sqrt(row[\"Runningsum\"])"));
	...
	public void test9() throws Exception {
		...
		IConditionalExpression filter = new ConditionalExpression("dataSetRow.CITY", IConditionalExpression.OP_EQ,
				"\"LONDON\"");
	...
	public void test10() throws Exception {
		...
		IBinding bind1 = new Binding("bind1", new ScriptExpression("row[\"Runningsum\"]"));
		query.addBinding(bind1);

		IBinding binding2 = new Binding("sqrtBind1", new ScriptExpression("Math.sqrt(row[\"bind1\"])"));
	...
	/*
	 * Please refer to SCR #74988 The value of static property "Total.OVERALL" has
	...
	public void testTed49051() throws Exception {
		...
		Binding b = new Binding("b1", new ScriptExpression("dataSetRow[\"CITY\"]"));
		query.addBinding(b);

		b = new Binding("b2", new ScriptExpression("dataSetRow[\"STORE\"]"));
		query.addBinding(b);

		b = new Binding("b3", new ScriptExpression("dataSetRow[\"SALE_DATE\"]"));
		query.addBinding(b);
		...
		b = new Binding("b6", new ScriptExpression("dataSetRow[\"QUANTITY\"]"));
		query.addBinding(b);
