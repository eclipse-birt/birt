...
public class MultiplePassTest extends APITestCase
{
	...
	/*	Binding b5 = new Binding( bindingNameRow[5], new ScriptExpression("row.b51"));
		b5.setAggrFunction( "SUM" );
		b5.addAggregateOn( "group0" );
		Binding b51 = new Binding( "b51", new ScriptExpression("dataSetRow.AMOUNT"));
		b51.setAggrFunction( "SUM" );
