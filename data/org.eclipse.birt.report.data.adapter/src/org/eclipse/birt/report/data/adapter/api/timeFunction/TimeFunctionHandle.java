...
//								local ) ) );
		...
		baseTimeFunctionMap.put( IBuildInBaseTimeFunction.CURRENT_PERIOD_FROM_N_PERIOD_AGO,
				new BaseTimeFunction( IBuildInBaseTimeFunction.CURRENT_PERIOD_FROM_N_PERIOD_AGO,
						...
						Message.getMessage( ResourceConstants.TIMEFUNCITON_CURRENT_PERIOD_FROM_N_PERIOD_AGO_DES,
								local ) ) );
		baseTimeFunctionMap.put( IBuildInBaseTimeFunction.PERIOD_TO_DATE_FROM_N_PERIOD_AGO,
