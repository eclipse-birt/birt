...
public class TableType
{
	...
	public final static TableType ALL = new TableType( Type.ALL,
			Type.ALL.name( ),
			FilterConfig.getTypeDisplayText( Type.ALL ) );
	public final static TableType TABLE = new TableType( Type.TABLE,
			Type.TABLE.name( ),
			FilterConfig.getTypeDisplayText( Type.TABLE ) );
	public final static TableType VIEW = new TableType( Type.VIEW,
			Type.VIEW.name( ),
			FilterConfig.getTypeDisplayText( Type.VIEW ) );
	public final static TableType PROCEDURE = new TableType( Type.PROCEDURE,
			Type.PROCEDURE.name( ),
			FilterConfig.getTypeDisplayText( Type.PROCEDURE ) );
	public final static TableType NO_LIMIT = new TableType( null,
			FilterConfig.JDBC_TYPE_NO_LIMIT,
			FilterConfig.getTypeDisplayText( Type.ALL ) );
