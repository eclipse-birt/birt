...
public class ExcelDataSourcePageHelper {
	...
	Properties collectCustomProperties(Properties props) {
		...
		props.setProperty(ExcelODAConstants.CONN_INCLCOLUMNNAME_PROP, getWhetherUseFirstLineAsColumnNameLine());
		props.setProperty(ExcelODAConstants.CONN_INCLTYPELINE_PROP, getWhetherUseSecondLineAsTypeLine());
