...
public interface IHelpConstants {
	...
	public static final String CONEXT_ID_DATASOURCE_EXCEL = PREFIX + "Wizard_ExcelDatasource_ID";//$NON-NLS-1$

	public static final String CONEXT_ID_DATASET_EXCEL = PREFIX + "Dialog_SelectExcelColumn_ID";//$NON-NLS-1$
