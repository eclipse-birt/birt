...
/*		String className = this.getClass( ).getName( );
		...
		String outputPath = "src/" + className.replace( '.', '/' ) ; //$NON-NLS-1$ //$NON-NLS-2$ 
		File outputFolder = new File( "sample.rptdesign" );
...
*/
	...
	void buildDataSources( ) throws SemanticException
	{
		OdaDataSourceHandle dsHandle = elementFactory.newOdaDataSource(
				"Data source", "org.eclipse.birt.report.data.oda.jdbc" ); //$NON-NLS-1$//$NON-NLS-2$
		...
		dsHandle.setProperty(
				"odaDriverClass", "net.sourceforge.jtds.jdbc.Driver" ); //$NON-NLS-1$ //$NON-NLS-2$
	...
	void buildDataSets( ) throws SemanticException
	{
		OdaDataSetHandle dsHandle = elementFactory.newOdaDataSet(
				"Data Set", ODA_EXTENSION_ID ); //$NON-NLS-1$
		dsHandle.setDataSource( "Data source" );
		dsHandle.setQueryText( "SELECT [Project].[Number],"
				+ "[Project].[Manager],"
				+ "[Project].[Type],[Project].[Status],"
				+ " [Project].[Starting_dt]," + "[Project].[Closing_dt], "
				+ "[Project].[Value]," + "[Project].[Billing],"
				+ "[ProjectDetails].[Region]," + "[ProjectDetails].[Budget],"
				+ "[ProjectDetails].[Expense],"
		...
		PropertyHandle filterHandle = dsHandle
				.getPropertyHandle( OdaDataSetHandle.FILTER_PROP );
	...
	void buildStyles( ) throws SemanticException
	{
		...
		style1.setProperty( StyleHandle.BORDER_BOTTOM_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		style1.setProperty( StyleHandle.BORDER_LEFT_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_NONE );
		style1.setProperty( StyleHandle.BORDER_TOP_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		...
		style2.setProperty( StyleHandle.BORDER_BOTTOM_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		style2.setProperty( StyleHandle.BORDER_LEFT_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		style2.setProperty( StyleHandle.BORDER_TOP_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		...
		style3.setProperty( StyleHandle.BORDER_BOTTOM_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		style3.setProperty( StyleHandle.BORDER_RIGHT_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		style3.setProperty( StyleHandle.BORDER_TOP_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
	...
	private void buildBodyTable( ) throws SemanticException
	{
		...
		table.setProperty( StyleHandle.FONT_SIZE_PROP,
				DesignChoiceConstants.FONT_SIZE_SMALLER );
		table.setProperty( StyleHandle.TEXT_ALIGN_PROP,
				DesignChoiceConstants.TEXT_ALIGN_CENTER );
		table.setProperty( StyleHandle.VERTICAL_ALIGN_PROP,
				DesignChoiceConstants.TEXT_ALIGN_CENTER );
		table.setWidth( "100%" );
		...
		data.setProperty( StyleHandle.TEXT_ALIGN_PROP,
				DesignChoiceConstants.TEXT_ALIGN_LEFT );
		...
		data.setProperty( StyleHandle.TEXT_ALIGN_PROP,
				DesignChoiceConstants.TEXT_ALIGN_CENTER );
		data
				.setValueExpr( "row[\"Budget\"] - row[\"Expense\"]/row[\"Completion\"]" );
		data.getPrivateStyle( ).setNumberFormatCategory(
				DesignChoiceConstants.NUMBER_FORMAT_TYPE_CUSTOM );
		data.getPrivateStyle( ).setNumberFormat( "###,###.00" );
		cell.getContent( ).add( data );
		...
		data = elementFactory.newDataItem( null );
		data.setProperty( StyleHandle.FONT_WEIGHT_PROP,
				DesignChoiceConstants.FONT_WEIGHT_BOLD );
		...
		data.setProperty( StyleHandle.FONT_WEIGHT_PROP,
				DesignChoiceConstants.FONT_WEIGHT_BOLD );
		data
				.setValueExpr( "Total.sum(row[\"Budget\"] - row[\"Expense\"]/row[\"Completion\"])" );
		data.getPrivateStyle( ).setNumberFormatCategory(
				DesignChoiceConstants.NUMBER_FORMAT_TYPE_CUSTOM );
		data.getPrivateStyle( ).setNumberFormat( "$###,###.00" );
		cell.getContent( ).add( data );
	...
	void buildBodyGrid( ) throws SemanticException
	{
		...
		grid2.setProperty( StyleHandle.TEXT_ALIGN_PROP,
				DesignChoiceConstants.TEXT_ALIGN_LEFT );
		grid2.setWidth( "80%" );
		...
		text.setProperty( StyleHandle.TEXT_ALIGN_PROP,
				DesignChoiceConstants.TEXT_ALIGN_CENTER );
		text.setContentType( DesignChoiceConstants.TEXT_CONTENT_TYPE_HTML );
		text
				.setContent( "<CENTER><STRONG><H2>ABOS Marketing<br>Project Analysis Report<br></H2></STRONG>Run Date: <value-of>new Date()</value-of></CENTER><br></br>" );
		...
		row2Cell1.setProperty( StyleHandle.BORDER_LEFT_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		row2Cell1.setProperty( StyleHandle.BORDER_LEFT_WIDTH_PROP,
				DesignChoiceConstants.LINE_WIDTH_THIN );
		row2Cell1.setProperty( StyleHandle.BORDER_TOP_COLOR_PROP, "#808080" );
		row2Cell1.setProperty( StyleHandle.BORDER_TOP_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		row2Cell1.setProperty( StyleHandle.BORDER_TOP_WIDTH_PROP,
				DesignChoiceConstants.LINE_WIDTH_THIN );

		LabelHandle row2Cell1Lable = elementFactory.newLabel( null );
		row2Cell1Lable.setProperty( StyleHandle.FONT_FAMILY_PROP, "Georgia" );
		row2Cell1Lable.setProperty( StyleHandle.FONT_SIZE_PROP,
				DesignChoiceConstants.FONT_SIZE_SMALLER );
		row2Cell1Lable.setProperty( StyleHandle.FONT_WEIGHT_PROP,
				DesignChoiceConstants.FONT_WEIGHT_BOLD );
		...
		row2Cell2.setProperty( StyleHandle.BORDER_TOP_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		row2Cell2.setProperty( StyleHandle.BORDER_TOP_WIDTH_PROP,
				DesignChoiceConstants.LINE_WIDTH_THIN );
		...
		row2Cell2Data.setProperty( StyleHandle.FONT_SIZE_PROP,
				DesignChoiceConstants.FONT_SIZE_SMALLER );
		...
		row2Cell3.setProperty( StyleHandle.BORDER_TOP_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		row2Cell3.setProperty( StyleHandle.BORDER_TOP_WIDTH_PROP,
				DesignChoiceConstants.LINE_WIDTH_THIN );

		LabelHandle row2Cell3Lable = elementFactory.newLabel( null );
		row2Cell3Lable.setProperty( StyleHandle.FONT_FAMILY_PROP, "Georgia" );
		row2Cell3Lable.setProperty( StyleHandle.FONT_SIZE_PROP,
				DesignChoiceConstants.FONT_SIZE_SMALLER );
		row2Cell3Lable.setProperty( StyleHandle.FONT_WEIGHT_PROP,
				DesignChoiceConstants.FONT_WEIGHT_BOLD );
		...
		row2Cell4.setProperty( StyleHandle.BORDER_RIGHT_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		row2Cell4.setProperty( StyleHandle.BORDER_RIGHT_WIDTH_PROP,
				DesignChoiceConstants.LINE_WIDTH_THIN );
		row2Cell4.setProperty( StyleHandle.BORDER_TOP_COLOR_PROP, "#808080" );
		row2Cell4.setProperty( StyleHandle.BORDER_TOP_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		row2Cell4.setProperty( StyleHandle.BORDER_TOP_WIDTH_PROP,
				DesignChoiceConstants.LINE_WIDTH_THIN );
		...
		row2Cell4Data.setProperty( StyleHandle.FONT_SIZE_PROP,
				DesignChoiceConstants.FONT_SIZE_SMALLER );
		...
		row3Cell1.setProperty( StyleHandle.BORDER_LEFT_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		row3Cell1.setProperty( StyleHandle.BORDER_LEFT_WIDTH_PROP,
				DesignChoiceConstants.LINE_WIDTH_THIN );

		LabelHandle row3Cell1Lable = elementFactory.newLabel( null );
		row3Cell1Lable.setProperty( StyleHandle.FONT_FAMILY_PROP, "Georgia" );
		row3Cell1Lable.setProperty( StyleHandle.FONT_SIZE_PROP,
				DesignChoiceConstants.FONT_SIZE_SMALLER );
		row3Cell1Lable.setProperty( StyleHandle.FONT_WEIGHT_PROP,
				DesignChoiceConstants.FONT_WEIGHT_BOLD );
		...
		row3Cell2Data.setProperty( StyleHandle.FONT_SIZE_PROP,
				DesignChoiceConstants.FONT_SIZE_SMALLER );
		...
		row3Cell3Lable.setProperty( StyleHandle.FONT_SIZE_PROP,
				DesignChoiceConstants.FONT_SIZE_SMALLER );
		row3Cell3Lable.setProperty( StyleHandle.FONT_WEIGHT_PROP,
				DesignChoiceConstants.FONT_WEIGHT_BOLD );
		...
		row3Cell4.setProperty( StyleHandle.BORDER_RIGHT_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		row3Cell4.setProperty( StyleHandle.BORDER_RIGHT_WIDTH_PROP,
				DesignChoiceConstants.LINE_WIDTH_THIN );
		...
		row3Cell4Data.setProperty( StyleHandle.FONT_SIZE_PROP,
				DesignChoiceConstants.FONT_SIZE_SMALLER );
		...
		row4Cell1.setProperty( StyleHandle.BORDER_LEFT_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		row4Cell1.setProperty( StyleHandle.BORDER_LEFT_WIDTH_PROP,
				DesignChoiceConstants.LINE_WIDTH_THIN );

		LabelHandle row4Cell1Lable = elementFactory.newLabel( null );
		row4Cell1Lable.setProperty( StyleHandle.FONT_FAMILY_PROP, "Georgia" );
		row4Cell1Lable.setProperty( StyleHandle.FONT_SIZE_PROP,
				DesignChoiceConstants.FONT_SIZE_SMALLER );
		row4Cell1Lable.setProperty( StyleHandle.FONT_WEIGHT_PROP,
				DesignChoiceConstants.FONT_WEIGHT_BOLD );
		...
		row4Cell2Data.setProperty( StyleHandle.FONT_SIZE_PROP,
				DesignChoiceConstants.FONT_SIZE_SMALLER );
		...
		row4Cell3Lable.setProperty( StyleHandle.FONT_SIZE_PROP,
				DesignChoiceConstants.FONT_SIZE_SMALLER );
		row4Cell3Lable.setProperty( StyleHandle.FONT_WEIGHT_PROP,
				DesignChoiceConstants.FONT_WEIGHT_BOLD );
		...
		row4Cell4.setProperty( StyleHandle.BORDER_RIGHT_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		row4Cell4.setProperty( StyleHandle.BORDER_RIGHT_WIDTH_PROP,
				DesignChoiceConstants.LINE_WIDTH_THIN );
		...
		row4Cell4Data.setProperty( StyleHandle.FONT_SIZE_PROP,
				DesignChoiceConstants.FONT_SIZE_SMALLER );
		...
		row5Cell1.setProperty( StyleHandle.BORDER_BOTTOM_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		row5Cell1.setProperty( StyleHandle.BORDER_BOTTOM_WIDTH_PROP,
				DesignChoiceConstants.LINE_WIDTH_THIN );
		row5Cell1.setProperty( StyleHandle.BORDER_LEFT_COLOR_PROP, "#808080" );
		row5Cell1.setProperty( StyleHandle.BORDER_LEFT_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		row5Cell1.setProperty( StyleHandle.BORDER_LEFT_WIDTH_PROP,
				DesignChoiceConstants.LINE_WIDTH_THIN );

		LabelHandle row5Cell1Lable = elementFactory.newLabel( null );
		row5Cell1Lable.setProperty( StyleHandle.FONT_FAMILY_PROP, "Georgia" );
		row5Cell1Lable.setProperty( StyleHandle.FONT_SIZE_PROP,
				DesignChoiceConstants.FONT_SIZE_SMALLER );
		row5Cell1Lable.setProperty( StyleHandle.FONT_WEIGHT_PROP,
				DesignChoiceConstants.FONT_WEIGHT_BOLD );
		...
		row5Cell2.setProperty( StyleHandle.BORDER_BOTTOM_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		row5Cell2.setProperty( StyleHandle.BORDER_BOTTOM_WIDTH_PROP,
				DesignChoiceConstants.LINE_WIDTH_THIN );
		...
		row5Cell2Data.setProperty( StyleHandle.FONT_SIZE_PROP,
				DesignChoiceConstants.FONT_SIZE_SMALLER );
		...
		row5Cell3.setProperty( StyleHandle.BORDER_BOTTOM_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		row5Cell3.setProperty( StyleHandle.BORDER_BOTTOM_WIDTH_PROP,
				DesignChoiceConstants.LINE_WIDTH_THIN );

		LabelHandle row5Cell3Lable = elementFactory.newLabel( null );
		row5Cell3Lable.setProperty( StyleHandle.FONT_FAMILY_PROP, "Georgia" );
		row5Cell3Lable.setProperty( StyleHandle.FONT_SIZE_PROP,
				DesignChoiceConstants.FONT_SIZE_SMALLER );
		row5Cell3Lable.setProperty( StyleHandle.FONT_WEIGHT_PROP,
				DesignChoiceConstants.FONT_WEIGHT_BOLD );
		...
		row5Cell4.setProperty( StyleHandle.BORDER_BOTTOM_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		row5Cell4.setProperty( StyleHandle.BORDER_BOTTOM_WIDTH_PROP,
				DesignChoiceConstants.LINE_WIDTH_THIN );
		row5Cell4.setProperty( StyleHandle.BORDER_RIGHT_COLOR_PROP, "#808080" );
		row5Cell4.setProperty( StyleHandle.BORDER_RIGHT_STYLE_PROP,
				DesignChoiceConstants.LINE_STYLE_SOLID );
		row5Cell4.setProperty( StyleHandle.BORDER_RIGHT_WIDTH_PROP,
				DesignChoiceConstants.LINE_WIDTH_THIN );
		...
		row5Cell4Data.setProperty( StyleHandle.FONT_SIZE_PROP,
				DesignChoiceConstants.FONT_SIZE_SMALLER );
		row5Cell4Data.getPrivateStyle( ).setDateTimeFormatCategory(
				DesignChoiceConstants.DATETIEM_FORMAT_TYPE_CUSTOM );
