...
public class Regression_150222 extends BaseTestCase
{
	...
	{
		openDesign( filename );
		ScalarParameterHandle p1 = (ScalarParameterHandle) designHandle
				.findParameter( "routename" ); //$NON-NLS-1$
		ScalarParameterHandle p2 = (ScalarParameterHandle) designHandle
				.findParameter( "DateUnit" ); //$NON-NLS-1$
		ScalarParameterHandle p3 = (ScalarParameterHandle) designHandle
				.findParameter( "BlockUnit" ); //$NON-NLS-1$
		ScalarParameterHandle p4 = (ScalarParameterHandle) designHandle
				.findParameter( "blocksize" ); //$NON-NLS-1$
		ScalarParameterHandle p5 = (ScalarParameterHandle) designHandle
				.findParameter( "partnum" ); //$NON-NLS-1$
		ScalarParameterHandle p6 = (ScalarParameterHandle) designHandle
				.findParameter( "location" ); //$NON-NLS-1$
		ScalarParameterHandle p7 = (ScalarParameterHandle) designHandle
				.findParameter( "DB" ); //$NON-NLS-1$
		ScalarParameterHandle p8 = (ScalarParameterHandle) designHandle
				.findParameter( "schema" ); //$NON-NLS-1$
