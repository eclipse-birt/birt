...
public class Regression_161383 extends BaseTestCase
{
	...
	public void test_regression_161383( ) throws SemanticException
	{
		...
		label.setStringProperty(
				Style.PAGE_BREAK_INSIDE_PROP,
				DesignChoiceConstants.PAGE_BREAK_INSIDE_AVOID );

		assertEquals( DesignChoiceConstants.PAGE_BREAK_INSIDE_AVOID, label
		...
		assertEquals( DesignChoiceConstants.PAGE_BREAK_INSIDE_AVOID, group1
				.getStringProperty( Style.PAGE_BREAK_INSIDE_PROP ) );
	 ...
	 * @throws SemanticException
	 */
	public void test_regression_161383_1( ) throws DesignFileException,
			SemanticException
	{
		openDesign( REPORT );
		...
		style1.setStringProperty(
				Style.PAGE_BREAK_INSIDE_PROP,
				DesignChoiceConstants.PAGE_BREAK_INSIDE_AVOID );
		row1.setStyleName( "style1" );

		assertEquals( DesignChoiceConstants.PAGE_BREAK_INSIDE_AVOID, row1
				.getStringProperty( Style.PAGE_BREAK_INSIDE_PROP ) );

		// Set page-break-inside on selector
		StyleHandle style2 = (StyleHandle) designHandle
				.findStyle( "table-header" );
		style2.setStringProperty(
				Style.PAGE_BREAK_INSIDE_PROP,
				DesignChoiceConstants.PAGE_BREAK_INSIDE_AVOID );
		assertEquals( DesignChoiceConstants.PAGE_BREAK_INSIDE_AVOID, row2
				.getStringProperty( Style.PAGE_BREAK_INSIDE_PROP ) );
	 ...
	 * @throws SemanticException
	 */
	public void test_regression_161383_2( ) throws DesignFileException,
			SemanticException
	{
		openDesign( REPORT1 );
	 ...
	 * @throws SemanticException
	 */
	public void test_regression_161383_3( ) throws DesignFileException,
			SemanticException
	{
		openDesign( REPORT2 );
