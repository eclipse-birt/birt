...

{
	...
	public void test_regression_156449( ) throws DesignFileException
	{
		...
		SharedStyleHandle header1style = designHandle
				.findStyle( "table-group-header-1" ); //$NON-NLS-1$
		SharedStyleHandle header2style = designHandle
				.findStyle( "table-group-header-2" ); //$NON-NLS-1$
		SharedStyleHandle footer1style = designHandle
				.findStyle( "table-group-footer-1" ); //$NON-NLS-1$
		SharedStyleHandle footer2style = designHandle
				.findStyle( "table-group-footer-2" ); //$NON-NLS-1$
		...
		DataItemHandle header1 = (DataItemHandle) designHandle
				.findElement( "header1" ); //$NON-NLS-1$
		DataItemHandle header2 = (DataItemHandle) designHandle
				.findElement( "header2" ); //$NON-NLS-1$
		LabelHandle footer1 = (LabelHandle) designHandle
				.findElement( "footer1" ); //$NON-NLS-1$
		LabelHandle footer2 = (LabelHandle) designHandle
				.findElement( "footer2" ); //$NON-NLS-1$
