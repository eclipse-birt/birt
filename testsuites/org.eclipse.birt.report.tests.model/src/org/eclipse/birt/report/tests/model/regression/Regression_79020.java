 ...
 * Test description:
 * <p>
 * Set verticle-align of row to "bottom", check the property value on content cells,
 * ensure the property is cascaded.  
 * </p>
 */
...
public class Regression_79020 extends BaseTestCase
{
	...
	public final static String INPUT = "regression_79020.rptdesign"; //$NON-NLS-1$
	...
	public void test() throws DesignFileException, SemanticException
	{
		...
		assertEquals( "baseline", cellHandle.getProperty( StyleHandle.VERTICAL_ALIGN_PROP ) ); //$NON-NLS-1$
