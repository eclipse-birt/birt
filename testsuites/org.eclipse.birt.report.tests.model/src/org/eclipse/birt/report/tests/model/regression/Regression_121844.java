...
public class Regression_121844 extends BaseTestCase
{
	...
	public void test_regression_121844( ) throws DesignFileException, SemanticException,
			IOException
	{
		openDesign( INPUT );
		...
		assertEquals(
				"regression_121844_lib.Data Set", table.getDataSet( ).getQualifiedName( ) ); //$NON-NLS-1$
