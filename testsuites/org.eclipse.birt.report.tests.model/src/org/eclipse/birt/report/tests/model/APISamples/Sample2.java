	 ...
	 //Add a label to the library
	   ...
	   libraryHandle.getComponents().add(label);
		...
		void buildTheme() throws SemanticException {
			...
			SimpleValueHandle value1 = (SimpleValueHandle)map1.getProperty(libraryHandle.getModule(), MapRule.DISPLAY_MEMBER);
			...
			SimpleValueHandle value2 = (SimpleValueHandle)map2.getProperty(libraryHandle.getModule(), MapRule.DISPLAY_MEMBER);
