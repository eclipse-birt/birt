...
public class Regression_164070 extends BaseTestCase
{
	...
	public void test_regression_164070( ) throws SemanticException
	{
		...
		label.setStringProperty(
				Style.WIDOWS_PROP,
				DesignChoiceConstants.WIDOWS_INHERIT );

		assertEquals( DesignChoiceConstants.WIDOWS_INHERIT, label
				.getStringProperty( Style.WIDOWS_PROP ) );

		label.setStringProperty(
				Style.ORPHANS_PROP,
				DesignChoiceConstants.ORPHANS_INHERIT );

		assertEquals( DesignChoiceConstants.ORPHANS_INHERIT, label
				.getStringProperty( Style.ORPHANS_PROP ) );
		...
		assertEquals( DesignChoiceConstants.WIDOWS_INHERIT, text
				.getStringProperty( Style.WIDOWS_PROP ) );
		...
		assertEquals( DesignChoiceConstants.ORPHANS_INHERIT, text
				.getStringProperty( Style.ORPHANS_PROP ) );
		...
		assertEquals( DesignChoiceConstants.WIDOWS_INHERIT, data
				.getStringProperty( Style.WIDOWS_PROP ) );
		...
		assertEquals( DesignChoiceConstants.ORPHANS_INHERIT, data
				.getStringProperty( Style.ORPHANS_PROP ) );
		...
		assertEquals( DesignChoiceConstants.WIDOWS_INHERIT, dtext
				.getStringProperty( Style.WIDOWS_PROP ) );
		...
		assertEquals( DesignChoiceConstants.ORPHANS_INHERIT, dtext
				.getStringProperty( Style.ORPHANS_PROP ) );
	}
}
