...
public class DynamicParameterTest extends BaseTestCase
{
	...
	public void testPropertiesOfDynamicParameter( ) throws Exception
	{
		...
		assertEquals( DesignChoiceConstants.PARAM_VALUE_TYPE_DYNAMIC, handle
				.getValueType( ) );
		...
		assertEquals( DesignChoiceConstants.PARAM_CONTROL_LIST_BOX, handle
				.getControlType( ) );
		...
		handle
				.setCategory( DesignChoiceConstants.DATETIEM_FORMAT_TYPE_LONG_DATE );
		assertEquals( DesignChoiceConstants.DATETIEM_FORMAT_TYPE_LONG_DATE,
				handle.getCategory( ) );
		...
		assertEquals( DesignChoiceConstants.PARAM_VALUE_TYPE_DYNAMIC, handle
				.getValueType( ) );
		assertEquals( DesignChoiceConstants.PARAM_TYPE_FLOAT, handle
				.getDataType( ) );
