...
public class LibraryCreateTest extends BaseTestCase
{
	...
	public void testCreatLibrary( ) throws Exception
	{
		...
		DataSourceHandle dataSourceHandle = (DataSourceHandle) designHandle
				.findDataSource( "db2d" );
		assertNotNull( "Datasource should not be null", dataSourceHandle );
		DataSetHandle dataSetHandle = (DataSetHandle) designHandle
				.findDataSet( "db2ds" );
	...
	public void testNoNameTable( ) throws Exception
	{
		...
		TableHandle tableHandle = (TableHandle) designHandle
				.getElementFactory( ).newTableItem( "" );
	...
	public void testDuplicateLibrary( ) throws Exception
	{
		// openDesign(fileName);
		LabelHandle labelHandle = (LabelHandle) designHandle
				.getElementFactory( ).newLabel( "label1" );
		designHandle.getBody( ).add( labelHandle );
		...
		{
			ElementExportUtil
					.exportElement( label2Handle, libraryHandle, false );
		}
		catch ( Exception e )
		{
			assertNotNull( e );
