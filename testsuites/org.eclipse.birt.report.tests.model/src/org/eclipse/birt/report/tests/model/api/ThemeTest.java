...
public class ThemeTest extends BaseTestCase
{
	...
	public void testThemeSearchAlgorithm( ) throws Exception
	{
		...
		assertEquals( "100%", designHandle.findElement( "mytable" ).getStringProperty(
				Style.FONT_SIZE_PROP ) );
		assertEquals( "aqua", designHandle.findElement( "mylabel" ).getStringProperty(
		...
		assertEquals( "100%", designHandle.findElement( "mytable" ).getStringProperty(
				Style.FONT_SIZE_PROP ) );
		assertNotNull( designHandle.findElement( "mylabel" ).getStringProperty(
				Style.BACKGROUND_COLOR_PROP ) );
