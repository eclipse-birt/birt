...
*/
	...
	public CrosstabReportItemHandle createEmptyCrosstab( ModuleHandle module )
	{
		try
		{
			...
			// create a cube
			CubeHandle cube1 = factory.newTabularCube( "cube1" );
			designHandle.getCubes( ).add( cube1 );

			// create a x-tab using the cube
			CrosstabReportItemHandle crosstabItem = (CrosstabReportItemHandle) CrosstabUtil
					.getReportItem( CrosstabExtendedItemFactory
							.createCrosstabReportItem( designHandle
									.getModuleHandle( ), cube1 ) );
			return crosstabItem;
		}
	...
	protected CrosstabReportItemHandle createSimpleCrosstab( ModuleHandle module )
	{
		try
		{
			...
			dimensionHandle.add(
					DimensionHandle.HIERARCHIES_PROP,
					hierarchyHandle );
			...
			dimensionViewHandle2.insertLevel(
					hierarchyHandle2.getLevel( 0 ),
					-1 );
			dimensionViewHandle2.insertLevel(
					hierarchyHandle2.getLevel( 1 ),
					-1 );
