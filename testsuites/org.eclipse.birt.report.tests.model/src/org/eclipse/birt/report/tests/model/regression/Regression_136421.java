...
public class Regression_136421 extends BaseTestCase
{
	 ...
	 */
	public void test_regression_136421( ) throws DesignFileException, SemanticException
	{
		openDesign( INPUT );
		...
		DataItemHandle tableRowData = (DataItemHandle) ( (CellHandle) ( (RowHandle) table
		...
		DataItemHandle data = (DataItemHandle) ( (CellHandle) ( (RowHandle) group
				.getHeader( ).get( 0 ) ).getCells( ).get( 0 ) ).getContent( )
				.get( 0 );
		try
		{
