...
//		copyInputToFile( INPUT_FOLDER + "/" + LIBRARY_B );
	...
	public void test_regression_132938( ) throws DesignFileException, SemanticException, IOException
	{
		...
		LabelHandle baseLabel = (LabelHandle) libraryHandle.findElement( "NewLabel" ); //$NON-NLS-1$
		...
		copyFile( getTempFolder( ) + "/" + OUTPUT_FOLDER + "/" + LIBRARY_A, getTempFolder( ) + "/" + INPUT_FOLDER + "/"
				+ LIBRARY_A );
	}
}
