 ...
 * <li>Error message pops up "The TemplateReportItem" is not allowed directly
 * or indirectly inside the cell's slot(content)."
 * <li>But if I transfer an element in a table cell which is created in a
 * report design to a template item, it is allowed.
 * </ol>
 * </p>
 * Test description:
 * <p>
...
public class Regression_117676 extends BaseTestCase
{
	...
	public void test_regression_117676( ) throws DesignFileException
	{
		...
		TableHandle localTable = (TableHandle) designHandle
				.findElement( "localTable" ); //$NON-NLS-1$
		LabelHandle label1 = (LabelHandle) ( (CellHandle) ( (RowHandle) localTable
