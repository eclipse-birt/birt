...
public class IDataIteratorTest extends EngineCase
{
	...
	private void checkGetQueryResults( IDataIterator iterator,
			IExtractionResults results )
	{
		...
		try
		{
			if ( iterator.next( ) )
			{
				assertEquals( 10334, Integer.parseInt( iterator
						.getValue( 0 )
						.toString( ) ) );
				assertEquals( "Mon Nov 19 00:00:00 PST 2012", iterator
						.getValue( 1 )
						.toString( ) );
