 ...
 * Test description:
 * </p>
 * Create a bar chart, add script function beforeDrawDataPointLabel()
 * </p>
 */

public class Regression_157608 extends ChartTestCase {

	private static String GOLDEN = "Regression_157608.jpg"; //$NON-NLS-1$
	private static String OUTPUT = "Regression_157608.jpg"; //$NON-NLS-1$
	...
	public static void main(String[] args) {
		new Regression_157608();
	}

	/**
	 * Constructor
	 */
	public Regression_157608() {
	...
	public static final Chart createLineChart() {
		...
		cwaLine.setScript("function beforeDrawDataPointLabel( dph, label, context )" //$NON-NLS-1$
				+ "{value = dph.getOrthogonalValue( ) .doubleValue( );" //$NON-NLS-1$
				+ "if ( ( value >= 50 ) & ( value <= 100 ) )" //$NON-NLS-1$
				+ "{label.getCaption( ).getColor( ).set( 32, 168, 255 );" //$NON-NLS-1$
				...
				+ "{label.getCaption( ).getColor( ).set( 168, 0, 208 );" //$NON-NLS-1$
				+ "label.getCaption().getFont().setItalic(true);" //$NON-NLS-1$
				+ "label.getCaption().getFont().setRotation(5);" //$NON-NLS-1$
				+ "label.getCaption().getFont().setStrikethrough(true);" //$NON-NLS-1$
				+ "label.getCaption().getFont().setSize(22);" //$NON-NLS-1$
				...
				+ "{label.getCaption( ).getColor( ).set( 0, 208, 32 );" //$NON-NLS-1$
				+ "label.getCaption().getFont().setItalic(true);" //$NON-NLS-1$
				+ "label.getCaption().getFont().setRotation(5);" //$NON-NLS-1$
				+ "label.getCaption().getFont().setStrikethrough(true);" //$NON-NLS-1$
				+ "label.getCaption().getFont().setSize(22);" //$NON-NLS-1$
				...
				+ "{label.getCaption( ).getColor( ).set( 255, 208, 32 );" //$NON-NLS-1$
				+ "label.getCaption().getFont().setItalic(true);" //$NON-NLS-1$
				+ "label.getCaption().getFont().setRotation(5);" //$NON-NLS-1$
				+ "label.getCaption().getFont().setStrikethrough(true);" //$NON-NLS-1$
				+ "label.getCaption().getFont().setSize(22);" //$NON-NLS-1$
