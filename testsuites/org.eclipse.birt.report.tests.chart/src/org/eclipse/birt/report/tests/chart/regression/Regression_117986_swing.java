 ...
 * </p>
 * Set ShowTooltip and UrlRedirect to the chart, preview, showTooltip does not
 * take effect
 * </p>
 * Test description:
 * <p>
 * Create a bar chart, set showTooltip and urlRedirect to Y series, render the
 * chart, verify if it can be take effect
 * </p>
 */

public final class Regression_117986_swing extends JPanel implements ICallBackNotifier, ComponentListener {
