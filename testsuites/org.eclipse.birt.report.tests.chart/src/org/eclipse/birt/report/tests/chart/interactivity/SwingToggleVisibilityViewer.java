 ...
 * 
 */
public final class SwingToggleVisibilityViewer extends JPanel implements
	...
	public static void main(String[] args) {
		SwingToggleVisibilityViewer stv = new SwingToggleVisibilityViewer();
	...
	private final class ControlPanel extends JPanel implements ActionListener {
		...
		private final SwingToggleVisibilityViewer stv;

		ControlPanel(SwingToggleVisibilityViewer stv) {
			this.stv = stv;
