...
public class AfterRendering extends ChartTestCase
{
	...
	private static String OUTPUT = "AfterRendering.jpg"; //$NON-NLS-1$	
	...
	{
		AfterRendering st = new AfterRendering( );
	}
	...
	public static final Chart createPieChart( )
	{
		...
		cwoaPie
				.setScript( "function afterRendering( gcs, icsc )" //$NON-NLS-1$
