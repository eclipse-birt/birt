...
public final class Regression_116616_swing extends JPanel
		implements
			ICallBackNotifier,
			ComponentListener
{
	...
	{
		final Regression_116616_swing siv = new Regression_116616_swing( );
	...
	private final class ControlPanel extends JPanel implements ActionListener
	{
		...
		private final Regression_116616_swing siv;

		ControlPanel( Regression_116616_swing siv )
		{
			this.siv = siv;
	...
	{
		JOptionPane.showMessageDialog( Regression_116616_swing.this, value
				.getIdentifier( ) );
	}
