 ...
 * more details.
 */
public final class SwingHighlightViewer extends JPanel implements ICallBackNotifier, ComponentListener {
	...
	private final class ControlPanel extends JPanel implements ActionListener {
		...
		private final SwingHighlightViewer siv;

		ControlPanel(SwingHighlightViewer siv) {
			this.siv = siv;
	...
	public void callback(Object event, Object source, CallBackValue value) {
		JOptionPane.showMessageDialog(SwingHighlightViewer.this, value.getIdentifier());
	}
}
