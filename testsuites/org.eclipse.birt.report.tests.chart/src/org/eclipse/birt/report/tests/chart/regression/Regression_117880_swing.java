 ...
 * </p>
 * There will be hide series error if set ToggleVisibility to the meter chart
 * with 3 dials
 * </p>
 * Test description:
 * </p>
 * If set ToggleVisibility to the meter chart with 3 dials, it will work
 * correctly
 * </p>
 */

public final class Regression_117880_swing extends JPanel implements ICallBackNotifier, ComponentListener {
	...
	private final class ControlPanel extends JPanel implements ActionListener {
		...
		private final Regression_117880_swing siv;

		ControlPanel(Regression_117880_swing siv) {
			this.siv = siv;
	...
	public void callback(Object event, Object source, CallBackValue value) {
		JOptionPane.showMessageDialog(Regression_117880_swing.this, value.getIdentifier());
	}
