 ...
 * </p>
 * Chart with "Mouse Click - Show Tooltip action" added, produces a run time script error at Report Preview.
 * </p>
 * Test description:
 * <p>
			...
			SelectionListener
{
	...
	public static void main( String[] args )
	{
		...
		Regression_143809_swt siv = new Regression_143809_swt( shell,
				SWT.NO_BACKGROUND );
...
//		ps.getTitle().getCaption().setValue("sss");
		...
		ps.getTriggers( )
		.add( TriggerImpl.create( TriggerCondition.MOUSE_CLICK_LITERAL,
