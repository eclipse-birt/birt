 ...
 * Description:
 * </p>
 * function beforeDrawAxisLabel()
 * </p>
 */

public class BeforeDrawAxisLabel extends ChartTestCase {
	...
	public static void main(String[] args) {
		new BeforeDrawAxisLabel();
	}

	/**
	 * Constructor
	 */
	public BeforeDrawAxisLabel() {
	...
	public static final Chart createLineChart() {
		...
		cwaLine.setScript("function beforeDrawAxisLabel(axis, label, scriptContext)" //$NON-NLS-1$
