 ...
 * more details.
 */
public final class SwingURLRedirectViewer extends JPanel implements ICallBackNotifier, ComponentListener {
	...
	private final class ControlPanel extends JPanel implements ActionListener {
		...
		private final SwingURLRedirectViewer siv;

		ControlPanel(SwingURLRedirectViewer siv) {
			this.siv = siv;
	...
	public void callback(Object event, Object source, CallBackValue value) {
		JOptionPane.showMessageDialog(SwingURLRedirectViewer.this, value.getIdentifier());
	}
}
