 ...
 * Description:
 * </p>
 * function beforeDrawSeries()
 * </p>
 */

public class BeforeDrawSeries extends ChartTestCase {

	private static String OUTPUT = "BeforeDrawSeries.jpg"; //$NON-NLS-1$
	...
	public static void main(String[] args) {
		new BeforeDrawSeries();
	}

	/**
	 * Constructor
	 */
	public BeforeDrawSeries() {
