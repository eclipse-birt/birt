 ...
 * </p>
 * If set icon to chart marker, interactivity can not take effort
 * </p>
 * Test description:
 * </p>
 * Set icon to chart marker, interactivity can not take effort
 * </p>
 */

public final class Regression_117699_swing extends JPanel implements ICallBackNotifier, ComponentListener {
	...
	public void callback(Object event, Object source, CallBackValue value) {
		JOptionPane.showMessageDialog(Regression_117699_swing.this, value.getIdentifier());
	}
	...
	public static final Chart URLRedirect_ScatterChart() {
		...
		for (int i = 0; i < ss.getMarkers().size(); i++) {
			...
			((Marker) ss.getMarkers().get(i))
					.setFill(ImageImpl.create(" http://image2.sina.com.cn/igame/new/new011/ver4/icon_rich.GIF "));
		}
