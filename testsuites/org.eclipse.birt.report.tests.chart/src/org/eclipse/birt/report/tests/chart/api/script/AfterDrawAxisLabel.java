...
public class AfterDrawAxisLabel extends ChartTestCase
{
	...
	public AfterDrawAxisLabel( )
	{
		...
		// "D:/workspaces/APICode/org.eclipse.birt.report.tests.chart/src/org/eclipse/birt/report/tests/chart/api/script/output/"
		// + OUTPUT ); //$NON-NLS-1$
	...
	public static final Chart createLineChart( )
	{
		...
		cwaLine
				.setScript( "function afterDrawAxisLabel(axis, label, scriptContext)" //$NON-NLS-1$
		...
		TextDataSet dsStringValue = TextDataSetImpl.create( new String[]{
				"Keyboards", "Monitors", "Printers", "Motherboards"} );
