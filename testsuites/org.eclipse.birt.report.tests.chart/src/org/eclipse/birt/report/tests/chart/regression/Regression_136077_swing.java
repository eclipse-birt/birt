 ...
 * </p>
 * Chart interactivity didn't work properly
 * </p>
 * Test description:
 * </p>
 * Create a bar chart and add interactivity URL Redirect to its title
 * </p>
 */

public final class Regression_136077_swing extends JPanel implements ICallBackNotifier, ComponentListener {
	...
	private final class ControlPanel extends JPanel implements ActionListener {
		...
		private final Regression_136077_swing siv;

		ControlPanel(Regression_136077_swing siv) {
			this.siv = siv;
	...
	public void callback(Object event, Object source, CallBackValue value) {
		JOptionPane.showMessageDialog(Regression_136077_swing.this, value.getIdentifier());
	}
	...
	public static final Chart URLRedirect_BarChart() {
		...
		Trigger trigger = TriggerImpl.create(TriggerCondition.ONCLICK_LITERAL,
				ActionImpl.create(ActionType.URL_REDIRECT_LITERAL, URLValueImpl.create("http://www.actuate.com", //$NON-NLS-1$
						...
						null, // $NON-NLS-1$
						null)));
		cwaBar.getTitle().getTriggers().add(trigger);
