...
public final class Regression_136077_swing extends JPanel
		implements
			ICallBackNotifier,
			ComponentListener
{
	...
	{
		JOptionPane.showMessageDialog( Regression_136077_swing.this, value
				.getIdentifier( ) );
	}
	...
	public static final Chart URLRedirect_BarChart( )
	{
		...
		Trigger trigger = TriggerImpl.create(
