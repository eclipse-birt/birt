 ...
 * Test decription:
 * </p>
 * Chart script: afterDrawSeriesTitle()
 * </p>
 */

public class AfterDrawSeriesTitle extends ChartTestCase {

	private static String OUTPUT = "AfterDrawSeriesTitle.jpg"; //$NON-NLS-1$
	...
	public static final Chart createPieChart() {
		...
		cwoaPie.setScript("function afterDrawSeriesTitle(series, label, scriptContext)" //$NON-NLS-1$
				+ "{importPackage(Packages.java.lang); " //$NON-NLS-1$
				+ "if (label.getCaption().getValue() == \"Actuate\")" //$NON-NLS-1$
