 ...
 * Description:
 * </p>
 * function afterDrawDataPointLabel()
 * </p>
 */

public class AfterDrawDataPointLabel extends ChartTestCase {
	...
	public static void main(String[] args) {
		new AfterDrawDataPointLabel();
	}

	/**
	 * Constructor
	 */
	public AfterDrawDataPointLabel() {
	...
	public static final Chart createLineChart() {
		...
		cwaLine.setScript("function afterDrawDataPointLabel( dph, label, context )" //$NON-NLS-1$
				...
				+ "{System.out.println(\"Betwee 50 & 100\");} " //$NON-NLS-1$
				+ "else if ( ( value >= 100 ) & ( value <= 150 ) )" //$NON-NLS-1$
				+ "{System.out.println(\"Betwee 100 & 150\");} " //$NON-NLS-1$
				+ "else if ( value > 150 )" //$NON-NLS-1$
				+ "{System.out.println(\"Over 150\");} " //$NON-NLS-1$
				+ "else if ( value < 50 )" //$NON-NLS-1$
				+ "{System.out.println(\"Under 50\");}} " //$NON-NLS-1$
		);
