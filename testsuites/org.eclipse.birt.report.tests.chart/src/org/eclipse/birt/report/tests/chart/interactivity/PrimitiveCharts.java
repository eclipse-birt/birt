...
public final class PrimitiveCharts
{
	...
	public static final Chart showTooltip_AreaChart() {
		...
		MarkerRange mr = MarkerRangeImpl.create(xAxisPrimary,
				NumberDataElementImpl.create(2.0), NumberDataElementImpl
						.create(3.0), null);
		mr.setOutline(LineAttributesImpl.create(ColorDefinitionImpl.create(239,
	...
	public static final Chart showTooltip_LineChart() {
		...
		MarkerRange mr = MarkerRangeImpl.create(yAxisPrimary,
				NumberDataElementImpl.create(60.0), NumberDataElementImpl
						.create(90.0), null);
		mr.setOutline(LineAttributesImpl.create(ColorDefinitionImpl.create(239,
				33, 3), LineStyle.DOTTED_LITERAL, 2));
		...
		ls.getMarker().setIconPalette(PaletteImpl.create(1,true));
		ls.getMarker().setType(MarkerType.ICON_LITERAL);
        ls.getMarker().getIconPalette().getEntries().add(ImageImpl.create("file:///"+System.getProperty("user.dir")+"/27.gif"));
...
//		ps.getTitle().getCaption().setValue("sss");
	...
	public static final Chart showTooltip_ScatterChart( )
	{
		...
		cwaScatter.getTitle( )
				.getLabel( )
				.getCaption( )
				.setValue( "Numeric Scatter Chart" ); //$NON-NLS-1$
		...
		ss.getTriggers( )
				.add( TriggerImpl.create( TriggerCondition.MOUSE_HOVER_LITERAL,
						ActionImpl.create( ActionType.SHOW_TOOLTIP_LITERAL,
								TooltipValueImpl.create( 500, null ) ) ) );
	...
	public static final Chart toggleVisibility_AreaChart() {
		...
		cwaArea.setRotation(Rotation3DImpl.create(new Angle3D[] {
		...
		FontDefinition fd1 = FontDefinitionImpl.create("Arial", (float) 20.0,
				true, true, false, true, false, 30.0, TextAlignmentImpl
						.create());
		...
		zAxisPrimary.getMajorGrid().setLineAttributes(
				LineAttributesImpl.create(ColorDefinitionImpl
						.create(239, 33, 3), LineStyle.SOLID_LITERAL, 2));
		zAxisPrimary.getMajorGrid().getLineAttributes().setColor(
				ColorDefinitionImpl.BLUE());
...
//		ps.getTitle().getCaption().setValue("sss");
	...
	public static final Chart toggleVisibility_ScatterChart() {
		...
		xAxisPrimary.getMajorGrid().setTickStyle(TickStyle.BELOW_LITERAL);
		xAxisPrimary.getMajorGrid().setTickAttributes(LineAttributesImpl.create(ColorDefinitionImpl.create(239,
				33, 3), LineStyle.DOTTED_LITERAL, 2));
		xAxisPrimary.getMajorGrid().getLineAttributes().setStyle(
				LineStyle.DOTTED_LITERAL);
		xAxisPrimary.getMajorGrid().getLineAttributes().setColor(
		...
		// Data Set
		NumberDataSet dsNumericValues1 = NumberDataSetImpl.create(new double[] {
				22.49, 163.55, -65.43, 0.0, -107.0 });
		NumberDataSet dsNumericValues2 = NumberDataSetImpl.create(new double[] {
				-36.53, 43.9, 8.29, 97.45, 32.0 });
		...
		ss.getLabel().setBackground(ColorDefinitionImpl.CYAN());
		ss.getLabel().setVisible(true);
		ss.getMarker().setIconPalette(PaletteImpl.create(1,true));
		ss.getMarker().setType(MarkerType.ICON_LITERAL);
        ss.getMarker().getIconPalette().getEntries().add(ImageImpl.create("file:///"+System.getProperty("user.dir")+"/27.gif"));
		ss.setDataSet(dsNumericValues2);
