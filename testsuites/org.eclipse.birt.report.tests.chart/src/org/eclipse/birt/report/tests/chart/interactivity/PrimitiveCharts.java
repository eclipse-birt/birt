...
public final class PrimitiveCharts extends ChartTestCase
{
	...
	public static final Chart showTooltip_LineChart( )
	{
		...
		MarkerRange mr = MarkerRangeImpl.create(
				yAxisPrimary,
				NumberDataElementImpl.create( 60.0 ),
				NumberDataElementImpl.create( 90.0 ),
				null );
		mr.setOutline( LineAttributesImpl.create( ColorDefinitionImpl.create(
				239,
				33,
...
//							+ "/27.gif" ) );
	...
	public static final Chart showTooltip_ScatterChart( )
	{
		...
		cwaScatter.getTitle( ).getLabel( ).getCaption( ).setValue(
				"Numeric Scatter Chart" ); //$NON-NLS-1$
		...
		// Data Set
		NumberDataSet dsNumericValues1 = NumberDataSetImpl
				.create( new double[]{-46.55, 25.32, 84.46, 125.95, 38.65,
						-54.32, 30} );
		NumberDataSet dsNumericValues2 = NumberDataSetImpl
				.create( new double[]{125.99, 352.95, -201.95, 299.95, -95.95,
						65.95, 58.95} );
	...
	public static final Chart showTooltip_StockChart( )
	{
		...
		tb.setBackground( GradientImpl.create( ColorDefinitionImpl.create(
				0,
				128,
		...
		cwaStock.getBlock( ).setBackground(
				GradientImpl.create(
						ColorDefinitionImpl.create( 196, 196, 196 ),
		...
		// X-Axis
		Axis xAxisPrimary = ( (ChartWithAxesImpl) cwaStock )
				.getPrimaryBaseAxes( )[0];
		...
		yAxisPrimary.getTitle( ).getCaption( ).setValue(
				"Microsoft ($ Stock Price)" );//$NON-NLS-1$
