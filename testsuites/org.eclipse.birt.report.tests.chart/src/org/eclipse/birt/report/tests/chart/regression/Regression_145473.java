 ...
 * </p>
 * Chart title text anchor can not take effect
 * </p>
 * Test description:
 * </p>
 * Create a bar chart, set its title anchor to south
 * </p>
 */

public class Regression_145473 extends ChartTestCase
{

	private static String GOLDEN = "Regression_145473.jpg"; //$NON-NLS-1$
	private static String OUTPUT = "Regression_145473.jpg"; //$NON-NLS-1$
	...
	{
		new Regression_145473( );
	}

	/**
	 * Constructor
	 */
	public Regression_145473( )
	{
	...
	public static final Chart createBarChart( )
	{
		...
		cwaBar.getTitle( ).setAnchor( Anchor.SOUTH_LITERAL );
