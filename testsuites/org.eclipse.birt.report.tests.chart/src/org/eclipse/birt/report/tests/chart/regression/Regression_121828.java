 ...
 * </p>
 * If set script to marker range label color, the color can not be displayed
 * </p>
 * Test description:
 * </p>
 * If set script to marker range label color, the color can be displayed
 * correctly
 * </p>
 */

public class Regression_121828 extends ChartTestCase
{

	private static String GOLDEN = "Regression_121828.jpg"; //$NON-NLS-1$
	private static String OUTPUT = "Regression_121828.jpg"; //$NON-NLS-1$
	...
	public void testRegression_121828( ) throws Exception
	{
		Regression_121828 st = new Regression_121828( );
	...
	public static final Chart createBarChart( )
	{
		...
		cwaBar
				.setScript( "function beforeDrawMarkerRange(axis, range, scriptContext)" //$NON-NLS-1$
						+ "{importPackage(Packages.java.util); "//$NON-NLS-1$
						+ "range.getLabel().getCaption().getColor().set(255, 0, 0);}" //$NON-NLS-1$ )
				);
