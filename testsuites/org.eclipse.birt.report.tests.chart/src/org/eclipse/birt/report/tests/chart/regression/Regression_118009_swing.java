 ...
 * </p>
 * 3D Line Chart, set marker type to icon, preivew error
 * </p>
 * Test description:
 * <p>
...
public final class Regression_118009_swing extends JPanel
		implements
			ICallBackNotifier,
			ComponentListener
{
	...
	private final class ControlPanel extends JPanel implements ActionListener
	{
		...
		private final Regression_118009_swing siv;

		ControlPanel( Regression_118009_swing siv )
		{
			this.siv = siv;
	...
	{
		JOptionPane.showMessageDialog( Regression_118009_swing.this, value
				.getIdentifier( ) );
	}
