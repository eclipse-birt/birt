 ...
 * Test decription:
 * </p>
 * Chart script: afterGeneration()
 * </p>
 */

public class AfterGeneration extends ChartTestCase
{

	private static String OUTPUT = "AfterGeneration.jpg"; //$NON-NLS-1$	
	...
	{
		AfterGeneration st = new AfterGeneration( );
	}
	...
	public static final Chart createPieChart( )
	{
		...
		cwoaPie
				.setScript( "function afterGeneration( gcs, icsc )" //$NON-NLS-1$
						...
						+ " if (gcs.getChartModel().getPlot( ).getClientArea( ).getOutline( ).isVisible() == true)" //$NON-NLS-1$
