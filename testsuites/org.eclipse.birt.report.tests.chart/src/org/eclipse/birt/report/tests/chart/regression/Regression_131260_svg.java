 ...
 * </p>
 * SVG: showTooltip, display string contains "\n", can not take effect
 * </p>
 * Test description:
 * <p>
 * Set interactivity-showTooltip to X Axis, and display string is
 * "abcdef\ndeeeeee", verify if it will be take effect.
 * </p>
 */

public class Regression_131260_svg extends Composite implements IUpdateNotifier, SelectionListener {
	...
	Regression_131260_svg(Composite parent, int style) {
		super(parent, style);
	...
	public static final Chart showTooltip_BarChart() {
		...
		xAxisPrimary.getTriggers().add(TriggerImpl.create(TriggerCondition.ONMOUSEMOVE_LITERAL,
				ActionImpl.create(ActionType.SHOW_TOOLTIP_LITERAL, TooltipValueImpl.create(0, "abcdef\ndeeeeee"))));
		...
		// true, true, false, true, false, 0.0, TextAlignmentImpl
		// .create());
