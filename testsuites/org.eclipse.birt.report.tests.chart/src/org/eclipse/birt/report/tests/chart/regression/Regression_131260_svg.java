 ...
 * Test description:
 * <p>
 * Set interactivity-showTooltip to X Axis, and display string is "abcdef\ndeeeeee", verify if it will be take effect.
 * </p>
 */


public class Regression_131260_svg extends Composite implements
		IUpdateNotifier, SelectionListener {
	...
	public static final Chart showTooltip_BarChart() {
		...
		xAxisPrimary.getTriggers().add(
				TriggerImpl.create(TriggerCondition.ONMOUSEMOVE_LITERAL,
						ActionImpl.create(ActionType.SHOW_TOOLTIP_LITERAL,
								TooltipValueImpl.create(0, new String("abcdef\ndeeeeee")))));
