 ...
 * </p>
 * Title interactivity-showtooltip, has no place to set show value.
 * </p>
 * Test description:
 * <p>
 * Set interactivity showtooltip to a chart title, verify if the tooltip can be
 * showed.
 * </p>
 */

public final class Regression_119808 extends JPanel implements ICallBackNotifier, ComponentListener {
	...
	private final class ControlPanel extends JPanel implements ActionListener {
		...
		private final Regression_119808 siv;
	...
	public void callback(Object event, Object source, CallBackValue value) {
		JOptionPane.showMessageDialog(Regression_119808.this, value.getIdentifier());
	}
	...
	public static final Chart showTooltip_BarChart() {
		...
		cwaBar.getTitle().getTriggers().add(TriggerImpl.create(TriggerCondition.ONMOUSEMOVE_LITERAL,
				ActionImpl.create(ActionType.SHOW_TOOLTIP_LITERAL, TooltipValueImpl.create(0, "title"))));
