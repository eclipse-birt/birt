 ...
 * </p>
 * 3D line chart, set marker shape to special shape, interactivity can not take effect.
 * </p>
 * Test description:
 * <p>
 * 3D line chart, set marker shape to cross, set showTooltip to line chart y series, preivew, verify showtooltip can be take effect.
 * </p>
 */

public final class Regression_142403_swing extends JPanel implements ICallBackNotifier,
		ComponentListener {
	...
	public static final Chart create3DLineChart( )
	{
		...
		ls.getMarker( ).setType( MarkerType.CROSS_LITERAL );
		ls.getMarker().setSize(15);
		ls.getTriggers( )
