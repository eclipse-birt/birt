...
public class Regression_103787 extends ChartTestCase
{
	...
	private static String GOLDEN = "Regression_103787.jpg"; //$NON-NLS-1$
	private static String OUTPUT = "Regression_103787.jpg"; //$NON-NLS-1$
	...
	public void testRegression_103787( ) throws Exception
	{
		Regression_103787 st = new Regression_103787( );
	...
	public static final Chart createBarChart( )
	{
		...
		yAxisPrimary2.getTitle( ).setVisible( true );
		yAxisPrimary2.getTitle( ).getCaption( ).setValue( "The second Y Axis" );
		...
		bs2.setDataSet( dsNumericValues1 );
		bs2.setStacked( true );
