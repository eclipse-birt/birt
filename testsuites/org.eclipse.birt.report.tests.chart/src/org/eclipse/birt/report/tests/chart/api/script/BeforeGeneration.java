 ...
 * Test decription:
 * </p>
 * Chart script: beforeGeneration()
 * </p>
 */

public class BeforeGeneration extends ChartTestCase
{

	private static String OUTPUT = "BeforeGeneration.jpg"; //$NON-NLS-1$	
	...
	{
		BeforeGeneration st = new BeforeGeneration( );
	}

	/**
	 * Constructor
	 */
	public BeforeGeneration( )
	{
	...
	public static final Chart createPieChart( )
	{
		...
		cwoaPie
				.setScript( "function beforeGeneration( cm, icsc )" //$NON-NLS-1$
						...
						+ " cm.getLegend().getOutline( ).setStyle( LineStyle.DASH_DOTTED_LITERAL );" //$NON-NLS-1$
						+ " cm.getLegend().getOutline( ).setColor( ColorDefinitionImpl.GREEN() );" //$NON-NLS-1$
						+ " cm.getLegend().getOutline( ).setVisible( true );} " //$NON-NLS-1$
					);
