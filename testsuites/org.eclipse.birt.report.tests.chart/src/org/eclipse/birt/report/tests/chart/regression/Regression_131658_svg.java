 ...
 * Test description:
 * <p>
 * Set interactivity-Highlight Series to Meter chart, verify if it can be take effect
 * </p>
 */


public class Regression_131658_svg extends Composite implements
	...
	public static final Chart createMeterChart( )
	{
		...
		dChart.getTitle( ).getLabel( ).getCaption( ).setValue(
				"City Temperature" );
