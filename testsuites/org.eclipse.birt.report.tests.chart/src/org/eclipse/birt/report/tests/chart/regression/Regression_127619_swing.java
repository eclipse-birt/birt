...
public final class Regression_127619_swing extends JPanel implements ICallBackNotifier, ComponentListener {
	...
	public static void main(String[] args) {
		final Regression_127619_swing siv = new Regression_127619_swing();
	...
	private final class ControlPanel extends JPanel implements ActionListener {
		...
		private final Regression_127619_swing siv;

		ControlPanel(Regression_127619_swing siv) {
			this.siv = siv;
	...
	public void callback(Object event, Object source, CallBackValue value) {
		JOptionPane.showMessageDialog(Regression_127619_swing.this, value.getIdentifier());
	}
	...
	public static Chart showTooltip_BarChart() {
		...
		bs.getTriggers().add(TriggerImpl.create(TriggerCondition.ONMOUSEMOVE_LITERAL,
				ActionImpl.create(ActionType.SHOW_TOOLTIP_LITERAL, TooltipValueImpl.create(500, "abcdef\ndeeeeee"))));
