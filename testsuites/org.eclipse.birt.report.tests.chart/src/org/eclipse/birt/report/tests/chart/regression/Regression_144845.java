 ...
 * </p>
 * Shadow of title is overlap the text area
 * </p>
 * Test description:
 * </p>
 * Create a bar chart, set its legend title to "aaaaaaaaaa", background to cyan
 * shadow to yellow
 * </p>
 */

public class Regression_144845 extends ChartTestCase {

	private static String GOLDEN = "Regression_144845.jpg"; //$NON-NLS-1$
	...
	public static void main(String[] args) {
		new Regression_144845();
	}

	/**
	 * Constructor
	 */
	public Regression_144845() {
	...
	public static final Chart createBarChart() {
		...
		lg.getTitle().getCaption().setValue("aaaaaaaaaa");
		lg.getTitle().setBackground(ColorDefinitionImpl.CYAN());
		lg.getTitle().setShadowColor(ColorDefinitionImpl.YELLOW());
		lg.setTitlePosition(Position.LEFT_LITERAL);
		lg.getClientArea().setBackground(ColorDefinitionImpl.GREY());
		lg.getClientArea().setShadowColor(ColorDefinitionImpl.YELLOW());
