...
public class SWTToggleVisibilityViewer implements IUpdateNotifier, PaintListener,
		SelectionListener {
	...
	public static void main(String[] args) {
		...
		SWTToggleVisibilityViewer stViewer = new SWTToggleVisibilityViewer();
