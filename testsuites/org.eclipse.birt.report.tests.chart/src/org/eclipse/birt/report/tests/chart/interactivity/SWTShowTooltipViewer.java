 ...
 */
public final class SWTShowTooltipViewer extends Composite implements PaintListener, IUpdateNotifier, SelectionListener {
	...
	public static void main(String[] args) {
		...
		SWTShowTooltipViewer siv = new SWTShowTooltipViewer(shell, SWT.NO_BACKGROUND);
