 ...
 * </p>
 * Area interactivity-showtooltip, has no place to set show value
 * </p>
 * Test description:
 * <p>
 * Set interactivity showtooltip to a chart area, verify if the tooltip can be
 * showed.
 * </p>
 */

public final class Regression_119810_swing extends JPanel implements ICallBackNotifier, ComponentListener {
	...
	public static void main(String[] args) {
		final Regression_119810_swing siv = new Regression_119810_swing();
	...
	private final class ControlPanel extends JPanel implements ActionListener {
		...
		private final Regression_119810_swing siv;

		ControlPanel(Regression_119810_swing siv) {
			this.siv = siv;
	...
	public void callback(Object event, Object source, CallBackValue value) {
		JOptionPane.showMessageDialog(Regression_119810_swing.this, value.getIdentifier());
	}
	...
	public static final Chart showTooltip_BarChart() {
		...
		cwaBar.getPlot().getTriggers().add(TriggerImpl.create(TriggerCondition.ONMOUSEMOVE_LITERAL,
				ActionImpl.create(ActionType.SHOW_TOOLTIP_LITERAL, TooltipValueImpl.create(0, "ChartArea"))));
		...
		FontDefinition fd = FontDefinitionImpl.create("Arial", (float) 10.0, true, true, false, true, false, 0,
