 ...
 * Test description:
 * <p>
 * Set interactivity showtooltip to a chart area, verify if the tooltip can be showed. 
 * </p>
 */

public final class Regression_119810_swing extends JPanel implements ICallBackNotifier,
		ComponentListener {
	...
	public static final Chart showTooltip_BarChart() {
		...
		cwaBar.getPlot().getTriggers().add(
				TriggerImpl.create(TriggerCondition.ONMOUSEMOVE_LITERAL,
						ActionImpl.create(ActionType.SHOW_TOOLTIP_LITERAL,
								TooltipValueImpl.create(0, "ChartArea"))));
