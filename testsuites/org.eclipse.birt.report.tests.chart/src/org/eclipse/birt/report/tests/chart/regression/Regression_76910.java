 ...
 * </p>
 * Checkbox Strikethrough doesn't take effect
* </p>
 * Test description:
 * <p>
 * Set strikethrough format to chart title, render the chart
 * </p>
 */

public class Regression_76910 extends ChartTestCase{
	
	
	private static String GOLDEN = "Regression_76910.jpg"; //$NON-NLS-1$
    private static String OUTPUT = "Regression_76910.jpg"; //$NON-NLS-1$
	...
	public void testRegression_76910( ) throws Exception
	{
		Regression_76910 st = new Regression_76910( );
	...
	public static final Chart createBarChart() {
		...
		cwaBar.getTitle( ).getLabel( ).getCaption().setFont(FontDefinitionImpl.create("Arial", (float) 10.0,
				false, false, false, true, false, 0, TextAlignmentImpl
				.create()));
