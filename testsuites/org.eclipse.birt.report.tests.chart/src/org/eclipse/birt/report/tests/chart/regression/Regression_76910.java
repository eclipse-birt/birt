...
public class Regression_76910 extends ChartTestCase {
	...
	public static final Chart createBarChart() {
		...
		cwaBar.getTitle().getLabel().getCaption().setFont(FontDefinitionImpl.create("Arial", (float) 10.0, false, false,
				false, true, false, 0, TextAlignmentImpl.create()));
