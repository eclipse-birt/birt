 ...
 * </p>
 * SVG:Set Toggle DataPoint Visibility to Y series, can not take effect
 * </p>
 * Test description:
 * <p>
 * Create a bar chart and add interactivity Toggle DataPoint Visibility to its Y
 * series
 * </p>
 */

public class Regression_132620_svg extends Composite implements IUpdateNotifier, SelectionListener {
	...
	public static final Chart toggleVisibility_BarChart() {
		...
		bs.getTriggers().add(TriggerImpl.create(TriggerCondition.ONCLICK_LITERAL, ActionImpl
				.create(ActionType.TOGGLE_DATA_POINT_VISIBILITY_LITERAL, SeriesValueImpl.create("not-used"))));
