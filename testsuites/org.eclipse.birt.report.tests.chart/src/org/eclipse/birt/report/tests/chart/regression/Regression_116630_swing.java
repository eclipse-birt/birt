 ...
 * </p>
 * Meter chart can not support interactivity-ToggleVisibility
 * </p>
 * Test description:
 * </p>
 * Meter chart can support interactivity-ToggleVisibility
 * </p>
 */

public final class Regression_116630_swing extends JPanel implements ICallBackNotifier, ComponentListener {
	...
	private final class ControlPanel extends JPanel implements ActionListener {
		...
		private final Regression_116630_swing siv;

		ControlPanel(Regression_116630_swing siv) {
			this.siv = siv;
	...
	public void callback(Object event, Object source, CallBackValue value) {
		JOptionPane.showMessageDialog(Regression_116630_swing.this, value.getIdentifier());
	}
