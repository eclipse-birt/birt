...
public class Regression_119805 extends ChartTestCase{
	...
	public void testRegression_119805( ) throws Exception
	{
		Regression_119805 st = new Regression_119805( );
	...
	public static final Chart createScatterChart() {
		...
		// Y-Axis 1
		Axis yAxisPrimary1 = ((ChartWithAxesImpl) cwaScatter)
		...
		NumberDataSet dsNumericValues3 = NumberDataSetImpl.create(new double[] {
				15.0, -78.34, 4.86, 65.98, 98.56 });
