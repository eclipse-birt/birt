 ...
 * </p>
 * Sript: Set label outline thinkness, label can be changed to bolder
 * </p>
 * Test description:
 * <p>
 * Sript: Set label outline thinkness, view the chart, verify if the label is
 * changed to bolder.
 * </p>
 */

public class Regression_141214 extends ChartTestCase
{

	private static String GOLDEN = "Regression_141214.jpg"; //$NON-NLS-1$
	...
	{
		new Regression_141214( );
	}

	/**
	 * Constructor
	 */
	public Regression_141214( )
	{
