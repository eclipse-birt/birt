...
public class Regression_149936 extends ChartTestCase {
	...
	public static final Chart createAreaChart() {
		...
		// Title
		cwaArea.getTitle().getLabel().getCaption().setValue("Area Chart With Multi-Yseries"); //$NON-NLS-1$
		...
		xAxisPrimary.getMinorGrid().setLineAttributes(
				LineAttributesImpl.create(ColorDefinitionImpl.BLACK(), LineStyle.DASH_DOTTED_LITERAL, 2));
		xAxisPrimary.getMinorGrid()
				.setTickAttributes(LineAttributesImpl.create(ColorDefinitionImpl.RED(), LineStyle.SOLID_LITERAL, 1));
		...
		// Data Set
		TextDataSet dsStringValue = TextDataSetImpl.create(new String[] { "1145923200", "1145923800", "1145924400",
				"1145925000", "1145925600", "1145926200", "1145923200", "1145923800", "1145924400", "1145925000",
				"1145925600", "1145926200", "1145926800", "1145927400", "1145928000", "1145928600", "1145929200",
				"1145929800", "1145930400", "1145931000", "1145931600", "1145932200", "1145932800", "1145334000",
				"1145934000", "1145934600", "1145935200", "1145935800" });
		NumberDataSet dsNumericValues1 = NumberDataSetImpl.create(new double[] { 10, 10, 10, 10, 10, 10, 10, 10,
				1600000, 1800000, 1600000, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10 });
