...
public class Regression_106126 extends ChartTestCase
{
	...
	private static String GOLDEN = "Regression_106126.jpg"; //$NON-NLS-1$
	private static String OUTPUT = "Regression_106126.jpg"; //$NON-NLS-1$
	...
	public void testRegression_106126( ) throws Exception
	{
		Regression_106126 st = new Regression_106126( );
	...
	public static final Chart createBarChart( )
	{
		...
		// Title
		cwaBar.getTitle( ).getLabel( ).getCaption( ).setValue( "abc\ndef" ); //$NON-NLS-1$
