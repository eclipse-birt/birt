...
public abstract class Component
{
	...
	protected void initialize( IPartContainer parent, String uri, String type,
			String relationshipType ) throws IOException
	{
		this.initialize( parent, uri, type, relationshipType, true );
	}

	protected void initialize( IPartContainer parent, String uri, String type,
			String relationshipType, boolean needCache ) throws IOException
	{
