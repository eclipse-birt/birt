...
//	static final String REPORT_DESIGN_RESOURCE = "org/eclipse/birt/report/engine/api/render_performance.rptdesign";
	...
	public void testRenderOnTransientFile() throws Exception {
		...
		IReportDocument reportDoc = engine.openReportDocument(null, reader, new HashMap());
		assertTrue(reportDoc.getVersion().equals(ReportDocumentConstants.BIRT_ENGINE_VERSION));
...
//			System.out.println( "2");
	...
	/*
	 * public void testGetParametersAndVariables( ) throws EngineException { String
	 * file =
	 * "org/eclipse/birt/report/engine/api/parametersAndVariables.rptdocument";
	 * removeFile(REPORT_DOCUMENT ); copyResource(file, REPORT_DOCUMENT);
	 * ReportDocumentReader document = (ReportDocumentReader) engine
	 * .openReportDocument(REPORT_DOCUMENT); IRenderTask renderTask =
	 * engine.createRenderTask(document); HashMap<String, String> expectedParamters
	 * = new HashMap<String, String>(); expectedParamters.put("param1", "value1");
	 * expectedParamters.put("param2", "value2"); Map<String, String> parameters =
	 * renderTask.getParameterValues(); assertEquals( expectedParamters,
	 * parameters); HashMap<String, String> expectedVariables = new HashMap<String,
	 * String>(); renderTask.close(); }
	 */
	...
	private void testRenderPageCount(IReportDocument document, int expectedPageCount, String format,
			RenderItemSetter renderItemSetter) throws EngineException {
	...
	private boolean isRenderTaskCloseStreamOnExit(IReportDocument document, String format, boolean closeOnExit)
