...
public class GridItemDesignTest extends AbstractDesignTestCase
{
	...
	/**
	 * test case to test the parser,especially the capability to parse the Grid.
	 * To get the content about Grid from an external file and then compare the
	 * expected result with the real result of each property of DataSet. If they
	 * are the same,that means the IR is correct, otherwise, there exists errors
	 * in the parser.In this test, we also do some validation job focusing on
	 * element row and cell, assure their correctness no matter where they are.
	 */
