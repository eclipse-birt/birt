...
/*
	...
	public void testRunWithCorruptDocument( ) throws Exception
	{
		...
		ArchiveFile archive = new ArchiveFile( REPORT_DOCUMENT, "rw+" );
		ArchiveEntry entry = archive.getEntry( "/content/content.dat" );
		entry.setLength( entry.getLength( ) / 2 );
		archive.close( );
...
*/
	...
	protected void doTestIV( String originalDesign, String changedDesign )
			throws Exception
	{
	...
	static private class IVTask
	{
		...
		public void run( ) throws Exception
		{
			...
			IReportDocument doc = engine.openReportDocument( null, reader,
					new HashMap( ) );
