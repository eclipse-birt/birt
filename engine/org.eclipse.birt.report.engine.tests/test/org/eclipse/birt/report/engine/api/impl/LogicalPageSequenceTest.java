...
public class LogicalPageSequenceTest extends TestCase
{
	...
	public void testMerge( )
	{
		...
		assertEquals( "[200-300],[400-500],[600-700],[1000-1100]",
	...
	public void testGetLogicalPageNumber( )
	{
		LogicalPageSequence sequence = new LogicalPageSequence( new long[][]{
				new long[]{100, 199}, new long[]{300, 399}} );
	...
	public void testGetPhysicalPageSequence( )
	{
		...
		long[][] pages = sequence
				.getPhysicalPageNumbers( new long[][]{new long[]{1, 200}} );
		assertEquals( "[100-199],[300-399]", toString( pages ) );
		pages = sequence.getPhysicalPageNumbers( new long[][]{
				new long[]{10, 20}, new long[]{99, 102}, new long[]{200, 200}} );
		assertEquals( "[109-119],[198-199],[300-301],[399-399]",
				toString( pages ) );
	}
