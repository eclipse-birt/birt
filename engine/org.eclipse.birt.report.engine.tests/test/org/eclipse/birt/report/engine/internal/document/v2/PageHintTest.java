...
public class PageHintTest extends EngineCase
{
	...
	protected ArrayList createPageHintV1( )
	{
		...
		for ( int i = 0; i < 2; i++ )
		{
			...
			section.starts = new InstanceIndex[]{new InstanceIndex( InstanceID
					.parse( "/3" ), 100 )};
			section.ends = new InstanceIndex[]{new InstanceIndex( InstanceID
					.parse( "/4" ), 100 )};
	...
	protected void checkPageHintV0( IPageHint hint, long number, long offset,
			long start, long end )
	{
