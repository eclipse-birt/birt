...
public class TableItemDesignTest extends AbstractDesignTestCase
{
	...
	/**
	 * test case to test the parser,especially the capability to parse the
	 * Table. To get the content about Table from an external file and then
	 * compare the expected result with the real result of some basic properties
	 * of DataSet. If they are the same,that means the IR is correct, otherwise,
