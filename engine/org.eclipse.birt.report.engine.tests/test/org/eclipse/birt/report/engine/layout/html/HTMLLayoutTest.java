...
public class HTMLLayoutTest extends EngineCase
{
	...
	/**
	 * Check there are 2 bookmarks with name <code>bookmark</code> int the
	 * document. And there are both in the specified page.
	 * 
	 * @param document
	 * @param bookmark
	 */
	private void checkBookmark( IReportDocument document, String bookmark,
			long pageNumber )
	{
