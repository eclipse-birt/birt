...
public class ParameterConverterTest extends TestCase {
	...
	public void testDateFormat() {
		...
		assertEquals(true, rpc.format(date).startsWith("September 13, 1998 at 8:01:44 PM PDT"));
	...
	public void testOtherFormat() {
		...
		assertEquals(number.format(1002.234), rpc.format(new Double(1002.234)));
		...
		assertEquals(number.format(1002.20), rpc.format(new Double(1002.20)));
		assertEquals(number.format(-1002.2), rpc.format(new Double(-1002.2)));
		assertEquals(number.format(0.004), rpc.format(new Double(0.004)));
		assertEquals(number.format(0.004123456), rpc.format(new Double(0.004123456)));
		assertEquals(number.format(-0.004), rpc.format(new Double(-0.004)));
		...
		assertEquals(number.format(1290.8889), rpc.format(new Double(1290.8889)));
		...
		assertEquals("-0.00", rpc.format(new Double(-0.004)));
		assertEquals("3,333,333,333.33", rpc.format(new Double(3333333333.33)));
		...
		assertEquals("-0.40%", rpc.format(new Double(-0.004)));
		assertEquals("333333333333.00%", rpc.format(new Double(3333333333.33)));
		assertEquals("0.00%", rpc.format(new Double(0)));
		...
		assertEquals("0.41 %", rpc.format(new Double(0.004123456)));
		assertEquals("-0.40 %", rpc.format(new Double(-0.004)));
		assertEquals("333,333,333,333.00 %", rpc.format(new Double(3333333333.33)));
		assertEquals("0.00 %", rpc.format(new Double(0)));
	...
	public void testParseToString() {
		...
		rpc = new ReportParameterConverter("@@@@", locale);
		assertEquals("1234fggggg", rpc.parse("1234fggggg", IScalarParameterDefn.TYPE_STRING));
		rpc = new ReportParameterConverter("@@@@!", locale);
		assertEquals("1234fggggg", rpc.parse("1234fggggg", IScalarParameterDefn.TYPE_STRING));

		rpc = new ReportParameterConverter("@@@@!", locale);
		assertEquals("123", rpc.parse("123 ", IScalarParameterDefn.TYPE_STRING));
		rpc = new ReportParameterConverter("@@@@!!!", locale);
		assertEquals("123", rpc.parse("123 ", IScalarParameterDefn.TYPE_STRING));
		rpc = new ReportParameterConverter("@@@@", locale);
		assertEquals("123456", rpc.parse("123456", IScalarParameterDefn.TYPE_STRING));
		rpc = new ReportParameterConverter("@@@@!", locale);
		assertEquals("123456", rpc.parse("123456", IScalarParameterDefn.TYPE_STRING));
		rpc = new ReportParameterConverter("(@@)@@@", locale);
		assertEquals("123", rpc.parse("(  )123", IScalarParameterDefn.TYPE_STRING));
		...
		rpc = new ReportParameterConverter("@@@@@aaa!", locale);
		assertEquals("123", rpc.parse("123  aaa", IScalarParameterDefn.TYPE_STRING));
		rpc = new ReportParameterConverter("@@@&&aaa!", locale);
		assertEquals("123  ", rpc.parse("123  aaa", IScalarParameterDefn.TYPE_STRING));
		rpc = new ReportParameterConverter("@@aaa!", locale);
		assertEquals("123", rpc.parse("12aaa3", IScalarParameterDefn.TYPE_STRING));
		rpc = new ReportParameterConverter("@@@@@aaa>!", locale);
		assertEquals("123", rpc.parse("123", IScalarParameterDefn.TYPE_STRING));
		...
		assertEquals("123", rpc.parse("123", IScalarParameterDefn.TYPE_STRING));
		rpc = new ReportParameterConverter(">", locale);
		assertEquals("123aaA", rpc.parse("123aaA", IScalarParameterDefn.TYPE_STRING));

		rpc = new ReportParameterConverter("***\"!", locale);
		assertEquals("123", rpc.parse("***\"123", IScalarParameterDefn.TYPE_STRING));
		rpc = new ReportParameterConverter("***&YY&&&!", locale);
		assertEquals("123 ", rpc.parse("***1YY23", IScalarParameterDefn.TYPE_STRING));
		rpc = new ReportParameterConverter("***&YY@@@!", locale);
		assertEquals("123", rpc.parse("***1YY23 ", IScalarParameterDefn.TYPE_STRING));
		// test for SSN
		rpc = new ReportParameterConverter("@@@-@@-@@@@!", locale);
		assertEquals("6000003274", rpc.parse("600-00-03274", IScalarParameterDefn.TYPE_STRING));
		// test for zipcode+4
		rpc = new ReportParameterConverter("@@@@@-@@@@!", locale);
		assertEquals("943050110", rpc.parse("94305-0110", IScalarParameterDefn.TYPE_STRING));
		rpc = new ReportParameterConverter("@@@@@-@@@@", locale);
		assertEquals("943050110", rpc.parse("94305-0110", IScalarParameterDefn.TYPE_STRING));
		// test for zipcode
		rpc = new ReportParameterConverter("@@@@@!", locale);
		assertEquals("94305", rpc.parse("94305", IScalarParameterDefn.TYPE_STRING));
		rpc = new ReportParameterConverter("@@@@@", locale);
		assertEquals("94305", rpc.parse("94305", IScalarParameterDefn.TYPE_STRING));
		// test for phonenumber
		rpc = new ReportParameterConverter("(@@@)-@@@-@@@@!", locale);
		assertEquals("6508372345", rpc.parse("(650)-837-2345", IScalarParameterDefn.TYPE_STRING));
		rpc = new ReportParameterConverter("(@@@)-@@@-@@@@", locale);
		assertEquals("6508372345", rpc.parse("(650)-837-2345", IScalarParameterDefn.TYPE_STRING));
		rpc = new ReportParameterConverter("(@@@)-@@@-@@@@!", locale);
		assertEquals("65083723456", rpc.parse("(650)-837-23456", IScalarParameterDefn.TYPE_STRING));
		rpc = new ReportParameterConverter("(@@@)-@@@-@@@@", locale);
		assertEquals("346508372345", rpc.parse("34(650)-837-2345", IScalarParameterDefn.TYPE_STRING));
	}
	...
	public void testParseToDate() {
		...
		locale = Locale.ITALY;
		rpc = new ReportParameterConverter("MM/dd/yy KK:mm aa", locale);
		assertEquals(date, rpc.parse("09/13/98 08:01 pm", IScalarParameterDefn.TYPE_DATE_TIME));
		...
		locale = Locale.ITALY;
		rpc = new ReportParameterConverter("Long Date", locale);
		assertEquals(date, rpc.parse("13 settembre 1998", IScalarParameterDefn.TYPE_DATE_TIME));
		...
		date = dateCal.getTime();
		rpc = new ReportParameterConverter("MM/dd/yyyy hh:mm:ss a", locale);
		assertEquals(date, rpc.parse("09/13/1998 08:01:44 PM", IScalarParameterDefn.TYPE_DATE_TIME));
		...
		assertEquals("2005-05-06", converter.parse(date1, IScalarParameterDefn.TYPE_DATE).toString());
		assertEquals("03:45:25", converter.parse(date1, IScalarParameterDefn.TYPE_TIME).toString());
	}
	...
	public void testParseToOther() {
		...
		ReportParameterConverter rpc;
		rpc = new ReportParameterConverter("#.0#", locale);
		assertEquals(new Double(1002.2), rpc.parse("1002.2", IScalarParameterDefn.TYPE_FLOAT));

		rpc = new ReportParameterConverter("$###,##0.00;'Negative'", locale);
		assertEquals(new BigDecimal("2139.3"), rpc.parse("$2,139.30", IScalarParameterDefn.TYPE_DECIMAL));
		assertEquals(new BigDecimal(-2000), rpc.parse("Negative2,000.00", IScalarParameterDefn.TYPE_DECIMAL));
		assertEquals(new BigDecimal(2000), rpc.parse("$2,000.00", IScalarParameterDefn.TYPE_DECIMAL));
		assertEquals(new BigDecimal("-2.13"), rpc.parse("Negative2.13", IScalarParameterDefn.TYPE_DECIMAL));

		rpc = new ReportParameterConverter(null, locale);
		assertEquals(new Boolean(true), rpc.parse("true", IScalarParameterDefn.TYPE_BOOLEAN));
		assertEquals(new Boolean(false), rpc.parse("false", IScalarParameterDefn.TYPE_BOOLEAN));
	}
	...
	public void testBigDecimal() {
		...
		ReportParameterConverter rpc;
		rpc = new ReportParameterConverter(null, locale);
		assertEquals(new BigDecimal("123456.789012"), rpc.parse("123456,789012", IScalarParameterDefn.TYPE_DECIMAL));
	...
	public void testFloat() {
		...
		ReportParameterConverter rpc;
		rpc = new ReportParameterConverter(null, locale);
		assertEquals(new Double("123456.789012"), rpc.parse("123456,789012", IScalarParameterDefn.TYPE_FLOAT));

		assertEquals("123456,789012", rpc.format(new Double("123456.789012")));
