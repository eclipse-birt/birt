...
abstract public class TOCTestCase extends EngineCase
{
	...
	protected void createEntry( TOCBuilder builder, TOCEntry parent,
			String name, String hiddenFormats )
	{
	...
	protected TOCEntry startEntry( TOCBuilder builder, TOCEntry parent,
			String name )
	{
	...
	protected TOCEntry startGroupEntry( TOCBuilder builder, TOCEntry parent,
			String name )
	{
	...
	protected TOCEntry startDummyEntry( TOCBuilder builder, TOCEntry parent,
	...
	protected ITreeNode createTree( )
	{
...

		{
			...
			{
				TOCEntry group21Header = startEntry( builder, group,
						"list-group-header" );
				...
				TOCEntry group21Footer = startEntry( builder, group,
						"group-footer" );
	...
	void outputTOCNode( StringBuffer buffer, TOCNode node, int level,
			boolean withStyle )
	{
		String nodeId = node.getNodeID( );
