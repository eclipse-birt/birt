	...
	public void startTable(HandlerState state, ITableContent table) throws BirtException {
		...
		if ((tableHandler != null) && (tableHandler.getColumnCount() == colSpan)
			...
			if (contentCollection != null) {
				contentCollection.forEach((itemDesign) -> {
					// set the nested table flag, if it set to true, no reset to false offered
					if (!containsTable && (itemDesign instanceof GridItemDesign || itemDesign instanceof TableItemDesign
