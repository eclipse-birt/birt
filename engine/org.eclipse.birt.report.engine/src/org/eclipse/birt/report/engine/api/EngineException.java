...
public class EngineException extends BirtException {
	...
	static protected UResourceBundle dftRb = new EngineResourceHandle(ULocale.getDefault()).getUResourceBundle();
	...
	public String getMessage() {
		...
		/*
		 * if ( message.length( ) > 0 && elementId >= 0 ) { message.append( " (" );
		 * message.append( EngineResourceHandle.getInstance( ) .getMessage(
		 * MessageConstants.ELEMENT_ID ) ); message.append( ":" ); message.append(
		 * elementId ); message.append( ")" ); }
		 */
