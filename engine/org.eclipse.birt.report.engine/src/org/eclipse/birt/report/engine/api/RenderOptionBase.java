 ...
 * include format of the request, whether to render HTML with style sheet, etc. 
 * Potential future options includes image formats in PDF (vector or bitmap), 
 * font embedding options, etc. 
 * <p>
 * The predefined options strings are what BIRT supports. Other options are available
 * depending on custom extensions. 
 */
public class RenderOptionBase implements IRenderOption {
	...
	public String getOutputFormat() {
		return getOption(OUTPUT_FORMAT);
	}
