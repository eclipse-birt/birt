...
public class CssParser implements CssParserConstants {
        ...
        /** The logger */
        private static org.apache.commons.logging.Log logger = org.apache.commons.logging.LogFactory.getLog(CssParser.class);
...
StringBuffer value;
    try {
     ...
     logger.error("The css statement is:"+cssStatement,ex);
     skipTo(SEMICOLON);
    }
  }
    ...
    case FUNCTION:
      ...
      case DIMEN:
        n = jj_consume_token(DIMEN);
                           logger.error("Unknown dimension:"+n.image);
        break;
      case FUNCTION:
        func = function();
                               value.append(func);
