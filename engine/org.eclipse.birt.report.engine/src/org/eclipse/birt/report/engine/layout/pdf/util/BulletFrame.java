...
public class BulletFrame
{
	...
	public static final char UPPER_ALPHA_CHARS[] = {0x0061, 0x0062, 0x0063,
			0x0064, 0x0065, // A
			// B
			// C
			// D
	...
	public static final char LOWER_ALPHA_CHARS[] = {0x0041, 0x0042, 0x0043,
			0x0044, 0x0045, // A
			// B
			// C
			// D
	...
	static
	{
		...
		TYPES.put( CSS_LISTSTYLETYPE_LOWERLATINC_VALUE, LIST_STYLE_UPPERLATIN );
		TYPES.put( CSS_LISTSTYLETYPE_UPPERLATIN_VALUE, LIST_STYLE_LOWERLATIN );
