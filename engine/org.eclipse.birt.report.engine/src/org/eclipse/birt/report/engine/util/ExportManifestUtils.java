...
public class ExportManifestUtils {
	...
	static final String[] API_JAR_PATTERNS = { "chartengineapi.jar", "com.ibm.icu.*.jar",
			...
			"scriptapi.jar", "modelodaapi.jar", "odadesignapi.jar", "javax.servlet_.*.jar", "javax.servlet.jsp_.*.jar",
			"org.eclipse.birt.report.engine.dataextraction_*.jar", "dataaggregationapi.jar", "emitterconfig.jar" };
