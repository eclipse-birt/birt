...
public interface ICell extends IDesignElement {
	...
	/**
	 * Gets the thickness of the diagonal line that is from top-left to bottom-right
	 * corner. Besides the dimension value,the value can be one of constants defined
	 ...
	 * user. Besides the dimension value,the value can be one of constants defined
	 * in <code>DesignChoiceConstatns</code>:
	 * <ul>
	 * <li><code>LINE_WIDTH_THIN</code>
	 * <li><code>LINE_WIDTH_MEDIUM</code>
	 ...
	 * </ul>
	 * 
	 * @param thickness the diagonal thickness with optional unit suffix.
	 * @throws ScriptException
	 */
	 ...
	 * </ul>
	 * 
	 * @param thickness the anti-diagonal thickness with optional unit suffix.
	 * @throws ScriptException
	 * 
	 */
