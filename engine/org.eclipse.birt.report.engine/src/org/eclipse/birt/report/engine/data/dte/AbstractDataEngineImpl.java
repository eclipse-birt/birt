...
public abstract class AbstractDataEngineImpl implements IDataEngine 
{
	...
	public AbstractDataEngineImpl( DataEngineFactory factory, ExecutionContext context ) throws BirtException
	{
	...
	public IBaseResultSet execute(IBaseResultSet parent, IDataQueryDefinition query, Object queryOwner, boolean useCache)
	...
	protected abstract IBaseResultSet doExecuteQuery(IBaseResultSet parent, IQueryDefinition query,
			Object queryOwner, boolean useCache) throws BirtException;

	protected abstract IBaseResultSet doExecuteCube(IBaseResultSet parent, ICubeQueryDefinition query,
			Object queryOwner, boolean useCache) throws BirtException;
	...
	public abstract String getResultID(String parent, String rawId, String queryId);
