...
public class BIRTPropertyManagerFactory implements PropertyManagerFactory {
	...
	public BIRTPropertyManagerFactory() {
		...
		vms[StyleConstants.STYLE_TEXT_OVERLINE] = new BooleanManager(BIRTConstants.BIRT_TEXT_OVERLINE_PROPERTY, true,
				false);
		vms[StyleConstants.STYLE_TEXT_UNDERLINE] = new BooleanManager(BIRTConstants.BIRT_TEXT_UNDERLINE_PROPERTY, true,
				false);
		...
		vms[StyleConstants.STYLE_TEXT_LINETHROUGH] = new BooleanManager(BIRTConstants.BIRT_TEXT_LINETHROUGH_PROPERTY,
				true, false);
