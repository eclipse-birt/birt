 ...
 * where the report generation and rendering process are globally customized. 
 * It is also the place where engine statistics are collected. Through report 
 ...
 * report generation. 
 * <p>
 * Engine supports running different types of tasks. Example tasks include running 
 * a report design to generate a report instance file, rendering a report instance to 
 * output format, running a report directly to output, running a dataset for preview,
 * seaching a report, etc.
 */
...
public class ReportEngine {
	 ...
	 * For a simple report with no images and links, engine will run without complaining.
	 * If the report has image/chart defined, the engine has to be configured with 
	 * relevant image and chart handlers.  
	 * 
	...
	/**
	 * creates a report design runnable based on a report design handle, from ehich
	 * embedded images and parameter definitions can be retrieved.
	 * 
	 * @param designHandle the report design handle created by the design engine  
	 * @return a report design runnable object
	 * @throws EngineException throwed when the input stream is null, or the 
	 * stream does not yield a valid report design
	 */
	...
	/**
	 * opens a report document file and creates a report instance handle. From the report instance
	 * object, report can be exported to different output formats.  
	 * 
	 * @param reportDocName report document file name
	 * @return a report instance handle
	 * @throws EngineException throwed when the file does not exist or the file is not a valid 
	 * report document 
	 */
	/*public ReportDocument openReportDocument(String reportDocName) throws EngineException
	{
		return null;
	}*/
