...
public class AttributeBuilderTest extends TestCase
{
	...
	public void testBuildPos( )
	{
		...
		assertEquals(
				"position: relative; left: 1mm; top: 2mm; width: 3mm; height: 4mm;", //$NON-NLS-1$
...
/*		StyleDeclaration style = new StyleDeclaration( );
		style.put( Style.BORDER_BOTTOM_COLOR_PROP, "gray" ); //$NON-NLS-1$
		style.put( Style.BORDER_BOTTOM_WIDTH_PROP, "2.0pt" ); //$NON-NLS-1$
		style.put( Style.BORDER_BOTTOM_STYLE_PROP, "dotted" ); //$NON-NLS-1$

		style.put( Style.BACKGROUND_COLOR_PROP, "black" ); //$NON-NLS-1$

		style.put( Style.FONT_FAMILY_PROP, "times new roman" ); //$NON-NLS-1$
		style.put( Style.COLOR_PROP, "red" ); //$NON-NLS-1$
		style.put( Style.FONT_SIZE_PROP, "12.0pt" ); //$NON-NLS-1$
		style.put( Style.FONT_WEIGHT_PROP,
				EngineIRConstants.FONT_WEIGHT_BOLD );
		style.put( Style.TEXT_LINE_THROUGH_PROP, "line-through" ); //$NON-NLS-1$
		style.put(Style.TEXT_UNDERLINE_PROP, "underline" ); //$NON-NLS-1$

		style.put( Style.PADDING_TOP_PROP, "1.0mm" ); //$NON-NLS-1$
		style.put( Style.PADDING_RIGHT_PROP, "2.0mm" ); //$NON-NLS-1$
		style.put( Style.PADDING_BOTTOM_PROP, "3.0mm" ); //$NON-NLS-1$
		style.put( Style.PADDING_LEFT_PROP, "4.0mm" ); //$NON-NLS-1$
		StringBuffer content = new StringBuffer( );

		AttributeBuilder.buildStyle( content, style, null );

		assertEquals(
				" font-family: times new roman; font-weight: bold; font-size: 12.0pt; text-decoration: line-through underline; padding-top: 1.0mm; padding-right: 2.0mm; padding-bottom: 3.0mm; padding-left: 4.0mm; border-bottom: 2.0pt dotted gray; color: red; background-color: black;", //$NON-NLS-1$
				content.toString( ) );
*/	}
}