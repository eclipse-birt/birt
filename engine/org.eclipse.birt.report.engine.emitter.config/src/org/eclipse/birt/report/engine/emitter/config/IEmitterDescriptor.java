...
public interface IEmitterDescriptor
{
	...
	/**
	 * Sets the init parameters for this descriptor. This method is always
	 * called right after the instantiation and before any other method call.
	 * Note if no init parameter defined, this method may not get called. This
	 * method should only be called by the
	 * <code>IEmitterConfigurationManager</code>.
	 */
