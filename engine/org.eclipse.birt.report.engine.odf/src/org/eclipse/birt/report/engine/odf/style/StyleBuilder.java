...
public class StyleBuilder
{
	...
	public static StyleEntry createStyleEntry( IStyle style, int type, StyleEntry parent )
	{
		...
		entry.setProperty( StyleConstant.FONT_FAMILY_PROP, OdfUtil
		...
		entry.setProperty( StyleConstant.TEXT_OVERLINE_PROP, "overline"
				.equalsIgnoreCase( style.getTextOverline( ) ) );
