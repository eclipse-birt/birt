...
import org.eclipse.birt.report.data.oda.pojo.input.InputFileOpener;
...
public class PojoQueryParserTest extends TestCase
{
	...
	public void testBasicParse( ) throws IOException, OdaException
	{
		...
		assertEquals( query.getDataSetClass( ), "org.eclipse.birt.report.data.oda.pojo.input.TeacherDataSet" );
