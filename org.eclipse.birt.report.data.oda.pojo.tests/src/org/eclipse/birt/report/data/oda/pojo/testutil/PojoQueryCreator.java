 ...
 *******************************************************************************/
package org.eclipse.birt.report.data.oda.pojo.testutil;
...
public class PojoQueryCreator
{
	...
	public static PojoQuery createWithA1tonMap( )
	{
		...
		IColumnsMapping cm = new OneColumnMapping( new MethodSource("getId", null), new Column("StudentId", "Integer", 5 ) ) ;
		ccm.addColumnsMapping( cm );
	...
	public static PojoQuery createWithParameters( )
	{
		...
		ClassColumnMappings ccm = new ClassColumnMappings( new MethodSource("getStudents", new IMethodParameter[]{
		...
		IColumnsMapping cm = new OneColumnMapping( new MethodSource("getId", null), new Column("StudentId", "Integer", 2 ) ) ;
		ccm.addColumnsMapping( cm );
		cm = new OneColumnMapping( new MethodSource("getName", null), new Column("StudentName", "String", 3 ) ) ;
		ccm.addColumnsMapping( cm );
		query.addColumnsMapping( ccm );
		
		ccm = new ClassColumnMappings( new MethodSource("getStudentById", new IMethodParameter[]{
				new VariableParameter( "id", Constants.PARAM_TYPE_int )}));
