    ...
    implements ILaunchConfigurationTab, IReportLauncherSettings
{
    ...
    public ReportAdvancedLauncherTab(boolean showFeatures)
    {
        ...
        fWorkspaceModels = ResourcesPlugin.getPlugin().getWorkspace().getRoot().getProjects();
    }
    ...
    public void createControl(Composite parent)
    {
        ...
        WorkbenchHelp.setHelp(composite, "org.eclipse.pde.doc.user.launcher_advanced");
    }
    ...
    private void createPluginViewer(Composite composite)
    {
        ...
        fWorkspacePlugins = new NamedElement(PDEPlugin.getResourceString("AdvancedLauncherTab.workspacePlugins"), pluginsImage);
    }
        ...
        throws CoreException
    {
        ...
        for(int i = 0; i < fWorkspaceModels.length; i++)
            if(deselected.contains(fWorkspaceModels[i].getName()) && fPluginTreeViewer.setChecked(fWorkspaceModels[i], false))
                fNumWorkspaceChecked--;
