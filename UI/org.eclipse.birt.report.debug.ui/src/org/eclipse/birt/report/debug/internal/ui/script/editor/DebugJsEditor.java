...
public class DebugJsEditor extends DecoratedScriptEditor
{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.birt.report.designer.ui.editor.script.DecoratedScriptEditor#createPartControl(org.eclipse.swt.widgets.Composite)
	 */
	public void createPartControl( Composite parent )
	{
		Font font = parent.getFont( );
		Composite composite = ScriptSWTFactory.createComposite( parent,
				font,
				1,
				1,
		...
		Composite header = ScriptSWTFactory.createComposite( composite,
				font,
				2,
				1,
				GridData.FILL_HORIZONTAL,
		...
		if ( getEditorInput( ) != null && getViewer( ) != null )
		{
			getViewer( ).getTextWidget( )
					.setEnabled( ( (DebugJsInput) getEditorInput( ) ).sourceAvailable( ) );
		}
	...
	protected void doSetInput( IEditorInput input ) throws CoreException
	{
		...
		provider.setFileName( ( (DebugJsInput) input ).getFile( )
				.getAbsolutePath( ) );
		...
		{
			getViewer( ).getTextWidget( )
					.setEnabled( ( (DebugJsInput) input ).sourceAvailable( ) );
		}
	}
	...
	private String getLabelMessage( )
	{
		...
		Object obj = ModuleUtil.getScriptObject( jsInput.getModuleHandle( ),
				jsInput.getId( ) );
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.birt.report.designer.ui.editor.script.DecoratedScriptEditor#createScriptInput(java.lang.String)
	 */
