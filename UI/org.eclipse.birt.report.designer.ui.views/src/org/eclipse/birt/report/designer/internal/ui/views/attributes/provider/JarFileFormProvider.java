...
import org.eclipse.birt.report.designer.internal.ui.dialogs.resource.AddJarResourceFileFolderSelectionDialog;
...
public class JarFileFormProvider extends AbstractFormHandleProvider
{
	...
	public boolean doAddItem( int pos ) throws Exception
	{
		...
		AddJarResourceFileFolderSelectionDialog dialog = new AddJarResourceFileFolderSelectionDialog( );
