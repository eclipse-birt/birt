		...
		Listener
{
	...
	public Control createControl( Composite parent )
	{
		...
		if ( isFormStyle( ) )
			...
			table = new Table( formPanel, SWT.SINGLE
					| SWT.BORDER
					| SWT.H_SCROLL
					| SWT.V_SCROLL
					| SWT.FULL_SELECTION );
	...
	private void moveItem( int oldPos, int newPos )
	{
		try
		{
			( (IFormProvider) getDescriptorProvider( ) ).doMoveItem( oldPos,
					newPos );
		}
		catch ( Exception e )
		{
			...
			ITableLabelProvider
	{
		...
		{
			return ( (IFormProvider) getDescriptorProvider( ) ).getColumnText( element,
					columnIndex );
		}
	}
	...
	private class FormCellModifier implements ICellModifier
	{
		...
		public boolean canModify( Object element, String property )
		{
			return ( (IFormProvider) getDescriptorProvider( ) ).canModify( element,
					property );
		}
		...
		{
			return ( (IFormProvider) getDescriptorProvider( ) ).getValue( element,
					property );
		}
		...
		public void modify( Object element, String property, Object value )
		{
			...
			try
			{
				( (AbstractFormHandleProvider) getDescriptorProvider( ) ).transModify( item.getData( ),
						property,
						value );
			}
			catch ( Exception e )
