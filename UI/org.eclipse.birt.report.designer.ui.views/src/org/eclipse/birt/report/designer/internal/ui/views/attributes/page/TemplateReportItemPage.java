...
public class TemplateReportItemPage extends AttributePage
{
	...
	public void buildUI( Composite parent  )
	{
		...
		TextPropertyDescriptorProvider nameProvider = new TextPropertyDescriptorProvider( TemplateReportItemHandle.NAME_PROP,
		...
		TextSection descriptionSection = new TextSection( descriptionProvider.getDisplayName( ),
				container,
				true );
		descriptionSection.setStyle( SWT.MULTI
				| SWT.WRAP
				| SWT.H_SCROLL
				| SWT.V_SCROLL );
