...
public class ColorBuilder extends Composite
{
	...
	private void initColorBuilder( Composite parent, int style,
			boolean isFormStyle )
	{
	 ...
	 * changed ); Point tableSize = colorSelector.getButton( ).computeSize(
	 * wHint, SWT.DEFAULT, changed ); int borderWidth = getBorderWidth( );
	 * 
