 ...
 * 
 */
public class SortingFormPropertyDescriptor extends PropertyDescriptor implements
		IFastConsumerProcessor
{
	...
	private void createTableViewer( )
	{
		...
		tableViewer.setContentProvider( ( (AbstractSortingFormHandleProvider) getDescriptorProvider( ) ).getFormContentProvider( this,
	...
	public void postElementEvent( )
	{
		...
		{
			if ( ( (ISortingFormProvider) getDescriptorProvider( ) ).needRefreshed( ( (ModelEventInfo) eventList.get( 0 ) ).getEvent( ) ) )
			{
