...
public class CategoryProviderFactory implements ICategoryProviderFactory
{
	...
	protected class CategoryHolder
	{
		...
		public CategoryHolder( String[] key, String[] label,
				Class<?>[] pageClass )
		{
			this.keys = key;
			this.labels = label;
		...
		/**
		 * Replaces an existing entry of given key with new label and new page
		 * class.
		 * 
		 * @param targetKey
		 * @param label
		 ...
		 * @param pageClass
		 */
		public void insertBefore( String beforeKey, String key, String label,
				Class<?> pageClass )
		{
	...
	protected CategoryHolder getCategories( String elementName )
	{
		if ( ReportDesignConstants.CELL_ELEMENT.equals( elementName ) )
		{
			return new CategoryHolder( new String[]{
					...
					new String[]{
							Messages.getString( "CellPageGenerator.List.General" ), //$NON-NLS-1$
		...
		if ( ReportDesignConstants.COLUMN_ELEMENT.equals( elementName ) )
		{
			return new CategoryHolder( new String[]{
					...
					new String[]{
							Messages.getString( "ColumnPageGenerator.List.General" ), //$NON-NLS-1$
		...
		if ( ReportDesignConstants.DATA_ITEM.equals( elementName ) )
		{
			return new CategoryHolder( new String[]{
					...
					new String[]{
							Messages.getString( "DataPageGenerator.List.General" ), //$NON-NLS-1$
		...
		if ( ReportDesignConstants.IMAGE_ITEM.equals( elementName ) )
		{
			return new CategoryHolder( new String[]{
					...
					new String[]{
							Messages.getString( "ImagePageGenerator.List.General" ), //$NON-NLS-1$
		...
		if ( ReportDesignConstants.LABEL_ITEM.equals( elementName ) )
		{
			return new CategoryHolder( new String[]{
					...
					new String[]{
							Messages.getString( "LabelPageGenerator.List.General" ), //$NON-NLS-1$
		...
		if ( ReportDesignConstants.LIST_ITEM.equals( elementName ) )
		{
			return new CategoryHolder( new String[]{
					...
					new String[]{
							Messages.getString( "ListPageGenerator.List.General" ), //$NON-NLS-1$
		...
		if ( ReportDesignConstants.ROW_ELEMENT.equals( elementName ) )
		{
			return new CategoryHolder( new String[]{
					...
					new String[]{
							Messages.getString( "RowPageGenerator.List.General" ), //$NON-NLS-1$
		...
		if ( ReportDesignConstants.SCALAR_PARAMETER_ELEMENT.equals( elementName ) )
		{
			return new CategoryHolder( new String[]{
					...
					new String[]{
							Messages.getString( "ScalarParameterPageGenerator.List.General" ), //$NON-NLS-1$
		...
		if ( ReportDesignConstants.PARAMETER_GROUP_ELEMENT.equals( elementName ) )
		{
			return new CategoryHolder( new String[]{
					...
					new String[]{
							Messages.getString( "TextPageGenerator.List.General" ), //$NON-NLS-1$
							Messages.getString( "ScalarParameterPageGenerator.List.I18n" ), //$NON-NLS-1$
							Messages.getString( "ReportPageGenerator.List.Comments" ), //$NON-NLS-1$
							Messages.getString( "ReportPageGenerator.List.UserProperties" ), //$NON-NLS-1$
							Messages.getString( "ReportPageGenerator.List.NamedExpressions" ), //$NON-NLS-1$
		...
		if ( ReportDesignConstants.AUTOTEXT_ITEM.equals( elementName ) )
		{
			return new CategoryHolder( new String[]{
					...
					new String[]{
							Messages.getString( "AutoTextPageGenerator.List.General" ), //$NON-NLS-1$
	...
	protected CategoryHolder getCategories( DesignElementHandle handle )
	{
		...
		if ( handle instanceof DataSetHandle )
		{
			return new CategoryHolder( new String[]{
					...
					new String[]{
							Messages.getString( "DataSetPageGenerator.List.General" ), //$NON-NLS-1$
							Messages.getString( "ReportPageGenerator.List.Comments" ), //$NON-NLS-1$
							Messages.getString( "ReportPageGenerator.List.AdvancedProperty" ), //$NON-NLS-1$
					},
					new Class[]{
		...
		if ( handle instanceof DataSourceHandle )
		{
			return new CategoryHolder( new String[]{
					...
					new String[]{
							Messages.getString( "DataSourcePageGenerator.List.General" ), //$NON-NLS-1$
							Messages.getString( "ReportPageGenerator.List.Comments" ), //$NON-NLS-1$
							Messages.getString( "ReportPageGenerator.List.AdvancedProperty" ), //$NON-NLS-1$
					},
					new Class[]{
		...
		if ( handle instanceof TemplateElementHandle )
		{
			return new CategoryHolder( new String[]{
					...
					new String[]{
							Messages.getString( "TemplateReportItemPageGenerator.List.General" ), //$NON-NLS-1$	
	...
	protected ICategoryProvider getCategoryProvider( String elementName )
	{
		...
		if ( holder != null )
		{
			return new CategoryProvider( holder.keys,
					holder.labels,
					holder.pageClasses );
		}
