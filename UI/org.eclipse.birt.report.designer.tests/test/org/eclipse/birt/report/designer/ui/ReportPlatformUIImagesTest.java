...
public class ReportPlatformUIImagesTest extends TestCase
{
	...
	public void testGetImage( )
	{
		String iconName[] = {
				//common icons
				IReportGraphicConstants.ICON_NEW_REPORT,
				IReportGraphicConstants.ICON_REPORT_FILE,
				IReportGraphicConstants.ICON_QUIK_EDIT,
				IReportGraphicConstants.ICON_REPORT_PERSPECTIVE,
				IReportGraphicConstants.ICON_REPORT_PROJECT,

				//element icons
				IReportGraphicConstants.ICON_ELEMENT_CELL,
				IReportGraphicConstants.ICON_ELEMENT_DATA,
				IReportGraphicConstants.ICON_ELEMENT_DATA_SET,
				IReportGraphicConstants.ICON_ELEMENT_DATA_SOURCE,
				IReportGraphicConstants.ICON_ELEMENT_EXTENDED_DATA_SET,
				IReportGraphicConstants.ICON_ELEMENT_EXTENDED_DATA_SOURCE,
				//IReportGraphicConstants.ICON_ELEMENT_EXTENDED_ITEM,
				IReportGraphicConstants.ICON_ELEMENT_GRID,
				IReportGraphicConstants.ICON_ELEMENT_GROUP,
				IReportGraphicConstants.ICON_ELEMENT_IMAGE,
				IReportGraphicConstants.ICON_ELEMENT_LABEL,
				IReportGraphicConstants.ICON_ELEMENT_LINE,
				IReportGraphicConstants.ICON_ELEMENT_LIST,
				IReportGraphicConstants.ICON_ELEMENT_LIST_GROUP,
				IReportGraphicConstants.ICON_ELEMNET_MASTERPAGE,
				IReportGraphicConstants.ICON_ELEMENT_PARAMETER,
				IReportGraphicConstants.ICON_ELEMENT_PARAMETER_GROUP,
				IReportGraphicConstants.ICON_ELEMENT_ROW,
				IReportGraphicConstants.ICON_ELEMENT_SCALAR_PARAMETER,
				IReportGraphicConstants.ICON_ELEMNET_SIMPLE_MASTERPAGE,
				...
				IReportGraphicConstants.ICON_NODE_MASTERPAGES,
				IReportGraphicConstants.ICON_NODE_STYLES,
				IReportGraphicConstants.ICON_NODE_HEADER,
				...
				IReportGraphicConstants.ICON_BORDER_BOTTOM,
				IReportGraphicConstants.ICON_BORDER_LEFT,
				IReportGraphicConstants.ICON_BORDER_NOBORDER,
				...
				IReportGraphicConstants.ICON_NODE_DATA_SOURCES,
				IReportGraphicConstants.ICON_NODE_PARAMETERS,
				...
				IReportGraphicConstants.ICON_ATTRIBUTE_FONT_WIDTH,
				IReportGraphicConstants.ICON_ATTRIBUTE_FONT_STYLE,
				IReportGraphicConstants.ICON_ATTRIBUTE_TEXT_UNDERLINE,
				IReportGraphicConstants.ICON_ATTRIBUTE_TEXT_LINE_THROUGH,
				IReportGraphicConstants.ICON_ATTRIBUTE_BORDER_NONE,
				IReportGraphicConstants.ICON_ATTRIBUTE_BORDER_FRAME,
				IReportGraphicConstants.ICON_ATTRIBUTE_BORDER_LEFT,
				IReportGraphicConstants.ICON_ATTRIBUTE_BORDER_RIGHT,
				IReportGraphicConstants.ICON_ATTRIBUTE_BORDER_TOP,
				IReportGraphicConstants.ICON_ATTRIBUTE_BORDER_BOTTOM,
				...
				IReportGraphicConstants.ICON_ATTRIBUTE_TOP_MARGIN,
				IReportGraphicConstants.ICON_ATTRIBUTE_BOTTOM_MARGIN,
				IReportGraphicConstants.ICON_ATTRIBUTE_LEFT_MARGIN,
				IReportGraphicConstants.ICON_ATTRIBUTE_RIGHT_MARGIN,
		...
		{
			assertNotNull( iconName[i],
					ReportPlatformUIImages.getImage( iconName[i] ) );
		}
