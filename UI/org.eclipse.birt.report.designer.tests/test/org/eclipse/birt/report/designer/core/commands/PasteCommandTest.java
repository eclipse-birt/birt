...
public class PasteCommandTest extends CmdBaseTestCase
{
	...
	protected void setUp( ) throws Exception
	{
		...
		/***********************************************************************
		 * Note the table will be like: the secondRow is actually the first row
		 * in the table the secondCell is actually the first cell in the row
		 * |-----------------------------------| |secondRow(no cell) |
		 * |-----------------------------------| |firstRow(secondCell |
		 * firstCell)--| |-----------------------------------|
		 *  
	...
	public void testPasteCell( )
	{
		...
		PasteCommand pasteCmd = new PasteCommand( firstCell,
				secondRow,
				null,
				false );
	...
	{
		assertEquals( 2, firstRow.getCells( ).getCount( ) );
		PasteCommand pasteCmd = new PasteCommand( secondCell,
				firstRow,
				firstCell,
				false );
		assertTrue( pasteCmd.canExecute( ) );
