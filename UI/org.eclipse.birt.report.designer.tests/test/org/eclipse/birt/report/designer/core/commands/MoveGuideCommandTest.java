...
public class MoveGuideCommandTest extends BaseTestCase {
	...
	public void testMoveGuildRightMargin() {
		...
		MoveGuideCommand moveGuideCmd = new MoveGuideCommand(rightMargin,
	...
	public void testMoveGuildLeftMargin() throws SemanticException {
		...
		MoveGuideCommand moveGuideCmd = new MoveGuideCommand(leftMargin,
		...
		DimensionValue dimInch = DimensionUtil.convertTo(dim,DesignChoiceConstants.UNITS_CM, DesignChoiceConstants.UNITS_IN );
	...
	public void testMoveGuildTopMargin() {
		...
		MoveGuideCommand moveGuideCmd = new MoveGuideCommand(topMargin,
	...
	public void testMoveGuildBottomMargin() {
		...
		MoveGuideCommand moveGuideCmd = new MoveGuideCommand(bottomMargin,
