...
public class SortingFormPage extends Composite implements Listener
{
	 ...
	 *            The data provider and processor
	 */
	public SortingFormPage( Composite parent, int style,
			ISortingFormHandleProvider provider, boolean bAddWithDialog )
	{
	 ...
	 */
	public SortingFormPage( Composite parent, int style,
			ISortingFormHandleProvider provider )
	{
		...
		table.addKeyListener( new KeyAdapter( ) {
			...
			public void keyPressed( KeyEvent e )
			{
				...
				if ( e.keyCode == SWT.DEL )
				{
					...
					{
						WidgetUtil.processError( SortingFormPage.this.getShell( ),
								e1 );
					}
				}
