...
public class WizardLibrarySettingPage extends WizardPage
{
	 ...
	 * @param titleImage
	 */
	public WizardLibrarySettingPage( String pageName, String title,
	...
	private String getFilePath( )
	{
		...
		if ( fileName != null )
		{
			...
			{
				ExceptionHandler.openErrorMessageBox( Messages.getString( "AddLibraryAction.Error.Title" ), //$NON-NLS-1$
						Messages.getFormattedString( "AddLibraryAction.Error.FileIsNotLibrary", new String[]{fileName, fileExt} ) ); //$NON-NLS-1$
				return getFilePath( );
			}
