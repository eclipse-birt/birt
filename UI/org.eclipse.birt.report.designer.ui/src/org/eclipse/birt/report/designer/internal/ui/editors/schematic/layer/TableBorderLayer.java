...
public class TableBorderLayer extends FreeformLayer
{
			...
			int y, int w, int h, int[] data )
	{
		...
		int rx = x + nlexWidth / 2;
		int rw = w - nlexWidth / 2;
		...
		if ( TableBorderCollisionArbiter.canExtend( data,
				...
				|| TableBorderCollisionArbiter.isBrotherWin( data,
						...
						false ) )
		{
			rx = x - nlexWidth / 2 - nlexWidth % 2;
			rw = w + nlexWidth / 2 + nlexWidth % 2;
			...
			int y, int w, int h, int[] data )
	{
		...
		int nBottomLeftX = -1;
		int nBottomLeftY = -1;
		if ( colIndex < colCount && rowIndex < rowCount - 1 )
		{
		...
		int ry = y + ntexWidth / 2;
		int rh = h - ntexWidth / 2;
		...
		if ( TableBorderCollisionArbiter.canExtend( data,
				...
				|| TableBorderCollisionArbiter.isBrotherWin( data,
						...
						true ) )
		{
			ry = y - ntexWidth / 2 - ntexWidth % 2;
			rh = h + ntexWidth / 2 + ntexWidth % 2;
