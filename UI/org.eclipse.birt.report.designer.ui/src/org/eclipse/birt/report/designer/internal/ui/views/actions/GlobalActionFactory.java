...
public class GlobalActionFactory
{
	...
	public final static String[] GLOBAL_INSERT_ACTIONS = {
			...
			ISelectionProvider provider )
	{
		...
		if ( elementType != null )
		{
			GlobalInsertAction action = new GlobalInsertAction( provider,
					id,
					elementType );
			action.setText( DEUtil.getElementDefn( elementType )
					.getDisplayName( ) );
			return action;
		}
		return null;
