...
public class HighlightHandleProvider
{
	...
	/**
	 * Returns the test expression property value for current highlight rules
	 * property.
	 * 
	 * @return
	 */
	...
	//	{
	//		PropertyHandle highRules = elementHandle.getPropertyHandle(
	// HighlightRule.TEST_EXPR_PROP );
	//
	//		return highRules.getStringValue( );
	//
	//	}
	...
	/**
	 * Sets the test expression property value for current highlight rules
	 * property.
	 * 
	 * @param exp
	...
	/**
	 * Deletes specified highlight rule item from current highlight rules
	 * property.
	 * 
	 * @param pos
	 *            item position.
