...
public class ParameterDialog extends BaseDialog {
	...
	private static final String CHOICE_NO_DEFAULT = Messages
			.getString("ParameterDialog.Choice.NoDefault"); //$NON-NLS-1$

	private static final String CHOICE_DISPLAY_TEXT = Messages
			.getString("ParameterDialog.Choice.DisplayText"); //$NON-NLS-1$

	private static final String CHOICE_VALUE_COLUMN = Messages
			.getString("ParameterDialog.Choice.ValueColumn"); //$NON-NLS-1$

	private static final String CHOICE_ASCENDING = Messages
			.getString("ParameterDialog.Choice.ASCENDING"); //$NON-NLS-1$

	private static final String CHOICE_DESCENDING = Messages
			.getString("ParameterDialog.Choice.DESCENDING"); //$NON-NLS-1$

	private static final String CHOICE_SELECT_VALUE = Messages
			.getString("ParameterDialog.Choice.SelectValue"); //$NON-NLS-1$

	private static final String GROUP_MORE_OPTION = Messages
			.getString("ParameterDialog.Group.MoreOption"); //$NON-NLS-1$

	private static final String LABEL_NAME = Messages
			.getString("ParameterDialog.Label.Name"); //$NON-NLS-1$

	private static final String LABEL_DATETIME_PROMPT = Messages
			.getFormattedString(
					"ParameterDialog.datetime.prompt", new String[] { "yyyy-MM-dd HH:mm:ss.SSS" }); //$NON-NLS-1$ //$NON-NLS-2$

	private static final String LABEL_DATE_PROMPT = Messages
			.getFormattedString(
					"ParameterDialog.date.prompt", new String[] { "yyyy-MM-dd" }); //$NON-NLS-1$ //$NON-NLS-2$

	private static final String LABEL_TIME_PROMPT = Messages
			.getFormattedString(
					"ParameterDialog.time.prompt", new String[] { "hh:mm:ss" }); //$NON-NLS-1$ //$NON-NLS-2$

	private static final String LABEL_PROMPT_TEXT = Messages
			.getString("ParameterDialog.Label.PromptText"); //$NON-NLS-1$

	private static final String LABEL_PARAM_DATA_TYPE = Messages
			.getString("ParameterDialog.Label.DataType"); //$NON-NLS-1$

	private static final String LABEL_DISPALY_TYPE = Messages
			.getString("ParameterDialog.Label.DisplayType"); //$NON-NLS-1$

	private static final String LABEL_DEFAULT_VALUE = Messages
			.getString("ParameterDialog.Label.DefaultValue"); //$NON-NLS-1$

	private static final String LABEL_HELP_TEXT = Messages
			.getString("ParameterDialog.Label.HelpText"); //$NON-NLS-1$

	private static final String LABEL_LIST_OF_VALUE = Messages
			.getString("ParameterDialog.Label.ListOfValue"); //$NON-NLS-1$

	private static final String LABEL_SORT_GROUP = Messages
			.getString("ParameterDialog.Label.SortGroup"); //$NON-NLS-1$

	private static final String LABEL_VALUES = Messages
			.getString("ParameterDialog.Label.Value"); //$NON-NLS-1$

	private static final String LABEL_FORMAT = Messages
			.getString("ParameterDialog.Label.Format"); //$NON-NLS-1$

	private static final String LABEL_LIST_LIMIT = Messages
			.getString("ParameterDialog.Label.Listlimit"); //$NON-NLS-1$
	...
	private static final String LABEL_SELECT_DATA_SET = Messages
			.getString("ParameterDialog.Label.SelectDataSet"); //$NON-NLS-1$

	private static final String LABEL_PREVIEW = Messages
			.getString("ParameterDialog.Label.Preview"); //$NON-NLS-1$

	private static final String LABEL_SORT_KEY = Messages
			.getString("ParameterDialog.Label.SortKey"); //$NON-NLS-1$

	private static final String LABEL_SORT_DIRECTION = Messages
			.getString("ParameterDialog.Label.SortDirection"); //$NON-NLS-1$

	private static final String CHECKBOX_ISREQUIRED = Messages
			.getString("ParameterDialog.CheckBox.IsRequired"); //$NON-NLS-1$

	private static final String CHECKBOX_DO_NOT_ECHO = Messages
			.getString("ParameterDialog.CheckBox.DoNotEchoInput"); //$NON-NLS-1$

	private static final String CHECKBOX_HIDDEN = Messages
			.getString("ParameterDialog.CheckBox.Hidden"); //$NON-NLS-1$

	private static final String CHECKBOX_DISTINCT = Messages
			.getString("ParameterDialog.CheckBox.Distinct"); //$NON-NLS-1$

	private static final String BUTTON_LABEL_CHANGE_FORMAT = Messages
			.getString("ParameterDialog.Button.ChangeFormat"); //$NON-NLS-1$

	private static final String BUTTON_LABEL_IMPORT = Messages
			.getString("ParameterDialog.Button.ImportValue"); //$NON-NLS-1$

	private static final String BUTTON_LABEL_SET_DEFAULT = Messages
			.getString("ParameterDialog.Button.SetDefault"); //$NON-NLS-1$

	private static final String BUTTON_LABEL_REMOVE_DEFAULT = Messages
			.getString("ParameterDialog.Button.RemoveDefault"); //$NON-NLS-1$

	private static final String BUTTON_CREATE_DATA_SET = Messages
			.getString("ParameterDialog.Button.CreateDataSet"); //$NON-NLS-1$

	private static final String RADIO_DYNAMIC = Messages
			.getString("ParameterDialog.Radio.Dynamic"); //$NON-NLS-1$

	private static final String CHECK_ALLOW_MULTI = Messages
			.getString("ParameterDialog.Check.AllowMulti"); //$NON-NLS-1$

	private static final String RADIO_STATIC = Messages
			.getString("ParameterDialog.Radio.Static"); //$NON-NLS-1$
	...
	private static final String ERROR_MSG_NAME_IS_EMPTY = Messages
			.getString("ParameterDialog.ErrorMessage.EmptyName"); //$NON-NLS-1$
	...
	private static final String FLAG_DEFAULT = Messages
			.getString("ParameterDialog.Flag.Default"); //$NON-NLS-1$

	private static final String COLUMN_VALUE = Messages
			.getString("ParameterDialog.Column.Value"); //$NON-NLS-1$

	private static final String COLUMN_DISPLAY_TEXT = Messages
			.getString("ParameterDialog.Column.DisplayText"); //$NON-NLS-1$

	private static final String COLUMN_DISPLAY_TEXT_KEY = Messages
			.getString("ParameterDialog.Column.DisplayTextKey"); //$NON-NLS-1$

	private static final String COLUMN_IS_DEFAULT = Messages
			.getString("ParameterDialog.Column.Default"); //$NON-NLS-1$

	private static final String BOOLEAN_TRUE = Messages
			.getString("ParameterDialog.Boolean.True"); //$NON-NLS-1$

	private static final String BOOLEAN_FALSE = Messages
			.getString("ParameterDialog.Boolean.False"); //$NON-NLS-1$
	...
	public static final String DISPLAY_NAME_CONTROL_LIST = Messages
			.getString("ParameterDialog.DisplayLabel.List"); //$NON-NLS-1$

	public static final String DISPLAY_NAME_CONTROL_COMBO = Messages
			.getString("ParameterDialog.DisplayLabel.Combo"); //$NON-NLS-1$

	private static final String NONE_DISPLAY_TEXT = Messages
			.getString("ParameterDialog.Label.None"); //$NON-NLS-1$

	private static final Image DEFAULT_ICON = ReportPlatformUIImages
			.getImage(IReportGraphicConstants.ICON_DEFAULT);
	...
	private static final IChoiceSet DATA_TYPE_CHOICE_SET = DEUtil
			.getMetaDataDictionary().getElement(
					ReportDesignConstants.SCALAR_PARAMETER_ELEMENT)
			.getProperty(ScalarParameterHandle.DATA_TYPE_PROP)
			.getAllowedChoices();

	private static final IChoiceSet CONTROL_TYPE_CHOICE_SET = DEUtil
			.getMetaDataDictionary().getChoiceSet(
					DesignChoiceConstants.CHOICE_PARAM_CONTROL);
	...
	private final ITableAreaModifier tableAreaModifier = new ITableAreaModifier() {
		...
		public boolean editItem(final Object element) {
			...
			SelectionChoiceDialog dialog = new SelectionChoiceDialog(Messages
					.getString("ParameterDialog.SelectionDialog.Edit")); //$NON-NLS-1$
			dialog.setInput(choice);
			dialog
					.setValidator(new SelectionChoiceDialog.ISelectionChoiceValidator() {

						public String validate(String displayLableKey,
								String displayLabel, String value) {
							return validateChoice(choice, displayLableKey,
									displayLabel, value);
						}
		...
		public boolean newItem() {
			...
			SelectionChoiceDialog dialog = new SelectionChoiceDialog(Messages
					.getString("ParameterDialog.SelectionDialog.New")); //$NON-NLS-1$
			dialog.setInput(choice);
			dialog
					.setValidator(new SelectionChoiceDialog.ISelectionChoiceValidator() {
						...
						public String validate(String displayLabelKey,
								String displayLabel, String value) {
							return validateChoice(null, displayLabelKey,
									displayLabel, value);
						}
					});
			if (dialog.open() == Dialog.OK) {
	...
	private void createPropertiesSection(Composite composite) {
		...
		dataTypeChooser.setItems(ChoiceSetFactory
				.getDisplayNamefromChoiceSet(DATA_TYPE_CHOICE_SET));
	...
	private void createControlTypeChooser(Composite propertiesSection) {
		IDialogHelperProvider helperProvider = (IDialogHelperProvider) ElementAdapterManager
				.getAdapter(this, IDialogHelperProvider.class);
		...
		controlTypeHelper.getControl().setLayoutData(
	...
	private void createDisplayOptionsSection(Composite composite) {
		...
		displayOptionSection.setLayoutData(new GridData(
		...
		formatField = new Text(formatSection, SWT.BORDER | SWT.SINGLE
				| SWT.READ_ONLY);
	...
	protected boolean initDialog() {
		...
		helpTextEditor.setText(UIUtil.convertToGUIString(inputParameter
				.getHelpText()));
		if (inputParameter.getValueType().equals(
				DesignChoiceConstants.PARAM_VALUE_TYPE_STATIC)) {
			staticRadio.setSelection(true);

			for (Iterator iter = inputParameter.getPropertyHandle(
					ScalarParameterHandle.SELECTION_LIST_PROP).iterator(); iter
					.hasNext();) {
				SelectionChoiceHandle choiceHandle = (SelectionChoiceHandle) iter
						.next();
		...
		if (PARAM_CONTROL_LIST.endsWith(getSelectedControlType())
			...
			if (DesignChoiceConstants.SCALAR_PARAM_TYPE_MULTI_VALUE
					.endsWith(inputParameter.getParamType())) {
		...
		if (inputParameter.getPropertyHandle(
				ScalarParameterHandle.LIST_LIMIT_PROP).isSet()) {
		...
		changeDataType();
		dataTypeChooser.setText(DATA_TYPE_CHOICE_SET.findChoice(
				inputParameter.getDataType()).getDisplayName());
		switchParamterType();
		loading = false;
		return true;
	}
			...
			if (DesignChoiceConstants.PARAM_CONTROL_CHECK_BOX
				...
				if (isValidValue(defaultValue) != null) {
					...
					if (defaultValue == null) {
						defaultValueChooser.select(defaultValueChooser
								.indexOf(CHOICE_NO_DEFAULT));
				...
				if (getSelectedDataType().equals(
					...
					defaultValueChooser.setText(DEUtil
							.resolveNull(defaultValue));
				} else if (defaultValue != null) {
					if ((defaultValue.equals(Boolean.toString(true)) || defaultValue
					...
					|| DesignChoiceConstants.PARAM_CONTROL_RADIO_BUTTON
							.endsWith(controlType)) {
				initSorttingArea();
				...
				if (lastControlType != null
						&& lastControlType
								.equals(DesignChoiceConstants.PARAM_CONTROL_TEXT_BOX)) {
					defaultValue = null;
				}
			}
			refreshValueTable();
	...
	private void initSorttingArea() {
		...
		if (!inputParameter.isFixedOrder()) {
			...
			distinct.setSelection(!inputParameter.distinct());
			boolean isStatic = DesignChoiceConstants.PARAM_VALUE_TYPE_STATIC
					.equals(inputParameter.getValueType());
			boolean isDynamic = DesignChoiceConstants.PARAM_VALUE_TYPE_DYNAMIC
					.equals(inputParameter.getValueType());
			if (isStatic) {
				String sortKey = inputParameter.getSortBy();
				if (sortKey == null
						|| sortKey
								.equals(DesignChoiceConstants.PARAM_SORT_VALUES_LABEL)) {
	...
	private void initFormatField() {
		...
		if ((DesignChoiceConstants.PARAM_TYPE_DECIMAL.equals(lastControlType) && DesignChoiceConstants.PARAM_TYPE_FLOAT
				.equals(type))
				|| (DesignChoiceConstants.PARAM_TYPE_FLOAT
						.equals(lastControlType) && DesignChoiceConstants.PARAM_TYPE_DECIMAL
						.equals(type))) {
			return;
		}
		...
		if (choiceSet == null) {
			...
			if (!loading
					|| ((inputParameter.getCategory() == null && inputParameter
							.getPattern() == null))) {
				if (DesignChoiceConstants.PARAM_TYPE_STRING.equals(type)) {
					formatCategroy = choiceSet
							.findChoice(
					...
					formatCategroy = choiceSet.findChoice(
	...
	private void refreshDataSets() {
		...
		for (Iterator iterator = inputParameter.getModuleHandle()
				.getVisibleDataSets().iterator(); iterator.hasNext();) {
		...
		// is created.
		{
			...
			if (StringUtil.isBlank(selectedDataSetName)) {
				...
				dataSetChooser.select(dataSetChooser
						.indexOf(selectedDataSetName));
				refreshColumns(false);
			}
			refresSortByItems();
		}
	...
	private DataSetHandle getDataSetHandle() {
		return inputParameter.getModuleHandle().findDataSet(
	...
	private void refreshColumns(boolean onlyFilter) {
		...
		if (!onlyFilter) {
			...
			for (Iterator iter = columnList.iterator(); iter.hasNext();) {
				displayTextChooser.add(((ResultSetColumnHandle) iter.next())
						.getColumnName());
			}
		...
		for (Iterator iter = columnList.iterator(); iter.hasNext();) {
			ResultSetColumnHandle cachedColumn = (ResultSetColumnHandle) iter
					.next();
	...
	private boolean matchDataType(ResultSetColumnHandle column) {
		...
		if (type.equals(DesignChoiceConstants.PARAM_TYPE_STRING)
				|| DesignChoiceConstants.COLUMN_DATA_TYPE_ANY.equals(column
						.getDataType())) {
			return true;
		}
		if (DesignChoiceConstants.COLUMN_DATA_TYPE_DATETIME.equals(column
				.getDataType())) {
			return type.equals(DesignChoiceConstants.PARAM_TYPE_DATETIME);
		} else if (DesignChoiceConstants.COLUMN_DATA_TYPE_DECIMAL.equals(column
				.getDataType())) {
			return type.equals(DesignChoiceConstants.PARAM_TYPE_DECIMAL);
		} else if (DesignChoiceConstants.COLUMN_DATA_TYPE_FLOAT.equals(column
				.getDataType())) {
			return type.equals(DesignChoiceConstants.PARAM_TYPE_FLOAT);
		} else if (DesignChoiceConstants.COLUMN_DATA_TYPE_INTEGER.equals(column
				.getDataType())) {
			return type.equals(DesignChoiceConstants.PARAM_TYPE_INTEGER);
		} else if (DesignChoiceConstants.COLUMN_DATA_TYPE_DATE.equals(column
				.getDataType())) {
			return type.equals(DesignChoiceConstants.PARAM_TYPE_DATE);
		} else if (DesignChoiceConstants.COLUMN_DATA_TYPE_TIME.equals(column
				.getDataType())) {
			return type.equals(DesignChoiceConstants.PARAM_TYPE_TIME);
		} else if (DesignChoiceConstants.COLUMN_DATA_TYPE_BOOLEAN.equals(column
				.getDataType())) {
	...
	private String getInputControlType() {
		...
		if (inputParameter.getControlType() == null) {
			type = DesignChoiceConstants.PARAM_CONTROL_TEXT_BOX;
				...
				.equals(inputParameter.getControlType())) {
	...
	private String getSelectedDataType() {
		...
		if (StringUtil.isBlank(dataTypeChooser.getText())) {
			...
			IChoice choice = DATA_TYPE_CHOICE_SET
					.findChoiceByDisplayName(dataTypeChooser.getText());
			type = choice.getName();
		}
		return type;
	}
	...
	private void switchToList() {
		...
		tableArea = new TableArea(tableAreaComposite, SWT.SINGLE
				| SWT.FULL_SELECTION | SWT.BORDER, tableAreaModifier);
		...
		String[] columns;
		int[] columnWidth;
		columns = new String[] { null, COLUMN_IS_DEFAULT, COLUMN_VALUE,
				COLUMN_DISPLAY_TEXT, COLUMN_DISPLAY_TEXT_KEY };
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == OK) {
					...
					for (int i = 0; i < importValues.length; i++) {
						SelectionChoice choice = StructureFactory
								.createSelectionChoice();
						choice.setValue(UIUtil.convertToModelString(
								importValues[i], false));
						if (labelMap.get(UIUtil.convertToModelString(
								importValues[i], false)) != null) {
							choice.setLabel((String) labelMap
									.get(importValues[i]));
						}
						choiceList.add(choice);
						if (defaultValue != null
								&& defaultValue.equals(UIUtil
										.convertToModelString(importValues[i],
												false))) {
		...
		changeDefault.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				SelectionChoice choice = (SelectionChoice) ((IStructuredSelection) valueTable
	...
	private void switchToDynamic() {
		...
		valueColumnExprButton.setToolTipText(Messages
				.getString("ParameterDialog.toolTipText.OpenExprButton")); //$NON-NLS-1$
		valueColumnExprButton.addSelectionListener(new SelectionAdapter() {

			public void widgetSelected(SelectionEvent event) {

				ExpressionBuilder expressionBuilder = new ExpressionBuilder(
						getExpression(columnChooser.getText()));
				expressionBuilder
						.setExpressionProvier(new ParameterExpressionProvider(
								inputParameter, dataSetChooser.getText()));
		...
		displayTextExprButton.setToolTipText(Messages
				.getString("ParameterDialog.toolTipText.OpenExprButton")); //$NON-NLS-1$
		displayTextExprButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent event) {
				...
				ExpressionBuilder expressionBuilder = new ExpressionBuilder(
						getExpression(displayTextChooser.getText()));
				expressionBuilder
						.setExpressionProvier(new ParameterExpressionProvider(
								inputParameter, dataSetChooser.getText()));

				if (expressionBuilder.open() == OK) {
					setExpression(displayTextChooser, expressionBuilder
							.getResult().trim());
				}
			}
		});
	...
	private void refresSortByItems() {
		...
		if (staticRadio.getSelection()) {
			...
			for (Iterator iter = columnList.iterator(); iter.hasNext();) {
				sortKeyChooser.add(((ResultSetColumnHandle) iter.next())
						.getColumnName());
			}
	...
	private void createSortingArea(Composite parent) {
		...
		sortDirectionChooser = new Combo(sortDirectionArea, SWT.BORDER
				| SWT.READ_ONLY);
		sortDirectionChooser.setLayoutData(new GridData(
				GridData.FILL_HORIZONTAL));
		...
		defaultValueChooser.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (defaultValueChooser.getSelectionIndex() == -1)
					return;
				String selection = defaultValueChooser
						.getItem(defaultValueChooser.getSelectionIndex());
				if (selection.equals(CHOICE_SELECT_VALUE)) {
	...
	private Object validateValue(String value) throws BirtException {
		...
		if (!((DesignChoiceConstants.PARAM_TYPE_STRING
				.endsWith(getSelectedDataType())) || (DesignChoiceConstants.PARAM_TYPE_BOOLEAN
				.endsWith(getSelectedDataType())))) {
			if (DesignChoiceConstants.PARAM_TYPE_DATETIME
					.equals(getSelectedDataType())) {
				tempdefaultValue = ParameterUtil
						.convertToStandardFormat(DataTypeUtil
								.toDate(tempdefaultValue));
			} else if (DesignChoiceConstants.PARAM_TYPE_DATE
					.equals(getSelectedDataType())) {
				tempdefaultValue = ParameterUtil
						.convertToStandardFormat(DataTypeUtil
								.toSqlDate(tempdefaultValue));
			} else if (DesignChoiceConstants.PARAM_TYPE_TIME
					.equals(getSelectedDataType())) {
				tempdefaultValue = ParameterUtil
						.convertToStandardFormat(DataTypeUtil
								.toSqlTime(tempdefaultValue));
			}

			return ParameterValidationUtil.validate(getSelectedDataType(),
					STANDARD_DATE_TIME_PATTERN, tempdefaultValue, ULocale
							.getDefault());
	...
	protected void okPressed() {
		...
		try {
			...
			inputParameter.setPromptText(UIUtil.convertToModelString(
					promptTextEditor.getText(), true));

			inputParameter
					.setParamType(DesignChoiceConstants.SCALAR_PARAM_TYPE_SIMPLE);
			...
			if (PARAM_CONTROL_COMBO.equals(newControlType)) {
				...
				if (allowMultiChoice.isVisible()
					...
					inputParameter
							.setParamType(DesignChoiceConstants.SCALAR_PARAM_TYPE_MULTI_VALUE);
				}
			} else {
				inputParameter.setProperty(
						ScalarParameterHandle.MUCH_MATCH_PROP, null);
			}
			...
			// Set data type
			inputParameter.setDataType(DATA_TYPE_CHOICE_SET
					.findChoiceByDisplayName(dataTypeChooser.getText())
					.getName());
			...
			if (isStatic()) {
				...
				if (!DesignChoiceConstants.PARAM_CONTROL_TEXT_BOX
						.equals(newControlType)
						&& !DesignChoiceConstants.PARAM_CONTROL_CHECK_BOX
								.equals(newControlType)) {
					for (Iterator iter = choiceList.iterator(); iter.hasNext();) {
						SelectionChoice choice = (SelectionChoice) iter.next();
						if (isValidValue(choice.getValue()) == null) {
				...
				inputParameter.setValueExpr(getExpression(columnChooser
						.getText()));
				...
				if (displayTextChooser.getText().equals(LABEL_NULL)) {
					...
					inputParameter
							.setLabelExpr(getExpression(displayTextChooser
									.getText()));
				}
				if (startPointTypeHelper != null) {
					if (startPointTypeHelper.getControl() != null
						...
						startPointTypeHelper.update(false);
						inputParameter
								.setAutoSuggestThreshold((Integer) startPointTypeHelper
										.getProperty(STARTPOINT_VALUE));
					}
				}
			}
			...
			if (isStatic()
					&& (PARAM_CONTROL_COMBO.equals(getSelectedControlType()) || DesignChoiceConstants.PARAM_CONTROL_RADIO_BUTTON
							.equals(getSelectedControlType()))
			...
			if (doNotEcho.isEnabled()) {
				if (dirtyProperties.containsKey(CHECKBOX_DO_NOT_ECHO)) {
					inputParameter
							.setConcealValue(getProperty(CHECKBOX_DO_NOT_ECHO));
				}
			} else {
				inputParameter.setProperty(
						ScalarParameterHandle.CONCEAL_VALUE_PROP, null);
			}
			...
			if (sorttingArea != null && !sorttingArea.isDisposed()
				...
				if (sortKeyChooser.getText().equals(NONE_DISPLAY_TEXT)) {
					...
					if (isStatic()) {
						...
						if (sortKeyChooser.getText()
							...
							inputParameter
									.setSortBy(DesignChoiceConstants.PARAM_SORT_VALUES_LABEL);
						} else if (sortKeyChooser.getText().equals(
								CHOICE_VALUE_COLUMN)) {
							inputParameter
									.setSortBy(DesignChoiceConstants.PARAM_SORT_VALUES_VALUE);
						}
						inputParameter.setSortByColumn(null);
					} else if (dynamicRadio.getSelection()) {
						inputParameter.setSortBy(null);
						inputParameter.setFixedOrder(false);
						inputParameter
								.setSortByColumn(getExpression(sortKeyChooser
										.getText()));
					}

					if (sortDirectionChooser.getText().equals(CHOICE_ASCENDING)) {
						inputParameter
								.setSortDirection(DesignChoiceConstants.SORT_DIRECTION_ASC);
					} else if (sortDirectionChooser.getText().equals(
							CHOICE_DESCENDING)) {
						inputParameter
								.setSortDirection(DesignChoiceConstants.SORT_DIRECTION_DESC);
					}
				}
			} else {
				inputParameter.setProperty(
						ScalarParameterHandle.FIXED_ORDER_PROP, null);
			}

			// Save limits
			if (!isStatic() && !StringUtil.isBlank(listLimit.getText())) {
				try {
					inputParameter.setListlimit(Integer.parseInt(listLimit
							.getText()));
				...
				inputParameter.setProperty(
						ScalarParameterHandle.LIST_LIMIT_PROP, null);
			}
		} catch (Exception e) {
			ExceptionHandler.handle(e);
			return;
	...
	private void updateTableButtons() {
		...
		if (valueTable.getSelection().isEmpty()) {
			...
			selectedChoice = (SelectionChoice) ((IStructuredSelection) valueTable
					.getSelection()).getFirstElement();
	...
	private void updateCheckBoxArea() {
		...
		if (DesignChoiceConstants.PARAM_CONTROL_TEXT_BOX
				.equals(getSelectedControlType())
				|| DesignChoiceConstants.PARAM_CONTROL_AUTO_SUGGEST
						.equals(getSelectedControlType())) {
	...
	private void updateMessageLine() {
		...
		if (errorMessage == null) {
			...
			if (!isStatic() && columnChooser != null
	...
	private IChoiceSet getFormatChoiceSet(String type) {
		...
		if (DesignChoiceConstants.PARAM_TYPE_STRING.equals(type)) {
			choiceSet = DEUtil.getMetaDataDictionary().getChoiceSet(
			...
			choiceSet = DEUtil.getMetaDataDictionary().getChoiceSet(
					DesignChoiceConstants.CHOICE_DATE_FORMAT_TYPE);
		} else if (DesignChoiceConstants.PARAM_TYPE_TIME.equals(type)) {
			choiceSet = DEUtil.getMetaDataDictionary().getChoiceSet(
					DesignChoiceConstants.CHOICE_TIME_FORMAT_TYPE);
	...
	private void updateFormatField() {
		...
		if (choiceSet == null) { // Boolean type;
			...
			if (type.equals(DesignChoiceConstants.PARAM_TYPE_DATETIME)) {
				previewString = new DateFormatter(
						ParameterUtil.isCustomCategory(formatCategroy) ? formatPattern
								: (formatCategroy
										.equals(DesignChoiceConstants.DATETIEM_FORMAT_TYPE_UNFORMATTED) ? DateFormatter.DATETIME_UNFORMATTED
										: formatCategroy), ULocale.getDefault())
						.format(new Date());
				...
				previewString = new StringFormatter(ParameterUtil
						.isCustomCategory(formatCategroy) ? formatPattern
						: formatCategroy, ULocale.getDefault()).format(Messages
						.getString("ParameterDialog.Label.Sample")); //$NON-NLS-1$
			} else if (type.equals(DesignChoiceConstants.PARAM_TYPE_INTEGER)) {
				previewString = new NumberFormatter(ParameterUtil
						.isCustomCategory(formatCategroy) ? formatPattern
						: formatCategroy, ULocale.getDefault())
						.format(1234567890);
			} else {
	...
	private boolean canBeBlank() {
		...
		{
			if (dirtyProperties.containsKey(CHECKBOX_ISREQUIRED)) {
				canBeBlank = !(((Boolean) dirtyProperties
						.get(CHECKBOX_ISREQUIRED)).booleanValue());
			} else {
	...
	private boolean canBeNull() {
		...
		if (dirtyProperties.containsKey(CHECKBOX_ISREQUIRED)) {
			canBeNull = !(((Boolean) dirtyProperties.get(CHECKBOX_ISREQUIRED))
					.booleanValue());
		} else {
	...
	private boolean isDefaultChoice(SelectionChoice choice) {
		...
		return choiceValue != null && defaultValue != null
	...
	private String convertToStandardFormat(String string) {
		if (string != null
				&& DesignChoiceConstants.PARAM_TYPE_DATETIME
						.equals(getSelectedDataType())) {
			try {
				string = ParameterUtil.convertToStandardFormat(DataTypeUtil
						.toDate(string, ULocale.US));
			} catch (BirtException e) {
			}
		}
		return string;
	...
	private String validateChoice(SelectionChoice choice,
		...
		if ((displayLabel == null && containValue(choice, newValue,
				COLUMN_DISPLAY_TEXT))
	...
	private void setExpression(Combo chooser, String key) {
		...
		for (int i = 0; i < columnList.size(); i++) {
			if (key.equals(DEUtil.getExpression(columnList.get(i)))) {
				// chooser.select( i );
				chooser.setText(((ResultSetColumnHandle) columnList.get(i))
						.getColumnName());
				return;
			}
		}
