...
public class CGridData
{
	...
	/**
	 * maximumWidth specifies the maximum width in pixels.  This value
	 * applies only if isHorizontalAlignFill is true. A value of 
	 * SWT.DEFAULT means that the maximum width will be the result
