...
public class TabDialog extends BaseDialog
{
	...
	/**
	 * Adds a new tab page to this dialog. The page is inserted at the end of
	 * the page list.
	 * 
	 * @param tabPage
	 ...
	 * implementation of this method does nothing.method does nothing.
	 * Subclasses should extend if extra pages need to be added before the
	 * dialog opens. New tab pages should be added by calling
	 * <code>addTab</code>.
	 */
	...
	/**
	 * The <code>TabDialog</code> overrides this method to set input for all
	 * pages after content has been created.
	 */
