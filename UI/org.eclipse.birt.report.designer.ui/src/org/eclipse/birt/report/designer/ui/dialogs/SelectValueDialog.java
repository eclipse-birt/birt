...
/**
 * This dialog takes an expression and a data set and shows a list of unique values for selection
 * from the data set.
...
public class SelectValueDialog extends BaseDialog
{
    ...
    /**
     * @param dataSetHandle The dataSetHandle to set.
     */
    ...
    protected Control createDialogArea(Composite parent)
    {
        ...
        selectValueList = new List(composite, isMultipleSelection()?SWT.MULTI:SWT.SINGLE | SWT.V_SCROLL | SWT.H_SCROLL);
    ...
    private void populateList()
    {
        try
        {
            ...
            BaseQueryDefinition query = (BaseQueryDefinition)DataSetManager.getCurrentInstance().getPreparedQuery(getDataSetHandle(), true, false).getReportQueryDefn();
