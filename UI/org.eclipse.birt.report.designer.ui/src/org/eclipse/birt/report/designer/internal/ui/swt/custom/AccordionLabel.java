...
public class AccordionLabel extends Canvas
{
	...
	void onPaint( PaintEvent event )
	{
		...
		if ( actionImage != null )
		{
			gc.drawImage( actionImage,
					0,
					0,
					actionImageWidth,
					actionImageHeight,
					rect.x + rect.width - rightMargin - actionImageWidth,
					imageY,
					actionImageWidth,
					actionImageHeight );
		...
		gc.setForeground( FormWidgetFactory.getInstance( )
				.getColors( )
				.getBorderColor( ) );
...
//				- rightMargin, rect.y + rect.height );
	...
	{
		Rectangle rect = getClientArea( );
		Rectangle actionArea = new Rectangle( rect.x
				+ rect.width
				- rightMargin
				- actionImageWidth
				- rightMargin, rect.y, rect.x
