...
public abstract class AbstractDataSourceConnectionWizard extends Wizard
{
	...
	/*
	 * Add Logic of storing teh actual data Source connection Each subclassed
	 ...
	 * the createDataSource method to create a data source. 
	 */
...
//	}
	...
	public IWizardPage getNextPage( IWizardPage page )
	{
		...
		/*if ( page.getWizard( ) == this
				&& page == getPages( )[getPages( ).length - 1] )
		{
			//Get the default data set wizard
			if ( dataSetWizard == null )
			{
				dataSetWizard = new DefaultDataSetWizard( dataSourceHandle,
						false );
				//Allow the wizard to create its pages
				dataSetWizard.addPages( );
			}
			//Return the starting page of the data set wizard
			return dataSetWizard.getStartingPage( );
		}*/
