...
import org.eclipse.birt.report.designer.internal.ui.views.NonModalWindow;
 ...
 *
 */
public class BaseNonModalWindow extends NonModalWindow {
	private static final String DIALOG_HEIGHT = "DIALOG_HEIGHT"; //$NON-NLS-1$

	private static final String DIALOG_WIDTH = "DIALOG_WIDTH"; //$NON-NLS-1$

	protected Logger logger = Logger.getLogger(BaseNonModalWindow.class.getName());
	 ...
	 * <code>BaseNonModalWindow( Shell parentShell, String title, true )</code>.
	 *
	 * @param title the title of the dialog
	 */

	protected BaseNonModalWindow(String title) {
		this(UIUtil.getDefaultShell(), title);
	}

	protected BaseNonModalWindow(Shell parentShell) {
	...
	protected BaseNonModalWindow(Shell parentShell, String title) {
		super(parentShell);
	 ...
	 * <p>
	 * (<code>BaseNonModalWindow</code>) overrides this method to initialize the
	 * dialog after create it. If initializtion failed, the dialog will be treated
	 * as cancel button is pressed
	 * </p>
	 *
	...
	public int open() {
		...
		if (initDialog()) {
			if (Policy.TRACING_DIALOGS) {
				...
				System.out.println("NonModalWindow >> Open " //$NON-NLS-1$
	 ...
	 * <p>
	 * The <code>BaseNonModalWindow</code> overrides this framework method sets in
	 ...
	 * (non-Javadoc)
	 *
	 * @see org.eclipse.jface.dialogs.NonModalWindow#getDialogBoundsSettings()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see org.eclipse.jface.dialogs.NonModalWindow#initializeBounds()
	 */
	@Override
