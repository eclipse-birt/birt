...
public class FormatStringLayoutPeer extends FormatLayoutPeer
{
	...
	public FormatStringLayoutPeer( int pageAlignment, boolean isFormStyle,
			boolean showLocale )
	{
	...
	protected void fireFormatChanged( String newCategory, String newPattern,
			String newLocale )
	{
		fireFormatChanged( StyleHandle.STRING_FORMAT_PROP,
				newCategory,
				newPattern,
				newLocale );
	}
	...
	protected void initiatePageLayout( String categoryStr, String patternStr,
			String localeStr )
	{
		initiatePageLayout( DesignChoiceConstants.STRING_FORMAT_TYPE_CUSTOM,
				categoryStr,
				patternStr,
				localeStr );
	}
