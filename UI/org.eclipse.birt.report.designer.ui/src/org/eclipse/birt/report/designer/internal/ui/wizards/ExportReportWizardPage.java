...
public class ExportReportWizardPage extends WizardPage implements Listener
{
	 ...
	 * @param titleImage
	 */
	public ExportReportWizardPage( String pageName, String title,
	...
	public boolean isPageComplete( )
	{
		return ( nameText.getText( ).trim( ).length( ) > 0 )
				&& ( folderText.getText( ).trim( ).length( ) > 0 )
				&& ( nameStatus.getSeverity( ) == IStatus.OK )
				&& ( folderStatus.getSeverity( ) == IStatus.OK );
	}
