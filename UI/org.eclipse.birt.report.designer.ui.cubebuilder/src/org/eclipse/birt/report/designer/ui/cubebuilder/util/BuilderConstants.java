...
public class BuilderConstants {
	...
	public static final String IMAGE_LEVEL = "icons/obj16/level.gif"; //$NON-NLS-1$
	...
	public static final String POSITION_X = "x"; //$NON-NLS-1$
	public static final String POSITION_Y = "y"; //$NON-NLS-1$
	public static final String SIZE_WIDTH = "width"; //$NON-NLS-1$
	public static final String SIZE_HEIGHT = "height"; //$NON-NLS-1$
