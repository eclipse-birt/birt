...
public final class ParameterPageUtil
{
	...
	static String[] cellLabels = new String[]{
	...
	static String[] dialogLabels = new String[]{
	...
	static String[] odaCellLabels = new String[]{
			Messages.getString( "dataset.editor.title.name" ), //$NON-NLS-1$
	 ...
	 * @return
	 */
	static String[] getLinkedReportParameterNames(
			OdaDataSetParameterHandle structureHandle )
	{
