...
postingDirectory=$WORKING_DIR/../releng/BIRTOutput/BIRT4.4-download/4.4.1
...
-Dbuild.date=$builddate -Dpackage.version=4_4_1 -DBranchVersion=4.4.1 -Dant.dir=$ANT_HOME/bin \
