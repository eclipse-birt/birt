...
public class ConditionLineList  implements java.io.Serializable {
    ...
    public ConditionLineList(
           org.eclipse.birt.report.soapengine.api.ConditionLine[] conditionLine) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConditionLineList)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.conditionLine==null && other.getConditionLine()==null) || 
    ...
    public synchronized int hashCode() {
        ...
        if (getConditionLine() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getConditionLine());
                 i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConditionLineList.class, true);
