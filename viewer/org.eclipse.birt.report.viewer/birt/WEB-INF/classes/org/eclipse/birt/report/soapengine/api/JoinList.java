...
public class JoinList  implements java.io.Serializable {
    ...
    public JoinList(
           org.eclipse.birt.report.soapengine.api.JoinDefinition[] join) {
           this.join = join;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof JoinList)) return false;
        ...
        _equals = true && 
            ((this.join==null && other.getJoin()==null) || 
             (this.join!=null &&
              java.util.Arrays.equals(this.join, other.getJoin())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getJoin() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getJoin());
                 i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(JoinList.class, true);
