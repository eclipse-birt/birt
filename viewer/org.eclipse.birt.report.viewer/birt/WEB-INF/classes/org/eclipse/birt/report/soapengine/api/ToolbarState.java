...
public class ToolbarState  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ToolbarState)) return false;
        ...
        _equals = true && 
            ...
            this.canUndo == other.isCanUndo() &&
            this.canRedo == other.isCanRedo() &&
            this.canSave == other.isCanSave() &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ToolbarState.class, true);
