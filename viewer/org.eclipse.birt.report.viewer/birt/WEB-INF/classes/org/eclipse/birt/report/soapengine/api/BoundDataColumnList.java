...
public class BoundDataColumnList  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BoundDataColumnList)) return false;
    ...
    public synchronized int hashCode() {
        ...
        if (getBoundDataColumn() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getBoundDataColumn());
                 i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BoundDataColumnList.class, true);
