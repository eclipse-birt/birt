...
public class TableColContextMenuState  implements java.io.Serializable {
    ...
    public TableColContextMenuState(
           boolean canNoRepeatValue,
           boolean canRepeatValue,
           boolean canExpand,
           boolean canCollapse) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TableColContextMenuState)) return false;
        ...
        boolean _equals;
        _equals = true && 
            this.canNoRepeatValue == other.isCanNoRepeatValue() &&
            this.canRepeatValue == other.isCanRepeatValue() &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TableColContextMenuState.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.eclipse.org/birt", "TableColContextMenuState"));
