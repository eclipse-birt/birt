...
public class CategoryChoiceList  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CategoryChoiceList)) return false;
    ...
    public synchronized int hashCode() {
        ...
        if (getCategoryChoice() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getCategoryChoice());
                 i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CategoryChoiceList.class, true);
