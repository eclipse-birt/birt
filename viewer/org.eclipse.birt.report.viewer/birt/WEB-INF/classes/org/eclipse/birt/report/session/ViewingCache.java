...
public class ViewingCache implements Serializable
{
	 ...
	 * @return
	 */
	public String createDocumentPath( String sessionId, String subSessionId,
			String filePath )
	{
		...
		return documentFolder			
				+ getSessionSubfolder( PREFIX_SUB_DOC_FOLDER, sessionId,
						subSessionId ) + documentName;
	}

	/**
	 * Returns the path to the folder containing the files for a given sub
	 * session.
	 * 
	 * @param sessionId
	 *            session ID
	 * @return file path
	 */
	private String getSessionSubfolder( String prefix, String sessionId,
			String subSessionId )
	{
	...
	{
		return imageFolder
				+ getSessionSubfolder( PREFIX_SUB_IMAGE_FOLDER, sessionId,
						subSessionId );
	}
	 ...
	 *            session ID
	 * @param subSessionId
	 *            sub session ID or null to clear the master session
	 */
	...
	public String getReportDocument(String reportFile, String sessionId, String subSessionId, String viewerId) {
		...
		documentFile = createDocumentPath(
