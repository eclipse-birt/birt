...
public class TestEngine extends TestCase implements ICrosstabConstants
{
	...
	public void testEngineExtension( )
	{
		...
		CrosstabReportItemHandle cri = createCrosstab( mh,
				true,
				true,
				true,
				2,
	...
	private CrosstabReportItemHandle createCrosstab( ModuleHandle module,
			boolean hasColumnEdge, boolean hasRowEdge, boolean hasGrandTotal,
			int measureCount, boolean hasMeasureHeader,
			boolean isVerticalMeasureHeader )
	{
		try
		{
			...
			if ( hasRowEdge )
			{
				if ( hasGrandTotal )
				{
					...
					crosstabItem.getGrandTotal( ROW_AXIS_TYPE )
							.addContent( createLabelHandle( module,
									"Grand Total" ) );

					applyBorder( crosstabItem.getGrandTotal( ROW_AXIS_TYPE ),
							"green" );
					applyBackground( crosstabItem.getGrandTotal( ROW_AXIS_TYPE ),
							"orange" );
				}
				...
				dvh.getLevel( 0 )
						...
						.addContent( createLabelHandle( module, "sub total" ) );
				dvh.getLevel( 1 )
						.getAggregationHeader( )
						.addContent( createLabelHandle( module, "sub total" ) );
				...
				dvh.getLevel( 0 )
						.getCell( )
						.addContent( createLabelHandle( module, "LV1" ) );
				dvh.getLevel( 1 )
						.getCell( )
						.addContent( createLabelHandle( module, "LV2" ) );
				...
				applyBackground( dvh.getLevel( 0 ).getAggregationHeader( ),
						"olive" );
				applyTextAlign( dvh.getLevel( 0 ).getAggregationHeader( ),
						"center" );
				applyBorder( dvh.getLevel( 1 ).getAggregationHeader( ), "green" );
				applyBackground( dvh.getLevel( 1 ).getAggregationHeader( ),
						"olive" );
				applyTextAlign( dvh.getLevel( 1 ).getAggregationHeader( ),
						"center" );
				...
				dvh.getLevel( 0 )
						.getCell( )
						.addContent( createLabelHandle( module, "LV3" ) );
			...
			if ( hasColumnEdge )
			{
				if ( hasGrandTotal )
				{
					...
					applyBorder( crosstabItem.getGrandTotal( COLUMN_AXIS_TYPE ),
							"green" );
					applyBackground( crosstabItem.getGrandTotal( COLUMN_AXIS_TYPE ),
							"orange" );
				}

				crosstabItem.insertDimension( null, COLUMN_AXIS_TYPE, -1 );
				DimensionViewHandle dvh2 = crosstabItem.getDimension( COLUMN_AXIS_TYPE,
						0 );
				...
				applyBorder( dvh2.getLevel( 0 ).getAggregationHeader( ),
						"green" );
				applyBackground( dvh2.getLevel( 0 ).getAggregationHeader( ),
						"olive" );
				applyTextAlign( dvh2.getLevel( 0 ).getAggregationHeader( ),
						"center" );
				applyBorder( dvh2.getLevel( 1 ).getAggregationHeader( ),
						"green" );
				applyBackground( dvh2.getLevel( 1 ).getAggregationHeader( ),
						"olive" );
				applyTextAlign( dvh2.getLevel( 1 ).getAggregationHeader( ),
						"center" );

				crosstabItem.insertDimension( null, COLUMN_AXIS_TYPE, -1 );
				DimensionViewHandle dvh3 = crosstabItem.getDimension( COLUMN_AXIS_TYPE,
						1 );
			...
			if ( measureCount > 0 )
			{
				...
				crosstabItem.getMeasure( 0 )
						.getCell( )
						.addContent( createLabelHandle( module, "Measure 0" ) );

				applyBorder( crosstabItem.getMeasure( 0 ).getCell( ), "green" );
				applyBackground( crosstabItem.getMeasure( 0 ).getCell( ),
						"teal" );
				...
				if ( hasMeasureHeader )
				{
					...
					crosstabItem.getMeasure( 0 )
							.getHeader( )
							.addContent( createLabelHandle( module, "Header 0" ) );

					applyBorder( crosstabItem.getMeasure( 0 ).getHeader( ),
							"green" );
					applyBackground( crosstabItem.getMeasure( 0 ).getHeader( ),
							"silver" );
				}
			}
			...
			if ( measureCount > 1 )
			{
				...
				crosstabItem.getMeasure( 1 )
						.getCell( )
						.addContent( createLabelHandle( module, "Measure 1" ) );

				applyBorder( crosstabItem.getMeasure( 1 ).getCell( ), "green" );
				applyBackground( crosstabItem.getMeasure( 1 ).getCell( ),
						"lime" );
				...
				if ( hasMeasureHeader )
				{
					...
					crosstabItem.getMeasure( 1 )
							.getHeader( )
							.addContent( createLabelHandle( module, "Header 1" ) );

					applyBorder( crosstabItem.getMeasure( 1 ).getHeader( ),
							"green" );
					applyBackground( crosstabItem.getMeasure( 1 ).getHeader( ),
							"aqua" );
				}
			...
			CrosstabReportItemHandle crosstabItem ) throws SemanticException
	{
		for ( int k = 0; k < crosstabItem.getMeasureCount( ); k++ )
		{
			...
			AggregationCellHandle handle = mv.addAggregation( null,
					null,
					null,
					null );
	...
	private void applyBorder( AbstractCrosstabItemHandle handle, String color )
	...
	private void applyBackground( AbstractCrosstabItemHandle handle,
			String color ) throws SemanticException
	{
		if ( handle == null )
		{
			return;
	...
	private void applyTextAlign( AbstractCrosstabItemHandle handle, String align )
			throws SemanticException
	{
		if ( handle == null )
		{
	...
	private void applyVerticalAlign( AbstractCrosstabItemHandle handle,
			String align ) throws SemanticException
	{
		if ( handle == null )
		{
			return;
	...
	private LabelHandle createLabelHandle( ModuleHandle module, String text )
			throws SemanticException
	{
