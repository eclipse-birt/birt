...
public class LevelViewParseTest extends BaseTestCase
{
	...
	public void testParse( ) throws Exception
	{
		...
		ExtendedItemHandle extendHandle = (ExtendedItemHandle) designHandle
				.getElementByID( 31l );
		LevelViewHandle levelHandle = (LevelViewHandle) extendHandle
				.getReportItem( );
	...
	public void testWriter( ) throws Exception
	{
		...
		DimensionViewHandle dimensionViewHandle = viewHandle.insertDimension(
				dimensionHandle, -1 );

		LevelHandle levelHandle = designHandle
				.findLevel( "Customer/CUSTOMER_SEX" );//$NON-NLS-1$
		ExtendedItemHandle levelExtendHandle = CrosstabExtendedItemFactory
				.createLevelView( designHandle.getRoot( ), levelHandle );
		LevelViewHandle levelViewHandle = (LevelViewHandle) CrosstabUtil
				.getReportItem( levelExtendHandle );
