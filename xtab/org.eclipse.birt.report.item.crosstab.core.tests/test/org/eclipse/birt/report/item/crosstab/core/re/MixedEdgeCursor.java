...
public class MixedEdgeCursor extends DummyEdgeCursor
{
	...
	void setEdgeEnd( DummyDimensionCursor dim, int idx ) throws OLAPException
	{
		...
		{
			dim.setEdgeEnd( dim.getEdgeStart( )
					+ dim.getCount( )
					* c
					- 1
					+ plus
	...
	public void addSegmentDimensionCursor( DimensionCursor dc, long edgeStart,
			long edgeEnd )
	{
		addDimensionCursor( new SegmentDimensionCursorWrapper( this,
				dc,
				edgeStart,
				edgeEnd ) );
	}
