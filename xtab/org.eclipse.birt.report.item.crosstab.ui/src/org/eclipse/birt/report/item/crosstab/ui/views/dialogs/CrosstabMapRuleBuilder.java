...
public class CrosstabMapRuleBuilder extends MapRuleBuilder {
	 ...
	 * @param provider
	 */
	public CrosstabMapRuleBuilder(Shell parentShell, String title, MapHandleProvider provider) {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (converter != null) {
					if (expression.getText().equals(VALUE_OF_THIS_DATA_ITEM)
						...
						expression.setText(ExpressionUtility
	...
	protected List getSelectValueList() throws BirtException {
		...
		DataSetHandle dataSetHandle = (DataSetHandle) ((CubeHandle) cube)
				.getElementProperty(ITabularCubeModel.DATA_SET_PROP);
