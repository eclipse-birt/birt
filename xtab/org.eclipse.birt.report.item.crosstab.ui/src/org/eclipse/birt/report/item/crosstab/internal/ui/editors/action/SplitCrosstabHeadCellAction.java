...
public class SplitCrosstabHeadCellAction extends AbstractCrosstabAction
{
	...
	private static final String NAME = "Splite Cell";
	...
	{
		transStar( NAME );
		CrosstabUtil.spliteHeaderCell(  cellHandle.getCrosstab( ) );
	...
	public boolean isEnabled( )
	{
		...
		return CrosstabAdaptUtil.canSpliteCrosstabHeaderCell( cellHandle.getCrosstab( ));		
	}
